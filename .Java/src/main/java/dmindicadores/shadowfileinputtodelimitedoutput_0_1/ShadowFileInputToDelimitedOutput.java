...
package dmindicadores.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements
		...
		final static byte[] commonByteArrayLock_DMINDICADORES_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_DMINDICADORES_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DMINDICADORES_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024
							&& commonByteArray_DMINDICADORES_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_DMINDICADORES_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_DMINDICADORES_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_DMINDICADORES_ShadowFileInputToDelimitedOutput,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DMINDICADORES_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"/home/sistemasoas/Documentos/developer/TOS_DI-20180829_1603-V7.1.1M3/workspace/DMINDICADORES/temp/preview/snies.csv"))
				...
				try {
					...
					Object filename_tFileInputDelimited = "/home/sistemasoas/Documents/snies.csv";
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class
					.getClassLoader().getResourceAsStream(
							"dmindicadores/shadowfileinputtodelimitedoutput_0_1/contexts/"
...
/************************************************************************************************
 * 54561 characters generated by Talend Open Studio for Data Integration on the
 * 25 de septiembre de 2018 03:32:21 PM COT
 ************************************************************************************************/
