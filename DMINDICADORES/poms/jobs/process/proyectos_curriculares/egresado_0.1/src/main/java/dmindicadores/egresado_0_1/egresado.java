...
package dmindicadores.egresado_0_1;
...
/**
 * Job: egresado Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 7.1.1.20180829_1603-M3
 * @status 
 */
public class egresado implements TalendJob {
	...
	private final String jobName = "egresado";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(egresado.this, new Object[] { e,
	...
	public static class inscritosStruct implements
		...
		final static byte[] commonByteArrayLock_DMINDICADORES_egresado = new byte[0];
		static byte[] commonByteArray_DMINDICADORES_egresado = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DMINDICADORES_egresado.length) {
					if (length < 1024
							&& commonByteArray_DMINDICADORES_egresado.length == 0) {
						commonByteArray_DMINDICADORES_egresado = new byte[1024];
					} else {
						commonByteArray_DMINDICADORES_egresado = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DMINDICADORES_egresado, 0, length);
				strReturn = new String(commonByteArray_DMINDICADORES_egresado,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DMINDICADORES_egresado) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tPostgresqlOutput_1 == null
					...
					tableName_tPostgresqlOutput_1 = "egresado";
				} else {
				...
				try (java.sql.ResultSet rsTable_tPostgresqlOutput_1 = dbMetaData_tPostgresqlOutput_1
					...
					while (rsTable_tPostgresqlOutput_1.next()) {
						...
						if (table_tPostgresqlOutput_1.equals("egresado")
					...
					while (rs_tOracleInput_1.next()) {
						...
						if (colQtyInRs_tOracleInput_1 < 4) {
							...
							row1.PROYECTO_SNIES = routines.system.JDBCUtil
									.getString(rs_tOracleInput_1, 4, true);
						}
						if (colQtyInRs_tOracleInput_1 < 5) {
							row1.CODIGO_PROYECTO = 0;
						} else {

							row1.CODIGO_PROYECTO = rs_tOracleInput_1.getInt(5);
						...
						if (colQtyInRs_tOracleInput_1 < 6) {
							...
							row1.PROYECTO = routines.system.JDBCUtil.getString(
									rs_tOracleInput_1, 6, true);
						}
						if (colQtyInRs_tOracleInput_1 < 7) {
							row1.CODIGO_FACULTAD = 0;
						} else {

							row1.CODIGO_FACULTAD = rs_tOracleInput_1.getInt(7);
						...
						if (colQtyInRs_tOracleInput_1 < 10) {
							...
							row1.EST_NOMBRE = routines.system.JDBCUtil
									.getString(rs_tOracleInput_1, 10, true);
						}
						if (colQtyInRs_tOracleInput_1 < 11) {
							row1.EST_NRO_IDEN = null;
						} else {

							row1.EST_NRO_IDEN = rs_tOracleInput_1.getLong(11);
						...
						if (colQtyInRs_tOracleInput_1 < 13) {
							...
							row1.LAU_VLREND = routines.system.JDBCUtil
									.getString(rs_tOracleInput_1, 13, true);
						}
						if (colQtyInRs_tOracleInput_1 < 14) {
							...
							row1.ESTADO_DESCRIPCION = routines.system.JDBCUtil
									.getString(rs_tOracleInput_1, 14, true);
						}
						...
						{ // start of Var scope
							...
							inscritos_tmp.id = Numeric
									.sequence("s1", 204285, 1);
	...
	public static void main(String[] args) {
		final egresado egresadoClass = new egresado();

		int exitCode = egresadoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = egresado.class.getClassLoader()
					.getResourceAsStream(
							"dmindicadores/egresado_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = egresado.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : egresado");
		}
...
/************************************************************************************************
 * 187853 characters generated by Talend Open Studio for Data Integration on the
 * 12 de septiembre de 2018 03:24:48 PM COT
 ************************************************************************************************/
