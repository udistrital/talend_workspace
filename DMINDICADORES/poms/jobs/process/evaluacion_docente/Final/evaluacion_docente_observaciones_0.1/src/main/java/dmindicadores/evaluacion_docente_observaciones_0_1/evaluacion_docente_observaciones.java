...
package dmindicadores.evaluacion_docente_observaciones_0_1;
...
/**
 * Job: evaluacion_docente_observaciones Purpose: <br>
 * Description: prueba <br>
 * @author test@talend.com
 * @version 7.1.1.20180829_1603-M3
 * @status 
 */
public class evaluacion_docente_observaciones implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "evaluacion_docente_observaciones";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_WKL00DJdEeWFMLJMBdbd9A", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_WKL00DJdEeWFMLJMBdbd9A", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				evaluacion_docente_observaciones.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(evaluacion_docente_observaciones.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class obsStruct implements routines.system.IPersistableRow<obsStruct> {
    final static byte[] commonByteArrayLock_DMINDICADORES_evaluacion_docente_observaciones = new byte[0];
    static byte[] commonByteArray_DMINDICADORES_evaluacion_docente_observaciones = new byte[0];
			    ...
			    public Integer codigo_espacio;

				public Integer getCodigo_espacio () {
			    ...
			    public long obs_identificacion_evaluado;

				public long getObs_identificacion_evaluado () {
					return this.obs_identificacion_evaluado;
				}
				
			    public String obs_identificacion_evaluador;

				public String getObs_identificacion_evaluador () {
					return this.obs_identificacion_evaluador;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DMINDICADORES_evaluacion_docente_observaciones.length) {
				if(length < 1024 && commonByteArray_DMINDICADORES_evaluacion_docente_observaciones.length == 0) {
   					commonByteArray_DMINDICADORES_evaluacion_docente_observaciones = new byte[1024];
				} else {
   					commonByteArray_DMINDICADORES_evaluacion_docente_observaciones = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DMINDICADORES_evaluacion_docente_observaciones, 0, length);
			strReturn = new String(commonByteArray_DMINDICADORES_evaluacion_docente_observaciones, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DMINDICADORES_evaluacion_docente_observaciones) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.proyecto = readString(dis);
						...
						this.codigo_espacio = readInteger(dis);
			        ...
			        this.obs_identificacion_evaluado = dis.readLong();
					
					this.obs_identificacion_evaluador = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.codigo_espacio,dos);
					...
					// long
		            	...
		            	dos.writeLong(this.obs_identificacion_evaluado);
					
					// String
				
						writeString(this.obs_identificacion_evaluador,dos);
    ...
    public String toString() {
		...
		sb.append(",obs_identificacion_evaluado="+String.valueOf(obs_identificacion_evaluado));
		sb.append(",obs_identificacion_evaluador="+obs_identificacion_evaluador);
	    sb.append("]");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_DMINDICADORES_evaluacion_docente_observaciones = new byte[0];
				...
				public int getObs_anio () {
					return this.obs_anio;
				}
				
			    public int obs_periodo;

				public int getObs_periodo () {
					return this.obs_periodo;
				}
				
			    public int obs_carrera;

				public int getObs_carrera () {
					return this.obs_carrera;
				}
				
			    public int obs_asignatura;

				public int getObs_asignatura () {
					return this.obs_asignatura;
				}
				
			    public String obs_fec_registro;

				public String getObs_fec_registro () {
					return this.obs_fec_registro;
				}
				
			    public String obs_observaciones;

				public String getObs_observaciones () {
					return this.obs_observaciones;
				}
				
			    public String obs_estado;

				public String getObs_estado () {
					return this.obs_estado;
				}
				
			    public String obs_grupo;

				public String getObs_grupo () {
					return this.obs_grupo;
				}
		...
		synchronized(commonByteArrayLock_DMINDICADORES_evaluacion_docente_observaciones) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.obs_anio = dis.readInt();
					
			        this.obs_periodo = dis.readInt();
					
			        this.obs_carrera = dis.readInt();
					
			        this.obs_asignatura = dis.readInt();
					
					this.obs_fec_registro = readString(dis);
					
					this.obs_observaciones = readString(dis);
					
					this.obs_estado = readString(dis);
					
					this.obs_grupo = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.obs_anio);
					
					// int
				
		            	dos.writeInt(this.obs_periodo);
					
					// int
				
		            	dos.writeInt(this.obs_carrera);
					
					// int
				
		            	dos.writeInt(this.obs_asignatura);
					
					// String
				
						writeString(this.obs_fec_registro,dos);
					
					// String
				
						writeString(this.obs_observaciones,dos);
					
					// String
				
						writeString(this.obs_estado,dos);
					
					// String
				
						writeString(this.obs_grupo,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("obs_id="+String.valueOf(obs_id));
		sb.append(",form_id="+String.valueOf(form_id));
		sb.append(",obs_identificacion_evaluador="+obs_identificacion_evaluador);
		sb.append(",obs_identificacion_evaluado="+String.valueOf(obs_identificacion_evaluado));
		sb.append(",obs_anio="+String.valueOf(obs_anio));
		sb.append(",obs_periodo="+String.valueOf(obs_periodo));
		sb.append(",obs_carrera="+String.valueOf(obs_carrera));
		sb.append(",obs_asignatura="+String.valueOf(obs_asignatura));
		sb.append(",obs_fec_registro="+obs_fec_registro);
		sb.append(",obs_observaciones="+obs_observaciones);
		sb.append(",obs_estado="+obs_estado);
		sb.append(",obs_grupo="+obs_grupo);
	    sb.append("]");
	...
	currentComponent="tPostgresqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("obs" + iterateId, 0, 0);
...
if(dbschema_tPostgresqlOutput_1 == null || dbschema_tPostgresqlOutput_1.trim().length() == 0) {
	tableName_tPostgresqlOutput_1 = "evaluacion_docente_observaciones";
} else {
	tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1 + "\".\"" + "evaluacion_docente_observaciones";
}
...
int count_tPostgresqlOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tPostgresqlOutput_1 = dbMetaData_tPostgresqlOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tPostgresqlOutput_1.next()) {
                                        ...
                                        if(table_tPostgresqlOutput_1.equals("evaluacion_docente_observaciones")
                                ...
                                try(java.sql.Statement stmtCreate_tPostgresqlOutput_1 = conn_tPostgresqlOutput_1.createStatement()) {
                                    stmtCreate_tPostgresqlOutput_1.execute("CREATE TABLE \"" + tableName_tPostgresqlOutput_1 + "\"(\"anno\" INT4 ,\"semestre\" INT4 ,\"codigo_facultad\" INT4 ,\"facultad\" VARCHAR(64)  ,\"codigo_proyecto\" INT4 ,\"proyecto\" VARCHAR(250)  ,\"codigo_espacio\" INT4 ,\"espacio\" VARCHAR(100)  ,\"codigo_docente\" INT8 ,\"docente\" VARCHAR(52)  ,\"codigo_tipo_vinculacion\" INT4 ,\"vinculacion\" VARCHAR(45)  ,\"grupo\" VARCHAR(44)  ,\"observaciones\" VARCHAR(10000)  ,\"fecha_registro\" VARCHAR(13)  ,\"fecha_carga\" VARCHAR ,\"obs_identificacion_evaluado\" INT8  not null ,\"obs_identificacion_evaluador\" VARCHAR(18)   not null )");
                                }
	    String insert_tPostgresqlOutput_1 = "INSERT INTO \"" + tableName_tPostgresqlOutput_1 + "\" (\"anno\",\"semestre\",\"codigo_facultad\",\"facultad\",\"codigo_proyecto\",\"proyecto\",\"codigo_espacio\",\"espacio\",\"codigo_docente\",\"docente\",\"codigo_tipo_vinculacion\",\"vinculacion\",\"grupo\",\"observaciones\",\"fecha_registro\",\"fecha_carga\",\"obs_identificacion_evaluado\",\"obs_identificacion_evaluador\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
obsStruct obs_tmp = new obsStruct();
// ###############################
		...
		int tos_count_tPostgresqlInput_1 = 0;
		    ...
		    java.sql.Connection conn_tPostgresqlInput_1 = null;
			    ...
			    java.lang.Class.forName(driverClass_tPostgresqlInput_1);
			   	String dbUser_tPostgresqlInput_1 = "consultaevaldocente";
			   	
        		
        		
        		 
	final String decryptedPassword_tPostgresqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("9629c423cea0e7eab33805d8d318a9af0e323c535663df22");
			   	
		        String dbPwd_tPostgresqlInput_1 = decryptedPassword_tPostgresqlInput_1;
		        
				
			String url_tPostgresqlInput_1 = "jdbc:postgresql://" + "postgresproduccion.c8an9arwoaua.us-east-1.rds.amazonaws.com" + ":" + "5432" + "/" + "saraacademica";
		    ...
		    String dbquery_tPostgresqlInput_1 = "SELECT \n  \"saraacademica\".\"autoevaluadoc\".\"evaldocente_observaciones\".\"obs_id\", \n  \"saraacademica\".\"autoeval"
+"uadoc\".\"evaldocente_observaciones\".\"form_id\", \n  \n \n \"saraacademica\".\"autoevaluadoc\".\"evaldocente_observacione"
+"s\".\"obs_identificacion_evaluador\", \n  \n \"saraacademica\".\"autoevaluadoc\".\"evaldocente_observaciones\".\"obs_ident"
+"ificacion_evaluado\",\n  \n  \"saraacademica\".\"autoevaluadoc\".\"evaldocente_observaciones\".\"obs_anio\", \n  \"saraacad"
+"emica\".\"autoevaluadoc\".\"evaldocente_observaciones\".\"obs_periodo\", \n  \"saraacademica\".\"autoevaluadoc\".\"evaldo"
+"cente_observaciones\".\"obs_carrera\", \n  \"saraacademica\".\"autoevaluadoc\".\"evaldocente_observaciones\".\"obs_asigna"
+"tura\", \n  \"saraacademica\".\"autoevaluadoc\".\"evaldocente_observaciones\".\"obs_fec_registro\", \n  \"saraacademica\"."
+"\"autoevaluadoc\".\"evaldocente_observaciones\".\"obs_observaciones\", \n  \"saraacademica\".\"autoevaluadoc\".\"evaldoce"
+"nte_observaciones\".\"obs_estado\", \n  \"saraacademica\".\"autoevaluadoc\".\"evaldocente_observaciones\".\"obs_grupo\"\nF"
+"ROM \"saraacademica\".\"autoevaluadoc\".\"evaldocente_observaciones\" where \"obs_observaciones\" \n <>''";
            ...
            if(rs_tPostgresqlInput_1.getObject(1) != null) {
                row1.obs_id = rs_tPostgresqlInput_1.getInt(1);
            } else {
            ...
            if(rs_tPostgresqlInput_1.getObject(2) != null) {
                row1.form_id = rs_tPostgresqlInput_1.getInt(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_1 < 3) {
								row1.obs_identificacion_evaluador = null;
							} else {
	                         		
        	row1.obs_identificacion_evaluador = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_1, 3, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_1 < 4) {
								row1.obs_identificacion_evaluado = 0;
							} else {
		                          
            if(rs_tPostgresqlInput_1.getObject(4) != null) {
                row1.obs_identificacion_evaluado = rs_tPostgresqlInput_1.getLong(4);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tPostgresqlInput_1.getObject(5) != null) {
                row1.obs_anio = rs_tPostgresqlInput_1.getInt(5);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tPostgresqlInput_1.getObject(6) != null) {
                row1.obs_periodo = rs_tPostgresqlInput_1.getInt(6);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tPostgresqlInput_1.getObject(7) != null) {
                row1.obs_carrera = rs_tPostgresqlInput_1.getInt(7);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_1 < 8) {
								row1.obs_asignatura = 0;
							} else {
		                          
            if(rs_tPostgresqlInput_1.getObject(8) != null) {
                row1.obs_asignatura = rs_tPostgresqlInput_1.getInt(8);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_1 < 9) {
								row1.obs_fec_registro = null;
							} else {
	                         		
        	row1.obs_fec_registro = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_1, 9, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_1 < 10) {
								row1.obs_observaciones = null;
							} else {
	                         		
        	row1.obs_observaciones = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_1, 10, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_1 < 11) {
								row1.obs_estado = null;
							} else {
	                         		
        	row1.obs_estado = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_1, 11, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_1 < 12) {
								row1.obs_grupo = null;
							} else {
	                         		
        	row1.obs_grupo = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_1, 12, false);
		                    }
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row2__anno = row1.obs_anio ;
	                        		    	if(exprKeyValue_row2__anno == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row2HashKey.anno = (int)(Integer) exprKeyValue_row2__anno;
                        		    		}
                        		    		
	                        		    	Object exprKeyValue_row2__semestre = row1.obs_periodo ;
	                        		    	if(exprKeyValue_row2__semestre == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row2HashKey.semestre = (int)(Integer) exprKeyValue_row2__semestre;
                        		    		}
                        		    		
	                        		    	Object exprKeyValue_row2__codigo_espacio = row1.obs_asignatura ;
	                        		    	if(exprKeyValue_row2__codigo_espacio == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row2HashKey.codigo_espacio = (int)(Integer) exprKeyValue_row2__codigo_espacio;
                        		    		}
                        		    		
	                        		    	Object exprKeyValue_row2__codigo_docente = row1.obs_identificacion_evaluado ;
	                        		    	if(exprKeyValue_row2__codigo_docente == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row2HashKey.codigo_docente = (long)(Long) exprKeyValue_row2__codigo_docente;
                        		    		}
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.anno = '" + row2HashKey.anno + "', row2.semestre = '" + row2HashKey.semestre + "', row2.codigo_espacio = '" + row2HashKey.codigo_espacio + "', row2.codigo_docente = '" + row2HashKey.codigo_docente + "'");
								} // G 071
...
// # Output table : 'obs'
obs_tmp.anno = row2.anno ;
obs_tmp.semestre = row2.semestre ;
obs_tmp.codigo_facultad = row2.codigo_facultad ;
obs_tmp.facultad = row2.facultad ;
obs_tmp.codigo_proyecto = row2.codigo_proyecto ;
obs_tmp.proyecto = row2.proyecto ;
obs_tmp.codigo_espacio = row2.codigo_espacio ;
obs_tmp.espacio = row2.espacio ;
obs_tmp.codigo_docente = row2.codigo_docente ;
obs_tmp.docente = row2.docente ;
obs_tmp.codigo_tipo_vinculacion = row2.codigo_tipo_vinculacion ;
obs_tmp.vinculacion = row2.vinculacion ;
obs_tmp.grupo = row1.obs_grupo ;
obs_tmp.observaciones = StringHandling.LEFT(row1.obs_observaciones,10000) ;
obs_tmp.fecha_registro = row1.obs_fec_registro ;
obs_tmp.fecha_carga = TalendDate.getDate("DD/MM/CCYY")  ;
obs_tmp.obs_identificacion_evaluado = row1.obs_identificacion_evaluado ;
obs_tmp.obs_identificacion_evaluador = row1.obs_identificacion_evaluador ;
obs = obs_tmp;
// ###############################
...
if(obs != null) { 
	...
	currentComponent="tPostgresqlOutput_1";
			...
			//obs
				...
				if(execStat){
					runStat.updateStatOnConnection("obs"+iterateId,1, 1);
				} 
...
} else {pstmt_tPostgresqlOutput_1.setInt(1, obs.anno);
}

                    if(obs.semestre == null) {
pstmt_tPostgresqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setInt(2, obs.semestre);
}

                    if(obs.codigo_facultad == null) {
pstmt_tPostgresqlOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setInt(3, obs.codigo_facultad);
}

                    if(obs.facultad == null) {
pstmt_tPostgresqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(4, obs.facultad);
}

                    if(obs.codigo_proyecto == null) {
pstmt_tPostgresqlOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setInt(5, obs.codigo_proyecto);
}

                    if(obs.proyecto == null) {
pstmt_tPostgresqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(6, obs.proyecto);
}

                    if(obs.codigo_espacio == null) {
pstmt_tPostgresqlOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setInt(7, obs.codigo_espacio);
}

                    if(obs.espacio == null) {
pstmt_tPostgresqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(8, obs.espacio);
}

                    if(obs.codigo_docente == null) {
pstmt_tPostgresqlOutput_1.setNull(9, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setLong(9, obs.codigo_docente);
}

                    if(obs.docente == null) {
pstmt_tPostgresqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(10, obs.docente);
}

                    if(obs.codigo_tipo_vinculacion == null) {
pstmt_tPostgresqlOutput_1.setNull(11, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setInt(11, obs.codigo_tipo_vinculacion);
}

                    if(obs.vinculacion == null) {
pstmt_tPostgresqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(12, obs.vinculacion);
}

                    if(obs.grupo == null) {
pstmt_tPostgresqlOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(13, obs.grupo);
}

                    if(obs.observaciones == null) {
pstmt_tPostgresqlOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(14, obs.observaciones);
}

                    if(obs.fecha_registro == null) {
pstmt_tPostgresqlOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(15, obs.fecha_registro);
}

                    if(obs.fecha_carga == null) {
pstmt_tPostgresqlOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(16, obs.fecha_carga);
}

                    pstmt_tPostgresqlOutput_1.setLong(17, obs.obs_identificacion_evaluado);

                    if(obs.obs_identificacion_evaluador == null) {
pstmt_tPostgresqlOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(18, obs.obs_identificacion_evaluador);
}
 ...
 */
	...
	nb_line_rejected_tPostgresqlOutput_1=nb_line_rejected_tPostgresqlOutput_1 + rejectedCount_tPostgresqlOutput_1;
        ...
        globalMap.put("tPostgresqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tPostgresqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("obs"+iterateId,2, 0); 
			 	}
			}
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.espacio = readString(dis,ois);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.inscritos = null;
           				} else {
           			    	this.inscritos = dis.readLong();
           				}
					
						this.docente = readString(dis,ois);
					
						this.codigo_tipo_vinculacion = readInteger(dis,ois);
					
						this.vinculacion = readString(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.espacio, dos, oos);
					
						if(this.inscritos == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.inscritos);
		            	}
					
						writeString(this.docente, dos, oos);
					
					writeInteger(this.codigo_tipo_vinculacion, dos, oos);
					
						writeString(this.vinculacion, dos, oos);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(obs)
 ...
 */
	...
	final String decryptedPassword_tPostgresqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("610243e4ca33e325f4f7aba1746784ea");
			   	
		        String dbPwd_tPostgresqlInput_2 = decryptedPassword_tPostgresqlInput_2;
		        
				
			String url_tPostgresqlInput_2 = "jdbc:postgresql://" + "10.20.0.88" + ":" + "5432" + "/" + "DMINDICADORES";
		    ...
		    String dbquery_tPostgresqlInput_2 = "SELECT anno, semestre, codigo_facultad, facultad, codigo_proyecto,\n  proyecto, \n       codigo_espacio, espacio, sum(ins"
+"critos) inscritos, codigo_docente, docente,\n  codigo_tipo_vinculacion,vinculacion, trim(both from grupo) grupo\n  \n \n FRO"
+"M evaluacion_docente_consolidado_inscritos \n\n  group by anno, semestre, codigo_facultad, facultad, codigo_proyecto,\n  pr"
+"oyecto, \n       codigo_espacio, espacio,   codigo_docente, docente, codigo_tipo_vinculacion,vinculacion,\n  grupo\n   orde"
+"r by codigo_espacio";
                ...
                row2.semestre = rs_tPostgresqlInput_2.getInt(2);
                    ...
                    throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tPostgresqlInput_2 < 3) {
								row2.codigo_facultad = 0;
							} else {
		                          
            if(rs_tPostgresqlInput_2.getObject(3) != null) {
                row2.codigo_facultad = rs_tPostgresqlInput_2.getInt(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row2.facultad = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_2, 4, false);
		                    }
            ...
            if(rs_tPostgresqlInput_2.getObject(5) != null) {
                row2.codigo_proyecto = rs_tPostgresqlInput_2.getInt(5);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row2.proyecto = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_2, 6, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_2 < 7) {
								row2.codigo_espacio = 0;
							} else {
		                          
            if(rs_tPostgresqlInput_2.getObject(7) != null) {
                row2.codigo_espacio = rs_tPostgresqlInput_2.getInt(7);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row2.espacio = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_2, 8, false);
		                    }
            ...
            if(rs_tPostgresqlInput_2.getObject(9) != null) {
                row2.inscritos = rs_tPostgresqlInput_2.getLong(9);
            } else {
                    row2.inscritos = null;
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_2 < 10) {
								row2.codigo_docente = 0;
							} else {
		                          
            if(rs_tPostgresqlInput_2.getObject(10) != null) {
                row2.codigo_docente = rs_tPostgresqlInput_2.getLong(10);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row2.docente = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_2, 11, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_2 < 12) {
								row2.codigo_tipo_vinculacion = null;
							} else {
		                          
            if(rs_tPostgresqlInput_2.getObject(12) != null) {
                row2.codigo_tipo_vinculacion = rs_tPostgresqlInput_2.getInt(12);
            } else {
                    row2.codigo_tipo_vinculacion = null;
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_2 < 13) {
								row2.vinculacion = null;
							} else {
	                         		
        	row2.vinculacion = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_2, 13, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_2 < 14) {
								row2.grupo = null;
							} else {
	                         		
        	row2.grupo = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_2, 14, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
			...
			//row2
				...
				row2_HashRow.codigo_espacio = row2.codigo_espacio;
				
				row2_HashRow.espacio = row2.espacio;
				
				row2_HashRow.inscritos = row2.inscritos;
				
				row2_HashRow.codigo_docente = row2.codigo_docente;
				
				row2_HashRow.docente = row2.docente;
				
				row2_HashRow.codigo_tipo_vinculacion = row2.codigo_tipo_vinculacion;
				
				row2_HashRow.vinculacion = row2.vinculacion;
				
				row2_HashRow.grupo = row2.grupo;
 ...
 */
    ...
    public static void main(String[] args){
        final evaluacion_docente_observaciones evaluacion_docente_observacionesClass = new evaluacion_docente_observaciones();

        int exitCode = evaluacion_docente_observacionesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = evaluacion_docente_observaciones.class.getClassLoader().getResourceAsStream("dmindicadores/evaluacion_docente_observaciones_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = evaluacion_docente_observaciones.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : evaluacion_docente_observaciones");
        }
...
/************************************************************************************************
 *     197816 characters generated by Talend Open Studio for Data Integration 
 *     on the 17 de septiembre de 2018 04:31:53 PM COT
 ************************************************************************************************/