...
package dmindicadores.evaluacion_docente_estudiantes_faltantes_0_1;
...
/**
 * Job: evaluacion_docente_estudiantes_faltantes Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 7.1.1.20180829_1603-M3
 * @status 
 */
public class evaluacion_docente_estudiantes_faltantes implements TalendJob {
	...
	private final String jobName = "evaluacion_docente_estudiantes_faltantes";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					evaluacion_docente_estudiantes_faltantes.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(
									evaluacion_docente_estudiantes_faltantes.this,
	...
	public void tOracleClose_2_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tOracleClose_2_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public static class row6Struct implements
		...
		final static byte[] commonByteArrayLock_DMINDICADORES_evaluacion_docente_estudiantes_faltantes = new byte[0];
		static byte[] commonByteArray_DMINDICADORES_evaluacion_docente_estudiantes_faltantes = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DMINDICADORES_evaluacion_docente_estudiantes_faltantes.length) {
					if (length < 1024
							&& commonByteArray_DMINDICADORES_evaluacion_docente_estudiantes_faltantes.length == 0) {
						commonByteArray_DMINDICADORES_evaluacion_docente_estudiantes_faltantes = new byte[1024];
					} else {
						commonByteArray_DMINDICADORES_evaluacion_docente_estudiantes_faltantes = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_DMINDICADORES_evaluacion_docente_estudiantes_faltantes,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DMINDICADORES_evaluacion_docente_estudiantes_faltantes) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tPostgresqlInput_2.next()) {
						...
						query_tPostgresqlRow_1 = "DELETE FROM evaluacion_docente_estudiantes_faltan\n WHERE anno=2018 and semestre=1";
	...
	public static class profesoresStruct implements
			routines.system.IPersistableRow<profesoresStruct> {
		final static byte[] commonByteArrayLock_DMINDICADORES_evaluacion_docente_estudiantes_faltantes = new byte[0];
		static byte[] commonByteArray_DMINDICADORES_evaluacion_docente_estudiantes_faltantes = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DMINDICADORES_evaluacion_docente_estudiantes_faltantes) {
				...
				try {
					...
					this.nombre_estudiante = readString(dis);

					this.correo_institucional = readString(dis);

					this.correo_personal = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.nombre_estudiante, dos);

				// String

				writeString(this.correo_institucional, dos);

				// String

				writeString(this.correo_personal, dos);
		...
		public String toString() {
			...
			sb.append(",nombre_estudiante=" + nombre_estudiante);
			sb.append(",correo_institucional=" + correo_institucional);
			sb.append(",correo_personal=" + correo_personal);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tPostgresqlOutput_1 == null
					...
					tableName_tPostgresqlOutput_1 = "evaluacion_docente_estudiantes_faltan";
				} else {
					tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1
							+ "\".\"" + "evaluacion_docente_estudiantes_faltan";
				}
				...
				try (java.sql.ResultSet rsTable_tPostgresqlOutput_1 = dbMetaData_tPostgresqlOutput_1
					...
					while (rsTable_tPostgresqlOutput_1.next()) {
						...
						if (table_tPostgresqlOutput_1
								.equals("evaluacion_docente_estudiantes_faltan")
					...
					try (java.sql.Statement stmtCreate_tPostgresqlOutput_1 = conn_tPostgresqlOutput_1
						...
						stmtCreate_tPostgresqlOutput_1
								.execute("CREATE TABLE \""
										...
										+ "\"(\"anno\" INT4 ,\"semestre\" INT4 ,\"codigo_facultad\" INT4 ,\"facultad\" VARCHAR(64)  ,\"codigo_proyecto\" INT4 ,\"proyecto\" VARCHAR(100)  ,\"codigo_estudiante\" INT8  not null ,\"nombre_estudiante\" VARCHAR(50)   not null ,\"correo_institucional\" VARCHAR(50)  ,\"correo_personal\" VARCHAR(50)  ,\"fecha_carga\" TIMESTAMP )");
					}
				}
				String insert_tPostgresqlOutput_1 = "INSERT INTO \""
						+ tableName_tPostgresqlOutput_1
						+ "\" (\"anno\",\"semestre\",\"codigo_facultad\",\"facultad\",\"codigo_proyecto\",\"proyecto\",\"codigo_estudiante\",\"nombre_estudiante\",\"correo_institucional\",\"correo_personal\",\"fecha_carga\") VALUES (?,?,?,?,?,?,?,?,?,?,?)";
				...
				String dbquery_tPostgresqlInput_1 = "SELECT distinct edi.\"ANNO\", edi.\"SEMESTRE\", edi.\"CODIGO_FACULTAD\", edi.\"FACULTAD\",\n  edi.\"CODIGO_PROYECTO\",ed"
						+ "i.\"PROYECTO\",\n  edi.\"ESTUDIANTE\"\n  \n FROM evaluacion_docente_inscritos edi where edi.\"ESTUDIANTE\" NOT IN (select d"
						+ "istinct \n edr.estudiante from evaluacion_docente_respuestas edr where edr.anno=2018 AND edr.semestre=3 and \n edr.codigo_"
						+ "tipo_evaluacion =1)\n  AND edi.\"ANNO\"=2018 and edi.\"SEMESTRE\"=3";
					...
					while (rs_tPostgresqlInput_1.next()) {
						...
						if (colQtyInRs_tPostgresqlInput_1 < 3) {
							...
							if (rs_tPostgresqlInput_1.getObject(3) != null) {
								row1.CODIGO_FACULTAD = rs_tPostgresqlInput_1
										.getInt(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tPostgresqlInput_1 < 5) {
							...
							if (rs_tPostgresqlInput_1.getObject(5) != null) {
								row1.CODIGO_PROYECTO = rs_tPostgresqlInput_1
										.getInt(5);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tPostgresqlInput_1 < 7) {
							...
							if (rs_tPostgresqlInput_1.getObject(7) != null) {
								row1.ESTUDIANTE = rs_tPostgresqlInput_1
										.getLong(7);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row2__EOT_COD = row1.ESTUDIANTE;
							if (exprKeyValue_row2__EOT_COD == null) {
								hasCasePrimitiveKeyWithNull_tMap_1 = true;
							} else {
								row2HashKey.EOT_COD = (long) (Long) exprKeyValue_row2__EOT_COD;
							}
						...
						if (tHash_Lookup_row2 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.EOT_COD = '"
							// + row2HashKey.EOT_COD + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							profesores_tmp.codigo_estudiante = row1.ESTUDIANTE;
							profesores_tmp.nombre_estudiante = row2.EST_NOMBRE;
							profesores_tmp.correo_institucional = row2.EOT_EMAIL_INS;
							profesores_tmp.correo_personal = row2.EOT_EMAIL;
							profesores_tmp.fecha_carga = TalendDate.parseDate(
									"dd-MM-yyyy",
						...
						if (profesores != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection("profesores"
										+ iterateId, 1, 1);
							}
							...
							pstmt_tPostgresqlOutput_1.setLong(7,
									profesores.codigo_estudiante);

							if (profesores.nombre_estudiante == null) {
								pstmt_tPostgresqlOutput_1.setNull(8,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(8,
										profesores.nombre_estudiante);
							}

							if (profesores.correo_institucional == null) {
								pstmt_tPostgresqlOutput_1.setNull(9,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(9,
										profesores.correo_institucional);
							}

							if (profesores.correo_personal == null) {
								pstmt_tPostgresqlOutput_1.setNull(10,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(10,
										profesores.correo_personal);
							}
	...
	public static class row2Struct implements
		...
		public long getEOT_COD() {
			return this.EOT_COD;
		}

		public String EOT_EMAIL_INS;

		public String getEOT_EMAIL_INS() {
			return this.EOT_EMAIL_INS;
		}

		public String EOT_EMAIL;

		public String getEOT_EMAIL() {
			return this.EOT_EMAIL;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.EOT_COD;
		...
		public void copyDataTo(row2Struct other) {
			...
			other.EOT_COD = this.EOT_COD;
			other.EOT_EMAIL_INS = this.EOT_EMAIL_INS;
			other.EOT_EMAIL = this.EOT_EMAIL;
			other.EST_NOMBRE = this.EST_NOMBRE;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.EOT_EMAIL_INS = readString(dis, ois);

				this.EOT_EMAIL = readString(dis, ois);

				this.EST_NOMBRE = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.EOT_EMAIL_INS, dos, oos);

				writeString(this.EOT_EMAIL, dos, oos);

				writeString(this.EST_NOMBRE, dos, oos);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("EOT_COD=" + String.valueOf(EOT_COD));
			sb.append(",EOT_EMAIL_INS=" + EOT_EMAIL_INS);
			sb.append(",EOT_EMAIL=" + EOT_EMAIL);
		...
		public int compareTo(row2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.EOT_COD, other.EOT_COD);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tOracleInput_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tOracleInput_1 = "select eot_cod,eot_email_ins, eot_email, est_nombre from acestotr \ninner join acest on eot_cod=est_cod";
					...
					while (rs_tOracleInput_1.next()) {
						...
						if (colQtyInRs_tOracleInput_1 < 1) {
							...
							if (rs_tOracleInput_1.getObject(1) != null) {
								row2.EOT_COD = rs_tOracleInput_1.getLong(1);
							} else {
						...
						if (colQtyInRs_tOracleInput_1 < 2) {
							row2.EOT_EMAIL_INS = null;
						} else {

							row2.EOT_EMAIL_INS = routines.system.JDBCUtil
						...
						if (colQtyInRs_tOracleInput_1 < 3) {
							...
							row2.EOT_EMAIL = routines.system.JDBCUtil
									.getString(rs_tOracleInput_1, 3, false);
						}
						if (colQtyInRs_tOracleInput_1 < 4) {
							row2.EST_NOMBRE = null;
						} else {

							row2.EST_NOMBRE = routines.system.JDBCUtil
						...
						row2_HashRow.EOT_COD = row2.EOT_COD;

						row2_HashRow.EOT_EMAIL_INS = row2.EOT_EMAIL_INS;

						row2_HashRow.EOT_EMAIL = row2.EOT_EMAIL;

						row2_HashRow.EST_NOMBRE = row2.EST_NOMBRE;
	...
	public void tOracleClose_2Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.sql.Connection conn_tOracleClose_2 = (java.sql.Connection) globalMap
						.get("conn_tOracleConnection_1");

				if (conn_tOracleClose_2 != null
						&& !conn_tOracleClose_2.isClosed()) {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tOracleClose_2:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public static void main(String[] args) {
		final evaluacion_docente_estudiantes_faltantes evaluacion_docente_estudiantes_faltantesClass = new evaluacion_docente_estudiantes_faltantes();

		int exitCode = evaluacion_docente_estudiantes_faltantesClass
				.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = evaluacion_docente_estudiantes_faltantes.class
					.getClassLoader().getResourceAsStream(
							"dmindicadores/evaluacion_docente_estudiantes_faltantes_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = evaluacion_docente_estudiantes_faltantes.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : evaluacion_docente_estudiantes_faltantes");
		}
...
/************************************************************************************************
 * 232477 characters generated by Talend Open Studio for Data Integration on the
 * 17 de septiembre de 2018 05:04:56 PM COT
 ************************************************************************************************/
