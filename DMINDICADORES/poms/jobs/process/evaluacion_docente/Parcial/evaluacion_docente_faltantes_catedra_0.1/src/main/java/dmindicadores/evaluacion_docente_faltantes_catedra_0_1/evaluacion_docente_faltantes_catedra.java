...
package dmindicadores.evaluacion_docente_faltantes_catedra_0_1;
...
/**
 * Job: evaluacion_docente_faltantes_catedra Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 7.1.1.20180829_1603-M3
 * @status 
 */
public class evaluacion_docente_faltantes_catedra implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "evaluacion_docente_faltantes_catedra";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_8qhQ4BQlEeSaqrdOz6Gyfw", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_8qhQ4BQlEeSaqrdOz6Gyfw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				evaluacion_docente_faltantes_catedra.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(evaluacion_docente_faltantes_catedra.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
    final static byte[] commonByteArrayLock_DMINDICADORES_evaluacion_docente_faltantes_catedra = new byte[0];
    static byte[] commonByteArray_DMINDICADORES_evaluacion_docente_faltantes_catedra = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DMINDICADORES_evaluacion_docente_faltantes_catedra.length) {
				if(length < 1024 && commonByteArray_DMINDICADORES_evaluacion_docente_faltantes_catedra.length == 0) {
   					commonByteArray_DMINDICADORES_evaluacion_docente_faltantes_catedra = new byte[1024];
				} else {
   					commonByteArray_DMINDICADORES_evaluacion_docente_faltantes_catedra = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DMINDICADORES_evaluacion_docente_faltantes_catedra, 0, length);
			strReturn = new String(commonByteArray_DMINDICADORES_evaluacion_docente_faltantes_catedra, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DMINDICADORES_evaluacion_docente_faltantes_catedra) {
...
query_tPostgresqlRow_1 = "DELETE FROM evaluacion_docente_faltantes_catedras\n WHERE anno=2018 and semestre=1";
...
public static class evaluacion_docente_faltantes_catedrasStruct implements routines.system.IPersistableRow<evaluacion_docente_faltantes_catedrasStruct> {
    final static byte[] commonByteArrayLock_DMINDICADORES_evaluacion_docente_faltantes_catedra = new byte[0];
    static byte[] commonByteArray_DMINDICADORES_evaluacion_docente_faltantes_catedra = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(evaluacion_docente_faltantes_catedrasStruct other) {
...
evaluacion_docente_faltantes_catedrasStruct evaluacion_docente_faltantes_catedras = new evaluacion_docente_faltantes_catedrasStruct();
	...
	currentComponent="tPostgresqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("evaluacion_docente_faltantes_catedras" + iterateId, 0, 0);
...
if(dbschema_tPostgresqlOutput_1 == null || dbschema_tPostgresqlOutput_1.trim().length() == 0) {
	tableName_tPostgresqlOutput_1 = "evaluacion_docente_faltantes_catedras";
} else {
	tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1 + "\".\"" + "evaluacion_docente_faltantes_catedras";
}
...
int count_tPostgresqlOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tPostgresqlOutput_1 = dbMetaData_tPostgresqlOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tPostgresqlOutput_1.next()) {
                                        ...
                                        if(table_tPostgresqlOutput_1.equals("evaluacion_docente_faltantes_catedras")
                                ...
                                if(!whetherExist_tPostgresqlOutput_1) {
                                    try (java.sql.Statement stmtCreate_tPostgresqlOutput_1 = conn_tPostgresqlOutput_1.createStatement()) {
                                        stmtCreate_tPostgresqlOutput_1.execute("CREATE TABLE \"" + tableName_tPostgresqlOutput_1 + "\"(\"anno\" INT4 ,\"semestre\" INT4 ,\"codigo_facultad\" INT4 ,\"facultad\" VARCHAR(64)  ,\"codigo_proyecto\" INT4 ,\"proyecto\" VARCHAR(70)  ,\"codigo_docente\" INT8 ,\"docente\" VARCHAR(52)  ,\"codigo_tipo_evaluacion\" INT4 ,\"tipo_evaluacion\" VARCHAR(64)  ,\"email\" VARCHAR(50)  )");
                                    }
                                }
	    String insert_tPostgresqlOutput_1 = "INSERT INTO \"" + tableName_tPostgresqlOutput_1 + "\" (\"anno\",\"semestre\",\"codigo_facultad\",\"facultad\",\"codigo_proyecto\",\"proyecto\",\"codigo_docente\",\"docente\",\"codigo_tipo_evaluacion\",\"tipo_evaluacion\",\"email\") VALUES (?,?,?,?,?,?,?,?,?,?,?)";
...
evaluacion_docente_faltantes_catedrasStruct evaluacion_docente_faltantes_catedras_tmp = new evaluacion_docente_faltantes_catedrasStruct();
// ###############################
 ...
 */
	...
	currentComponent="tPostgresqlInput_1";
		...
		int tos_count_tPostgresqlInput_1 = 0;
		    ...
		    String dbquery_tPostgresqlInput_1 = "SELECT distinct edi.\"ANNO\", edi.\"SEMESTRE\", edi.\"CODIGO_FACULTAD\", edi.\"FACULTAD\",\n  edi.\"CODIGO_PROYECTO\",ed"
+"i.\"PROYECTO\",edi.\"CODIGO_DOCENTE\", edi.\"DOCENTE\",\n  '5' codigo_tipo_evaluacion,'Autoevaluación Cátedras' tipo_eval"
+"uacion \n  FROM evaluacion_docente_inscritos edi\n  LEFT JOIN evaluacion_docente_respuestas edr on (edr.anno=edi.\"ANNO\" "
+"AND \n edr.semestre=edi.\"SEMESTRE\" AND edr. codigo_docente=edi.\"CODIGO_DOCENTE\" \n  AND edr.codigo_proyecto_estudiante"
+"=edi.\"CODIGO_PROYECTO\" AND edr.codigo_facultad_estudiante = \n edi.\"CODIGO_FACULTAD\" AND edr.codigo_tipo_evaluacion=5"
+")\n  WHERE  edr.codigo_tipo_evaluacion \n isnull and edi.\"CODIGO_ESPACIO\"  in (4,2035,12,4206,2035,3009,40,\n 1082) and e"
+"di.\"ANNO\"=2018 AND edi.\"SEMESTRE\"=3\n  \n  UNION \n  SELECT distinct edi.\"ANNO\", edi.\"SEMESTRE\", edi.\"CODIGO_FACUL"
+"TAD\", edi.\"FACULTAD\",\n  edi.\"CODIGO_PROYECTO\",edi.\"PROYECTO\", edi.\"CODIGO_DOCENTE\", edi.\"DOCENTE\",\n  '6' codi"
+"go_tipo_evaluacion,'Decanos Cátedras' tipo_evaluacion \n  FROM evaluacion_docente_inscritos edi\n  LEFT JOIN evaluacion_do"
+"cente_respuestas edr on (edr.anno=edi.\"ANNO\" AND \n edr.semestre=edi.\"SEMESTRE\" AND edr. codigo_docente=edi.\"CODIGO_"
+"DOCENTE\" \n  AND edr.codigo_proyecto_estudiante=edi.\"CODIGO_PROYECTO\" AND edr.codigo_facultad_estudiante = \n edi.\"COD"
+"IGO_FACULTAD\" AND edr.codigo_tipo_evaluacion=6)\n  WHERE  edr.codigo_tipo_evaluacion \n isnull and edi.\"CODIGO_ESPACIO\""
+"  in (4,2035,12,4206,2035,3009,40,\n 1082) and edi.\"ANNO\"=2018 AND edi.\"SEMESTRE\"=3";
...
evaluacion_docente_faltantes_catedras = null;


// # Output table : 'evaluacion_docente_faltantes_catedras'
evaluacion_docente_faltantes_catedras_tmp.anno = row1.ANNO ;
evaluacion_docente_faltantes_catedras_tmp.semestre = row1.SEMESTRE ;
evaluacion_docente_faltantes_catedras_tmp.codigo_facultad = row1.CODIGO_FACULTAD ;
evaluacion_docente_faltantes_catedras_tmp.facultad = row1.FACULTAD ;
evaluacion_docente_faltantes_catedras_tmp.codigo_proyecto = row1.CODIGO_PROYECTO ;
evaluacion_docente_faltantes_catedras_tmp.proyecto = row1.PROYECTO ;
evaluacion_docente_faltantes_catedras_tmp.codigo_docente = row1.CODIGO_DOCENTE ;
evaluacion_docente_faltantes_catedras_tmp.docente = row1.DOCENTE ;
evaluacion_docente_faltantes_catedras_tmp.codigo_tipo_evaluacion = row1.codigo_tipo_evaluacion ;
evaluacion_docente_faltantes_catedras_tmp.tipo_evaluacion = row1.tipo_evaluacion ;
evaluacion_docente_faltantes_catedras_tmp.email = row2.DOC_EMAIL ;
evaluacion_docente_faltantes_catedras = evaluacion_docente_faltantes_catedras_tmp;
// ###############################
 ...
 */
// Start of branch "evaluacion_docente_faltantes_catedras"
if(evaluacion_docente_faltantes_catedras != null) { 
	...
	currentComponent="tPostgresqlOutput_1";
			...
			//evaluacion_docente_faltantes_catedras
			//evaluacion_docente_faltantes_catedras


			
				if(execStat){
					runStat.updateStatOnConnection("evaluacion_docente_faltantes_catedras"+iterateId,1, 1);
				} 
        ...
        whetherReject_tPostgresqlOutput_1 = false;
                    if(evaluacion_docente_faltantes_catedras.anno == null) {
pstmt_tPostgresqlOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setInt(1, evaluacion_docente_faltantes_catedras.anno);
}

                    if(evaluacion_docente_faltantes_catedras.semestre == null) {
pstmt_tPostgresqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setInt(2, evaluacion_docente_faltantes_catedras.semestre);
}

                    if(evaluacion_docente_faltantes_catedras.codigo_facultad == null) {
pstmt_tPostgresqlOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setInt(3, evaluacion_docente_faltantes_catedras.codigo_facultad);
}

                    if(evaluacion_docente_faltantes_catedras.facultad == null) {
pstmt_tPostgresqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(4, evaluacion_docente_faltantes_catedras.facultad);
}

                    if(evaluacion_docente_faltantes_catedras.codigo_proyecto == null) {
pstmt_tPostgresqlOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setInt(5, evaluacion_docente_faltantes_catedras.codigo_proyecto);
}

                    if(evaluacion_docente_faltantes_catedras.proyecto == null) {
pstmt_tPostgresqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(6, evaluacion_docente_faltantes_catedras.proyecto);
}

                    if(evaluacion_docente_faltantes_catedras.codigo_docente == null) {
pstmt_tPostgresqlOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setLong(7, evaluacion_docente_faltantes_catedras.codigo_docente);
}

                    if(evaluacion_docente_faltantes_catedras.docente == null) {
pstmt_tPostgresqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(8, evaluacion_docente_faltantes_catedras.docente);
}

                    if(evaluacion_docente_faltantes_catedras.codigo_tipo_evaluacion == null) {
pstmt_tPostgresqlOutput_1.setNull(9, java.sql.Types.INTEGER);
} else {pstmt_tPostgresqlOutput_1.setInt(9, evaluacion_docente_faltantes_catedras.codigo_tipo_evaluacion);
}

                    if(evaluacion_docente_faltantes_catedras.tipo_evaluacion == null) {
pstmt_tPostgresqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(10, evaluacion_docente_faltantes_catedras.tipo_evaluacion);
}

                    if(evaluacion_docente_faltantes_catedras.email == null) {
pstmt_tPostgresqlOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_1.setString(11, evaluacion_docente_faltantes_catedras.email);
}
...
} // End of branch "evaluacion_docente_faltantes_catedras"
 ...
 */
	...
	nb_line_rejected_tPostgresqlOutput_1=nb_line_rejected_tPostgresqlOutput_1 + rejectedCount_tPostgresqlOutput_1;
        ...
        globalMap.put("tPostgresqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tPostgresqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("evaluacion_docente_faltantes_catedras"+iterateId,2, 0); 
			 	}
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(evaluacion_docente_faltantes_catedras)
 ...
 */
    ...
    public static void main(String[] args){
        final evaluacion_docente_faltantes_catedra evaluacion_docente_faltantes_catedraClass = new evaluacion_docente_faltantes_catedra();

        int exitCode = evaluacion_docente_faltantes_catedraClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = evaluacion_docente_faltantes_catedra.class.getClassLoader().getResourceAsStream("dmindicadores/evaluacion_docente_faltantes_catedra_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = evaluacion_docente_faltantes_catedra.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : evaluacion_docente_faltantes_catedra");
        }
...
/************************************************************************************************
 *     253576 characters generated by Talend Open Studio for Data Integration 
 *     on the 17 de septiembre de 2018 04:31:50 PM COT
 ************************************************************************************************/