...
package dmindicadores.evaluacion_docente_parcial_total_0_1;
...
/**
 * Job: evaluacion_docente_parcial_total Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 7.1.1.20180829_1603-M3
 * @status 
 */
public class evaluacion_docente_parcial_total implements TalendJob {
	...
	private final String jobName = "evaluacion_docente_parcial_total";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					evaluacion_docente_parcial_total.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(evaluacion_docente_parcial_total.this,
	...
	public static class row6Struct implements
		...
		final static byte[] commonByteArrayLock_DMINDICADORES_evaluacion_docente_parcial_total = new byte[0];
		static byte[] commonByteArray_DMINDICADORES_evaluacion_docente_parcial_total = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DMINDICADORES_evaluacion_docente_parcial_total.length) {
					if (length < 1024
							&& commonByteArray_DMINDICADORES_evaluacion_docente_parcial_total.length == 0) {
						commonByteArray_DMINDICADORES_evaluacion_docente_parcial_total = new byte[1024];
					} else {
						commonByteArray_DMINDICADORES_evaluacion_docente_parcial_total = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_DMINDICADORES_evaluacion_docente_parcial_total,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DMINDICADORES_evaluacion_docente_parcial_total) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tPostgresqlInput_2.next()) {
						...
						//
						// lowercase the name
						// row2.name = row5.name.toLowerCase();

						row2.id_anno = row5.id_anno;
						row2.id_semestre = row5.id_semestre;
						nb_line_tJavaRow_1++;
						...
						query_tPostgresqlRow_1 = "DELETE FROM evaluacion_docente_respuestas\n WHERE anno=2018 and semestre=1";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tPostgresqlOutput_1 == null
					...
					tableName_tPostgresqlOutput_1 = "evaluacion_docente_respuestas";
				} else {
					tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1
							+ "\".\"" + "evaluacion_docente_respuestas";
				}
				...
				try (java.sql.ResultSet rsTable_tPostgresqlOutput_1 = dbMetaData_tPostgresqlOutput_1
					...
					while (rsTable_tPostgresqlOutput_1.next()) {
						...
						if (table_tPostgresqlOutput_1
								.equals("evaluacion_docente_respuestas")
					...
					try (java.sql.Statement stmtCreate_tPostgresqlOutput_1 = conn_tPostgresqlOutput_1
						...
						stmtCreate_tPostgresqlOutput_1
								.execute("CREATE TABLE \""
										...
										+ "\"(\"id\" INT4 ,\"anno\" INT4  not null ,\"semestre\" INT4  not null ,\"codigo_docente\" INT8  not null ,\"codigo_proyecto_estudiante\" INT4  not null ,\"proyecto_estudiante\" VARCHAR(100)  ,\"codigo_facultad_estudiante\" INT4 ,\"facultad_estudiante\" VARCHAR ,\"estudiante\" INT8  not null ,\"grupo\" VARCHAR(45)  ,\"codigo_asignatura\" INT4 ,\"codigo_proyecto\" INT4 ,\"proyecto\" VARCHAR(100)  ,\"docente\" VARCHAR(52)  ,\"codigo_facultad\" INT4 ,\"facultad\" VARCHAR(64)  ,\"asignatura\" VARCHAR(100)  ,\"respuesta\" INT4 ,\"nivel\" VARCHAR(10)  ,\"fecha_registro\" TIMESTAMP(29)   not null ,\"codigo_tipo_evaluacion\" INT4  not null ,\"tipo_evaluacion\" VARCHAR(255)   not null ,\"porcentaje_evaluacion\" INT4  not null ,\"numero_pregunta\" INT4 ,\"fecha_carga\" TIMESTAMP(29)  ,primary key(\"id\"))");
					}
				}
				String insert_tPostgresqlOutput_1 = "INSERT INTO \""
						+ tableName_tPostgresqlOutput_1
						+ "\" (\"id\",\"anno\",\"semestre\",\"codigo_docente\",\"codigo_proyecto_estudiante\",\"proyecto_estudiante\",\"codigo_facultad_estudiante\",\"facultad_estudiante\",\"estudiante\",\"grupo\",\"codigo_asignatura\",\"codigo_proyecto\",\"proyecto\",\"docente\",\"codigo_facultad\",\"facultad\",\"asignatura\",\"respuesta\",\"nivel\",\"fecha_registro\",\"codigo_tipo_evaluacion\",\"tipo_evaluacion\",\"porcentaje_evaluacion\",\"numero_pregunta\",\"fecha_carga\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String dbquery_tPostgresqlInput_1 = "SELECT id, anno, semestre, codigo_docente, codigo_proyecto_estudiante, \n       proyecto_estudiante, codigo_facultad_est"
						+ "udiante, facultad_estudiante, \n       estudiante, grupo, codigo_asignatura, codigo_proyecto, proyecto, \n       docente, "
						+ "codigo_facultad, facultad, asignatura, respuesta, nivel, \n       fecha_registro, codigo_tipo_evaluacion, tipo_evaluacion"
						+ ", porcentaje_evaluacion, \n       numero_pregunta, fecha_carga\n  FROM evaluacion_docente_respuestas_temporal\n	LEFT JOIN e"
						+ "valuacion_docente_borradas ON anno=\"ANNO\" and semestre=\"SEMESTRE\" and codigo_docente=\"CODIGO_DOCENTE\" and codigo_a"
						+ "signatura=\"CODIGO_ESPACIO\" and estudiante=\"ESTUDIANTE\"\n  where anno=2018 and semestre=3 and  \"ANNO\" is null\n  ";
					...
					while (rs_tPostgresqlInput_1.next()) {
						...
						if (colQtyInRs_tPostgresqlInput_1 < 2) {
							...
							if (rs_tPostgresqlInput_1.getObject(2) != null) {
								row1.anno = rs_tPostgresqlInput_1.getInt(2);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tPostgresqlInput_1 < 3) {
							...
							if (rs_tPostgresqlInput_1.getObject(3) != null) {
								row1.semestre = rs_tPostgresqlInput_1.getInt(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tPostgresqlInput_1 < 5) {
							...
							if (rs_tPostgresqlInput_1.getObject(5) != null) {
								row1.codigo_proyecto_estudiante = rs_tPostgresqlInput_1
										.getInt(5);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tPostgresqlInput_1 < 6) {
							row1.proyecto_estudiante = null;
						} else {

							row1.proyecto_estudiante = routines.system.JDBCUtil
									.getString(rs_tPostgresqlInput_1, 6, false);
						}
						if (colQtyInRs_tPostgresqlInput_1 < 7) {
							row1.codigo_facultad_estudiante = null;
						} else {

							if (rs_tPostgresqlInput_1.getObject(7) != null) {
								row1.codigo_facultad_estudiante = rs_tPostgresqlInput_1
										.getInt(7);
							} else {
								row1.codigo_facultad_estudiante = null;
							}
						...
						if (colQtyInRs_tPostgresqlInput_1 < 8) {
							row1.facultad_estudiante = null;
						} else {

							row1.facultad_estudiante = routines.system.JDBCUtil
						...
						if (colQtyInRs_tPostgresqlInput_1 < 11) {
							...
							if (rs_tPostgresqlInput_1.getObject(11) != null) {
								row1.codigo_asignatura = rs_tPostgresqlInput_1
										.getInt(11);
							} else {
								row1.codigo_asignatura = null;
							}
						...
						if (colQtyInRs_tPostgresqlInput_1 < 13) {
							...
							row1.proyecto = routines.system.JDBCUtil.getString(
									rs_tPostgresqlInput_1, 13, false);
						}
						if (colQtyInRs_tPostgresqlInput_1 < 14) {
							...
							row1.docente = routines.system.JDBCUtil.getString(
									rs_tPostgresqlInput_1, 14, false);
						}
						...
						if (colQtyInRs_tPostgresqlInput_1 < 16) {
							...
							row1.facultad = routines.system.JDBCUtil.getString(
									rs_tPostgresqlInput_1, 16, false);
						}
						...
						if (colQtyInRs_tPostgresqlInput_1 < 18) {
							...
							if (rs_tPostgresqlInput_1.getObject(18) != null) {
								row1.respuesta = rs_tPostgresqlInput_1
										.getInt(18);
							} else {
								row1.respuesta = null;
							}
						...
						if (colQtyInRs_tPostgresqlInput_1 < 19) {
							...
							row1.nivel = routines.system.JDBCUtil.getString(
									rs_tPostgresqlInput_1, 19, false);
						}
						if (colQtyInRs_tPostgresqlInput_1 < 20) {
							...
							row1.fecha_registro = routines.system.JDBCUtil
									.getDate(rs_tPostgresqlInput_1, 20);
						}
						if (colQtyInRs_tPostgresqlInput_1 < 21) {
							row1.codigo_tipo_evaluacion = 0;
						} else {

							if (rs_tPostgresqlInput_1.getObject(21) != null) {
								row1.codigo_tipo_evaluacion = rs_tPostgresqlInput_1
										.getInt(21);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tPostgresqlInput_1 < 22) {
							...
							row1.tipo_evaluacion = routines.system.JDBCUtil
									.getString(rs_tPostgresqlInput_1, 22, false);
						}
						if (colQtyInRs_tPostgresqlInput_1 < 23) {
							row1.porcentaje_evaluacion = 0;
						} else {

							if (rs_tPostgresqlInput_1.getObject(23) != null) {
								row1.porcentaje_evaluacion = rs_tPostgresqlInput_1
										.getInt(23);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tPostgresqlInput_1 < 24) {
							row1.numero_pregunta = null;
						} else {

							if (rs_tPostgresqlInput_1.getObject(24) != null) {
								row1.numero_pregunta = rs_tPostgresqlInput_1
										.getInt(24);
							} else {
								row1.numero_pregunta = null;
							}
						...
						if (colQtyInRs_tPostgresqlInput_1 < 25) {
							...
							row1.fecha_carga = routines.system.JDBCUtil
									.getDate(rs_tPostgresqlInput_1, 25);
						}
						...
						{ // start of Var scope
							...
							evaluacion_tmp.id = row1.id;
							evaluacion_tmp.anno = row1.anno;
							evaluacion_tmp.semestre = row1.semestre;
							evaluacion_tmp.codigo_docente = row1.codigo_docente;
							evaluacion_tmp.codigo_proyecto_estudiante = row1.codigo_proyecto_estudiante;
							evaluacion_tmp.proyecto_estudiante = row1.proyecto_estudiante;
							evaluacion_tmp.codigo_facultad_estudiante = row1.codigo_facultad_estudiante;
							evaluacion_tmp.facultad_estudiante = row1.facultad_estudiante;
							evaluacion_tmp.estudiante = row1.estudiante;
							evaluacion_tmp.grupo = row1.grupo;
							evaluacion_tmp.codigo_asignatura = row1.codigo_asignatura;
							evaluacion_tmp.codigo_proyecto = row1.codigo_proyecto;
							evaluacion_tmp.proyecto = row1.proyecto;
							evaluacion_tmp.docente = row1.docente;
							evaluacion_tmp.codigo_facultad = row1.codigo_facultad;
							evaluacion_tmp.facultad = row1.facultad;
							evaluacion_tmp.asignatura = row1.asignatura;
							evaluacion_tmp.respuesta = row1.respuesta;
							evaluacion_tmp.nivel = row1.nivel;
							evaluacion_tmp.fecha_registro = row1.fecha_registro;
							evaluacion_tmp.codigo_tipo_evaluacion = row1.codigo_tipo_evaluacion;
							evaluacion_tmp.tipo_evaluacion = row1.tipo_evaluacion;
							evaluacion_tmp.porcentaje_evaluacion = row1.porcentaje_evaluacion;
							evaluacion_tmp.numero_pregunta = row1.numero_pregunta;
							evaluacion_tmp.fecha_carga = row1.fecha_carga;
						...
						if (evaluacion != null) {
							...
							if (evaluacion.codigo_proyecto == null) {
								...
								pstmt_tPostgresqlOutput_1.setInt(12,
							...
							pstmt_tPostgresqlOutput_1.setInt(21,
	...
	public static void main(String[] args) {
		final evaluacion_docente_parcial_total evaluacion_docente_parcial_totalClass = new evaluacion_docente_parcial_total();

		int exitCode = evaluacion_docente_parcial_totalClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = evaluacion_docente_parcial_total.class
					.getClassLoader().getResourceAsStream(
							"dmindicadores/evaluacion_docente_parcial_total_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = evaluacion_docente_parcial_total.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : evaluacion_docente_parcial_total");
		}
...
/************************************************************************************************
 * 221547 characters generated by Talend Open Studio for Data Integration on the
 * 17 de septiembre de 2018 05:03:55 PM COT
 ************************************************************************************************/
