...
package co_udistrital_temporal.proyectos_0_1;
...
/**
 * Job: proyectos Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20180829_1603-M3
 * @status 
 */
public class proyectos implements TalendJob {
	...
	private final String jobName = "proyectos";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(proyectos.this, new Object[] { e,
	...
	public static class proyectosStruct implements
			routines.system.IPersistableRow<proyectosStruct> {
		final static byte[] commonByteArrayLock_CO_UDISTRITAL_TEMPORAL_proyectos = new byte[0];
		static byte[] commonByteArray_CO_UDISTRITAL_TEMPORAL_proyectos = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final proyectosStruct other = (proyectosStruct) obj;
		...
		public void copyDataTo(proyectosStruct other) {
		...
		public void copyKeysDataTo(proyectosStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CO_UDISTRITAL_TEMPORAL_proyectos.length) {
					if (length < 1024
							&& commonByteArray_CO_UDISTRITAL_TEMPORAL_proyectos.length == 0) {
						commonByteArray_CO_UDISTRITAL_TEMPORAL_proyectos = new byte[1024];
					} else {
						commonByteArray_CO_UDISTRITAL_TEMPORAL_proyectos = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CO_UDISTRITAL_TEMPORAL_proyectos,
						0, length);
				strReturn = new String(
						commonByteArray_CO_UDISTRITAL_TEMPORAL_proyectos, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CO_UDISTRITAL_TEMPORAL_proyectos) {
		 ...
		 * Compare keys
		 */
		public int compareTo(proyectosStruct other) {
	...
	public void tOracleInput_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				proyectosStruct proyectos = new proyectosStruct();
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("proyectos" + iterateId,
								0, 0);
				...
				if (dbschema_tPostgresqlOutput_1 == null
					...
					tableName_tPostgresqlOutput_1 = "proyectos";
				} else {
				...
				try (java.sql.Statement stmtCreate_tPostgresqlOutput_1 = conn_tPostgresqlOutput_1
					...
					stmtCreate_tPostgresqlOutput_1
							.execute("CREATE TABLE \""
									+ tableName_tPostgresqlOutput_1
									+ "\"(\"codigo_proyecto\" INT4  not null ,\"proyecto\" VARCHAR(111)  ,\"codigo_proyecto_snies\" INT4 ,\"proyecto_snies\" VARCHAR(141)  ,\"codigo_facultad\" INT4 ,\"facultad\" VARCHAR(105)  ,\"modalidad\" VARCHAR(50)   not null ,\"nivel\" VARCHAR(10)  ,primary key(\"codigo_proyecto\"))");
				}
				String insert_tPostgresqlOutput_1 = "INSERT INTO \""
						+ tableName_tPostgresqlOutput_1
						+ "\" (\"codigo_proyecto\",\"proyecto\",\"codigo_proyecto_snies\",\"proyecto_snies\",\"codigo_facultad\",\"facultad\",\"modalidad\",\"nivel\") VALUES (?,?,?,?,?,?,?,?)";
				...
				proyectosStruct proyectos_tmp = new proyectosStruct();
				// ###############################
				...
				String dbquery_tOracleInput_1 = "SELECT UNIQUE\ncra_cod codigo_proyecto,\ncra_nombre proyecto,\nas_cra_cod_snies codigo_proyecto_snies, \nas_cra_nom proyect"
						+ "o_snies,\ndep_cod codigo_facultad,\ndep_nombre facultad,\ntra_nombre modalidad, \ntra_nivel  nivel\nFROM mntac.accra \nLEFT JO"
						+ "IN mntac.accra_snies ON as_cra_cod=cra_cod \nLEFT JOIN mntac.actipcra ON  cra_tip_cra=tra_cod\nLEFT JOIN gedep ON cra_dep_"
						+ "cod=dep_cod\nwhere tra_cod not in (50)\norder by cra_cod";
				...
				try {
					...
					while (rs_tOracleInput_1.next()) {
						...
						if (colQtyInRs_tOracleInput_1 < 7) {
							...
							row1.MODALIDAD = routines.system.JDBCUtil
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row2__codigo_snies_proyecto = row1.CODIGO_PROYECTO_SNIES;
							if (exprKeyValue_row2__codigo_snies_proyecto == null) {
								hasCasePrimitiveKeyWithNull_tMap_1 = true;
							} else {
								row2HashKey.codigo_snies_proyecto = (int) (Integer) exprKeyValue_row2__codigo_snies_proyecto;
							}
						...
						if (tHash_Lookup_row2 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.codigo_snies_proyecto = '"
							// + row2HashKey.codigo_snies_proyecto + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							// # Output table : 'proyectos'
							proyectos_tmp.codigo_proyecto = row1.CODIGO_PROYECTO;
							proyectos_tmp.proyecto = row1.PROYECTO;
							proyectos_tmp.codigo_proyecto_snies = row1.CODIGO_PROYECTO_SNIES;
							proyectos_tmp.proyecto_snies = row2.nombre_snies_proyecto;
							proyectos_tmp.codigo_facultad = row1.CODIGO_FACULTAD;
							proyectos_tmp.facultad = row1.FACULTAD;
							proyectos_tmp.modalidad = row1.MODALIDAD;
							proyectos_tmp.nivel = row1.NIVEL;
							proyectos = proyectos_tmp;
							// ###############################
						...
						if (proyectos != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection("proyectos"
										+ iterateId, 1, 1);
							}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tPostgresqlOutput_2 == null
					...
					tableName_tPostgresqlOutput_2 = "proyectos_snies";
				} else {
				...
				try (java.sql.ResultSet rsTable_tPostgresqlOutput_2 = dbMetaData_tPostgresqlOutput_2
					...
					while (rsTable_tPostgresqlOutput_2.next()) {
						...
						if (table_tPostgresqlOutput_2.equals("proyectos_snies")
				...
				if (whetherExist_tPostgresqlOutput_2) {
					try (java.sql.Statement stmtDrop_tPostgresqlOutput_2 = conn_tPostgresqlOutput_2
							.createStatement()) {
				...
				try (java.sql.Statement stmtCreate_tPostgresqlOutput_2 = conn_tPostgresqlOutput_2
					...
					stmtCreate_tPostgresqlOutput_2
							.execute("CREATE TABLE \""
									+ tableName_tPostgresqlOutput_2
									+ "\"(\"codigo_proyecto\" INT4  not null ,\"proyecto\" VARCHAR(111)  ,\"codigo_proyecto_snies\" INT4 ,\"proyecto_snies\" VARCHAR(141)  ,\"codigo_facultad\" INT4 ,\"facultad\" VARCHAR(105)  ,\"modalidad\" VARCHAR(50)   not null ,\"nivel\" VARCHAR(10)  )");
				}
					...
					while (rs_tPostgresqlInput_2.next()) {
						...
						if (colQtyInRs_tPostgresqlInput_2 < 1) {
							...
							if (rs_tPostgresqlInput_2.getObject(1) != null) {
								row3.codigo_proyecto = rs_tPostgresqlInput_2
										.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tPostgresqlInput_2 < 3) {
							...
							if (rs_tPostgresqlInput_2.getObject(3) != null) {
								row3.codigo_proyecto_snies = rs_tPostgresqlInput_2
										.getInt(3);
							} else {
								row3.codigo_proyecto_snies = null;
							}
						...
						if (colQtyInRs_tPostgresqlInput_2 < 5) {
							...
							if (rs_tPostgresqlInput_2.getObject(5) != null) {
								row3.codigo_facultad = rs_tPostgresqlInput_2
										.getInt(5);
							} else {
								row3.codigo_facultad = null;
							}
						...
						if (row3.codigo_proyecto_snies == null) {
							pstmt_tPostgresqlOutput_2.setNull(3,
									java.sql.Types.INTEGER);
						} else {
							pstmt_tPostgresqlOutput_2.setInt(3,
									row3.codigo_proyecto_snies);
						}

						if (row3.proyecto_snies == null) {
						...
						if (row3.nivel == null) {
							...
							pstmt_tPostgresqlOutput_2.setString(8, row3.nivel);
						}
						...
						if ((batchSize_tPostgresqlOutput_2 > 0)
							...
							try {
								...
								java.sql.SQLException ne_tPostgresqlOutput_2 = e_tPostgresqlOutput_2
										.getNextException(), sqle_tPostgresqlOutput_2 = null;
								String errormessage_tPostgresqlOutput_2;
								if (ne_tPostgresqlOutput_2 != null) {
									// build new exception to provide the
									// original cause
									sqle_tPostgresqlOutput_2 = new java.sql.SQLException(
											e_tPostgresqlOutput_2.getMessage()
													+ "\ncaused by: "
													+ ne_tPostgresqlOutput_2
															.getMessage(),
											ne_tPostgresqlOutput_2
													.getSQLState(),
											ne_tPostgresqlOutput_2
													.getErrorCode(),
											ne_tPostgresqlOutput_2);
									errormessage_tPostgresqlOutput_2 = sqle_tPostgresqlOutput_2
											.getMessage();
								} else {
									errormessage_tPostgresqlOutput_2 = e_tPostgresqlOutput_2
											.getMessage();
								}

								int countSum_tPostgresqlOutput_2 = 0;
								for (int countEach_tPostgresqlOutput_2 : e_tPostgresqlOutput_2
										.getUpdateCounts()) {
									countSum_tPostgresqlOutput_2 += (countEach_tPostgresqlOutput_2 < 0 ? 0
											: countEach_tPostgresqlOutput_2);
								}
				...
				try {
					...
					if (ne_tPostgresqlOutput_2 != null) {
						...
						sqle_tPostgresqlOutput_2 = new java.sql.SQLException(
								e_tPostgresqlOutput_2.getMessage()
										+ "\ncaused by: "
										+ ne_tPostgresqlOutput_2.getMessage(),
								ne_tPostgresqlOutput_2.getSQLState(),
								ne_tPostgresqlOutput_2.getErrorCode(),
								ne_tPostgresqlOutput_2);
						errormessage_tPostgresqlOutput_2 = sqle_tPostgresqlOutput_2
								.getMessage();
					} else {
	...
	public static class row2Struct implements
		...
		public int codigo_snies_proyecto;

		public int getCodigo_snies_proyecto() {
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.codigo_snies_proyecto;
		...
		public boolean equals(Object obj) {
			...
			if (this.codigo_snies_proyecto != other.codigo_snies_proyecto)
				return false;
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CO_UDISTRITAL_TEMPORAL_proyectos) {
				...
				try {
					...
					this.codigo_snies_proyecto = dis.readInt();
		...
		public void writeKeysData(ObjectOutputStream dos) {
			try {
				...
				dos.writeInt(this.codigo_snies_proyecto);
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.nombre_snies_proyecto = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.nombre_snies_proyecto, dos, oos);
	...
	public void tPostgresqlInput_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(after_tOracleInput_1) outputs:(row2,row2) | target
				// node:tAdvancedHash_row2 - inputs:(row2) outputs:()
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(proyectos)
				...
				String dbquery_tPostgresqlInput_1 = "SELECT codigo_snies_proyecto, nombre_snies_proyecto\n  FROM \"CO_UDISTRITAL_TEMPORAL\".snies";
				...
				try {
					...
					while (rs_tPostgresqlInput_1.next()) {
						...
						if (colQtyInRs_tPostgresqlInput_1 < 1) {
							row2.codigo_snies_proyecto = 0;
						} else {

							if (rs_tPostgresqlInput_1.getObject(1) != null) {
								row2.codigo_snies_proyecto = rs_tPostgresqlInput_1
										.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tPostgresqlInput_1 < 2) {
							row2.nombre_snies_proyecto = null;
						} else {

							row2.nombre_snies_proyecto = routines.system.JDBCUtil
						...
						row2_HashRow.codigo_snies_proyecto = row2.codigo_snies_proyecto;

						row2_HashRow.nombre_snies_proyecto = row2.nombre_snies_proyecto;
	...
	public static void main(String[] args) {
		final proyectos proyectosClass = new proyectos();

		int exitCode = proyectosClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = proyectos.class.getClassLoader()
					.getResourceAsStream(
							"co_udistrital_temporal/proyectos_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = proyectos.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : proyectos");
		}
...
/************************************************************************************************
 * 235116 characters generated by Talend Open Studio for Data Integration on the
 * 12 de septiembre de 2018 02:59:31 PM COT
 ************************************************************************************************/
