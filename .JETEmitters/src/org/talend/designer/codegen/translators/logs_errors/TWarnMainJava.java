...
public class TWarnMainJava
{
  ...
  protected final String TEXT_45 = "\t" + NL + "try {" + NL + "\t" + NL + "\tresumeUtil.addLog(\"USER_DEF_LOG\", \"NODE:";
  protected final String TEXT_46 = "\", \"\", Thread.currentThread().getId() + \"\", \"";
  protected final String TEXT_47 = "\",\"\",";
  protected final String TEXT_48 = ",\"\", \"\");";
  protected final String TEXT_49 = NL + "\t";
  protected final String TEXT_50 = ".addMessage(\"tWarn\", \"";
  protected final String TEXT_51 = "\", ";
  protected final String TEXT_52 = ", ";
  protected final String TEXT_53 = ", ";
  protected final String TEXT_54 = ");" + NL + "\t";
  protected final String TEXT_55 = "Process(globalMap);";
  protected final String TEXT_56 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_57 = "_WARN_MESSAGES\", ";
  protected final String TEXT_58 = "); " + NL + "\tglobalMap.put(\"";
  protected final String TEXT_59 = "_WARN_PRIORITY\", ";
  protected final String TEXT_60 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_61 = "_WARN_CODE\", ";
  protected final String TEXT_62 = ");" + NL + "\t" + NL + "} catch (Exception e_";
  protected final String TEXT_63 = ") {" + NL + "\tlogIgnoredError(String.format(\"";
  protected final String TEXT_64 = " - tWarn failed to log message due to internal error: %s\", e_";
  protected final String TEXT_65 = "), e_";
