...
public class TMomInputLoopBeginJava
{
  ...
  protected final String TEXT_327 = NL + "\t\t\t\tSystem.setProperty(\"com.ibm.mq.cfg.MessageProperties.PropctlToFORCE_RFH2\",\"Yes\");" + NL + "\t\t\t\tjava.util.Hashtable properties";
  ...
  protected final String TEXT_337 = NL + "\t\t              System.setProperty(\"com.ibm.mq.cfg.useIBMCipherMappings\",\"";
  protected final String TEXT_338 = "\");" + NL + "\t\t              com.ibm.mq.MQEnvironment.sslCipherSuite = ";
  protected final String TEXT_339 = ";" + NL + "\t\t          ";
  protected final String TEXT_340 = NL + "\t\t              com.ibm.mq.MQEnvironment.sslCipherSuite = \"";
  protected final String TEXT_341 = "\";" + NL + "\t\t          ";
  protected final String TEXT_342 = NL + "\t\t\t\t\tproperties";
  protected final String TEXT_343 = ".put(\"userID\",";
  ...
  protected final String TEXT_352 = NL + "\t\t\t" + NL + "\t\t\t" + NL + "\t\t\t\t\tproperties";
  protected final String TEXT_353 = ".put(\"password\",decryptedPassword_";
  protected final String TEXT_354 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\tqMgr_";
  protected final String TEXT_356 = "=new com.ibm.mq.MQQueueManager(";
  protected final String TEXT_357 = ",properties";
  protected final String TEXT_358 = ");" + NL + "\t\t\t\tglobalMap.put(\"qMgr_";
  protected final String TEXT_359 = "\",qMgr_";
  protected final String TEXT_360 = ");" + NL + "\t\t\t";
  protected final String TEXT_361 = NL + "\t\t\t\tString msgId_";
  protected final String TEXT_362 = " = ";
  protected final String TEXT_363 = ";" + NL + "\t\t    \tif (msgId_";
  protected final String TEXT_364 = " != null & !(\"\").equals(msgId_";
  protected final String TEXT_365 = ")) {" + NL + "\t\t\t\t\tString padding_";
  protected final String TEXT_366 = " = new String();" + NL + "\t\t\t       \tint padlen_";
  protected final String TEXT_367 = " = 24;" + NL + "\t\t\t " + NL + "\t\t\t       \tint len_";
  protected final String TEXT_368 = " = Math.abs(padlen_";
  protected final String TEXT_369 = ") - msgId_";
  protected final String TEXT_370 = ".toString().length();" + NL + "\t\t\t       \tif (len_";
  protected final String TEXT_371 = " > 0) {" + NL + "\t\t\t        \tfor (int i = 0 ; i < len_";
  protected final String TEXT_372 = " ; i++) {" + NL + "\t\t\t           \t\tpadding_";
  protected final String TEXT_373 = " = padding_";
  protected final String TEXT_374 = " + \" \";" + NL + "\t\t\t         \t}" + NL + "\t\t\t        \tmsgId_";
  protected final String TEXT_375 = " = msgId_";
  protected final String TEXT_376 = " + padding_";
  protected final String TEXT_377 = ";" + NL + "\t\t\t        }" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_378 = NL + "\t\t\ttry{" + NL + "\t" + NL + "\t\t\t\tint openOptions";
  protected final String TEXT_379 = "=com.ibm.mq.MQC.MQOO_INPUT_SHARED | com.ibm.mq.MQC.MQOO_FAIL_IF_QUIESCING | com.ibm.mq.MQC.MQOO_INQUIRE";
  protected final String TEXT_380 = " | com.ibm.mq.MQC.MQOO_BROWSE";
  protected final String TEXT_381 = ";" + NL + "\t\t\t" + NL + "\t\t\t\tcom.ibm.mq.MQGetMessageOptions gmo";
  protected final String TEXT_382 = "=new com.ibm.mq.MQGetMessageOptions();" + NL + "\t\t\t\t";
  protected final String TEXT_383 = NL + "\t\t\t\t\tgmo";
  protected final String TEXT_384 = ".options=gmo";
  protected final String TEXT_385 = ".options+com.ibm.mq.MQC.MQGMO_BROWSE_FIRST;" + NL + "\t\t\t\t\tint browseCursor_";
  protected final String TEXT_386 = " = 0;" + NL + "\t\t\t\t";
  protected final String TEXT_387 = NL + "\t\t\t\t\tgmo";
  protected final String TEXT_388 = ".options=gmo";
  protected final String TEXT_389 = ".options+com.ibm.mq.MQC.MQGMO_SYNCPOINT;" + NL + "\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t\tgmo";
  protected final String TEXT_391 = ".options=gmo";
  protected final String TEXT_392 = ".options+com.ibm.mq.MQC.";
  protected final String TEXT_393 = "MQGMO_NO_WAIT";
  protected final String TEXT_394 = "MQGMO_WAIT";
  protected final String TEXT_395 = ";" + NL + "\t\t\t\tgmo";
  protected final String TEXT_396 = ".options=gmo";
  protected final String TEXT_397 = ".options+com.ibm.mq.MQC.MQGMO_FAIL_IF_QUIESCING;" + NL + "\t\t\t\tgmo";
  protected final String TEXT_398 = ".waitInterval=com.ibm.mq.MQC.MQWI_UNLIMITED;" + NL + "\t\t\t\tcom.ibm.mq.MQException.log = null;" + NL + "\t\t\t\tboolean flag";
  protected final String TEXT_399 = "=true;" + NL + "\t\t\t" + NL + "\t\t\t\tremoteQ_";
  protected final String TEXT_400 = "=qMgr_";
  protected final String TEXT_401 = ".accessQueue(";
  protected final String TEXT_402 = ",openOptions";
  protected final String TEXT_403 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t\t\tint[] selectors_";
  protected final String TEXT_405 = " = new int[2];" + NL + "\t\t\t\t\tint[] intAttrs_";
  protected final String TEXT_406 = " = new int[1];" + NL + "\t\t\t\t\tint threshold_";
  protected final String TEXT_407 = " = 0;" + NL + "\t\t\t\t\tString backoutQName_";
  protected final String TEXT_408 = " = \"\";" + NL + "\t\t\t\t\tbyte[] charAttrs_";
  protected final String TEXT_409 = " = new byte[com.ibm.mq.MQC.MQ_Q_NAME_LENGTH];" + NL + "\t\t\t\t\tselectors_";
  protected final String TEXT_410 = "[0] = com.ibm.mq.MQC.MQCA_BACKOUT_REQ_Q_NAME;" + NL + "\t\t\t\t\tselectors_";
  protected final String TEXT_411 = "[1] = com.ibm.mq.MQC.MQIA_BACKOUT_THRESHOLD;" + NL + "\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_412 = "\t" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_413 = " - Initing backout queue ...\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_414 = NL + "\t\t\t\t\t\tremoteQ_";
  protected final String TEXT_415 = ".inquire(selectors_";
  protected final String TEXT_416 = ", intAttrs_";
  protected final String TEXT_417 = ", charAttrs_";
  protected final String TEXT_418 = ");" + NL + "\t\t\t\t\t\tthreshold_";
  protected final String TEXT_419 = " = intAttrs_";
  protected final String TEXT_420 = "[0];" + NL + "\t\t\t\t\t\tbackoutQName_";
  protected final String TEXT_421 = " = new String(charAttrs_";
  protected final String TEXT_422 = ");" + NL + "\t\t\t\t\t\tif(threshold_";
  protected final String TEXT_423 = " > 0 && backoutQName_";
  protected final String TEXT_424 = ".trim().length()>0){" + NL + "\t\t\t\t\t\t\tbackoutQueue_";
  protected final String TEXT_425 = " = qMgr_";
  protected final String TEXT_426 = ".accessQueue(backoutQName_";
  protected final String TEXT_427 = ", 16);" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\tthrow new java.lang.Exception(\"Init backout queue unsuccessfully!\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_428 = "\t" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_429 = " - The backout queue of \"+";
  protected final String TEXT_430 = "+\" is:\"+backoutQName_";
  protected final String TEXT_431 = ");" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_432 = " - The threshold value of messages in \"+";
  protected final String TEXT_433 = "+\" is:\"+threshold_";
  protected final String TEXT_434 = ");" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_435 = " - Init backout queue successfully.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_436 = NL + "\t\t\t\t\t}catch (java.lang.Exception e_";
  protected final String TEXT_437 = ") {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_438 = "\t" + NL + "\t\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_439 = " - Init backout queue unsuccessfully, poison messages will remain on the input queue.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_440 = NL + "\t\t\t\t\t\t\tSystem.err.println(\"Init backout queue unsuccessfully, poison messages will remain on the input queue.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_441 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_442 = NL + "\t" + NL + "\t\t\t";
  protected final String TEXT_443 = NL + "\t\t\t\tif(Integer.valueOf(remoteQ_";
  protected final String TEXT_444 = ".getCurrentDepth()).equals(0))" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tflag";
  protected final String TEXT_445 = "= false;" + NL + "\t\t\t\t} \t" + NL + "\t\t\t";
  protected final String TEXT_446 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_447 = " - Ready to receive message.\");" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_448 = " - Waiting...\");" + NL + "\t\t\t";
  protected final String TEXT_449 = "\t" + NL + "\t\t\t\tSystem.out.println(\"Ready to receive message\");" + NL + "\t\t\t\tSystem.out.println(\"Waiting...\");\t" + NL + "\t\t\t    ";
  protected final String TEXT_450 = "\t" + NL + "\t\t\t            log.info(\"";
  protected final String TEXT_451 = " - Consume max message number:  \" + ";
  protected final String TEXT_452 = ");" + NL + "\t\t\t        ";
  protected final String TEXT_453 = NL + "\t\t\t        int remainingMaxNum_";
  protected final String TEXT_454 = " = ";
  protected final String TEXT_455 = ";" + NL + "\t\t\t        ";
  protected final String TEXT_456 = NL + "\t\t\t            boolean hasWaitAndRetry_";
  protected final String TEXT_457 = " = false;" + NL + "\t\t\t        ";
  protected final String TEXT_458 = NL + "\t\t\t\twhile(flag";
  protected final String TEXT_459 = "){" + NL + "\t\t\t";
  protected final String TEXT_460 = NL + "\t\t\t\tglobalMap.put(\"currentMessageIsConsumed_";
  protected final String TEXT_461 = "\",false);//if current message has been commited,no need to backout it to the backout queue." + NL + "\t\t\t";
  protected final String TEXT_462 = NL + "\t\t\t\t     if(remainingMaxNum_";
  protected final String TEXT_463 = " <= 1){" + NL + "\t\t\t\t         flag";
  protected final String TEXT_464 = "= false;" + NL + "\t\t\t\t     }" + NL + "\t\t\t\t ";
  protected final String TEXT_465 = NL + "\t\t\t\t    if(Integer.valueOf(remoteQ_";
  protected final String TEXT_466 = ".getCurrentDepth()).equals(1)) {" + NL + "\t\t\t\t         flag";
  protected final String TEXT_467 = "= false;" + NL + "\t\t\t\t    }" + NL + "\t\t\t   ";
  protected final String TEXT_468 = NL + "\t\t\t\tif(browseCursor_";
  protected final String TEXT_469 = " > 0){" + NL + "\t\t\t\t\tgmo";
  protected final String TEXT_470 = ".options=com.ibm.mq.MQC.MQGMO_BROWSE_NEXT; " + NL + "\t\t\t\t\tgmo";
  protected final String TEXT_471 = ".options=gmo";
  protected final String TEXT_472 = ".options+com.ibm.mq.MQC.";
  protected final String TEXT_473 = "MQGMO_NO_WAIT";
  protected final String TEXT_474 = "MQGMO_WAIT";
  protected final String TEXT_475 = ";" + NL + "\t\t\t\t\tgmo";
  protected final String TEXT_476 = ".options=gmo";
  protected final String TEXT_477 = ".options+com.ibm.mq.MQC.MQGMO_FAIL_IF_QUIESCING;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tbrowseCursor_";
  protected final String TEXT_478 = "++;" + NL + "\t\t\t";
  protected final String TEXT_479 = NL + "\t\t\tcom.ibm.mq.MQMessage inMessage";
  protected final String TEXT_480 = "=new com.ibm.mq.MQMessage();" + NL + "\t\t\t";
  protected final String TEXT_481 = NL + "\t\t\t\tinMessage";
  protected final String TEXT_482 = ".messageId = msgId_";
  protected final String TEXT_483 = ".getBytes(\"ISO-8859-15\");" + NL + "\t\t\t";
  protected final String TEXT_484 = "\t\t" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\tremoteQ_";
  protected final String TEXT_485 = ".get(inMessage";
  protected final String TEXT_486 = ",gmo";
  protected final String TEXT_487 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_488 = NL + "\t\t\t\t\t    remainingMaxNum_";
  protected final String TEXT_489 = " --;" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_490 = NL + "\t\t\t\t\t        hasWaitAndRetry_";
  protected final String TEXT_491 = " = false;" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_492 = NL + "\t\t\t\t}catch (com.ibm.mq.MQException me_";
  protected final String TEXT_493 = ") {   " + NL + "\t\t            if (me_";
  protected final String TEXT_494 = ".reasonCode == com.ibm.mq.MQException.MQRC_NO_MSG_AVAILABLE) {" + NL + "\t\t                ";
  protected final String TEXT_495 = NL + "\t\t\t\t             if(!hasWaitAndRetry_";
  protected final String TEXT_496 = "){" + NL + "\t\t\t\t                 ";
  protected final String TEXT_497 = "\t" + NL + "\t\t\t                        log.info(\"";
  protected final String TEXT_498 = " - No message available, would retry after \" + ";
  protected final String TEXT_499 = "+\"s\");" + NL + "\t\t\t                    ";
  protected final String TEXT_500 = NL + "\t\t\t\t                 Thread.sleep(";
  protected final String TEXT_501 = "*1000);" + NL + "\t\t\t\t                 hasWaitAndRetry_";
  protected final String TEXT_502 = " = true;" + NL + "\t\t\t\t                 flag";
  protected final String TEXT_503 = "= true;" + NL + "\t\t\t\t                 continue;" + NL + "\t\t\t\t             }else{" + NL + "\t\t\t\t                 ";
  protected final String TEXT_504 = "\t" + NL + "\t\t\t                        log.info(\"";
  protected final String TEXT_505 = " - No message available after retry, stop to receive message !\");" + NL + "\t\t\t                    ";
  protected final String TEXT_506 = NL + "\t\t\t\t                 break;" + NL + "\t\t\t\t             }" + NL + "\t\t\t\t         ";
  protected final String TEXT_507 = NL + "\t\t            \t    break;" + NL + "\t\t            \t";
  protected final String TEXT_508 = "   " + NL + "\t\t            }else{" + NL + "\t\t            \tthrow me_";
  protected final String TEXT_509 = ";" + NL + "\t\t            }   " + NL + "     \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_510 = NL + "\t\t\t\tremoteQ_";
  protected final String TEXT_511 = ".get(inMessage";
  protected final String TEXT_512 = ",gmo";
  protected final String TEXT_513 = ");" + NL + "\t\t\t";
  protected final String TEXT_514 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_515 = "\t\t\t\t" + NL + "\t\t\torg.talend.mq.headers.rfh2.MQRFH2 mqrfh2_";
  protected final String TEXT_516 = " = new org.talend.mq.headers.rfh2.MQRFH2(inMessage";
  protected final String TEXT_517 = ");" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_518 = NL + NL + "\t\t\t";
  protected final String TEXT_519 = NL + "\t    \t\tString msg_";
  protected final String TEXT_520 = "=inMessage";
  protected final String TEXT_521 = ".readStringOfByteLength(inMessage";
  protected final String TEXT_522 = ".getDataLength());" + NL + "\t\t\t";
  protected final String TEXT_523 = NL + "\t\t\t\tbyte[] bytesMsgBody_";
  protected final String TEXT_524 = " = new byte[inMessage";
  protected final String TEXT_525 = ".getDataLength()];" + NL + "\t\t\t\tinMessage";
  protected final String TEXT_526 = ".readFully(bytesMsgBody_";
  protected final String TEXT_527 = ");" + NL + "\t\t\t";
  protected final String TEXT_528 = NL + "\t\t\t\tString msg_";
  protected final String TEXT_529 = " = new String(bytesMsgBody_";
  protected final String TEXT_530 = ");" + NL + "\t\t\t";
  protected final String TEXT_531 = NL + "\t\t\t\tjava.util.Map msg_";
  protected final String TEXT_532 = " = (java.util.Map)inMessage";
  protected final String TEXT_533 = ".readObject();\t\t\t  " + NL + "\t\t\t";
  protected final String TEXT_534 = NL + "\t\t\t\tqMgr_";
  protected final String TEXT_535 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_536 = NL + NL + NL + "\t\t";
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(useIBMCipherMappings);
    stringBuffer.append(TEXT_338);
    stringBuffer.append(customCipherSuite);
    ...
    stringBuffer.append(TEXT_442);
			...
			if(("false").equals(kListen) && !useMax) {
    ...
    stringBuffer.append(TEXT_483);
			...
			if((("false").equals(kListen) && ("true").equals(useMsgId) && !"Map".equals(msgBobyType)) || useMax){
