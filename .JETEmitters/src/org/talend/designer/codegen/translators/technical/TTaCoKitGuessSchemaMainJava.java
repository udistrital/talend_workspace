...
public class TTaCoKitGuessSchemaMainJava
{
  ...
  protected final String TEXT_7 = NL + NL + "    java.util.Iterator<Object> rowIter = null;" + NL + "    Object rowObj = null;";
  protected final String TEXT_8 = NL + "            if (";
  protected final String TEXT_9 = " != null) {" + NL + "                inputsHandler_";
  protected final String TEXT_10 = ".setInputValue(\"";
  protected final String TEXT_11 = "\", ";
  protected final String TEXT_12 = ");" + NL + "            }";
  protected final String TEXT_13 = NL + "            rowIter = (java.util.Iterator<Object>)inputIterMap_";
  protected final String TEXT_14 = ".get(\"";
  protected final String TEXT_15 = "\");" + NL + "            rowObj = null;" + NL + "            if (rowIter != null && rowIter.hasNext()) {" + NL + "                rowObj = rowIter.next();" + NL + "            }" + NL + "            if (rowObj != null) {" + NL + "                inputsHandler_";
  protected final String TEXT_16 = ".setInputValue(\"";
  protected final String TEXT_17 = "\", rowObj);" + NL + "            }";
  protected final String TEXT_18 = NL + "          if(";
  protected final String TEXT_19 = " != null){" + NL + "            inputsHandler_";
  protected final String TEXT_20 = ".setInputValue(\"";
  protected final String TEXT_21 = "\", ";
  protected final String TEXT_22 = ");" + NL + "          }";
  protected final String TEXT_23 = NL;
  protected final String TEXT_24 = NL + NL + "processor_";
  protected final String TEXT_25 = ".onElement(inputs_";
  protected final String TEXT_26 = ", outputs_";
  protected final String TEXT_27 = ");" + NL + "nbLineInput_";
  protected final String TEXT_28 = "++;" + NL + "globalMap.put(\"";
  protected final String TEXT_29 = "_NB_LINE\", nbLineInput_";
  protected final String TEXT_30 = ");" + NL + "" + NL + "        Object rowObject_";
  protected final String TEXT_31 = " = outputHandler_";
  protected final String TEXT_32 = ".getValue(\"";
  protected final String TEXT_33 = "\");" + NL + "        if (rowObject_";
  protected final String TEXT_34 = " != null && Object.class == rowObject_";
  protected final String TEXT_35 = ".getClass()) {" + NL + "            // means we will not find it through data" + NL + "            // try by reflection" + NL + "            tacokitGuessSchema.fromOutputEmitterPojo(processorImpl_";
  protected final String TEXT_36 = ", \"";
  protected final String TEXT_37 = "\");" + NL + "            return;" + NL + "        }" + NL + "        if (rowObject_";
  protected final String TEXT_38 = " != null && tacokitGuessSchema.guessSchemaThroughResult(rowObject_";
  protected final String TEXT_39 = ")) {" + NL + "            return;" + NL + "        }" + NL + "" + NL + "        _recordsCount_";
  protected final String TEXT_40 = "++;" + NL + "        if(_recordsCount_";
  protected final String TEXT_41 = " > 100){" + NL + "            return; //stop reading. a sort of timeout" + NL + "        }" + NL;
