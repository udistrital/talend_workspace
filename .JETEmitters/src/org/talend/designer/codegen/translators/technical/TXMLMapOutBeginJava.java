...
public class TXMLMapOutBeginJava {
  ...
  protected final String TEXT_99 = "\", TalendString.replaceSpecialCharForXML(FormatterUtils.fm(valueMap.get(\"";
  ...
  protected final String TEXT_107 = ",\"\",FormatterUtils.fm(valueMap.get(\"";
  ...
  protected final String TEXT_116 = "\",FormatterUtils.fm(valueMap.get(\"";
  ...
  protected final String TEXT_225 = "\")!=null) {" + NL + "    \t\t\t\tcurrentValue = FormatterUtils.fm(valueMap.get(\"";
  ...
  protected final String TEXT_241 = ", FormatterUtils.fm(valueMap.get(\"";
