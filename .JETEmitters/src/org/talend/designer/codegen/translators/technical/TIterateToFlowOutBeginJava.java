...
public class TIterateToFlowOutBeginJava
{
  ...
  protected final String TEXT_44 = NL + "OnSubjobOkStruct";
  protected final String TEXT_45 = " struct_";
  protected final String TEXT_46 = " = new OnSubjobOkStruct";
  protected final String TEXT_47 = "();";
  protected final String TEXT_48 = NL + "struct_";
  protected final String TEXT_49 = ".";
  protected final String TEXT_50 = "  = ";
  protected final String TEXT_51 = ";";
  protected final String TEXT_52 = NL + "\tlog.trace(\"struct_";
  protected final String TEXT_53 = " - \" + struct_";
  protected final String TEXT_54 = ".toLogString());";
  protected final String TEXT_55 = NL;
  protected final String TEXT_56 = NL + "\t";
  protected final String TEXT_57 = NL + "\t\tsynchronized (";
  protected final String TEXT_58 = ".this.globalMap) {" + NL + "\t";
  protected final String TEXT_59 = NL + "\t\tsynchronized (";
  protected final String TEXT_60 = ".this.obj) {" + NL + "\t";
  protected final String TEXT_61 = NL + "\t\t    if(";
  protected final String TEXT_62 = ".this.globalMap.containsKey(\"";
  protected final String TEXT_63 = "\")){" + NL + "\t\t    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_64 = "> list_";
  protected final String TEXT_65 = " = (java.util.List<OnSubjobOkStruct";
  protected final String TEXT_66 = ">)";
  protected final String TEXT_67 = ".this.globalMap.get(\"";
  protected final String TEXT_68 = "\"); " + NL + "\t\t    \tlist_";
  protected final String TEXT_69 = ".add(struct_";
  protected final String TEXT_70 = ");" + NL + "\t\t    }else{" + NL + "\t\t    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_71 = "> list_";
  protected final String TEXT_72 = " = java.util.Collections.synchronizedList(new java.util.ArrayList<OnSubjobOkStruct";
  protected final String TEXT_73 = ">());" + NL + "\t\t    \tlist_";
  protected final String TEXT_74 = ".add(struct_";
  protected final String TEXT_75 = ");" + NL + "\t\t    \t";
  protected final String TEXT_76 = ".this.globalMap.put(\"";
  protected final String TEXT_77 = "\",list_";
  protected final String TEXT_78 = ");" + NL + "\t\t    }" + NL + "\t\t}";
  protected final String TEXT_79 = NL + "    if(globalMap.get(\"";
  protected final String TEXT_80 = "\") != null){" + NL + "    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_81 = "> list_";
  protected final String TEXT_82 = " = (java.util.List<OnSubjobOkStruct";
  protected final String TEXT_83 = ">)globalMap.get(\"";
  protected final String TEXT_84 = "\"); " + NL + "    \tlist_";
  protected final String TEXT_85 = ".add(struct_";
  protected final String TEXT_86 = ");" + NL + "    }else{" + NL + "    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_87 = "> list_";
  protected final String TEXT_88 = " = new java.util.ArrayList<OnSubjobOkStruct";
  protected final String TEXT_89 = ">();" + NL + "    \tlist_";
  protected final String TEXT_90 = ".add(struct_";
  protected final String TEXT_91 = ");" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_92 = "\",list_";
