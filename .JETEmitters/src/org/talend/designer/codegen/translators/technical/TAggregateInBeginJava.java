...
public class TAggregateInBeginJava
{
  ...
  protected final String TEXT_44 = NL + "java.util.Collection<AggOperationStruct_";
  protected final String TEXT_45 = "> values_";
  protected final String TEXT_46 = " = hash_";
  protected final String TEXT_47 = ".values();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_48 = "_NB_LINE\", values_";
  protected final String TEXT_49 = ".size());" + NL;
  protected final String TEXT_50 = NL + "for(AggOperationStruct_";
  protected final String TEXT_51 = " aggregated_row_";
  protected final String TEXT_52 = " : values_";
  protected final String TEXT_53 = ") { // G_AggR_600" + NL + NL;
