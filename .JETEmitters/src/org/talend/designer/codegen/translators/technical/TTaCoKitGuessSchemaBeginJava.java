...
public class TTaCoKitGuessSchemaBeginJava
{
  ...
  protected final String TEXT_61 = ".plugin()).get()" + NL + "                     .get(org.talend.sdk.component.runtime.manager.ComponentManager.AllServices.class)" + NL + "                     .getServices().get(javax.json.bind.Jsonb.class);" + NL + "    final org.talend.sdk.component.runtime.di.AutoChunkProcessor processor_";
  protected final String TEXT_62 = " = new org.talend.sdk.component.runtime.di.AutoChunkProcessor(chunkSize_";
  protected final String TEXT_63 = ", processorImpl_";
  protected final String TEXT_64 = ");" + NL + "" + NL + "    org.talend.sdk.component.runtime.di.JobStateAware.init(processorImpl_";
  protected final String TEXT_65 = ", globalMap);" + NL + "    processor_";
  protected final String TEXT_66 = ".start();" + NL + "    globalMap.put(\"processor_";
  protected final String TEXT_67 = "\", processor_";
  protected final String TEXT_68 = ");" + NL + "" + NL + "    int nbLineInput_";
  protected final String TEXT_69 = " = 0;";
  protected final String TEXT_70 = NL;
  protected final String TEXT_71 = NL;
  protected final String TEXT_72 = NL + NL + "    final org.talend.sdk.component.runtime.di.InputsHandler inputsHandler_";
  protected final String TEXT_73 = " = new org.talend.sdk.component.runtime.di.InputsHandler(jsonb_";
  protected final String TEXT_74 = ");";
  protected final String TEXT_75 = NL + NL + "    java.util.Map<String, Object> inputIterMap_";
  protected final String TEXT_76 = " = new java.util.HashMap<String, Object>();" + NL;
  protected final String TEXT_77 = NL + "        Class<?> inputsClass_";
  protected final String TEXT_78 = "_";
  protected final String TEXT_79 = " = Object.class;" + NL + "        java.util.Map<Object, Object> ";
  protected final String TEXT_80 = "_map = (java.util.Map<Object, Object>)globalMap.get(\"tHash_";
  protected final String TEXT_81 = "\");" + NL + "        java.util.Iterator<Object> ";
  protected final String TEXT_82 = "_iter = null;" + NL + "        if (";
  protected final String TEXT_83 = "_map != null) {" + NL + "            if(";
  protected final String TEXT_84 = "_map.values().iterator().hasNext()) {" + NL + "                Object firstObj = ";
  protected final String TEXT_85 = "_map.values().iterator().next();" + NL + "                if(firstObj != null) {" + NL + "                    inputsClass_";
  protected final String TEXT_86 = "_";
  protected final String TEXT_87 = " = firstObj.getClass();" + NL + "                }" + NL + "            }";
  protected final String TEXT_88 = NL + "            ";
  protected final String TEXT_89 = "_iter = ";
  protected final String TEXT_90 = "_map.values().iterator();" + NL + "            inputIterMap_";
  protected final String TEXT_91 = ".put(\"";
  protected final String TEXT_92 = "\", ";
  protected final String TEXT_93 = "_iter);" + NL + "        }";
  protected final String TEXT_94 = NL;
  protected final String TEXT_95 = NL + "        inputsHandler_";
  protected final String TEXT_96 = ".addConnection(\"";
  protected final String TEXT_97 = "\", inputsClass_";
  protected final String TEXT_98 = "_";
  protected final String TEXT_99 = ");";
  protected final String TEXT_100 = NL + "            inputsHandler_";
  protected final String TEXT_101 = ".addConnection(\"";
  protected final String TEXT_102 = "\", ";
  protected final String TEXT_103 = ".getClass());";
  protected final String TEXT_104 = NL + "    final org.talend.sdk.component.runtime.output.InputFactory inputs_";
  protected final String TEXT_105 = " = inputsHandler_";
  protected final String TEXT_106 = ".asInputFactory();";
  protected final String TEXT_107 = NL + NL + "        final org.talend.sdk.component.runtime.di.OutputsHandler outputHandler_";
  protected final String TEXT_108 = " = new org.talend.sdk.component.runtime.di.OutputsHandler(jsonb_";
  protected final String TEXT_109 = ");" + NL + "        outputHandler_";
  protected final String TEXT_110 = ".addConnection(\"";
  protected final String TEXT_111 = "\", Object.class);" + NL + "        final org.talend.sdk.component.runtime.output.OutputFactory outputs_";
  protected final String TEXT_112 = " = outputHandler_";
  protected final String TEXT_113 = ".asOutputFactory();";
  protected final String TEXT_114 = NL + NL + "    org.talend.sdk.component.runtime.di.schema.TaCoKitGuessSchema tacokitGuessSchema =" + NL + "                            new org.talend.sdk.component.runtime.di.schema.TaCoKitGuessSchema(out, configuration_";
  ...
  protected final String TEXT_123 = NL + "            try {" + NL + "                tacokitGuessSchema.guessInputComponentSchema();" + NL + "            } finally {" + NL + "                tacokitGuessSchema.close();" + NL + "            }";
  protected final String TEXT_124 = NL + "        globalMap.put(\"___tacokitGuessSchema___\", tacokitGuessSchema);" + NL + "        int _recordsCount_";
