...
public class TS3GetBeginJava
{
  ...
  protected final String TEXT_188 = " - Getting an object with key:\" + ";
  protected final String TEXT_189 = ");" + NL + "\t\t";
  protected final String TEXT_190 = NL + "\t\tconn_";
  protected final String TEXT_191 = ".getObject(new com.amazonaws.services.s3.model.GetObjectRequest(";
  protected final String TEXT_192 = ", ";
  protected final String TEXT_193 = "),new java.io.File(";
  protected final String TEXT_194 = "));" + NL + "\t\t";
  protected final String TEXT_195 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_196 = " - Get the object successfully.\");" + NL + "\t\t";
