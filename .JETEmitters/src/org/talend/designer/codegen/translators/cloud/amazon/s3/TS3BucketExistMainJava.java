...
public class TS3BucketExistMainJava
{
  ...
  protected final String TEXT_186 = NL + "\tboolean bucketExist_";
  protected final String TEXT_187 = "=false;" + NL + "\ttry{" + NL + "\t\tbucketExist_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".doesBucketExist(";
  protected final String TEXT_190 = ");" + NL + "\t\t";
  protected final String TEXT_191 = "\t" + NL + "\t\t\tif(bucketExist_";
  protected final String TEXT_192 = "){" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_193 = " - Bucket \"+";
  protected final String TEXT_194 = "+\" exists.\");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_195 = " - Bucket \"+";
  protected final String TEXT_196 = "+\" does not exist.\");" + NL + "\t\t\t}" + NL + "\t\t";
  ...
  protected final String TEXT_210 = "_BUCKET_NAME\", ";
  protected final String TEXT_211 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_212 = "_BUCKET_EXIST\", bucketExist_";
