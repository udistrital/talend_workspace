...
public class TS3BucketCreateMainJava
{
  ...
  protected final String TEXT_188 = " - Creating a bucket with name:\" + ";
  protected final String TEXT_189 = ");" + NL + "\t\t";
  protected final String TEXT_190 = NL + "\t\tconn_";
  protected final String TEXT_191 = ".createBucket(";
  protected final String TEXT_192 = ");" + NL + "\t\t";
  protected final String TEXT_193 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_194 = " - Create the bucket successfully.\");" + NL + "\t\t";
  protected final String TEXT_195 = NL + "\t}catch(java.lang.Exception e_";
