...
public class TS3ListBeginJava
{
  ...
  protected final String TEXT_186 = NL + NL + "\tint nb_bucket_";
  protected final String TEXT_187 = " = 0;" + NL + "\tint nb_bucket_object_";
  protected final String TEXT_188 = " = 0;" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_189 = NL + "\t\t\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".listBuckets();" + NL + "\t\t\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_192 = " : buckets_";
  protected final String TEXT_193 = ") {" + NL + "\t\t\t\tString currentBucketName_";
  protected final String TEXT_194 = " = bucket_";
  protected final String TEXT_195 = ".getName();" + NL + "\t\t\t\t";
  protected final String TEXT_196 = NL + "\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_197 = " - Retrieving objects from:\" + currentBucketName_";
  protected final String TEXT_198 = " + \".\");" + NL + "\t\t\t\t";
  protected final String TEXT_199 = NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectListing objects_";
  protected final String TEXT_200 = " = null;" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\tobjects_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = ".listObjects(currentBucketName_";
  protected final String TEXT_203 = ",";
  protected final String TEXT_204 = ");" + NL + "\t\t\t\t}catch(com.amazonaws.AmazonClientException e_";
  protected final String TEXT_205 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_206 = NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_207 = " - Failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_208 = ");" + NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_209 = " - \"+e_";
  protected final String TEXT_210 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_211 = NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_212 = "] failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_213 = ");" + NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_214 = "] \"+e_";
  protected final String TEXT_215 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t\t\tcontinue;" + NL + "\t\t\t\t}" + NL + "\t\t";
  protected final String TEXT_217 = NL + "\t\t\tjava.util.List<java.util.Map<String,String>> buckets_map_list_";
  protected final String TEXT_218 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "\t\t\tjava.util.Map<String,String> bucket_prefix_map_";
  protected final String TEXT_219 = " = null;" + NL + "\t\t\tString object_prefix_";
  protected final String TEXT_220 = " = \"\";" + NL + "\t\t\t";
  protected final String TEXT_221 = NL + "\t\t\t\t\tobject_prefix_";
  protected final String TEXT_222 = " = ";
  protected final String TEXT_223 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_224 = NL + "\t\t\t\tbucket_prefix_map_";
  protected final String TEXT_225 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\tbucket_prefix_map_";
  protected final String TEXT_226 = ".put(";
  protected final String TEXT_227 = ",object_prefix_";
  protected final String TEXT_228 = ");" + NL + "\t\t\t\tbuckets_map_list_";
  protected final String TEXT_229 = ".add(bucket_prefix_map_";
  protected final String TEXT_230 = ");" + NL + "\t\t\t\tobject_prefix_";
  protected final String TEXT_231 = " = \"\";" + NL + "\t\t\t";
  protected final String TEXT_232 = NL + "\t\t\tfor (java.util.Map<String,String> bucketMap_";
  protected final String TEXT_233 = ": buckets_map_list_";
  protected final String TEXT_234 = ") {" + NL + "\t\t\t\tString currentBucketName_";
  protected final String TEXT_235 = " = \"\";" + NL + "\t\t\t\tString currentPrefix_";
  protected final String TEXT_236 = " = \"\";" + NL + "\t\t\t\tfor(java.util.Map.Entry<String,String> entry_";
  protected final String TEXT_237 = ":bucketMap_";
  protected final String TEXT_238 = ".entrySet()){" + NL + "\t\t\t\t\tcurrentBucketName_";
  protected final String TEXT_239 = " = entry_";
  protected final String TEXT_240 = ".getKey();" + NL + "\t\t\t\t\tcurrentPrefix_";
  protected final String TEXT_241 = " = entry_";
  protected final String TEXT_242 = ".getValue();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectListing objects_";
  protected final String TEXT_243 = " = null;" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_244 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_245 = " - Retrieving objects from:\" + currentBucketName_";
  protected final String TEXT_246 = " + \".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_247 = NL + "\t\t\t\t\tobjects_";
  protected final String TEXT_248 = " = conn_";
  protected final String TEXT_249 = ".listObjects(currentBucketName_";
  protected final String TEXT_250 = ",currentPrefix_";
  protected final String TEXT_251 = ");" + NL + "\t\t\t\t}catch(com.amazonaws.AmazonClientException e_";
  protected final String TEXT_252 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_253 = NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_254 = " - Failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_255 = ");" + NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_256 = " - \"+e_";
  protected final String TEXT_257 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_258 = NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_259 = "] failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_260 = ");" + NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_261 = "] \"+e_";
  protected final String TEXT_262 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_263 = NL + "\t\t\t\t\tcontinue;" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_264 = NL + "\t\t\t\twhile(true){" + NL + "\t\t\t\t\tjava.util.List<com.amazonaws.services.s3.model.S3ObjectSummary> list_objects_";
  protected final String TEXT_265 = " = objects_";
  protected final String TEXT_266 = ".getObjectSummaries();" + NL + "\t\t\t\t\tif(list_objects_";
  protected final String TEXT_267 = ".size()>0){" + NL + "\t\t\t\t\t\tnb_bucket_";
  protected final String TEXT_268 = "++;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tfor (com.amazonaws.services.s3.model.S3ObjectSummary objectSummary_";
  protected final String TEXT_269 = " : list_objects_";
  protected final String TEXT_270 = ") {" + NL + "\t\t\t\t\t\tnb_bucket_object_";
  protected final String TEXT_271 = "++;" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_272 = "_CURRENT_BUCKET\", currentBucketName_";
  protected final String TEXT_273 = ");" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_274 = "_CURRENT_KEY\", objectSummary_";
  protected final String TEXT_275 = ".getKey());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_276 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_277 = " - Retrieving the object \" + nb_bucket_object_";
  protected final String TEXT_278 = " + \".\");" + NL + "\t\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_279 = " - Key of current object : \" + objectSummary_";
  protected final String TEXT_280 = ".getKey());" + NL + "\t\t\t\t\t\t";
