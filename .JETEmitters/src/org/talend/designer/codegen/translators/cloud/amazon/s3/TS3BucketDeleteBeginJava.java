...
public class TS3BucketDeleteBeginJava
{
  ...
  protected final String TEXT_188 = " - Deleting a bucket with name:\" + ";
  protected final String TEXT_189 = ");" + NL + "\t\t";
  protected final String TEXT_190 = NL + "\t\tconn_";
  protected final String TEXT_191 = ".deleteBucket(";
  protected final String TEXT_192 = ");" + NL + "\t\t";
  protected final String TEXT_193 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_194 = " - Delete the bucket successfully.\");" + NL + "\t\t";
