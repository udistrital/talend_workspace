...
public class TS3PutBeginJava
{
  ...
  protected final String TEXT_186 = NL + "\tString key_";
  protected final String TEXT_187 = " = ";
  protected final String TEXT_188 = ";" + NL + "\t" + NL + "\tint partSizeInBytes_";
  protected final String TEXT_189 = " = ";
  protected final String TEXT_190 = " * 1024 * 1024;" + NL + "\t" + NL + "\tObject fileOrStream_";
  protected final String TEXT_191 = " = ";
  protected final String TEXT_192 = ";" + NL + "\t" + NL + "\tboolean useStream_";
  protected final String TEXT_193 = " = false;" + NL + "\tjava.io.InputStream uploadStream_";
  protected final String TEXT_194 = " = null;" + NL + "\t" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_195 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_196 = " - Uploading an object with key:\" + key_";
  protected final String TEXT_197 = ");" + NL + "\t\t";
  protected final String TEXT_198 = NL + "\t\t" + NL + "\t\tif(fileOrStream_";
  protected final String TEXT_199 = " instanceof String){" + NL + "\t\t    useStream_";
  protected final String TEXT_200 = " = false;" + NL + "\t\t}else if(fileOrStream_";
  protected final String TEXT_201 = " instanceof java.io.InputStream){" + NL + "\t\t    useStream_";
  protected final String TEXT_202 = " = true;" + NL + "\t\t}" + NL + "\t\t" + NL + "    com.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_203 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_204 = NL + "\t\t\t\t";
  protected final String TEXT_205 = "\t" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_206 = " - No KMS - Normal SSE\");" + NL + "\t\t\t\t";
  protected final String TEXT_207 = NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_208 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t";
  protected final String TEXT_209 = NL + "\t\t" + NL + "\t\tif(!useStream_";
  protected final String TEXT_210 = ") {" + NL + "\t\t\t\tjava.io.File inputFile_";
  protected final String TEXT_211 = " = new java.io.File((String)fileOrStream_";
  protected final String TEXT_212 = ");" + NL + "\t\t\t\t" + NL + "\t\t\t\tlong multipart_upload_threshold_";
  protected final String TEXT_213 = " = 5 * 1024 * 1024;" + NL + "\t\t\t\t" + NL + "    \t\tcom.amazonaws.services.s3.transfer.TransferManager tm_";
  protected final String TEXT_214 = " = com.amazonaws.services.s3.transfer.TransferManagerBuilder" + NL + "    \t\t\t.standard()" + NL + "    \t\t\t.withMinimumUploadPartSize((long)partSizeInBytes_";
  protected final String TEXT_215 = ")" + NL + "    \t\t\t.withMultipartUploadThreshold(multipart_upload_threshold_";
  protected final String TEXT_216 = ")" + NL + "    \t\t\t.withS3Client(conn_";
  protected final String TEXT_217 = ")" + NL + "    \t\t\t.build();" + NL + "    \t\t\t" + NL + "  \t\t\tcom.amazonaws.services.s3.model.PutObjectRequest putRequest_";
  protected final String TEXT_218 = " = new com.amazonaws.services.s3.model.PutObjectRequest(";
  protected final String TEXT_219 = ", key_";
  protected final String TEXT_220 = ", inputFile_";
  protected final String TEXT_221 = ").withMetadata(objectMetadata_";
  protected final String TEXT_222 = ");" + NL + "  \t\t" + NL + "  \t\t\t";
  protected final String TEXT_223 = NL;
  protected final String TEXT_224 = NL + "\t";
  protected final String TEXT_225 = "\t" + NL + "\t\tlog.info(\"";
  protected final String TEXT_226 = " - KMS-Enabled - kmsid=\"+";
  protected final String TEXT_227 = ");" + NL + "\t";
  protected final String TEXT_228 = NL + "\t";
  protected final String TEXT_229 = NL + "\t\t";
  protected final String TEXT_230 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_231 = " - No KMS key - use default\");" + NL + "\t\t";
  protected final String TEXT_232 = NL + "\t\tputRequest_";
  protected final String TEXT_233 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams ());" + NL + "\t";
  protected final String TEXT_234 = NL + "\t\t";
  protected final String TEXT_235 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_236 = " - Key found - use key\");" + NL + "\t\t";
  protected final String TEXT_237 = NL + "\t\tputRequest_";
  protected final String TEXT_238 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams (";
  protected final String TEXT_239 = "));" + NL + "\t";
  protected final String TEXT_240 = NL + "  \t\t" + NL + "  \t\t\tcom.amazonaws.services.s3.transfer.Upload upload_";
  protected final String TEXT_241 = " = tm_";
  protected final String TEXT_242 = ".upload(putRequest_";
  protected final String TEXT_243 = ");" + NL + "  \t\t" + NL + "  \t\t\tupload_";
  protected final String TEXT_244 = ".waitForCompletion();" + NL + "\t\t} else {" + NL + "\t\t\t\tjava.io.InputStream sourceStream_";
  protected final String TEXT_245 = " = ((java.io.InputStream)fileOrStream_";
  protected final String TEXT_246 = ");" + NL + "\t\t\t\t" + NL + "  \t\t\tclass S3StreamUtil {" + NL + "    \t    public int getLength(byte[] output) {" + NL + "    \t\t    for (int i = output.length - 1; i > 0; i--) {" + NL + "    \t\t\t    if (output[i] != 0) {" + NL + "    \t\t\t\t    return i + 1;" + NL + "    \t\t\t    }" + NL + "    \t\t    }" + NL + "    \t\t    return 0;" + NL + "    \t    }" + NL + "      \t}" + NL + "      \t" + NL + "      \tS3StreamUtil streamUtil_";
  protected final String TEXT_247 = " = new S3StreamUtil();" + NL + "    \t\tbyte[] buffer_";
  protected final String TEXT_248 = " = new byte[partSizeInBytes_";
  protected final String TEXT_249 = "];" + NL + "    \t\tsourceStream_";
  protected final String TEXT_250 = ".read(buffer_";
  protected final String TEXT_251 = ");" + NL + "    \t\tlong curPartSize_";
  protected final String TEXT_252 = " = streamUtil_";
  protected final String TEXT_253 = ".getLength(buffer_";
  protected final String TEXT_254 = ");" + NL + "    \t\tboolean multiUpload_";
  protected final String TEXT_255 = " = curPartSize_";
  protected final String TEXT_256 = " == partSizeInBytes_";
  protected final String TEXT_257 = ";" + NL + "    \t\t" + NL + "    \t\tif(!multiUpload_";
  protected final String TEXT_258 = ") {" + NL + "    \t\t\t\tobjectMetadata_";
  protected final String TEXT_259 = ".setContentLength(curPartSize_";
  protected final String TEXT_260 = ");" + NL + "    \t\t\t\tuploadStream_";
  protected final String TEXT_261 = " = new java.io.ByteArrayInputStream(buffer_";
  protected final String TEXT_262 = ",0,Long.valueOf(curPartSize_";
  protected final String TEXT_263 = ").intValue());" + NL + "    \t\t\t\tcom.amazonaws.services.s3.model.PutObjectRequest putRequest_";
  protected final String TEXT_264 = " = new com.amazonaws.services.s3.model.PutObjectRequest(";
  protected final String TEXT_265 = ", key_";
  protected final String TEXT_266 = ", uploadStream_";
  protected final String TEXT_267 = ", objectMetadata_";
  protected final String TEXT_268 = ");" + NL + "    \t\t\t\t" + NL + "    \t\t\t\t";
  protected final String TEXT_269 = NL;
  protected final String TEXT_270 = NL + "\t";
  protected final String TEXT_271 = "\t" + NL + "\t\tlog.info(\"";
  protected final String TEXT_272 = " - KMS-Enabled - kmsid=\"+";
  protected final String TEXT_273 = ");" + NL + "\t";
  protected final String TEXT_274 = NL + "\t";
  protected final String TEXT_275 = NL + "\t\t";
  protected final String TEXT_276 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_277 = " - No KMS key - use default\");" + NL + "\t\t";
  protected final String TEXT_278 = NL + "\t\tputRequest_";
  protected final String TEXT_279 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams ());" + NL + "\t";
  protected final String TEXT_280 = NL + "\t\t";
  protected final String TEXT_281 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_282 = " - Key found - use key\");" + NL + "\t\t";
  protected final String TEXT_283 = NL + "\t\tputRequest_";
  protected final String TEXT_284 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams (";
  protected final String TEXT_285 = "));" + NL + "\t";
  protected final String TEXT_286 = NL + "    \t\t\t\t" + NL + "    \t\t\t\tconn_";
  protected final String TEXT_287 = ".putObject(putRequest_";
  protected final String TEXT_288 = ");" + NL + "    \t\t} else {" + NL + "    \t\t\t\tuploadStream_";
  protected final String TEXT_289 = " = new java.io.ByteArrayInputStream(buffer_";
  protected final String TEXT_290 = ");" + NL + "      \t\t\tjava.util.List<com.amazonaws.services.s3.model.PartETag> partTags_";
  protected final String TEXT_291 = " = new java.util.ArrayList<com.amazonaws.services.s3.model.PartETag>();" + NL + "      \t\t\tcom.amazonaws.services.s3.model.InitiateMultipartUploadRequest putRequest_";
  protected final String TEXT_292 = " = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest(";
  protected final String TEXT_293 = ", key_";
  protected final String TEXT_294 = ", objectMetadata_";
  protected final String TEXT_295 = ");" + NL + "      \t\t\t" + NL + "      \t\t\t";
  protected final String TEXT_296 = NL;
  protected final String TEXT_297 = NL + "\t";
  protected final String TEXT_298 = "\t" + NL + "\t\tlog.info(\"";
  protected final String TEXT_299 = " - KMS-Enabled - kmsid=\"+";
  protected final String TEXT_300 = ");" + NL + "\t";
  protected final String TEXT_301 = NL + "\t";
  protected final String TEXT_302 = NL + "\t\t";
  protected final String TEXT_303 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_304 = " - No KMS key - use default\");" + NL + "\t\t";
  protected final String TEXT_305 = NL + "\t\tputRequest_";
  protected final String TEXT_306 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams ());" + NL + "\t";
  protected final String TEXT_307 = NL + "\t\t";
  protected final String TEXT_308 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_309 = " - Key found - use key\");" + NL + "\t\t";
  protected final String TEXT_310 = NL + "\t\tputRequest_";
  protected final String TEXT_311 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams (";
  protected final String TEXT_312 = "));" + NL + "\t";
  protected final String TEXT_313 = NL + "      \t\t\t" + NL + "      \t\t\tcom.amazonaws.services.s3.model.InitiateMultipartUploadResult initResponse_";
  protected final String TEXT_314 = " = conn_";
  protected final String TEXT_315 = ".initiateMultipartUpload(putRequest_";
  protected final String TEXT_316 = ");" + NL + "      \t\t\tString uploadId_";
  protected final String TEXT_317 = " = initResponse_";
  protected final String TEXT_318 = ".getUploadId();" + NL + "      \t\t\tint partNumber_";
  protected final String TEXT_319 = " = 1;" + NL + "      \t\t\tboolean streamHasNext_";
  protected final String TEXT_320 = " = true;" + NL + "      \t\t\tbyte[] probeAvailability_";
  protected final String TEXT_321 = " = new byte[1];" + NL + "      \t\t\ttry {" + NL + "  \t\t\t\t\t\t\twhile (streamHasNext_";
  protected final String TEXT_322 = ") {" + NL + "        \t\t\t\t\t\tcom.amazonaws.services.s3.model.UploadPartRequest uploadRequest_";
  protected final String TEXT_323 = " = new com.amazonaws.services.s3.model.UploadPartRequest()" + NL + "                    \t.withBucketName(";
  protected final String TEXT_324 = ")" + NL + "                    \t.withKey(key_";
  protected final String TEXT_325 = ").withUploadId(uploadId_";
  protected final String TEXT_326 = ")" + NL + "                    \t.withPartNumber(partNumber_";
  protected final String TEXT_327 = ").withPartSize(curPartSize_";
  protected final String TEXT_328 = ");" + NL + "            \t\t    uploadRequest_";
  protected final String TEXT_329 = ".setInputStream(uploadStream_";
  protected final String TEXT_330 = ");" + NL + "            \t\t    streamHasNext_";
  protected final String TEXT_331 = " = sourceStream_";
  protected final String TEXT_332 = ".read(probeAvailability_";
  protected final String TEXT_333 = ") != -1;" + NL + "            \t\t    if(!streamHasNext_";
  protected final String TEXT_334 = "){" + NL + "                    \t    uploadRequest_";
  protected final String TEXT_335 = ".setLastPart(true);" + NL + "                    \t}" + NL + "" + NL + "                \t\tpartTags_";
  protected final String TEXT_336 = ".add(conn_";
  protected final String TEXT_337 = ".uploadPart(uploadRequest_";
  protected final String TEXT_338 = ").getPartETag());" + NL + "                  \t    partNumber_";
  protected final String TEXT_339 = "++;" + NL + "" + NL + "          \t\t     \tif(uploadStream_";
  protected final String TEXT_340 = "!=null){" + NL + "      \t\t         \t\t\tuploadStream_";
  protected final String TEXT_341 = ".close();" + NL + "          \t\t     \t}" + NL + "          \t\t     \tbuffer_";
  protected final String TEXT_342 = " = new byte[partSizeInBytes_";
  protected final String TEXT_343 = "];" + NL + "          \t\t     \tsourceStream_";
  protected final String TEXT_344 = ".read(buffer_";
  protected final String TEXT_345 = ",1,partSizeInBytes_";
  protected final String TEXT_346 = "-1);" + NL + "          \t\t     \tbuffer_";
  protected final String TEXT_347 = "[0] = probeAvailability_";
  protected final String TEXT_348 = "[0];" + NL + "          \t\t     \tprobeAvailability_";
  protected final String TEXT_349 = " = new byte[1];" + NL + "          \t\t     \tcurPartSize_";
  protected final String TEXT_350 = " = streamUtil_";
  protected final String TEXT_351 = ".getLength(buffer_";
  protected final String TEXT_352 = ");" + NL + "          \t\t     \tuploadStream_";
  protected final String TEXT_353 = " = new java.io.ByteArrayInputStream(buffer_";
  protected final String TEXT_354 = ");" + NL + "        \t\t\t\t}" + NL + "        \t\t\t\t" + NL + "            \t\tcom.amazonaws.services.s3.model.CompleteMultipartUploadRequest compRequest_";
  protected final String TEXT_355 = " = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest(";
  protected final String TEXT_356 = ", key_";
  protected final String TEXT_357 = "," + NL + "                        uploadId_";
  protected final String TEXT_358 = ", partTags_";
  protected final String TEXT_359 = ");" + NL + "            \t\tconn_";
  protected final String TEXT_360 = ".completeMultipartUpload(compRequest_";
  protected final String TEXT_361 = ");" + NL + "            } catch (java.lang.Exception uploadException_";
  protected final String TEXT_362 = ") {" + NL + "  \t\t\t\t\t\t\tconn_";
  protected final String TEXT_363 = ".abortMultipartUpload(new com.amazonaws.services.s3.model.AbortMultipartUploadRequest(";
  protected final String TEXT_364 = ", key_";
  protected final String TEXT_365 = ", uploadId_";
  protected final String TEXT_366 = "));" + NL + "    \t\t\t\t\t\tthrow uploadException_";
  protected final String TEXT_367 = ";" + NL + "            }" + NL + "    \t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_368 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_369 = " - Upload the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_370 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_371 = "){" + NL + "\t\t";
  protected final String TEXT_372 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_373 = ");" + NL + "\t\t";
  protected final String TEXT_374 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_375 = " - \" + e_";
  protected final String TEXT_376 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_378 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_379 = NL + "\t}finally{" + NL + "\t\tif(useStream_";
  protected final String TEXT_380 = " && uploadStream_";
  protected final String TEXT_381 = "!=null){" + NL + "    \tuploadStream_";
  protected final String TEXT_382 = ".close();" + NL + "    }" + NL + "\t    " + NL + "\t\t";
  protected final String TEXT_383 = NL + "\t\tif(conn_";
  protected final String TEXT_384 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_385 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
