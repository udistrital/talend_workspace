...
public class TS3DeleteBeginJava
{
  ...
  protected final String TEXT_186 = NL + "\ttry{" + NL + "\t\tString key_";
  protected final String TEXT_187 = " = ";
  protected final String TEXT_188 = ";" + NL + "\t\tif(key_";
  protected final String TEXT_189 = "!=null && key_";
  protected final String TEXT_190 = ".trim().length()>0){" + NL + "\t\t\t";
  protected final String TEXT_191 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_192 = " - Deleting an object with key:\" + ";
  protected final String TEXT_193 = ");" + NL + "\t\t\t";
  protected final String TEXT_194 = NL + "\t\t\tconn_";
  protected final String TEXT_195 = ".deleteObject(";
  protected final String TEXT_196 = ", key_";
  protected final String TEXT_197 = ");" + NL + "\t\t\t";
  protected final String TEXT_198 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_199 = " - Delete the object successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_200 = NL + "\t\t}else{" + NL + "\t\t\tthrow(new RuntimeException(\"Please set key!\"));" + NL + "\t\t}" + NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_201 = "){" + NL + "\t\t";
  protected final String TEXT_202 = NL + "\t\t\tthrow(e_";
  ...
  protected final String TEXT_207 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_208 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_209 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_210 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_211 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
