...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_362 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_366 = ".equalsIgnoreCase(";
  protected final String TEXT_367 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_368 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_369 = NL + "                                if(!whetherExist_";
  protected final String TEXT_370 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_390 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_403 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_424 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_435 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_441 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_442 = " = stmtTruncCount_";
  protected final String TEXT_443 = ".executeQuery(\"";
  protected final String TEXT_444 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_445 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_446 = " = rsTruncCount_";
  protected final String TEXT_447 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_464 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_465 = " = conn_";
  protected final String TEXT_466 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_467 = " = stmtTruncCount_";
  protected final String TEXT_468 = ".executeQuery(\"";
  protected final String TEXT_469 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_477 = NL + "                while(rsTruncCount_";
  protected final String TEXT_478 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_479 = " += rsTruncCount_";
  protected final String TEXT_480 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_481 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_482 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_483 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_484 = ".append(\",\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_488 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_522 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_523 = ",insert_";
  protected final String TEXT_524 = ",keyPsmt_";
  ...
  protected final String TEXT_529 = NL + "\t            class BufferLine_";
  protected final String TEXT_530 = " {" + NL + "    \t            ";
  protected final String TEXT_531 = NL + "                            ";
  protected final String TEXT_532 = " ";
  protected final String TEXT_533 = ";";
  protected final String TEXT_534 = NL + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_543 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_544 = "> exInsertColValueList";
  protected final String TEXT_545 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_546 = " exInsertColValue";
  protected final String TEXT_547 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_548 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_549 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_550 = ".append(\"(";
  protected final String TEXT_551 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_552 = "-1) extendInsertValueStmt_";
  protected final String TEXT_553 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_554 = " = \"INSERT INTO `\"+";
  protected final String TEXT_555 = "+\"` (";
  protected final String TEXT_556 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_557 = ".toString();";
  protected final String TEXT_558 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_559 = " += \tduplidateClause_";
  protected final String TEXT_560 = ".toString();";
  protected final String TEXT_561 = NL + "\t\t\t\t";
  protected final String TEXT_562 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_563 = " = new StringBuffer(insert_";
  protected final String TEXT_564 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_565 = ".insert(insert_";
  protected final String TEXT_566 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_567 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_568 = " =insertStringBuffer_";
  protected final String TEXT_569 = ".toString(); ";
  protected final String TEXT_570 = "    " + NL + "\t            java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_575 = ");" + NL + "" + NL + "\t            String insertColName";
  protected final String TEXT_576 = " = \"";
  protected final String TEXT_577 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_578 = " =  \"";
  protected final String TEXT_579 = "\";" + NL + "\t            int rowCount";
  protected final String TEXT_580 = " = 0;";
  protected final String TEXT_581 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_582 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_583 = " + \"` (";
  protected final String TEXT_584 = ") VALUES (";
  protected final String TEXT_585 = ")\";";
  protected final String TEXT_586 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_587 = " += \tduplidateClause_";
  protected final String TEXT_588 = ".toString();";
  protected final String TEXT_589 = NL + "\t\t        int batchSize_";
  protected final String TEXT_590 = " = ";
  protected final String TEXT_591 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_592 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_593 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_594 = " = new StringBuffer(insert_";
  protected final String TEXT_595 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_596 = ".insert(insert_";
  protected final String TEXT_597 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_598 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_599 = " =insertStringBuffer_";
  ...
  protected final String TEXT_604 = ");" + NL + "\t\t        resourceMap.put(\"pstmt_";
  protected final String TEXT_605 = "\", pstmt_";
  protected final String TEXT_606 = ");" + NL;
  protected final String TEXT_607 = NL + "\t    String update_";
  protected final String TEXT_608 = " = \"UPDATE `\" + ";
  protected final String TEXT_609 = " + \"` SET ";
  protected final String TEXT_610 = " WHERE ";
  protected final String TEXT_611 = "\";" + NL + "\t    ";
  protected final String TEXT_612 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_613 = " = new StringBuffer(update_";
  protected final String TEXT_614 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_615 = ".insert(update_";
  protected final String TEXT_616 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_617 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_618 = " =updateStringBuffer_";
  protected final String TEXT_619 = ".toString(); ";
  protected final String TEXT_620 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_621 = " = conn_";
  protected final String TEXT_622 = ".prepareStatement(update_";
  ...
  protected final String TEXT_626 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_627 = " = conn_";
  protected final String TEXT_628 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_629 = " + \"` WHERE ";
  protected final String TEXT_630 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_631 = "\", pstmt_";
  protected final String TEXT_632 = ");" + NL + "\t    String insert_";
  protected final String TEXT_633 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_634 = " + \"` (";
  protected final String TEXT_635 = ") VALUES (";
  protected final String TEXT_636 = ")\";" + NL + "\t    ";
  protected final String TEXT_637 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_638 = " = new StringBuffer(insert_";
  protected final String TEXT_639 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_640 = ".insert(insert_";
  protected final String TEXT_641 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_642 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_643 = " =insertStringBuffer_";
  protected final String TEXT_644 = ".toString(); ";
  protected final String TEXT_645 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_646 = " = conn_";
  protected final String TEXT_647 = ".prepareStatement(insert_";
  protected final String TEXT_648 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_649 = "\", pstmtInsert_";
  protected final String TEXT_650 = ");" + NL + "\t    String update_";
  protected final String TEXT_651 = " = \"UPDATE `\" + ";
  protected final String TEXT_652 = " + \"` SET ";
  protected final String TEXT_653 = " WHERE ";
  protected final String TEXT_654 = "\";" + NL + "\t    ";
  protected final String TEXT_655 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_656 = " = new StringBuffer(update_";
  protected final String TEXT_657 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_658 = ".insert(update_";
  protected final String TEXT_659 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_660 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_661 = " =updateStringBuffer_";
  protected final String TEXT_662 = ".toString(); ";
  protected final String TEXT_663 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_664 = " = conn_";
  protected final String TEXT_665 = ".prepareStatement(update_";
  protected final String TEXT_666 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_667 = "\", pstmtUpdate_";
  protected final String TEXT_668 = ");" + NL + "\t    ";
  protected final String TEXT_669 = NL + "\t    String update_";
  protected final String TEXT_670 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_682 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_683 = " = conn_";
  protected final String TEXT_684 = ".prepareStatement(update_";
  protected final String TEXT_685 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_703 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_704 = "\", pstmtInsert_";
  protected final String TEXT_705 = ");" + NL + "\t    ";
  protected final String TEXT_706 = NL + "\t    String delete_";
  protected final String TEXT_707 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_708 = " + \"` WHERE ";
  protected final String TEXT_709 = "\";" + NL + "\t    ";
  protected final String TEXT_710 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_711 = " = new StringBuffer(delete_";
  protected final String TEXT_712 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_713 = ".insert(delete_";
  protected final String TEXT_714 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_715 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_716 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_720 = ".prepareStatement(delete_";
  protected final String TEXT_721 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_722 = "\", pstmt_";
  protected final String TEXT_723 = ");" + NL + "\t    ";
  protected final String TEXT_724 = NL + "\t    String replace_";
  protected final String TEXT_725 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_726 = " + \"` (";
  protected final String TEXT_727 = ") VALUES (";
  protected final String TEXT_728 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_729 = " = conn_";
  protected final String TEXT_730 = ".prepareStatement(replace_";
  ...
  protected final String TEXT_742 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_743 = "\", pstmt_";
  protected final String TEXT_744 = ");" + NL + "\t    ";
  protected final String TEXT_745 = NL + "\t    String insert_";
  protected final String TEXT_746 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_747 = " + \"` (";
  protected final String TEXT_748 = ") VALUES (";
  protected final String TEXT_749 = ")\";" + NL + "\t    ";
  protected final String TEXT_750 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_751 = " = new StringBuffer(insert_";
  protected final String TEXT_752 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_753 = ".insert(insert_";
  protected final String TEXT_754 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_755 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_756 = " =insertStringBuffer_";
  protected final String TEXT_757 = ".toString(); ";
  protected final String TEXT_758 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_759 = " = conn_";
  protected final String TEXT_760 = ".prepareStatement(insert_";
  protected final String TEXT_761 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_762 = "\", pstmt_";
  protected final String TEXT_763 = ");" + NL + "\t    ";
  protected final String TEXT_764 = NL + "        StringBuffer query_";
  protected final String TEXT_765 = " = null;" + NL + "       \t";
  protected final String TEXT_766 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_767 = " = insert_";
  protected final String TEXT_768 = ".split(\"\\\\?\");";
  protected final String TEXT_769 = NL + "\t\t\tupdate_";
  protected final String TEXT_770 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_771 = " = update_";
  protected final String TEXT_772 = ".split(\"\\\\?\");";
  protected final String TEXT_773 = NL + "\t\t\tupdate_";
  protected final String TEXT_774 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_775 = " = update_";
  protected final String TEXT_776 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_777 = " = insert_";
  protected final String TEXT_778 = ".split(\"\\\\?\");";
  protected final String TEXT_779 = NL + "\t\t\tdelete_";
  protected final String TEXT_780 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_781 = " = delete_";
  protected final String TEXT_782 = ".split(\"\\\\?\");";
  protected final String TEXT_783 = NL + "\t\t\treplace_";
  protected final String TEXT_784 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_785 = " = replace_";
  protected final String TEXT_786 = ".split(\"\\\\?\");";
  protected final String TEXT_787 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_788 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_789 = " = insertIgnore_";
  protected final String TEXT_790 = ".split(\"\\\\?\");";
  protected final String TEXT_791 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_792 = " = insert_";
  protected final String TEXT_793 = ".split(\"\\\\?\");";
  protected final String TEXT_794 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_795 = " {" + NL + "    \t            ";
  protected final String TEXT_796 = NL + "                            ";
  protected final String TEXT_797 = " ";
  protected final String TEXT_798 = ";";
  protected final String TEXT_799 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_800 = ";" + NL + "\t\t\t";
  protected final String TEXT_801 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_802 = "(";
  protected final String TEXT_803 = NL + "                                ,";
  protected final String TEXT_804 = NL + "                            ";
  protected final String TEXT_805 = " ";
  protected final String TEXT_806 = NL + "\t\t\t\t, routines.system.Dynamic ";
  ...
  protected final String TEXT_815 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_816 = "> exInsertColValueList";
  protected final String TEXT_817 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_818 = " exInsertColValue";
  protected final String TEXT_819 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_820 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_821 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_822 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_823 = "=1;";
  protected final String TEXT_824 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_825 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_826 = "=0;";
  protected final String TEXT_827 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_828 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_829 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_830 = " =null;" + NL + "\tint rowCount";
  ...
  protected final String TEXT_836 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_837 = " =  null;";
  protected final String TEXT_838 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_839 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_840 = " = null;";
  protected final String TEXT_841 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_842 = " = null;";
  protected final String TEXT_843 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_844 = " = null;";
  protected final String TEXT_845 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
