...
public class TMysqlRowBeginJava
{
  ...
  protected final String TEXT_134 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_140 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_141 = "\", pstmt_";
  protected final String TEXT_142 = ");";
  protected final String TEXT_143 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_146 = "\", stmt_";
