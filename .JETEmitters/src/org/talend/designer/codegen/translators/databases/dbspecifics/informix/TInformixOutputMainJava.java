...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_524 = NL + "\t    pstmt_";
  protected final String TEXT_525 = " = conn_";
  protected final String TEXT_526 = ".prepareStatement(delete_";
  protected final String TEXT_527 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_697 = NL + "            int checkCount_";
  protected final String TEXT_698 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_699 = " = pstmt_";
  protected final String TEXT_700 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_701 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_702 = " = rs_";
  protected final String TEXT_703 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
