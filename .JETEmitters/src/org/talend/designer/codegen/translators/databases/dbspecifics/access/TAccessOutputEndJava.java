...
public class TAccessOutputEndJava
{
  ...
  protected final String TEXT_64 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_65 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_66 = "\");" + NL + "        }";
  protected final String TEXT_67 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_68 = "\", true);";
  protected final String TEXT_69 = NL + "        conn_";
  protected final String TEXT_70 = ".commit();";
  ...
  protected final String TEXT_76 = NL + "    int rejectedCount_";
  protected final String TEXT_77 = " = 0;";
  protected final String TEXT_78 = NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_91 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_92 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_93 = "_NB_LINE\",nb_line_";
  protected final String TEXT_94 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_95 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_96 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_97 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_98 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_99 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_100 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_101 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_102 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_103 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_104 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_107 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_110 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_113 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_114 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_115 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_116 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_119 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_131 = "_NB_LINE_REJECTED\", nb_line_rejected_";
