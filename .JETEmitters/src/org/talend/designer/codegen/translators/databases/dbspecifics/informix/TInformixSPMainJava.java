...
public class TInformixSPMainJava
{
  ...
  protected final String TEXT_46 = NL + "\t\t\t// No code generated: IN or INOUT arguments defined, whereas ";
  protected final String TEXT_47 = " has no input" + NL + "\t\t\t";
  protected final String TEXT_48 = NL + "\t\t\t\t\tif (";
  protected final String TEXT_49 = ".";
  protected final String TEXT_50 = " == null) {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_51 = ".setNull(";
  protected final String TEXT_52 = ", java.sql.Types.";
  protected final String TEXT_53 = ");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\t\t\tif (";
  protected final String TEXT_55 = ".";
  protected final String TEXT_56 = " == '\\0') {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_57 = ".setString(";
  protected final String TEXT_58 = ", \"\");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\tstatement_";
  ...
  protected final String TEXT_63 = NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_64 = ".setTimestamp(";
  protected final String TEXT_65 = ", new java.sql.Timestamp(";
  protected final String TEXT_66 = ".";
  protected final String TEXT_67 = ".getTime()));" + NL + "\t\t\t\t\t";
  protected final String TEXT_68 = NL + "\t\t\t\t\tstatement_";
  ...
  protected final String TEXT_75 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_76 = ".registerOutParameter(";
  protected final String TEXT_77 = ", java.sql.Types.";
  protected final String TEXT_78 = ");" + NL + "\t  \t\t\t";
  protected final String TEXT_79 = NL + "\t\tstatement_";
  protected final String TEXT_80 = ".execute();" + NL + "\t\t";
  ...
  protected final String TEXT_89 = ".getResultSet();";
  protected final String TEXT_90 = NL + "\t\t\t\t\t\t\t\tjava.sql.ResultSet tmpResult_";
  protected final String TEXT_91 = " = statement_";
  protected final String TEXT_92 = ".getResultSet();" + NL + "\t\t\t\t\t\t\t\tif (tmpResult_";
  protected final String TEXT_93 = ".next()) {";
  protected final String TEXT_94 = NL + "\t\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_95 = " = tmpResult_";
  protected final String TEXT_96 = ".getString(";
  protected final String TEXT_97 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_98 = " != null && tmpString_";
  protected final String TEXT_99 = ".length() > 0) {" + NL + "\t\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_100 = ".";
  protected final String TEXT_101 = " = tmpString_";
  protected final String TEXT_102 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_103 = NL + "\t\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_104 = " = tmpResult_";
  protected final String TEXT_105 = ".getTimestamp(";
  protected final String TEXT_106 = ");" + NL + "\t\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_107 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_108 = ".";
  protected final String TEXT_109 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_110 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_111 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_112 = ".";
  protected final String TEXT_113 = " = tmpResult_";
  protected final String TEXT_114 = ".get";
  protected final String TEXT_115 = "(";
  protected final String TEXT_116 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t}";
  protected final String TEXT_118 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_119 = " = statement_";
  protected final String TEXT_120 = ".getString(";
  protected final String TEXT_121 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_122 = " != null && tmpString_";
  protected final String TEXT_123 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_124 = ".";
  protected final String TEXT_125 = " = tmpString_";
  protected final String TEXT_126 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_127 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_128 = " = statement_";
  protected final String TEXT_129 = ".getTimestamp(";
  protected final String TEXT_130 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_131 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_132 = ".";
  protected final String TEXT_133 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_134 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_141 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_142 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_143 = ".";
  protected final String TEXT_144 = " = null;" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_155 = NL + "\t\t// No code generated: define a schema for ";
