...
public class TVerticaBulkExecMainJava {
  ...
  protected final String TEXT_71 = NL + "java.io.FileInputStream fis_";
  protected final String TEXT_72 = " = (java.io.FileInputStream)";
  protected final String TEXT_73 = ".content;";
  protected final String TEXT_74 = NL + "java.io.FileInputStream fis_";
  protected final String TEXT_75 = " = null;";
  protected final String TEXT_76 = NL + "try{";
  protected final String TEXT_77 = NL + "java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_78 = " = conn_";
  protected final String TEXT_79 = ".createStatement();";
  protected final String TEXT_80 = NL + "log.info(\"";
  protected final String TEXT_81 = " - Creating temp table ";
  protected final String TEXT_82 = "\" + tableName_";
  protected final String TEXT_83 = " + \"";
  protected final String TEXT_84 = ".\" );";
  protected final String TEXT_85 = NL + NL + "stmtCreateTmp_";
  protected final String TEXT_86 = ".execute(sql_create_tmpdb);";
  protected final String TEXT_87 = NL + "    log.info(\"";
  protected final String TEXT_88 = " - Create temp table ";
  protected final String TEXT_89 = "\" + tableName_";
  protected final String TEXT_90 = " + \"";
  protected final String TEXT_91 = " has succeeded.\");";
  protected final String TEXT_92 = NL + "stmtCreateTmp_";
  protected final String TEXT_93 = ".close();";
  protected final String TEXT_94 = NL + "    fis_";
  protected final String TEXT_95 = "= new java.io.FileInputStream(new java.io.File(";
  protected final String TEXT_96 = "));";
  protected final String TEXT_97 = NL + "    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_98 = ").startCopyIn(sql_";
  protected final String TEXT_99 = ", fis_";
  protected final String TEXT_100 = ");" + NL + "    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_101 = ").addStreamToCopyIn(fis_";
  protected final String TEXT_102 = ");";
  protected final String TEXT_103 = NL + "    log.info(\"";
  protected final String TEXT_104 = "- Bulk insert data into";
  protected final String TEXT_105 = "\" + tableName_";
  protected final String TEXT_106 = "+ \"";
  protected final String TEXT_107 = "has finished.\");";
  protected final String TEXT_108 = NL;
  protected final String TEXT_109 = NL + "    vcs_";
  protected final String TEXT_110 = ".addStream(fis_";
  protected final String TEXT_111 = ");" + NL + "    vcs_";
  protected final String TEXT_112 = ".execute();";
  protected final String TEXT_113 = NL + "    log.info(\"";
  protected final String TEXT_114 = " - Bulk insert data into ";
  protected final String TEXT_115 = "\" + tableName_";
  protected final String TEXT_116 = " + \"";
  protected final String TEXT_117 = " has finished.\");";
  protected final String TEXT_118 = NL + "    String tmpTableName_";
  protected final String TEXT_119 = "= \"tmp_";
  protected final String TEXT_120 = "\" + pid + Thread.currentThread().getId();" + NL + "    if(dbschema_";
  protected final String TEXT_121 = "== null || dbschema_";
  protected final String TEXT_122 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_123 = "=";
  protected final String TEXT_124 = ";" + NL + "    }" + NL + "    else {" + NL + "        tableName_";
  protected final String TEXT_125 = "= dbschema_";
  protected final String TEXT_126 = "+ \".\" +";
  protected final String TEXT_127 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_128 = "=dbschema_";
  protected final String TEXT_129 = "+ \".\" + tmpTableName_";
  protected final String TEXT_130 = ";" + NL + "    }" + NL + "    java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_134 = "- Updating";
  protected final String TEXT_135 = "\" + tableName_";
  protected final String TEXT_136 = "+ \"";
  protected final String TEXT_137 = "from";
  protected final String TEXT_138 = "\"+tmpTableName_";
  protected final String TEXT_139 = "+\"";
  protected final String TEXT_140 = ".\");" + NL;
  protected final String TEXT_141 = NL + "    stmtUpdateBulk_";
  protected final String TEXT_142 = ".executeUpdate(\"";
  protected final String TEXT_143 = "\");" + NL;
  protected final String TEXT_144 = NL + NL + "    stmtUpdateBulk_";
  protected final String TEXT_145 = ".close();" + NL + "    tableName_";
  protected final String TEXT_146 = "= tmpTableName_";
  protected final String TEXT_147 = ";";
  protected final String TEXT_148 = NL + "}finally{" + NL;
  protected final String TEXT_149 = NL + "        java.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_153 = "- Dropping temp table";
  protected final String TEXT_154 = "\" + tableName_";
  protected final String TEXT_155 = "+ \"";
  protected final String TEXT_156 = ".\");";
  protected final String TEXT_157 = NL + "        stmtTmpDrop_";
  protected final String TEXT_158 = ".execute(\"";
  protected final String TEXT_159 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_160 = ".close();";
  protected final String TEXT_161 = NL + "        log.info(\"";
  protected final String TEXT_162 = "- Drop temp table";
  protected final String TEXT_163 = "\" + tableName_";
  protected final String TEXT_164 = "+ \"";
  protected final String TEXT_165 = "has succeeded.\");";
  protected final String TEXT_166 = NL + "    if(fis_";
  protected final String TEXT_167 = "!=null)" + NL + "        fis_";
