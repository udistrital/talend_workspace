...
public class TSQLDWHCloseMainJava
{
  protected static String nl;
  public static synchronized TSQLDWHCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHCloseMainJava result = new TSQLDWHCloseMainJava();
    nl = null;
    return result;
  }
