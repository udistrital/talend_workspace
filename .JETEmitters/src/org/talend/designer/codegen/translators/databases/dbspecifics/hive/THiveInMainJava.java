...
public class THiveInMainJava
{
  ...
  protected final String TEXT_310 = " - query added: \" + command);" + NL + "        \t\t\t";
  protected final String TEXT_311 = NL + "        \t\t}" + NL + "        \t}" + NL + "        \t" + NL + "        \tString query_";
  protected final String TEXT_312 = " = ";
  protected final String TEXT_313 = ";";
  protected final String TEXT_314 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_315 = " - query added: \" + query_";
  protected final String TEXT_316 = ".replaceAll(\"\\n\", \" \").replaceAll(\" +\", \" \") + \";\");" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_317 = " - queries sent to cluster, waiting for execution result ...\");";
  protected final String TEXT_318 = NL + "           \t\tString execution_result_";
  protected final String TEXT_319 = " = instance_";
  protected final String TEXT_320 = ".execute(queries_";
  protected final String TEXT_321 = " + query_";
  protected final String TEXT_322 = " + \";\", ";
  protected final String TEXT_323 = ").getResults();";
  protected final String TEXT_324 = NL + "\t\t\t\tString execution_result_";
  protected final String TEXT_325 = " = instance_";
  protected final String TEXT_326 = ".execute(queries_";
  protected final String TEXT_327 = " + query_";
  protected final String TEXT_328 = " + \";\").getResults();";
  protected final String TEXT_329 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_330 = " - execution finished.\");" + NL + "\t\t\t";
  protected final String TEXT_331 = NL + "\t\t\tjava.io.InputStream ";
  protected final String TEXT_332 = " = new java.io.ByteArrayInputStream(execution_result_";
  protected final String TEXT_333 = ".getBytes());" + NL + "\t\t\t";
