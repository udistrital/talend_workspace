...
public class TAccessOutputBulkBeginJava
{
  ...
  protected final String TEXT_44 = NL + "\t\tString fileName_";
  protected final String TEXT_45 = " = (new java.io.File(";
  protected final String TEXT_46 = ")).getAbsolutePath().replace(\"\\\\\",\"/\");";
  protected final String TEXT_47 = NL + "\t\tString directory_";
  protected final String TEXT_48 = " = null;" + NL + "\t\tif((fileName_";
  protected final String TEXT_49 = ".indexOf(\"/\") != -1)) {     " + NL + "\t\t    directory_";
  protected final String TEXT_50 = " = fileName_";
  protected final String TEXT_51 = ".substring(0, fileName_";
  protected final String TEXT_52 = ".lastIndexOf(\"/\"));            " + NL + "\t\t} else {" + NL + "\t\t    directory_";
  protected final String TEXT_53 = " = \"\";" + NL + "\t\t}" + NL + "" + NL + "\t\tif(directory_";
  protected final String TEXT_54 = " != null && directory_";
  protected final String TEXT_55 = ".trim().length() != 0) {" + NL + " \t\t\tjava.io.File dir_";
  protected final String TEXT_56 = " = new java.io.File(directory_";
  protected final String TEXT_57 = ");" + NL + "\t\t\tif(!dir_";
  protected final String TEXT_58 = ".exists()) {";
  protected final String TEXT_59 = NL + "                if(dir_";
  protected final String TEXT_60 = ".mkdirs()){";
  protected final String TEXT_61 = NL + "                    System.out.println(\"The directory '\"+directory_";
  protected final String TEXT_62 = "+\"' has been created successfully.\");" + NL + "                }else{";
  protected final String TEXT_63 = NL + "                    System.err.println(\"Fail to create directory '\"+directory_";
  protected final String TEXT_64 = "+\"'.\");" + NL + "                }" + NL + "" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_65 = NL + NL + "\t\tint nb_line_";
  protected final String TEXT_66 = " = 0;" + NL + "\t\t" + NL + "\t\tfinal String OUT_DELIM_";
  protected final String TEXT_67 = " = \",\";" + NL + "\t\t" + NL + "\t\tfinal String OUT_DELIM_ROWSEP_";
  protected final String TEXT_68 = " = \"\\n\";" + NL + "\t\t";
  protected final String TEXT_69 = "\t\t\t\t" + NL + "\t\tfinal String OUT_FIELDS_ENCLOSURE_";
  protected final String TEXT_70 = " = ";
  protected final String TEXT_71 = ";" + NL + "\t\t";
  protected final String TEXT_72 = "\t\t" + NL + "\t\t" + NL + "\t\tjava.io.File file_";
  protected final String TEXT_73 = "=new java.io.File(";
  protected final String TEXT_74 = ");" + NL + "\t\tfinal java.io.BufferedWriter out";
  protected final String TEXT_75 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        \t\tnew java.io.FileOutputStream(file_";
  protected final String TEXT_76 = ", ";
  protected final String TEXT_77 = "),";
  protected final String TEXT_78 = "));" + NL + "       \tresourceMap.put(\"out";
  protected final String TEXT_79 = "\", out";
  ...
  protected final String TEXT_86 = "out";
  protected final String TEXT_87 = ".write(OUT_DELIM_";
  protected final String TEXT_88 = ");";
  protected final String TEXT_89 = NL + "    \t\tout";
  protected final String TEXT_90 = ".write(OUT_DELIM_ROWSEP_";
  protected final String TEXT_91 = ");" + NL + "    \t\tout";
  protected final String TEXT_92 = ".flush();" + NL + "    \t}";
