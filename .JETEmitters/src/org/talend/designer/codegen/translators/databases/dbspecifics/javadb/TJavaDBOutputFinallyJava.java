...
public class TJavaDBOutputFinallyJava
{
  ...
  protected final String TEXT_46 = NL + "try {" + NL + "    if(resourceMap.get(\"statementClosed_";
  protected final String TEXT_47 = "\")==null){";
  protected final String TEXT_48 = NL + "            java.sql.PreparedStatement pstmtUpdateToClose_";
  protected final String TEXT_49 = " = null;" + NL + "            if ((pstmtUpdateToClose_";
  protected final String TEXT_50 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_51 = "\")) != null) {" + NL + "                pstmtUpdateToClose_";
  protected final String TEXT_52 = ".close();" + NL + "            }" + NL + "            java.sql.PreparedStatement pstmtInsertToClose_";
  protected final String TEXT_53 = " = null;" + NL + "            if ((pstmtInsertToClose_";
  protected final String TEXT_54 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_55 = "\")) != null) {" + NL + "                pstmtInsertToClose_";
  protected final String TEXT_56 = ".close();" + NL + "            }";
  protected final String TEXT_57 = NL + "            java.sql.PreparedStatement pstmtToClose_";
  protected final String TEXT_58 = " = null;" + NL + "            if ((pstmtToClose_";
  protected final String TEXT_59 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmt_";
  protected final String TEXT_60 = "\")) != null) {" + NL + "                pstmtToClose_";
  protected final String TEXT_61 = ".close();" + NL + "            }";
  protected final String TEXT_62 = NL + "    }" + NL + "} finally {" + NL + "    if(resourceMap.get(\"finish_";
  protected final String TEXT_63 = "\")==null){" + NL + "        if(resourceMap.get(\"conn_";
  protected final String TEXT_64 = "\")!=null){" + NL + "            try {";
  protected final String TEXT_65 = NL + "                ((java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_66 = "\")).close();";
  protected final String TEXT_67 = NL + "                java.sql.DriverManager.getConnection(\"jdbc:derby:;shutdown=true\");";
