...
public class TVerticaBulkExecEndJava {
  ...
  protected final String TEXT_72 = ").finishCopyIn();" + NL + "    " + NL + "    rs_";
  protected final String TEXT_73 = "= stmt_";
  protected final String TEXT_74 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_75 = ");" + NL + "    int nbLineAfterLoad_";
  protected final String TEXT_76 = "= 0;" + NL + "    while (rs_";
  protected final String TEXT_77 = ".next()) {" + NL + "        nbLineAfterLoad_";
  protected final String TEXT_78 = "= rs_";
  protected final String TEXT_79 = ".getInt(1);" + NL + "    }" + NL + "    stmt_";
  protected final String TEXT_80 = ".close();" + NL + "    if(";
  protected final String TEXT_81 = "&& nbLineBeforeLoad_";
  protected final String TEXT_82 = ">= nbLineAfterLoad_";
  protected final String TEXT_83 = "){" + NL + "        throw new RuntimeException(\"No record was inserted in component";
  protected final String TEXT_84 = "\");" + NL + "    }" + NL + "    else{";
  protected final String TEXT_85 = NL + "        log.info(\"";
  protected final String TEXT_86 = "- Number of records inserted to table";
  protected final String TEXT_87 = "\" + tableName_";
  protected final String TEXT_88 = "+ \"";
  protected final String TEXT_89 = "by";
  protected final String TEXT_90 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_91 = "- nbLineBeforeLoad_";
  protected final String TEXT_92 = ")+\".\");";
  protected final String TEXT_93 = NL + "        System.out.println(\"Number of records inserted to table";
  protected final String TEXT_94 = "\" + tableName_";
  protected final String TEXT_95 = "+ \"";
  protected final String TEXT_96 = "by";
  protected final String TEXT_97 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_98 = "- nbLineBeforeLoad_";
  protected final String TEXT_99 = "));" + NL + "    }" + NL + "    globalMap.put(\"";
  protected final String TEXT_100 = "_ACCEPTED_ROW_NUMBER\",nbLineAfterLoad_";
  protected final String TEXT_101 = "- nbLineBeforeLoad_";
  protected final String TEXT_102 = ");";
  protected final String TEXT_103 = NL + "    vcs_";
  protected final String TEXT_104 = ".finish();" + NL + "" + NL + "    long copyNumber_";
  protected final String TEXT_105 = " = vcs_";
  protected final String TEXT_106 = ".getRowCount();" + NL + "    " + NL + "    //get rejected and accepted row number" + NL + "    java.sql.Statement stmt_accept_reject_";
  protected final String TEXT_107 = " = conn_";
  protected final String TEXT_108 = ".createStatement();" + NL + "    " + NL + "    java.sql.ResultSet rs_";
  protected final String TEXT_109 = " = stmt_accept_reject_";
  protected final String TEXT_110 = ".executeQuery(\"select get_num_accepted_rows()\");" + NL + "    int acceptedRowNumber_";
  protected final String TEXT_111 = " = 0;" + NL + "    while (rs_";
  protected final String TEXT_112 = ".next()) {" + NL + "        acceptedRowNumber_";
  protected final String TEXT_113 = " = rs_";
  protected final String TEXT_114 = ".getInt(1);" + NL + "    }" + NL + "    " + NL + "    rs_";
  protected final String TEXT_115 = " = stmt_accept_reject_";
  protected final String TEXT_116 = ".executeQuery(\"select get_num_rejected_rows()\");" + NL + "    int rejectedRowNumber_";
  protected final String TEXT_117 = " = 0;" + NL + "    while (rs_";
  protected final String TEXT_118 = ".next()) {" + NL + "        rejectedRowNumber_";
  protected final String TEXT_119 = " = rs_";
  protected final String TEXT_120 = ".getInt(1);" + NL + "    }" + NL + "    " + NL + "    stmt_accept_reject_";
  protected final String TEXT_121 = ".close();" + NL + "    " + NL + "    if(";
  protected final String TEXT_122 = " && copyNumber_";
  protected final String TEXT_123 = " <= 0){" + NL + "        throw new RuntimeException(\"No record was inserted into component ";
  protected final String TEXT_124 = "\");" + NL + "    }else{";
  protected final String TEXT_125 = NL + "            log.info(\"";
  protected final String TEXT_126 = " - Number of records inserted into table ";
  protected final String TEXT_127 = "\" + tableName_";
  protected final String TEXT_128 = " + \"";
  protected final String TEXT_129 = " by ";
  protected final String TEXT_130 = ": \" + (copyNumber_";
  protected final String TEXT_131 = ")+\".\");";
  protected final String TEXT_132 = NL + "        System.out.println(\"Number of records inserted into table ";
  ...
  protected final String TEXT_137 = "));" + NL + "    }" + NL + "    " + NL + "    globalMap.put(\"";
  protected final String TEXT_138 = "_ACCEPTED_ROW_NUMBER\",acceptedRowNumber_";
  protected final String TEXT_139 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_140 = "_REJECTED_ROW_NUMBER\",rejectedRowNumber_";
  protected final String TEXT_141 = ");";
  protected final String TEXT_142 = NL + "}" + NL + "finally {";
