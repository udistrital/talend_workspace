...
public class TTeradataCommitMainJava
{
  ...
  protected final String TEXT_121 = NL + "    }finally{";
  protected final String TEXT_122 = NL + "            //add query band support for teradata12+" + NL + "            // end query band for session" + NL + "            conn_";
  ...
  protected final String TEXT_129 = NL + "                    System.err.println(e.getMessage());" + NL + "             }" + NL;
