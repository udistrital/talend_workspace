...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_586 = ".addBatch();" + NL + "                batchSizeCounter_";
  protected final String TEXT_587 = "++;" + NL + "                nb_line_";
  protected final String TEXT_588 = "++;";
  protected final String TEXT_589 = NL + "            ////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_590 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_591 = " = insertedCount_";
  protected final String TEXT_592 = " + pstmt_";
  protected final String TEXT_593 = ".executeUpdate();";
  protected final String TEXT_594 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_595 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_596 = " = true;";
  protected final String TEXT_597 = NL + "                    throw(e_";
  ...
  protected final String TEXT_611 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_612 = ").getSQLState();";
  protected final String TEXT_613 = NL + "                        ";
  protected final String TEXT_614 = ".errorMessage = e_";
  protected final String TEXT_615 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_616 = ";";
  protected final String TEXT_617 = NL + "                        System.err.print(e_";
  ...
  protected final String TEXT_656 = ".addBatch();" + NL + "                batchSizeCounter_";
  protected final String TEXT_657 = "++;" + NL + "                nb_line_";
  protected final String TEXT_658 = "++;";
  protected final String TEXT_659 = NL + "            //////////////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_664 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_665 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_666 = " = true;";
  ...
  protected final String TEXT_681 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_682 = ").getSQLState();";
  protected final String TEXT_683 = NL + "                        ";
  protected final String TEXT_684 = ".errorMessage = e_";
  protected final String TEXT_685 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_686 = ";";
  protected final String TEXT_687 = NL + "                        System.err.print(e_";
  protected final String TEXT_688 = ".getMessage());";
  protected final String TEXT_689 = NL + "            }" + NL + "            /////////////////////////////////////";
  protected final String TEXT_690 = NL + "                        ";
  protected final String TEXT_691 = NL + "                    ";
  protected final String TEXT_692 = NL + "            int checkCount_";
  protected final String TEXT_693 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_694 = " = pstmt_";
  protected final String TEXT_695 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_696 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_697 = " = rs_";
  protected final String TEXT_698 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_699 = " > 0) {";
  ...
  protected final String TEXT_767 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_892 = NL + "             }" + NL + "                } catch(java.lang.Exception e_";
  ...
  protected final String TEXT_928 = NL + "                globalMap.put(\"";
  protected final String TEXT_929 = "_QUERY\", query_";
  protected final String TEXT_930 = ".toString().trim());";
  protected final String TEXT_931 = NL + "              pstmt_";
  protected final String TEXT_932 = ".addBatch();" + NL + "              batchSizeCounter_";
  protected final String TEXT_933 = "++;" + NL + "              nb_line_";
  protected final String TEXT_934 = "++;";
  protected final String TEXT_935 = NL + "            //////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_936 = " = deletedCount_";
  protected final String TEXT_937 = " + pstmt_";
  protected final String TEXT_938 = ".executeUpdate();" + NL + "              nb_line_";
  protected final String TEXT_939 = "++;";
  protected final String TEXT_940 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_941 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_942 = " = true;";
  protected final String TEXT_943 = NL + "                    throw(e_";
  protected final String TEXT_944 = ");";
  protected final String TEXT_945 = NL + "                    nb_line_";
  ...
  protected final String TEXT_955 = NL + "                        rejectedCount_";
  protected final String TEXT_956 = " = rejectedCount_";
  protected final String TEXT_957 = " + 1;";
  protected final String TEXT_958 = NL + "                        ";
  protected final String TEXT_959 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_960 = ").getSQLState();";
  protected final String TEXT_961 = NL + "                        ";
  protected final String TEXT_962 = ".errorMessage = e_";
  protected final String TEXT_963 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_964 = ";";
  protected final String TEXT_965 = NL + "                        System.err.print(e_";
  protected final String TEXT_966 = ".getMessage());";
  ...
  protected final String TEXT_982 = ")) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_983 = " = 0;" + NL + "                        int countSum_";
  protected final String TEXT_984 = " = 0;" + NL;
  protected final String TEXT_985 = NL + "                        for(int countEach_";
  protected final String TEXT_986 = ":pstmt_";
  protected final String TEXT_987 = ".executeBatch()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_992 = NL + "                            insertedCount_";
  protected final String TEXT_993 = " += countSum_";
  protected final String TEXT_994 = ";";
  protected final String TEXT_995 = NL + "                            updatedCount_";
  protected final String TEXT_996 = " += countSum_";
  protected final String TEXT_997 = ";";
  protected final String TEXT_998 = NL + "                            deletedCount_";
  protected final String TEXT_999 = " += countSum_";
  protected final String TEXT_1000 = ";";
  protected final String TEXT_1001 = NL + "                }catch(java.sql.SQLException e_";
  protected final String TEXT_1002 = "){";
  protected final String TEXT_1003 = NL + "                    java.sql.SQLException e2_";
  protected final String TEXT_1004 = " = e_";
  protected final String TEXT_1005 = ";" + NL + "                    while (e2_";
  protected final String TEXT_1006 = " != null) {";
  protected final String TEXT_1007 = NL + "                        System.err.println(e_";
  protected final String TEXT_1008 = ".getMessage());" + NL + "                        e2_";
  protected final String TEXT_1009 = " = e2_";
  protected final String TEXT_1010 = ".getNextException();" + NL + "                    }";
  protected final String TEXT_1011 = NL + "            java.sql.SQLException e3_";
  protected final String TEXT_1012 = " = e_";
  protected final String TEXT_1013 = ";" + NL + "                    boolean isFailure = false;" + NL + "            while(e_";
  protected final String TEXT_1014 = " != null){" + NL + "                if(e_";
  protected final String TEXT_1015 = ".getErrorCode() == -2801){";
  protected final String TEXT_1016 = NL + "                    System.out.println(\" Message: \" + e_";
  protected final String TEXT_1017 = ".getMessage());" + NL + "                    e_";
  protected final String TEXT_1018 = ".printStackTrace();" + NL + "                    System.out.println();" + NL + "                }" + NL + "                else if(e_";
  protected final String TEXT_1019 = ".getErrorCode() == 1339){" + NL + "                    isFailure = true;" + NL + "                }" + NL + "                else{";
  protected final String TEXT_1020 = NL + "                    System.out.println(\" Message: \" + e_";
  protected final String TEXT_1021 = ".getMessage());" + NL + "                    e_";
  protected final String TEXT_1022 = ".printStackTrace();" + NL + "                }" + NL + "                e_";
  protected final String TEXT_1023 = " = e_";
  protected final String TEXT_1024 = ".getNextException();" + NL + "            }" + NL + "            if(isFailure && e_";
  protected final String TEXT_1025 = " != null){";
  protected final String TEXT_1026 = NL + "                System.out.println(\" Message: \" + e_";
  protected final String TEXT_1027 = ".getMessage());" + NL + "                e_";
  protected final String TEXT_1028 = ".printStackTrace();" + NL + "            }";
  protected final String TEXT_1029 = NL + "                throw (e3_";
  protected final String TEXT_1030 = ");";
  protected final String TEXT_1031 = NL + "                System.err.println(e3_";
  protected final String TEXT_1032 = ".getMessage());";
  ...
  protected final String TEXT_1037 = ") {" + NL + "                        try {";
  protected final String TEXT_1038 = NL + "                                       if (batchSizeCounter_";
  protected final String TEXT_1039 = " > 0) {" + NL + "                                           int countSum_";
  protected final String TEXT_1040 = " = 0;" + NL;
  ...
  protected final String TEXT_1060 = ".commit();" + NL + "                            commitCounter_";
  protected final String TEXT_1061 = " = 0;";
  protected final String TEXT_1062 = NL + "                        }catch(java.sql.SQLException e_";
  protected final String TEXT_1063 = "){";
  protected final String TEXT_1064 = NL + "                            java.sql.SQLException e2_";
  protected final String TEXT_1065 = " = e_";
  protected final String TEXT_1066 = ";" + NL + "                            while (e2_";
  protected final String TEXT_1067 = " != null) {";
  protected final String TEXT_1068 = NL + "                                System.err.println(e_";
  protected final String TEXT_1069 = ".getMessage());" + NL + "                                e2_";
  protected final String TEXT_1070 = " = e2_";
  protected final String TEXT_1071 = ".getNextException();" + NL + "                            }";
  protected final String TEXT_1072 = NL + "                    java.sql.SQLException e3_";
  protected final String TEXT_1073 = " = e_";
  protected final String TEXT_1074 = ";" + NL + "                            boolean isFailure = false;" + NL + "                    while(e_";
  protected final String TEXT_1075 = " != null){" + NL + "                        if(e_";
  protected final String TEXT_1076 = ".getErrorCode() == -2801){";
  protected final String TEXT_1077 = NL + "                            System.out.println(\" Message: \" + e_";
  protected final String TEXT_1078 = ".getMessage());" + NL + "                            e_";
  protected final String TEXT_1079 = ".printStackTrace();" + NL + "                            System.out.println();" + NL + "                        }" + NL + "                        else if(e_";
  protected final String TEXT_1080 = ".getErrorCode() == 1339){" + NL + "                            isFailure = true;" + NL + "                        }" + NL + "                        else{";
  protected final String TEXT_1081 = NL + "                            System.out.println(\" Message: \" + e_";
  protected final String TEXT_1082 = ".getMessage());" + NL + "                            e_";
  protected final String TEXT_1083 = ".printStackTrace();" + NL + "                        }" + NL + "                        e_";
  protected final String TEXT_1084 = " = e_";
  protected final String TEXT_1085 = ".getNextException();" + NL + "                    }" + NL + "                    if(isFailure && e_";
  protected final String TEXT_1086 = " != null){";
  protected final String TEXT_1087 = NL + "                        System.out.println(\" Message: \" + e_";
  protected final String TEXT_1088 = ".getMessage());" + NL + "                        e_";
  protected final String TEXT_1089 = ".printStackTrace();" + NL + "                    }";
  protected final String TEXT_1090 = NL + "                        throw (e3_";
  protected final String TEXT_1091 = ");";
  protected final String TEXT_1092 = NL + "                        System.err.println(e3_";
  protected final String TEXT_1093 = ".getMessage());";
