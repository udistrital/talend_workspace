...
public class TAS400OutputMainJava {
  ...
  protected final String TEXT_402 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t\tresourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_521 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_530 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_531 = " = insert_";
  protected final String TEXT_532 = ".split(\"\\\\?\");";
  protected final String TEXT_533 = NL + "\t\t\tupdate_";
  protected final String TEXT_534 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_535 = " = update_";
  protected final String TEXT_536 = ".split(\"\\\\?\");";
  protected final String TEXT_537 = NL + "\t\t\tupdate_";
  protected final String TEXT_538 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_539 = " = update_";
  protected final String TEXT_540 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_541 = " = insert_";
  protected final String TEXT_542 = ".split(\"\\\\?\");";
  protected final String TEXT_543 = NL + "\t\t\tdelete_";
  protected final String TEXT_544 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_545 = " = delete_";
  protected final String TEXT_546 = ".split(\"\\\\?\");";
  protected final String TEXT_547 = NL + "\t\t\treplace_";
  protected final String TEXT_548 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_549 = " = replace_";
  protected final String TEXT_550 = ".split(\"\\\\?\");";
  protected final String TEXT_551 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_552 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_553 = " = insertIgnore_";
  protected final String TEXT_554 = ".split(\"\\\\?\");";
  protected final String TEXT_555 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_556 = " = insert_";
  protected final String TEXT_557 = ".split(\"\\\\?\");";
  protected final String TEXT_558 = NL + "\t}";
  protected final String TEXT_559 = NL + "\t\t\t\t\tcommitEvery_";
  protected final String TEXT_560 = " = buffersSize_";
  protected final String TEXT_561 = ";";
  protected final String TEXT_562 = NL + "\t\t\t\t\tbatchSize_";
  ...
  protected final String TEXT_568 = NL + "                        query_";
  protected final String TEXT_569 = " = ";
  protected final String TEXT_570 = ";";
  protected final String TEXT_571 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_572 = ",";
  protected final String TEXT_573 = ".";
  protected final String TEXT_574 = ", ";
  protected final String TEXT_575 = ",insertSQLSplits_";
  protected final String TEXT_576 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_577 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_597 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_616 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  ...
  protected final String TEXT_658 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_659 = "++;" + NL + "\t\t\t";
  protected final String TEXT_660 = NL + "\t\t\tbatchSizeCounter_";
  protected final String TEXT_661 = "++;" + NL + "    \t\t";
  protected final String TEXT_662 = NL + "             try {" + NL + "                nb_line_";
  protected final String TEXT_663 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_664 = " = updatedCount_";
  protected final String TEXT_665 = " + pstmt_";
  protected final String TEXT_666 = ".executeUpdate();";
  protected final String TEXT_667 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_668 = " = true;";
  protected final String TEXT_669 = NL + "                    throw(e);";
  ...
  protected final String TEXT_678 = NL + "                        rejectedCount_";
  protected final String TEXT_679 = " = rejectedCount_";
  protected final String TEXT_680 = " + 1;";
  protected final String TEXT_681 = NL + "                        ";
  protected final String TEXT_682 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_683 = NL + "                        ";
  protected final String TEXT_684 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_685 = ";";
  protected final String TEXT_686 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_687 = NL + "            }";
  protected final String TEXT_688 = NL + "                    \t";
  protected final String TEXT_689 = NL + "                    ";
  protected final String TEXT_690 = NL + "            int checkCount_";
  protected final String TEXT_691 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_692 = " = pstmt_";
  protected final String TEXT_693 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_694 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_695 = " = rs_";
  protected final String TEXT_696 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_697 = " > 0) {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_736 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_737 = " = updatedCount_";
  protected final String TEXT_738 = " + pstmtUpdate_";
  protected final String TEXT_739 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_740 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_741 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_762 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_763 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  protected final String TEXT_764 = NL + "                        ";
  protected final String TEXT_765 = NL + "                            query_";
  protected final String TEXT_766 = " = ";
  protected final String TEXT_767 = ";";
  protected final String TEXT_768 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_769 = ",";
  protected final String TEXT_770 = ".";
  protected final String TEXT_771 = ", ";
  protected final String TEXT_772 = ",insertSQLSplits_";
  ...
  protected final String TEXT_786 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_787 = "++;";
  protected final String TEXT_788 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_789 = " = true;";
  protected final String TEXT_790 = NL + "                        throw(e);";
  protected final String TEXT_791 = NL + "                \t\tnb_line_";
  protected final String TEXT_792 = "++;" + NL + "                    \t";
  protected final String TEXT_793 = NL + "                            ";
  protected final String TEXT_794 = " = new ";
  protected final String TEXT_795 = "Struct();";
  protected final String TEXT_796 = NL + "                                ";
  protected final String TEXT_797 = ".";
  protected final String TEXT_798 = " = ";
  protected final String TEXT_799 = ".";
  protected final String TEXT_800 = ";";
  protected final String TEXT_801 = NL + "                            rejectedCount_";
  protected final String TEXT_802 = " = rejectedCount_";
  protected final String TEXT_803 = " + 1;";
  protected final String TEXT_804 = NL + "                            ";
  protected final String TEXT_805 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_806 = NL + "                            ";
  protected final String TEXT_807 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_808 = ";";
  protected final String TEXT_809 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_810 = NL + "                }" + NL + "    \t\t}" + NL + "" + NL + "    \t\t";
  protected final String TEXT_811 = NL + "    \t    int updateFlag_";
  protected final String TEXT_812 = "=0;" + NL + "            try {" + NL + "    \t    ";
  protected final String TEXT_813 = NL + "                    ";
  protected final String TEXT_814 = NL + "                        query_";
  protected final String TEXT_815 = " = ";
  protected final String TEXT_816 = ";";
  protected final String TEXT_817 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_818 = ",";
  protected final String TEXT_819 = ".";
  protected final String TEXT_820 = ", ";
  protected final String TEXT_821 = ",updateSQLSplits_";
  ...
  protected final String TEXT_851 = NL + "                updateFlag_";
  protected final String TEXT_852 = "=pstmtUpdate_";
  protected final String TEXT_853 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_854 = " = updatedCount_";
  protected final String TEXT_855 = "+updateFlag_";
  protected final String TEXT_856 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_857 = " == 0) {" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_858 = NL + "\t\t\t\tquery_";
  protected final String TEXT_859 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_868 = ",insertSQLSplits_";
  protected final String TEXT_869 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_870 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_876 = NL + "                    globalMap.put(\"";
  protected final String TEXT_877 = "_QUERY\", query_";
  protected final String TEXT_878 = ".toString().trim());";
  protected final String TEXT_879 = NL + "                    insertedCount_";
  protected final String TEXT_880 = " = insertedCount_";
  protected final String TEXT_881 = " + pstmtInsert_";
  protected final String TEXT_882 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_883 = "++;";
  protected final String TEXT_884 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_885 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_886 = NL + "    \t\t\t}" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_887 = " = true;";
  protected final String TEXT_888 = NL + "                        throw(e);";
  ...
  protected final String TEXT_893 = "Struct();";
  protected final String TEXT_894 = NL + "                                ";
  protected final String TEXT_895 = ".";
  protected final String TEXT_896 = " = ";
  protected final String TEXT_897 = ".";
  protected final String TEXT_898 = ";";
  protected final String TEXT_899 = NL + "                            rejectedCount_";
  protected final String TEXT_900 = " = rejectedCount_";
  protected final String TEXT_901 = " + 1;";
  protected final String TEXT_902 = NL + "                            ";
  protected final String TEXT_903 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_904 = NL + "                            ";
  protected final String TEXT_905 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_906 = ";";
  protected final String TEXT_907 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_908 = NL + "                }";
  protected final String TEXT_909 = NL + "                    \t";
  protected final String TEXT_910 = NL + "\t                        query_";
  ...
  protected final String TEXT_923 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_924 = "++;" + NL + "\t\t\t";
  protected final String TEXT_925 = NL + "   \t\t\tbatchSizeCounter_";
  protected final String TEXT_926 = "++;" + NL + "   \t\t   ";
  protected final String TEXT_927 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_928 = " = deletedCount_";
  protected final String TEXT_929 = " + pstmt_";
  protected final String TEXT_930 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_931 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_932 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_933 = " = true;";
  protected final String TEXT_934 = NL + "                    throw(e);";
  ...
  protected final String TEXT_939 = "Struct();";
  protected final String TEXT_940 = NL + "                            ";
  protected final String TEXT_941 = ".";
  protected final String TEXT_942 = " = ";
  protected final String TEXT_943 = ".";
  protected final String TEXT_944 = ";";
  protected final String TEXT_945 = NL + "                        rejectedCount_";
  protected final String TEXT_946 = " = rejectedCount_";
  protected final String TEXT_947 = " + 1;";
  protected final String TEXT_948 = NL + "                        ";
  protected final String TEXT_949 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_950 = NL + "                        ";
  protected final String TEXT_951 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_952 = ";";
  protected final String TEXT_953 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_954 = NL + "            }" + NL + "    \t";
  protected final String TEXT_955 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_966 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_967 = " > 0) && (batchSize_";
  protected final String TEXT_968 = " <= batchSizeCounter_";
  protected final String TEXT_969 = ")) {" + NL + "    \t\t\t    ";
  protected final String TEXT_970 = NL + NL + "int[] status_";
  protected final String TEXT_971 = " = null;" + NL + "int countSum_";
  protected final String TEXT_972 = " = 0;" + NL + "try {" + NL + "    batchSizeCounter_";
  protected final String TEXT_973 = " = 0;";
  protected final String TEXT_974 = NL + "    status_";
  protected final String TEXT_975 = " = pstmt_";
  protected final String TEXT_976 = ".executeBatch();";
  protected final String TEXT_977 = NL + "    for(int countEach_";
  protected final String TEXT_978 = ": status_";
  protected final String TEXT_979 = ") {" + NL + "        countSum_";
  protected final String TEXT_980 = " += (countEach_";
  protected final String TEXT_981 = " < 0 ? 0 : countEach_";
  protected final String TEXT_982 = ");" + NL + "    }" + NL + "}catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_983 = "){";
  protected final String TEXT_984 = NL + "        throw(e_";
  protected final String TEXT_985 = ");";
  protected final String TEXT_986 = NL + "    for(int countEach_";
  protected final String TEXT_987 = ": e_";
  protected final String TEXT_988 = ".getUpdateCounts()) {" + NL + "        countSum_";
  protected final String TEXT_989 = " += (countEach_";
  protected final String TEXT_990 = " < 0 ? 0 : countEach_";
  protected final String TEXT_991 = ");" + NL + "    }";
  protected final String TEXT_992 = NL + "    System.err.println(e_";
  protected final String TEXT_993 = ".getMessage());";
  protected final String TEXT_994 = NL + "}" + NL + "try {" + NL + "    tmp_batchUpdateCount_";
  protected final String TEXT_995 = " = pstmt_";
  protected final String TEXT_996 = ".getUpdateCount();" + NL + "}catch (java.sql.SQLException e_";
  protected final String TEXT_997 = "){";
  protected final String TEXT_998 = NL + "    System.err.println(e_";
  protected final String TEXT_999 = ".getMessage());" + NL + "}" + NL + "tmp_batchUpdateCount_";
  protected final String TEXT_1000 = " = tmp_batchUpdateCount_";
  protected final String TEXT_1001 = " > countSum_";
  protected final String TEXT_1002 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_1003 = " : countSum_";
  protected final String TEXT_1004 = ";";
  protected final String TEXT_1005 = NL + "    insertedCount_";
  protected final String TEXT_1006 = " += tmp_batchUpdateCount_";
  ...
  protected final String TEXT_1021 = NL + NL + "int[] status_";
  protected final String TEXT_1022 = " = null;" + NL + "int countSum_";
  protected final String TEXT_1023 = " = 0;" + NL + "try {" + NL + "    batchSizeCounter_";
  protected final String TEXT_1024 = " = 0;";
  protected final String TEXT_1025 = NL + "    status_";
  protected final String TEXT_1026 = " = pstmt_";
  protected final String TEXT_1027 = ".executeBatch();";
  protected final String TEXT_1028 = NL + "    for(int countEach_";
  protected final String TEXT_1029 = ": status_";
  protected final String TEXT_1030 = ") {" + NL + "        countSum_";
  protected final String TEXT_1031 = " += (countEach_";
  protected final String TEXT_1032 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1033 = ");" + NL + "    }" + NL + "}catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1034 = "){";
  protected final String TEXT_1035 = NL + "        throw(e_";
  protected final String TEXT_1036 = ");";
  protected final String TEXT_1037 = NL + "    for(int countEach_";
  protected final String TEXT_1038 = ": e_";
  protected final String TEXT_1039 = ".getUpdateCounts()) {" + NL + "        countSum_";
  protected final String TEXT_1040 = " += (countEach_";
  protected final String TEXT_1041 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1042 = ");" + NL + "    }";
  protected final String TEXT_1043 = NL + "    System.err.println(e_";
  protected final String TEXT_1044 = ".getMessage());";
  protected final String TEXT_1045 = NL + "}" + NL + "try {" + NL + "    tmp_batchUpdateCount_";
  protected final String TEXT_1046 = " = pstmt_";
  protected final String TEXT_1047 = ".getUpdateCount();" + NL + "}catch (java.sql.SQLException e_";
  protected final String TEXT_1048 = "){";
  protected final String TEXT_1049 = NL + "    System.err.println(e_";
  protected final String TEXT_1050 = ".getMessage());" + NL + "}" + NL + "tmp_batchUpdateCount_";
  protected final String TEXT_1051 = " = tmp_batchUpdateCount_";
  protected final String TEXT_1052 = " > countSum_";
  protected final String TEXT_1053 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_1054 = " : countSum_";
  protected final String TEXT_1055 = ";";
  protected final String TEXT_1056 = NL + "    insertedCount_";
  protected final String TEXT_1057 = " += tmp_batchUpdateCount_";
  protected final String TEXT_1058 = ";";
  protected final String TEXT_1059 = NL + "    updatedCount_";
  protected final String TEXT_1060 = " += tmp_batchUpdateCount_";
  protected final String TEXT_1061 = ";";
  protected final String TEXT_1062 = NL + "    deletedCount_";
  protected final String TEXT_1063 = " += tmp_batchUpdateCount_";
  protected final String TEXT_1064 = ";";
  protected final String TEXT_1065 = NL + "                                   }" + NL + "\t                ";
  protected final String TEXT_1066 = NL + "\t                \t";
  protected final String TEXT_1067 = NL + "                        conn_";
  protected final String TEXT_1068 = ".commit();";
  protected final String TEXT_1069 = NL + "                        commitCounter_";
