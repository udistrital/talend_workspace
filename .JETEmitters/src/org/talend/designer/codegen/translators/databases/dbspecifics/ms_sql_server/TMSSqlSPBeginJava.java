...
public class TMSSqlSPBeginJava
{
  ...
  protected final String TEXT_53 = " = (String)globalMap.get(\"";
  protected final String TEXT_54 = "\");" + NL + "\tconn_";
  protected final String TEXT_55 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_56 = "\");" + NL + "\t";
  protected final String TEXT_57 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_58 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  ...
  protected final String TEXT_66 = ".get(dsAlias_";
  protected final String TEXT_67 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_68 = NL + "    dbschema_";
  protected final String TEXT_69 = " = ";
  protected final String TEXT_70 = ";";
  protected final String TEXT_71 = NL + "    String driverClass_";
  protected final String TEXT_72 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_73 = NL + "    String driverClass_";
  protected final String TEXT_74 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_75 = NL + "\t";
  protected final String TEXT_76 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_77 = ");" + NL + "    String port_";
  protected final String TEXT_78 = " = ";
  protected final String TEXT_79 = ";" + NL + "    String dbname_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = " ;";
  protected final String TEXT_82 = NL + "    String url_";
  protected final String TEXT_83 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_84 = " ;";
  protected final String TEXT_85 = NL + "    String url_";
  protected final String TEXT_86 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_87 = " ;";
  protected final String TEXT_88 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_89 = ")) {" + NL + "    \turl_";
  protected final String TEXT_90 = " += \":\" + ";
  protected final String TEXT_91 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_92 = ")) {";
  protected final String TEXT_93 = NL + "\t\t\t\turl_";
  protected final String TEXT_94 = " += \"//\" + ";
  protected final String TEXT_95 = "; " + NL + "\t";
  protected final String TEXT_96 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_97 = " += \";databaseName=\" + ";
  protected final String TEXT_98 = "; " + NL + "\t";
  protected final String TEXT_99 = NL + "    }" + NL + "    url_";
  protected final String TEXT_100 = " += \";appName=\" + projectName + \";\" + ";
  ...
  protected final String TEXT_123 = ".createStatement();" + NL + "" + NL + "//stmt_";
  protected final String TEXT_124 = ".execute(\"SET NOCOUNT ON\");" + NL + "String spSchema_";
  protected final String TEXT_125 = " = \"\";" + NL + "if(dbschema_";
  protected final String TEXT_126 = " != null && !dbschema_";
  protected final String TEXT_127 = ".trim().isEmpty()) {" + NL + "    spSchema_";
  protected final String TEXT_128 = " = \"[\"+dbschema_";
  protected final String TEXT_129 = "+\"].\";" + NL + "}" + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_130 = " = conn_";
  protected final String TEXT_131 = ".prepareCall(\"{";
  protected final String TEXT_132 = "call \" + spSchema_";
  protected final String TEXT_133 = " + ";
  protected final String TEXT_134 = " + \"(";
  protected final String TEXT_135 = ")}\"";
  protected final String TEXT_136 = NL + "\t,java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY";
  protected final String TEXT_137 = NL + ");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_138 = ";" + NL + "String tmpString_";
