...
public class TSybaseSPMainJava
{
  ...
  protected final String TEXT_48 = NL + "\t\t\t\tif(true){" + NL + "\t\t\t\t\tthrow new RuntimeException(\"Please specify the \\\"return\\\" column in the drop-down list of \\\"Return result in\\\"! You should select \\\"IN\\\" as input parameter type only when \\\"is function\\\" is checked!\");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_81 = NL + "\t\tjava.sql.ResultSet rs_";
  protected final String TEXT_82 = " = statement_";
  protected final String TEXT_83 = ".executeQuery();" + NL + "\t";
  protected final String TEXT_84 = NL + "\t\tstatement_";
  protected final String TEXT_85 = ".executeQuery();" + NL + "\t";
  protected final String TEXT_86 = NL + "\t\tstatement_";
  protected final String TEXT_87 = ".executeUpdate();" + NL + "\t";
  protected final String TEXT_88 = NL + "\t\tstatement_";
  protected final String TEXT_89 = ".execute();" + NL + "\t";
  ...
  protected final String TEXT_99 = ".getResultSet();";
  protected final String TEXT_100 = NL + "\t\t\t\t\t  \t\t\t\twhile(rs_";
  protected final String TEXT_101 = ".next()){" + NL + "\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_102 = NL + "\t\t\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_103 = " = rs_";
  protected final String TEXT_104 = ".getString(";
  protected final String TEXT_105 = ");" + NL + "\t\t\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_106 = " != null && tmpString_";
  protected final String TEXT_107 = ".length() > 0) {" + NL + "\t\t\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_108 = ".";
  protected final String TEXT_109 = " = tmpString_";
  protected final String TEXT_110 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_111 = NL + "\t\t\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_112 = " = rs_";
  protected final String TEXT_113 = ".getDate(";
  protected final String TEXT_114 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_115 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_116 = ".";
  protected final String TEXT_117 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_118 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_126 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_127 = " = statement_";
  protected final String TEXT_128 = ".getString(";
  protected final String TEXT_129 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_130 = " != null && tmpString_";
  protected final String TEXT_131 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_132 = ".";
  protected final String TEXT_133 = " = tmpString_";
  protected final String TEXT_134 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_135 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_136 = " = statement_";
  protected final String TEXT_137 = ".getDate(";
  protected final String TEXT_138 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_139 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_140 = ".";
  protected final String TEXT_141 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_142 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_143 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_144 = ".";
  protected final String TEXT_145 = " = statement_";
  protected final String TEXT_146 = ".get";
  protected final String TEXT_147 = "(";
  protected final String TEXT_148 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_150 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_163 = NL + "\t\t// No code generated: define a schema for ";
