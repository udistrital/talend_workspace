...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_337 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_343 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_347 = ".equalsIgnoreCase(";
  protected final String TEXT_348 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_349 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_350 = NL + "                                if(!whetherExist_";
  protected final String TEXT_351 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_371 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_384 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_392 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_393 = ".";
  protected final String TEXT_394 = ", \"";
  protected final String TEXT_395 = "\")";
  protected final String TEXT_396 = ".toUpperCase()";
  ...
  protected final String TEXT_405 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_416 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_417 = " = conn_";
  protected final String TEXT_418 = ".createStatement()) {";
  protected final String TEXT_419 = NL + "                              stmtTruncCount_";
  protected final String TEXT_420 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_421 = "));";
  protected final String TEXT_422 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_423 = " = stmtTruncCount_";
  protected final String TEXT_424 = ".executeQuery(\"";
  protected final String TEXT_425 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_426 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_427 = " = rsTruncCount_";
  protected final String TEXT_428 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_439 = NL + "                    if(!conn_";
  protected final String TEXT_440 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_441 = ".commit();" + NL + "                    }";
  protected final String TEXT_442 = NL + "                deletedCount_";
  protected final String TEXT_443 = " += rsTruncCountNumber_";
  protected final String TEXT_444 = ";" + NL + "            }";
  protected final String TEXT_445 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_446 = " = conn_";
  protected final String TEXT_447 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_448 = " = stmtTruncCount_";
  protected final String TEXT_449 = ".executeQuery(\"";
  protected final String TEXT_450 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_458 = NL + "                while(rsTruncCount_";
  protected final String TEXT_459 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_460 = " += rsTruncCount_";
  protected final String TEXT_461 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_469 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_484 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  protected final String TEXT_485 = " + \" WHERE ";
  protected final String TEXT_486 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_487 = "\", pstmt_";
  protected final String TEXT_488 = ");" + NL + "\t    String insert_";
  protected final String TEXT_489 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_495 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_496 = "\", pstmtInsert_";
  ...
  protected final String TEXT_504 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_505 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_514 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_523 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_524 = "\", pstmtInsert_";
  protected final String TEXT_525 = ");" + NL + "\t    ";
  protected final String TEXT_526 = NL + "\t    String delete_";
  protected final String TEXT_527 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_531 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_565 = NL + NL + "        int commitEvery_";
  protected final String TEXT_566 = " = ";
  protected final String TEXT_567 = ";" + NL + "" + NL + "        int commitCounter_";
  protected final String TEXT_568 = " = 0;" + NL;
