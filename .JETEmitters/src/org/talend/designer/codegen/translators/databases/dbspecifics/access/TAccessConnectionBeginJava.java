...
public class TAccessConnectionBeginJava
{
  ...
  protected final String TEXT_39 = ";" + NL + "\t\t\tif (dbUser_";
  protected final String TEXT_40 = " == null) {" + NL + "\t\t\t\tdbUser_";
  protected final String TEXT_41 = " = \"\";" + NL + "\t\t\t}" + NL + "\t\t\tif (dbPwd_";
  protected final String TEXT_42 = " == null) {" + NL + "\t\t\t\tdbPwd_";
  protected final String TEXT_43 = " = \"\";" + NL + "\t\t\t}" + NL + "\t\t\tatnParams_";
  protected final String TEXT_44 = " = atnParams_";
  protected final String TEXT_45 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_46 = " = new java.util.Properties();" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_47 = ".put(\"user\",dbUser_";
  protected final String TEXT_48 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_49 = ".put(\"password\",dbPwd_";
  protected final String TEXT_50 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_51 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_52 = ".getBytes()));" + NL + "\t\t\tconn_";
  protected final String TEXT_53 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_54 = ", atnParamsPrope_";
  protected final String TEXT_55 = ");";
  protected final String TEXT_56 = NL + NL + "\t";
  protected final String TEXT_57 = NL + NL + "\tString dbUser_";
  ...
  protected final String TEXT_120 = ".rollback();" + NL + "\t\t\t";
  ...
  protected final String TEXT_126 = ".setAutoCommit(";
  protected final String TEXT_127 = ");" + NL + "\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\tlog.";
  protected final String TEXT_129 = "(\"";
  protected final String TEXT_130 = " - \" + ";
  protected final String TEXT_131 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_132 = NL + "\t    \t\tlog.";
  protected final String TEXT_133 = "(\"";
  protected final String TEXT_134 = "\");" + NL + "\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_136 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_137 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_138 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_139 = ": pstmt_";
  protected final String TEXT_140 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_141 = " += (countEach_";
  protected final String TEXT_142 = " < 0 ? 0 : ";
  protected final String TEXT_143 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_144 = NL + "\t";
  protected final String TEXT_145 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_146 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  ...
  protected final String TEXT_153 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_154 = " = ";
  protected final String TEXT_155 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_156 = ".get(dsAlias_";
  protected final String TEXT_157 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_158 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_159 = " = dataSources_";
  protected final String TEXT_160 = ".get(dsAlias_";
  protected final String TEXT_161 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_162 = "\", conn_";
  protected final String TEXT_163 = ");" + NL + "\t}";
  protected final String TEXT_164 = NL + "\tif (null != conn_";
