...
public class TTeradataInputEndJava
{
  ...
  protected final String TEXT_115 = NL + NL + "\t}" + NL + "}finally{" + NL + "\tif (rs_";
  protected final String TEXT_116 = " != null) {" + NL + "\t\trs_";
  protected final String TEXT_117 = ".close();" + NL + "\t}" + NL + "\tif (stmt_";
  protected final String TEXT_118 = " != null) {" + NL + "\t\tstmt_";
  protected final String TEXT_119 = ".close();" + NL + "\t}";
  protected final String TEXT_120 = NL + "\tif(conn_";
  protected final String TEXT_121 = " != null && !conn_";
  protected final String TEXT_122 = ".isClosed()) {" + NL + "\t    ";
  protected final String TEXT_123 = NL;
  protected final String TEXT_124 = NL + "    conn_";
  protected final String TEXT_125 = ".setAutoCommit(true);" + NL + "    try{" + NL + "         conn_";
  protected final String TEXT_126 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_127 = NL + "                   try{" + NL + "                        conn_";
  protected final String TEXT_128 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_129 = ");" + NL + "                   }catch(Exception e){" + NL + "                         System.err.println(e.getMessage());" + NL + "                   }";
  protected final String TEXT_130 = NL + "     }catch(Exception e){";
