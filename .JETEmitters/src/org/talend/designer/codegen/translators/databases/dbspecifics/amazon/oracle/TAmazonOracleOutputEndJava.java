...
public class TAmazonOracleOutputEndJava
{
  ...
  protected final String TEXT_49 = NL + "\t\ttry (java.sql.Statement stmtCreateGeoColumns_";
  protected final String TEXT_50 = " = conn_";
  protected final String TEXT_51 = ".createStatement()) {" + NL + "" + NL + "\t\t\t// Delete geometry columns entry if already exists." + NL + "\t\t\tString deleteGeometryColumns_";
  protected final String TEXT_52 = " = \"DELETE FROM user_sdo_geom_metadata \"" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t+ \"WHERE TABLE_NAME='\" + ";
  protected final String TEXT_53 = " + \"'\";" + NL + "\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\tstmtCreateGeoColumns_";
  protected final String TEXT_55 = ".execute(deleteGeometryColumns_";
  protected final String TEXT_56 = ");" + NL + "\t\t\t";
  protected final String TEXT_57 = NL + NL + "\t\t\tfor (String column: geometryColumnToExtends.keySet()) {" + NL + "\t\t\t\tcom.vividsolutions.jts.geom.Envelope extend = geometryColumnToExtends.get(column);" + NL + "" + NL + "\t\t\t\t// Create new entry in geometry columns table" + NL + "\t\t\t\tString insertGeometryColumns_";
  protected final String TEXT_58 = " = \"INSERT INTO user_sdo_geom_metadata (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES ('\"" + NL + "\t        \t\t\t\t\t\t\t\t\t\t+ ";
  protected final String TEXT_59 = " + \"','\" + column.toUpperCase(java.util.Locale.US) + \"', \"" + NL + "\t        \t\t\t\t\t\t\t\t\t\t+ \"MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('x', \" + extend.getMinX() + \", \" + extend.getMaxX() + \", ";
  protected final String TEXT_60 = "), \"" + NL + "\t        \t\t\t\t\t\t\t\t\t\t+ \"MDSYS.SDO_DIM_ELEMENT('y', \" + extend.getMinY() + \", \" + extend.getMaxY() + \", ";
  protected final String TEXT_61 = ")), \"" + NL + "\t        \t\t\t\t\t\t\t\t\t\t+ ";
  protected final String TEXT_62 = " +\")\";" + NL + "\t\t\t\t";
  protected final String TEXT_63 = NL + "\t\t\t\tstmtCreateGeoColumns_";
  protected final String TEXT_64 = ".execute(insertGeometryColumns_";
  ...
  protected final String TEXT_68 = "+\"_\" + geometryColumnName;" + NL + "\t\t\tif (index_name.length() > 30) {" + NL + "\t\t\t\tindex_name = index_name.substring(0, 29);" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\ttry (java.sql.Statement stmtCreateIndex_";
  ...
  protected final String TEXT_75 = NL + "\t\t\t\t} catch (java.sql.SQLException e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\t}" + NL + "" + NL + "\t\t\t\t// Create spatial index using GIST on geometry columns" + NL + "\t\t\t\tString createIndex_";
  protected final String TEXT_77 = " = \"CREATE INDEX \"+index_name + \" \"" + NL + "\t\t\t\t\t\t+ \"ON \" + ";
  protected final String TEXT_78 = " + \"(\" + geometryColumnName + \") \"" + NL + "\t\t\t\t\t\t+ \"INDEXTYPE IS MDSYS.SPATIAL_INDEX\";" + NL + "\t\t\t\t";
  protected final String TEXT_79 = NL + "\t\t        stmtCreateIndex_";
  protected final String TEXT_80 = ".execute(createIndex_";
  protected final String TEXT_81 = ");" + NL + "\t\t        ";
  protected final String TEXT_82 = NL + "\t        }" + NL + "\t    }" + NL + "\t\t";
  protected final String TEXT_83 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_84 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_85 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_86 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_87 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_88 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_89 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_90 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_91 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_92 = "\");" + NL + "        }";
  protected final String TEXT_93 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_94 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_95 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_96 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_97 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_98 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_99 = "\");" + NL + "        }";
  protected final String TEXT_100 = NL + "                if(batchSizeCounter_";
  protected final String TEXT_101 = " > 0){" + NL + "                try {" + NL + "                \tif (pstmt_";
  ...
  protected final String TEXT_106 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_107 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_108 = NL + "            \t}" + NL + "            \tif (pstmt_";
  protected final String TEXT_109 = " != null) {" + NL + "\t            \ttmp_batchUpdateCount_";
  protected final String TEXT_110 = " = pstmt_";
  protected final String TEXT_111 = ".getUpdateCount();" + NL + "\t    \t    \t";
  protected final String TEXT_112 = NL + "\t    \t    \t\tinsertedCount_";
  protected final String TEXT_113 = NL + "\t    \t    \t";
  protected final String TEXT_114 = NL + "\t    \t    \t\tupdatedCount_";
  protected final String TEXT_115 = NL + "\t    \t    \t";
  protected final String TEXT_116 = NL + "\t    \t    \t    deletedCount_";
  protected final String TEXT_117 = NL + "\t    \t    \t";
  protected final String TEXT_118 = NL + "\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_119 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_120 = ":0);" + NL + "                }" + NL + "            }";
  protected final String TEXT_121 = NL + "        if(pstmt_";
  protected final String TEXT_122 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_123 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_124 = "\");" + NL + "        }";
  protected final String TEXT_125 = NL + "    resourceMap.put(\"statementClosed_";
