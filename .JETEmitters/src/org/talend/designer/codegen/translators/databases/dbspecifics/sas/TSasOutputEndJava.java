...
public class TSasOutputEndJava
{
  ...
  protected final String TEXT_69 = NL + "\tif (commitCounter_";
  ...
  protected final String TEXT_77 = "\t" + NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_78 = "\", true);" + NL + "\t";
  protected final String TEXT_79 = NL + NL + "nb_line_deleted_";
  ...
  protected final String TEXT_97 = "_NB_LINE_REJECTED\",nb_line_rejected_";
