...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_340 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_346 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_347 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_348 = " = rsTable_";
  protected final String TEXT_349 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_350 = ".equalsIgnoreCase(";
  protected final String TEXT_351 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_352 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_353 = NL + "                                if(!whetherExist_";
  protected final String TEXT_354 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_374 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_387 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_395 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_408 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_418 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_419 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_425 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_426 = " = stmtTruncCount_";
  protected final String TEXT_427 = ".executeQuery(\"";
  protected final String TEXT_428 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_429 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_430 = " = rsTruncCount_";
  protected final String TEXT_431 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_442 = NL + "                    if(!conn_";
  protected final String TEXT_443 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_444 = ".commit();" + NL + "                    }";
  protected final String TEXT_445 = NL + "                deletedCount_";
  protected final String TEXT_446 = " += rsTruncCountNumber_";
  protected final String TEXT_447 = ";" + NL + "            }";
  protected final String TEXT_448 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_461 = NL + "                while(rsTruncCount_";
  protected final String TEXT_462 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_463 = " += rsTruncCount_";
  protected final String TEXT_464 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_465 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_466 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_467 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_468 = ".append(\",\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_493 = "    " + NL + "" + NL + "                java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_545 = ");" + NL + "\t            String insertColName";
  protected final String TEXT_546 = " = \"";
  protected final String TEXT_547 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_548 = " =  \"";
  protected final String TEXT_549 = "\";" + NL + "\t            int rowCount";
  protected final String TEXT_550 = " = 0;";
  protected final String TEXT_551 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_552 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_553 = " + \"` (";
  protected final String TEXT_554 = ") VALUES (";
  protected final String TEXT_555 = ")\";";
  protected final String TEXT_556 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_557 = " += \tduplidateClause_";
  protected final String TEXT_558 = ".toString();";
  protected final String TEXT_559 = NL + "\t\t        int batchSize_";
  protected final String TEXT_560 = " = ";
  protected final String TEXT_561 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  ...
  protected final String TEXT_578 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_593 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_600 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_601 = "\", pstmt_";
  protected final String TEXT_602 = ");" + NL + "\t    String insert_";
  protected final String TEXT_603 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_604 = " + \"` (";
  protected final String TEXT_605 = ") VALUES (";
  protected final String TEXT_606 = ")\";" + NL + "\t    ";
  protected final String TEXT_607 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_608 = " = new StringBuffer(insert_";
  protected final String TEXT_609 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_610 = ".insert(insert_";
  protected final String TEXT_611 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_612 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_613 = " =insertStringBuffer_";
  protected final String TEXT_614 = ".toString(); ";
  protected final String TEXT_615 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_616 = " = conn_";
  protected final String TEXT_617 = ".prepareStatement(insert_";
  protected final String TEXT_618 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_619 = "\", pstmtInsert_";
  ...
  protected final String TEXT_633 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_634 = " = conn_";
  protected final String TEXT_635 = ".prepareStatement(update_";
  protected final String TEXT_636 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_655 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_656 = "\", pstmtUpdate_";
  protected final String TEXT_657 = ");" + NL + "\t    String insert_";
  protected final String TEXT_658 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_659 = " + \"` (";
  protected final String TEXT_660 = ") VALUES (";
  protected final String TEXT_661 = ")\";" + NL + "\t     ";
  protected final String TEXT_662 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_663 = " = new StringBuffer(insert_";
  protected final String TEXT_664 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_665 = ".insert(insert_";
  protected final String TEXT_666 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_667 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_668 = " =insertStringBuffer_";
  protected final String TEXT_669 = ".toString(); ";
  protected final String TEXT_670 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_671 = " = conn_";
  protected final String TEXT_672 = ".prepareStatement(insert_";
  protected final String TEXT_673 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_674 = "\", pstmtInsert_";
  ...
  protected final String TEXT_694 = NL + "\t    String replace_";
  protected final String TEXT_695 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_696 = " + \"` (";
  protected final String TEXT_697 = ") VALUES (";
  protected final String TEXT_698 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_699 = " = conn_";
  protected final String TEXT_700 = ".prepareStatement(replace_";
  protected final String TEXT_701 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_702 = "\", pstmt_";
  protected final String TEXT_703 = ");";
  protected final String TEXT_704 = NL + "\t    String insertIgnore_";
  protected final String TEXT_705 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_706 = " + \"` (";
  protected final String TEXT_707 = ") VALUES (";
  protected final String TEXT_708 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_709 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_710 = " = conn_";
  protected final String TEXT_711 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_712 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_713 = "\", pstmt_";
  protected final String TEXT_714 = ");";
  protected final String TEXT_715 = NL + "\t    String insert_";
  protected final String TEXT_716 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_717 = " + \"` (";
  protected final String TEXT_718 = ") VALUES (";
  protected final String TEXT_719 = ")\";" + NL + "\t    ";
  protected final String TEXT_720 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_721 = " = new StringBuffer(insert_";
  protected final String TEXT_722 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_723 = ".insert(insert_";
  protected final String TEXT_724 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_725 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_726 = " =insertStringBuffer_";
  ...
  protected final String TEXT_730 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_739 = NL + "\t\t\tupdate_";
  protected final String TEXT_740 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_741 = " = update_";
  ...
  protected final String TEXT_746 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_747 = " = insert_";
  protected final String TEXT_748 = ".split(\"\\\\?\");";
  protected final String TEXT_749 = NL + "\t\t\tdelete_";
  protected final String TEXT_750 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_751 = " = delete_";
  protected final String TEXT_752 = ".split(\"\\\\?\");";
  protected final String TEXT_753 = NL + "\t\t\treplace_";
  protected final String TEXT_754 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_755 = " = replace_";
  protected final String TEXT_756 = ".split(\"\\\\?\");";
  protected final String TEXT_757 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_758 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_759 = " = insertIgnore_";
  protected final String TEXT_760 = ".split(\"\\\\?\");";
  protected final String TEXT_761 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_762 = " = insert_";
  protected final String TEXT_763 = ".split(\"\\\\?\");";
  protected final String TEXT_764 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_765 = " {" + NL + "    \t            ";
  protected final String TEXT_766 = NL + "                            ";
  protected final String TEXT_767 = " ";
  protected final String TEXT_768 = ";";
  protected final String TEXT_769 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_770 = ";" + NL + "\t\t\t";
  protected final String TEXT_771 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_772 = "(";
  protected final String TEXT_773 = NL + "                                ,";
  protected final String TEXT_774 = NL + "                            ";
  protected final String TEXT_775 = " ";
  protected final String TEXT_776 = NL + "\t\t\t\t, routines.system.Dynamic ";
  ...
  protected final String TEXT_785 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_786 = "> exInsertColValueList";
  protected final String TEXT_787 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_788 = " exInsertColValue";
  protected final String TEXT_789 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_790 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_791 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_792 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_793 = "=1;";
  protected final String TEXT_794 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_795 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_796 = "=0;";
  protected final String TEXT_797 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_798 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_799 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_800 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_801 = "=0;" + NL + "\t";
  protected final String TEXT_802 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_806 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_807 = " =  null;";
  protected final String TEXT_808 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_809 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_810 = " = null;";
  protected final String TEXT_811 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_812 = " = null;";
  protected final String TEXT_813 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_814 = " = null;";
  protected final String TEXT_815 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
