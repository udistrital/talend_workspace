...
public class TSybaseBulkExecBeginJava {
  ...
  protected final String TEXT_116 = " = \"jdbc:sqlanywhere:Host=\" + host_";
  protected final String TEXT_117 = " + \":\" + port_";
  protected final String TEXT_118 = " + \";DatabaseName=\" + db_";
  protected final String TEXT_119 = "; ";
  protected final String TEXT_120 = NL + "\t\t\tString url_";
  protected final String TEXT_121 = " = \"jdbc:sqlanywhere:Host=\" + host_";
  protected final String TEXT_122 = " + \":\" + port_";
  protected final String TEXT_123 = " + \";DatabaseName\" + db_";
  protected final String TEXT_124 = " + \";\" + ";
  protected final String TEXT_125 = ";";
  protected final String TEXT_126 = NL + "\t\t\tString url_";
  protected final String TEXT_127 = " = \"jdbc:sybase:Tds:\" + host_";
  protected final String TEXT_128 = " + \":\" + port_";
  protected final String TEXT_129 = " + \"/\" + db_";
  protected final String TEXT_130 = ";";
  protected final String TEXT_131 = NL + "\t\t\tString url_";
  protected final String TEXT_132 = " = \"jdbc:sybase:Tds:\" + host_";
  protected final String TEXT_133 = " + \":\" + port_";
  protected final String TEXT_134 = " + \"/\" + db_";
  protected final String TEXT_135 = " + \"?\" + ";
  protected final String TEXT_136 = ";";
  protected final String TEXT_137 = NL + "\t\t";
  protected final String TEXT_138 = NL + "\t\t\t String driverClass_";
  protected final String TEXT_139 = " = \"sap.jdbc4.sqlanywhere.IDriver\";" + NL + "\t\t";
  protected final String TEXT_140 = NL + "\t\t\t String driverClass_";
  protected final String TEXT_141 = " = \"com.sybase.jdbc4.jdbc.SybDriver\";" + NL + "\t\t";
  protected final String TEXT_142 = NL + "\t\t\t String driverClass_";
  protected final String TEXT_143 = " = \"com.sybase.jdbc3.jdbc.SybDriver\";" + NL + "\t    ";
  protected final String TEXT_144 = NL + "   \t \tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_145 = ");" + NL + "    \tjava.sql.Connection conn_";
  protected final String TEXT_146 = " = null;" + NL + "    \t" + NL + "\t\t";
  protected final String TEXT_147 = NL + "if(dbschema_";
  protected final String TEXT_148 = " != null && dbschema_";
  protected final String TEXT_149 = ".trim().length() != 0) {" + NL + "\ttableName_";
  ...
  protected final String TEXT_157 = " - Droping table ";
  ...
  protected final String TEXT_165 = " - Drop table ";
  ...
  protected final String TEXT_182 = " - Create table ";
  ...
  protected final String TEXT_188 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_192 = " - Creating table ";
  ...
  protected final String TEXT_200 = " - Create table ";
  protected final String TEXT_201 = "\" + tableName_";
  protected final String TEXT_202 = " + \"";
  protected final String TEXT_203 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_236 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_249 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_253 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_254 = ".equals(schema_";
  protected final String TEXT_255 = ") || (schema_";
  protected final String TEXT_256 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_257 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_266 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_267 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_268 = " == null || dbschema_";
  protected final String TEXT_269 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_270 = " = conn_";
  protected final String TEXT_271 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_272 = " = stmtSchema_";
  protected final String TEXT_273 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_274 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_275 = " = rsSchema_";
  protected final String TEXT_276 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_277 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_278 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_279 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_280 = " = rsTable_";
  protected final String TEXT_281 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_282 = " = rsTable_";
  protected final String TEXT_283 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_284 = ".equals";
  protected final String TEXT_285 = "IgnoreCase";
  protected final String TEXT_286 = "(";
  protected final String TEXT_287 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  ...
  protected final String TEXT_296 = "(schema_";
  ...
  protected final String TEXT_300 = NL + "            \tString tableForSearch_";
  protected final String TEXT_301 = " = ";
  protected final String TEXT_302 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_303 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_304 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_305 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_306 = " =  tableForSearch_";
  protected final String TEXT_307 = ".substring(1,tableForSearch_";
  protected final String TEXT_308 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_309 = " =  tableForSearch_";
  protected final String TEXT_310 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_314 = ".getTables(null, conn_";
  protected final String TEXT_315 = ".getSchema(), tableForSearch_";
  protected final String TEXT_316 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_317 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_318 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_319 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_325 = ".getTables(null, dbschema_";
  protected final String TEXT_326 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_327 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_328 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_329 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_453 = NL + NL + "StringBuilder command_";
  protected final String TEXT_454 = " =  new StringBuilder();" + NL + "command_";
  protected final String TEXT_455 = ".append(";
  protected final String TEXT_456 = " + \" \");";
  protected final String TEXT_457 = NL + "    String tmpTableName_";
  protected final String TEXT_458 = " = tableName_";
  protected final String TEXT_459 = ";" + NL + "    tableName_";
  protected final String TEXT_460 = " = \"tmp_";
  protected final String TEXT_461 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    if(dbschema_";
  protected final String TEXT_462 = " != null && dbschema_";
  protected final String TEXT_463 = ".trim().length() != 0) {" + NL + "    \ttableName_";
  ...
  protected final String TEXT_469 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_470 = ".append(db_";
  protected final String TEXT_471 = " + \".\" + tableName_";
  protected final String TEXT_472 = ");" + NL + "} else {" + NL + "    command_";
  protected final String TEXT_473 = ".append(db_";
  protected final String TEXT_474 = " + \"..\" + tableName_";
  protected final String TEXT_475 = ");" + NL + "}" + NL + "command_";
  protected final String TEXT_476 = ".append(\" in \" + ";
  protected final String TEXT_477 = ");" + NL + "String headRow_";
  protected final String TEXT_478 = " = ";
  protected final String TEXT_479 = ";" + NL + "if(headRow_";
  protected final String TEXT_480 = " != null && headRow_";
  protected final String TEXT_481 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_482 = ".append(\" -F \" + headRow_";
  protected final String TEXT_483 = ");" + NL + "}" + NL;
  protected final String TEXT_484 = NL + "\tcommand_";
  protected final String TEXT_485 = ".append(\" -b \" + ";
  protected final String TEXT_486 = ");";
  protected final String TEXT_487 = NL + NL + "command_";
  protected final String TEXT_488 = ".append(\" -t \" + ";
  protected final String TEXT_489 = ");" + NL + "command_";
  protected final String TEXT_490 = ".append(\" -r \" + ";
  protected final String TEXT_491 = ");" + NL + "command_";
  protected final String TEXT_492 = ".append(\" -c -U \" + dbUser_";
  protected final String TEXT_493 = " + \" -P \" + dbPwd_";
  protected final String TEXT_494 = ");";
  protected final String TEXT_495 = NL + "command_";
  protected final String TEXT_496 = ".append(\" -I \" + ";
  protected final String TEXT_497 = ");";
  protected final String TEXT_498 = NL + "    command_";
  protected final String TEXT_499 = ".append(\" -S \" + ";
  protected final String TEXT_500 = ");";
  protected final String TEXT_501 = NL + "\tcommand_";
  protected final String TEXT_502 = ".append(\" -S \" + host_";
  protected final String TEXT_503 = ");";
  protected final String TEXT_504 = NL + "String encoding_";
  protected final String TEXT_505 = " = ";
  protected final String TEXT_506 = ";" + NL + "if(encoding_";
  protected final String TEXT_507 = " != null && encoding_";
  protected final String TEXT_508 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_509 = ".append(\" -J \" + encoding_";
  protected final String TEXT_510 = ");" + NL + "}" + NL;
  protected final String TEXT_511 = NL + "\tlog.info(\"";
  protected final String TEXT_512 = " - Executing command:'\" + command_";
  protected final String TEXT_513 = " + \"'.\");";
  protected final String TEXT_514 = NL + "    Runtime runtime_";
  protected final String TEXT_515 = " = Runtime.getRuntime();" + NL + "    final Process ps_";
  protected final String TEXT_516 = " = runtime_";
  protected final String TEXT_517 = ".exec(command_";
  protected final String TEXT_518 = ".toString());";
  protected final String TEXT_519 = NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_523 = " - Creating temp table ";
  protected final String TEXT_524 = "\" + tableName_";
  protected final String TEXT_525 = " + \"";
  protected final String TEXT_526 = ".\" );" + NL + "\t\t";
  protected final String TEXT_527 = NL + "        stmtCreateTmp_";
  protected final String TEXT_528 = ".execute(\"";
  protected final String TEXT_529 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_530 = ".close();            ";
  protected final String TEXT_531 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_532 = " - Create temp table ";
  ...
  protected final String TEXT_541 = NL + NL + "Thread normal_";
  protected final String TEXT_542 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_543 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_544 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_545 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_546 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_547 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_548 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_549 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_550 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_551 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_552 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_553 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_554 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_555 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_556 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_557 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_558 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_559 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_560 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_561 = ".interrupt();" + NL + "error_";
  protected final String TEXT_562 = ".interrupt();";
  protected final String TEXT_563 = NL + "\tlog.info(\"";
  protected final String TEXT_564 = " - Excute command: '\" + command_";
  protected final String TEXT_565 = " + \"' has finished.\");";
