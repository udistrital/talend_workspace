...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_83 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_84 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_85 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_99 = ".setAutoCommit(";
  ...
  protected final String TEXT_108 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_109 = ".executeBatch();" + NL + "\t\t\t";
  ...
  protected final String TEXT_113 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_114 = " += (countEach_";
  protected final String TEXT_115 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_125 = NL + "\t" + NL + "\tStringBuffer command_";
  protected final String TEXT_126 = " = new StringBuffer();" + NL + "\tcommand_";
  protected final String TEXT_127 = ".append(";
  protected final String TEXT_128 = ")" + NL + "\t\t.append(\" \\\"\")" + NL + "\t\t.append(";
  protected final String TEXT_129 = ")" + NL + "\t\t.append(\"\\\" queryout \\\"\")" + NL + "\t\t.append(";
  protected final String TEXT_130 = ")" + NL + "\t\t.append(\"\\\" \")" + NL + "\t\t.append(\"";
  protected final String TEXT_131 = "\")" + NL + "\t";
  protected final String TEXT_132 = NL + "\t\t.append(\" -S\")" + NL + "\t\t.append(";
  protected final String TEXT_133 = ")" + NL + "\t";
  protected final String TEXT_134 = NL + "\t\t.append(\" -T\")" + NL + "\t";
  protected final String TEXT_135 = NL + "\t\t.append(\" -U\")" + NL + "\t\t.append(";
  protected final String TEXT_136 = ")" + NL + "\t\t.append(\" -P\")" + NL + "\t\t.append(decryptedPassword_";
  protected final String TEXT_137 = ")" + NL + "\t";
  protected final String TEXT_138 = NL + "\t\t.append(\" -t\")" + NL + "\t\t.append(";
  protected final String TEXT_139 = ")" + NL + "\t\t.append(\" -r\")" + NL + "\t\t.append(";
  protected final String TEXT_140 = ");" + NL + "\t" + NL + "\tRuntime runtime_";
  protected final String TEXT_141 = " = Runtime.getRuntime();" + NL + "\t";
  protected final String TEXT_142 = NL + "\tfinal Process ps";
  protected final String TEXT_143 = " = runtime_";
  protected final String TEXT_144 = ".exec(command_";
  protected final String TEXT_145 = ".toString());" + NL + "\tThread normal_";
  protected final String TEXT_146 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps";
  protected final String TEXT_147 = ".getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_148 = NL + "\t\t\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_150 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_151 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_152 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\tnormal_";
  protected final String TEXT_154 = ".start();" + NL + "\tThread error_";
  protected final String TEXT_155 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps";
  protected final String TEXT_156 = ".getErrorStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_157 = NL + "\t\t\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_159 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_160 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_162 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\terror_";
  protected final String TEXT_163 = ".start();" + NL + "\tps";
  protected final String TEXT_164 = ".waitFor();" + NL + "\tnormal_";
  protected final String TEXT_165 = ".interrupt();" + NL + "\terror_";
  protected final String TEXT_166 = ".interrupt();" + NL + "\t";
  protected final String TEXT_167 = NL + "\tString dbschema_";
  protected final String TEXT_168 = " = \"\";" + NL + "\t";
  protected final String TEXT_169 = NL + "java.sql.Connection conn_";
  protected final String TEXT_170 = " = null;";
  protected final String TEXT_171 = NL + "String dbUser_";
  protected final String TEXT_172 = " = null;";
  protected final String TEXT_173 = NL + "\tdbschema_";
  protected final String TEXT_174 = " = (String)globalMap.get(\"";
  protected final String TEXT_175 = "\");" + NL + "\tconn_";
  protected final String TEXT_176 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_177 = "\");" + NL + "\t";
  protected final String TEXT_178 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_179 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_180 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_181 = " = ";
  protected final String TEXT_182 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_183 = ".get(dsAlias_";
  protected final String TEXT_184 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_185 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconn_";
  protected final String TEXT_186 = " = dataSources_";
  protected final String TEXT_187 = ".get(dsAlias_";
  protected final String TEXT_188 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_189 = NL + "    dbschema_";
  protected final String TEXT_190 = " = ";
  protected final String TEXT_191 = ";";
  protected final String TEXT_192 = NL + "    String driverClass_";
  protected final String TEXT_193 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_194 = NL + "    String driverClass_";
  protected final String TEXT_195 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_196 = NL + "\t";
  protected final String TEXT_197 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_198 = ");" + NL + "    String port_";
  protected final String TEXT_199 = " = ";
  protected final String TEXT_200 = ";" + NL + "    String dbname_";
  protected final String TEXT_201 = " = ";
  protected final String TEXT_202 = " ;";
  protected final String TEXT_203 = NL + "    String url_";
  protected final String TEXT_204 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_205 = " ;";
  protected final String TEXT_206 = NL + "    String url_";
  protected final String TEXT_207 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_208 = " ;";
  protected final String TEXT_209 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_210 = ")) {" + NL + "    \turl_";
  protected final String TEXT_211 = " += \":\" + ";
  protected final String TEXT_212 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_213 = ")) {";
  protected final String TEXT_214 = NL + "\t\t\t\turl_";
  protected final String TEXT_215 = " += \"//\" + ";
  protected final String TEXT_216 = "; " + NL + "\t";
  protected final String TEXT_217 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_218 = " += \";databaseName=\" + ";
  protected final String TEXT_219 = "; " + NL + "\t";
  protected final String TEXT_220 = NL + "    }" + NL + "    url_";
  protected final String TEXT_221 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_222 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_232 = NL + NL + "    String dbPwd_";
  protected final String TEXT_233 = " = decryptedPassword_";
  protected final String TEXT_234 = ";";
  protected final String TEXT_235 = "\t" + NL + "    conn_";
  protected final String TEXT_236 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_237 = ",dbUser_";
  protected final String TEXT_238 = ",dbPwd_";
  protected final String TEXT_239 = ");";
  protected final String TEXT_240 = NL + "\t";
  protected final String TEXT_241 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_242 = NL + "\tString tableName_";
  protected final String TEXT_243 = " = null;\t" + NL + "\tif(dbschema_";
  protected final String TEXT_244 = " == null || dbschema_";
  protected final String TEXT_245 = ".trim().length() == 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_246 = " = ";
  protected final String TEXT_247 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  ...
  protected final String TEXT_256 = " - Droping table ";
  protected final String TEXT_257 = "\" + tableName_";
  ...
  protected final String TEXT_264 = " - Drop table ";
  protected final String TEXT_265 = "\" + tableName_";
  protected final String TEXT_266 = " + \"";
  protected final String TEXT_267 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_269 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_273 = " - Creating table ";
  protected final String TEXT_274 = "\" + tableName_";
  ...
  protected final String TEXT_281 = " - Create table ";
  protected final String TEXT_282 = "\" + tableName_";
  protected final String TEXT_283 = " + \"";
  protected final String TEXT_284 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_308 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_309 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_310 = " = tableNameForSearch_";
  protected final String TEXT_311 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_312 = " = tableNameForSearch_";
  protected final String TEXT_313 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_314 = " = dbMetaData_";
  protected final String TEXT_315 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_316 = ", tableNameForSearch_";
  protected final String TEXT_317 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_318 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_319 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_320 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_333 = ".equalsIgnoreCase(";
  protected final String TEXT_334 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_335 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_336 = ") || dbschema_";
  protected final String TEXT_337 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_348 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_349 = " = rsTable_";
  protected final String TEXT_350 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_351 = ".equals(";
  protected final String TEXT_352 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_353 = ".equals(schema_";
  protected final String TEXT_354 = ") || (schema_";
  protected final String TEXT_355 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_356 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_365 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_366 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_367 = " == null || dbschema_";
  protected final String TEXT_368 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_369 = " = conn_";
  protected final String TEXT_370 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_371 = " = stmtSchema_";
  protected final String TEXT_372 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_373 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_374 = " = rsSchema_";
  protected final String TEXT_375 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_376 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_377 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_399 = NL + "            \tString tableForSearch_";
  protected final String TEXT_400 = " = ";
  protected final String TEXT_401 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_402 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_403 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_404 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_405 = " =  tableForSearch_";
  protected final String TEXT_406 = ".substring(1,tableForSearch_";
  protected final String TEXT_407 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_408 = " =  tableForSearch_";
  protected final String TEXT_409 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_415 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_416 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_417 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_418 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_419 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_420 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_421 = " = conn_";
  protected final String TEXT_422 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_423 = " = dbMetaData_";
  protected final String TEXT_424 = ".getTables(null, dbschema_";
  protected final String TEXT_425 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_426 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_427 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_428 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  protected final String TEXT_429 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_430 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "                rsTable_";
  protected final String TEXT_431 = ".close();";
  protected final String TEXT_432 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_433 = " = conn_";
  protected final String TEXT_434 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_435 = " = dbMetaData_";
  protected final String TEXT_436 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_437 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_438 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_439 = " = rsTable_";
  protected final String TEXT_440 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_441 = ".equals";
  protected final String TEXT_442 = "IgnoreCase";
  protected final String TEXT_443 = "(";
  protected final String TEXT_444 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_445 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_446 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_447 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_448 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_452 = " - Creating table ";
  ...
  protected final String TEXT_460 = " - Create table ";
  protected final String TEXT_461 = "\" + tableName_";
  protected final String TEXT_462 = " + \"";
  protected final String TEXT_463 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_464 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_465 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_466 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_467 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_471 = " - Droping table ";
  protected final String TEXT_472 = "\" + tableName_";
  protected final String TEXT_473 = " + \"";
  protected final String TEXT_474 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_475 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_476 = ".execute(\"";
  protected final String TEXT_477 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_478 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_479 = " - Drop table ";
  protected final String TEXT_480 = "\" + tableName_";
  protected final String TEXT_481 = " + \"";
  protected final String TEXT_482 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_483 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_484 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_485 = " = conn_";
  protected final String TEXT_486 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_487 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_488 = " - Creating table ";
  protected final String TEXT_489 = "\" + tableName_";
  protected final String TEXT_490 = " + \"";
  protected final String TEXT_491 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_492 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_493 = ".execute(\"";
  protected final String TEXT_494 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_495 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_496 = " - Create table ";
  protected final String TEXT_497 = "\" + tableName_";
  protected final String TEXT_498 = " + \"";
  protected final String TEXT_499 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_500 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_501 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_502 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_506 = " - Clearing table ";
  ...
  protected final String TEXT_514 = "- Clear table ";
  protected final String TEXT_515 = "\" + tableName_";
  protected final String TEXT_516 = " + \"";
  protected final String TEXT_517 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_518 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_519 = ".close();" + NL + "\t\t";
  protected final String TEXT_520 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_521 = " = conn_";
  protected final String TEXT_522 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_523 = " = stmtTruncCount_";
  protected final String TEXT_524 = ".executeQuery(\"";
  protected final String TEXT_525 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_529 = " - Trancating table ";
  protected final String TEXT_530 = "\" + tableName_";
  protected final String TEXT_531 = " + \"";
  protected final String TEXT_532 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_533 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_534 = ".executeUpdate(\"";
  protected final String TEXT_535 = "\");" + NL + "   \t    \t";
  protected final String TEXT_536 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_537 = " - Truncate table ";
  protected final String TEXT_538 = "\" + tableName_";
  protected final String TEXT_539 = " + \"";
  protected final String TEXT_540 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_541 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_542 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_543 = " += rsTruncCount_";
  protected final String TEXT_544 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_545 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_546 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_547 = ".close();" + NL + "\t\t";
  protected final String TEXT_548 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_549 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_550 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_551 = NL + "    \t";
  protected final String TEXT_552 = NL + "    \t\tjava.sql.Statement stmtBulkInsert_";
  protected final String TEXT_553 = " = conn_";
  protected final String TEXT_554 = ".createStatement();" + NL + "    \t\tString bulkSQL_";
  protected final String TEXT_555 = " = \"BULK INSERT ";
  protected final String TEXT_556 = "\" + tableName_";
  protected final String TEXT_557 = " + \"";
  protected final String TEXT_558 = " FROM '\" + ";
  protected final String TEXT_559 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_560 = " + \"',DATAFILETYPE='";
  protected final String TEXT_561 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_562 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_563 = " + ";
  protected final String TEXT_564 = "\",FIRE_TRIGGERS\" + ";
  protected final String TEXT_565 = " \",ROWTERMINATOR='\" + ";
  ...
  protected final String TEXT_570 = " - Bulk inserting data into ";
  protected final String TEXT_571 = "\" + tableName_";
  protected final String TEXT_572 = " + \"";
  protected final String TEXT_573 = ".\" );" + NL + "    \t\t";
  protected final String TEXT_574 = NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_575 = ".execute(bulkSQL_";
  protected final String TEXT_576 = ");" + NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_577 = ".close();" + NL + "    \t\t";
  protected final String TEXT_578 = NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_579 = " - Bulk insert data into ";
  protected final String TEXT_580 = "\" + tableName_";
  protected final String TEXT_581 = " + \"";
  protected final String TEXT_582 = " has finished.\");" + NL + "    \t\t";
  protected final String TEXT_583 = NL + "    \t\t\tint keyCount_";
  protected final String TEXT_584 = " = ";
  protected final String TEXT_585 = ";" + NL + "    \t\t\tif(keyCount_";
  protected final String TEXT_586 = " == 0) {" + NL + "    \t\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "    \t\t\t}" + NL + "    \t\t\tString tmpTableName_";
  protected final String TEXT_587 = " = tableName_";
  protected final String TEXT_588 = ";" + NL + "    \t\t\ttableName_";
  protected final String TEXT_589 = " = \"tmp_";
  protected final String TEXT_590 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_594 = " - Creating temp table ";
  protected final String TEXT_595 = "\" + tableName_";
  protected final String TEXT_596 = " + \"";
  protected final String TEXT_597 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_598 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_599 = ".execute(\"";
  protected final String TEXT_600 = ")\");" + NL + "    \t\t\t";
  protected final String TEXT_601 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_602 = " - Create temp table ";
  protected final String TEXT_603 = "\" + tableName_";
  protected final String TEXT_604 = " + \"";
  protected final String TEXT_605 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_606 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_607 = ".close();" + NL + "    \t\t\tjava.sql.Statement stmtTmpBulk_";
  protected final String TEXT_608 = " = conn_";
  protected final String TEXT_609 = ".createStatement();" + NL + "    \t\t\tString bulkSQL_";
  protected final String TEXT_610 = " = \"BULK INSERT ";
  protected final String TEXT_611 = "\" + tableName_";
  protected final String TEXT_612 = " + \"";
  protected final String TEXT_613 = " FROM '\" + ";
  protected final String TEXT_614 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_615 = " + \"',DATAFILETYPE='";
  protected final String TEXT_616 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_617 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_618 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_619 = "+\"')\";" + NL + "    \t\t\t";
  protected final String TEXT_620 = NL + "    \t\t\t\tlog.debug(\"";
  protected final String TEXT_621 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_622 = "+\".\");" + NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_623 = " - Bulk inserting data into ";
  protected final String TEXT_624 = "\" + tableName_";
  protected final String TEXT_625 = " + \"";
  protected final String TEXT_626 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_627 = NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_628 = ".execute(bulkSQL_";
  protected final String TEXT_629 = ");" + NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_630 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_631 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_632 = " - Bulk insert data into ";
  protected final String TEXT_633 = "\" + tableName_";
  protected final String TEXT_634 = " + \"";
  protected final String TEXT_635 = " has finished.\");" + NL + "    \t\t\t";
  protected final String TEXT_636 = NL + "    \t\t\ttableName_";
  protected final String TEXT_637 = " = tmpTableName_";
  protected final String TEXT_638 = ";" + NL + "    \t\t\ttmpTableName_";
  protected final String TEXT_639 = " = \"tmp_";
  protected final String TEXT_640 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_641 = " = conn_";
  protected final String TEXT_642 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_643 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_644 = " - Updating ";
  protected final String TEXT_645 = "\" + tableName_";
  protected final String TEXT_646 = " + \"";
  protected final String TEXT_647 = " from ";
  protected final String TEXT_648 = "\"+tmpTableName_";
  protected final String TEXT_649 = "+\"";
  protected final String TEXT_650 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_651 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_652 = ".executeUpdate(\"";
  protected final String TEXT_653 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_654 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_655 = ".close();" + NL + "    \t\t\ttableName_";
  protected final String TEXT_656 = " = \"tmp_";
  protected final String TEXT_657 = "\" + \"_\" +pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtTmpDrop_";
  protected final String TEXT_658 = " = conn_";
  protected final String TEXT_659 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_660 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_661 = " - Droping temp table ";
  protected final String TEXT_662 = "\" + tableName_";
  protected final String TEXT_663 = " + \"";
  protected final String TEXT_664 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_665 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_666 = ".execute(\"";
  protected final String TEXT_667 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_668 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_669 = " - Drop temp table ";
  protected final String TEXT_670 = "\" + tableName_";
  protected final String TEXT_671 = "+ \"";
  protected final String TEXT_672 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_673 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_674 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_675 = NL + "\t\tif(conn_";
  protected final String TEXT_676 = " != null && !conn_";
  protected final String TEXT_677 = ".isClosed()) {" + NL + "\t\t   ";
