...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_387 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_395 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_415 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_428 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_447 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_448 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_449 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_455 = NL + "                stmtClear_";
  protected final String TEXT_456 = ".executeUpdate(\"";
  protected final String TEXT_457 = "\");";
  protected final String TEXT_458 = NL + "            }";
  protected final String TEXT_459 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_460 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_461 = " = conn_";
  protected final String TEXT_462 = ".createStatement()) {";
  protected final String TEXT_463 = NL + "                              stmtTruncCount_";
  protected final String TEXT_464 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_465 = "));";
  protected final String TEXT_466 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_467 = " = stmtTruncCount_";
  protected final String TEXT_468 = ".executeQuery(\"";
  protected final String TEXT_469 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_470 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_471 = " = rsTruncCount_";
  protected final String TEXT_472 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_483 = NL + "                    if(!conn_";
  protected final String TEXT_484 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_485 = ".commit();" + NL + "                    }";
  protected final String TEXT_486 = NL + "                deletedCount_";
  protected final String TEXT_487 = " += rsTruncCountNumber_";
  protected final String TEXT_488 = ";" + NL + "            }";
  protected final String TEXT_489 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_490 = " = conn_";
  protected final String TEXT_491 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_492 = " = stmtTruncCount_";
  protected final String TEXT_493 = ".executeQuery(\"";
  protected final String TEXT_494 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_495 = " = conn_";
  protected final String TEXT_496 = ".createStatement()) {";
  protected final String TEXT_497 = NL + "                conn_";
  protected final String TEXT_498 = ".commit();";
  ...
  protected final String TEXT_505 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_519 = "    " + NL + "" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_520 = " = conn_";
  protected final String TEXT_521 = ".prepareStatement(insert_";
  protected final String TEXT_522 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_555 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_556 = " = new StringBuffer(insert_";
  protected final String TEXT_557 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_558 = ".insert(insert_";
  protected final String TEXT_559 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_560 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_561 = " =insertStringBuffer_";
  protected final String TEXT_562 = ".toString(); ";
  protected final String TEXT_563 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_564 = " = conn_";
  protected final String TEXT_565 = ".prepareStatement(insert_";
  protected final String TEXT_566 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_584 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_585 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_592 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_593 = " = new StringBuffer(update_";
  protected final String TEXT_594 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_595 = ".insert(update_";
  protected final String TEXT_596 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_597 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_598 = " =updateStringBuffer_";
  protected final String TEXT_599 = ".toString(); ";
  protected final String TEXT_600 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_601 = " = conn_";
  protected final String TEXT_602 = ".prepareStatement(update_";
  protected final String TEXT_603 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_604 = "\", pstmtUpdate_";
  protected final String TEXT_605 = ");" + NL + "\t    String insert_";
  protected final String TEXT_606 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_607 = " + \" (";
  protected final String TEXT_608 = ") VALUES (";
  ...
  protected final String TEXT_618 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_642 = NL + "        StringBuffer query_";
  protected final String TEXT_643 = " = null;" + NL + "\t   ";
  protected final String TEXT_644 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_645 = " = insert_";
  ...
  protected final String TEXT_652 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_653 = " = update_";
  protected final String TEXT_654 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_655 = " = insert_";
  protected final String TEXT_656 = ".split(\"\\\\?\");";
  protected final String TEXT_657 = NL + "\t\t\tdelete_";
  protected final String TEXT_658 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_659 = " = delete_";
  protected final String TEXT_660 = ".split(\"\\\\?\");";
  protected final String TEXT_661 = NL + "\t\t\treplace_";
  protected final String TEXT_662 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_663 = " = replace_";
  protected final String TEXT_664 = ".split(\"\\\\?\");";
  protected final String TEXT_665 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_666 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_667 = " = insertIgnore_";
  protected final String TEXT_668 = ".split(\"\\\\?\");";
  protected final String TEXT_669 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_670 = " = insert_";
  protected final String TEXT_671 = ".split(\"\\\\?\");";
  protected final String TEXT_672 = NL + "\t   ";
  protected final String TEXT_673 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_674 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_675 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_676 = " = true;" + NL + "    \t";
  protected final String TEXT_677 = NL + NL + "\tclass ClobTypeUtil_";
  protected final String TEXT_678 = " {" + NL + "\t\tpublic Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t\toracle.sql.CLOB tempClob = null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\t// If the temporary CLOB has not yet been created, create one" + NL + "\t\t\t\ttempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "\t\t\t\t// Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t\t\ttempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "\t\t\t\t// Get the output stream to write" + NL + "\t\t\t\tjava.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "\t\t\t\tif(data instanceof oracle.sql.CLOB) {" + NL + "\t\t\t\t\toracle.sql.CLOB inClob = (oracle.sql.CLOB) data;" + NL + "\t\t\t        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "\t\t\t        char[] chs = new char[128];" + NL + "\t\t\t       \tint len = 0;" + NL + "\t\t\t\t\twhile ((len = inReader.read(chs)) != -1) {" + NL + "\t\t\t        \ttempClobWriter.write(chs, 0, len);" + NL + "\t\t\t        }" + NL + "\t\t\t    }else if(data instanceof String) {" + NL + "\t\t\t       // Write the data into the temporary CLOB" + NL + "\t\t\t\t\ttempClobWriter.write((String)data);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\treturn data;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t// Flush and close the stream" + NL + "\t\t\t\ttempClobWriter.flush();" + NL + "\t\t\t\ttempClobWriter.close();" + NL + "\t\t\t\t// Close the temporary CLOB" + NL + "\t\t\t\ttempClob.close();" + NL + "\t\t\t} catch( java.sql.SQLException sqlexp){" + NL + "\t  \t\t\t";
  protected final String TEXT_679 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\tsqlexp.printStackTrace();" + NL + "\t\t\t} catch(java.lang.Exception exp){" + NL + "\t  \t\t\t";
  protected final String TEXT_680 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\texp.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t\treturn tempClob;" + NL + "\t\t}" + NL + "\t}" + NL + "\tClobTypeUtil_";
  protected final String TEXT_681 = " clobTypeUtil_";
  protected final String TEXT_682 = "=new ClobTypeUtil_";
  protected final String TEXT_683 = "();";
  protected final String TEXT_684 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_685 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_686 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_687 = " =null;" + NL + "\t";
  protected final String TEXT_688 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_695 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_696 = " = null;";
  protected final String TEXT_697 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_698 = " = null;";
  protected final String TEXT_699 = NL + "\t\t\tString[] replaceSQLSplits_";
