...
public class TSybaseInputBeginJava
{
  ...
  protected final String TEXT_180 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_181 = " + \":\" + ";
  protected final String TEXT_182 = " + \";DatabaseName=\" + ";
  protected final String TEXT_183 = "; ";
  protected final String TEXT_184 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_185 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_186 = " + \":\" + ";
  protected final String TEXT_187 = " + \";DatabaseName\" + ";
  protected final String TEXT_188 = " + \";\" + ";
  protected final String TEXT_189 = ";";
  protected final String TEXT_190 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_191 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_192 = " + \":\" + ";
  protected final String TEXT_193 = " + \"/\" + ";
  protected final String TEXT_194 = ";";
  protected final String TEXT_195 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_196 = " = \"jdbc:sybase:Tds:\" + ";
