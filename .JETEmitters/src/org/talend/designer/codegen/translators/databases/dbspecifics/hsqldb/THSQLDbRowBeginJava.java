...
public class THSQLDbRowBeginJava
{
  ...
  protected final String TEXT_154 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_160 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_161 = "\", pstmt_";
  protected final String TEXT_162 = ");";
  protected final String TEXT_163 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_164 = " = conn_";
  protected final String TEXT_165 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
