...
public class TJavaDBRowEndJava
{
  ...
  protected final String TEXT_75 = ".close();" + NL + "        resourceMap.remove(\"pstmt_";
  protected final String TEXT_76 = "\");";
  protected final String TEXT_77 = NL + "        stmt_";
  protected final String TEXT_78 = ".close();" + NL + "        resourceMap.remove(\"stmt_";
  protected final String TEXT_79 = "\");";
  protected final String TEXT_80 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_81 = "\", true);";
  protected final String TEXT_82 = NL + "\t\tif(commitEvery_";
  protected final String TEXT_83 = ">commitCounter_";
  protected final String TEXT_84 = "){" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_85 = NL + "\t" + NL + "\t\t\tcommitCounter_";
  protected final String TEXT_86 = "=0;" + NL + "\t" + NL + "\t\t}";
  protected final String TEXT_87 = NL + "    resourceMap.put(\"finish_";
  protected final String TEXT_88 = "\", true);";
  protected final String TEXT_89 = NL + "\ttry" + NL + "\t{" + NL + "\t\tjava.sql.DriverManager.getConnection(\"jdbc:derby:;shutdown=true\");" + NL + "\t}" + NL + "\tcatch(java.sql.SQLException se)" + NL + "\t{" + NL + "        /*" + NL + "           In embedded mode, an application should shut down Derby." + NL + "           If the application fails to shut down Derby explicitly," + NL + "           the Derby does not perform a checkpoint when the JVM shuts down, which means" + NL + "           that the next connection will be slower." + NL + "           Explicitly shutting down Derby with the URL is preferred." + NL + "           This style of shutdown will always throw an \"exception\"." + NL + "         */" + NL + "\t}\t";
  protected final String TEXT_90 = NL + "\tserverControl_";
  protected final String TEXT_91 = ".shutdown();" + NL + "\t";
