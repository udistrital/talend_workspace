...
public class TRedshiftOutputBulkBeginJava
{
  ...
  protected final String TEXT_45 = " = 0;" + NL + "\tString rowSeparator_";
  protected final String TEXT_46 = " = \"\\n\";" + NL + "\tString fieldSeparator_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = NL + "\t\",\";";
  protected final String TEXT_49 = NL + "\tString.valueOf(";
  protected final String TEXT_50 = ");";
  protected final String TEXT_51 = NL + NL + "\tchar textEnclosure_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = NL + "\t'\\0';" + NL + "\t" + NL + "\tString escapedFieldSeparator_";
  protected final String TEXT_54 = " = \"\\\\\" + fieldSeparator_";
  protected final String TEXT_55 = ";";
  protected final String TEXT_56 = NL + "\t'\"';";
  protected final String TEXT_57 = NL + "\tString.valueOf(";
  protected final String TEXT_58 = ").charAt(0);";
  protected final String TEXT_59 = NL + "\tString textEnclosureReplaced_";
  protected final String TEXT_60 = " = \"\" + textEnclosure_";
  protected final String TEXT_61 = ";" + NL + "\tString textEnclosureReplacement_";
  protected final String TEXT_62 = " = \"\" + textEnclosure_";
  protected final String TEXT_63 = " + textEnclosure_";
  protected final String TEXT_64 = ";" + NL + "\t" + NL + "\tjava.io.File file_";
  protected final String TEXT_65 = " = new java.io.File(";
  protected final String TEXT_66 = ");\t\t" + NL + "" + NL + "\t";
  protected final String TEXT_67 = NL + "    java.io.File parentFile_";
  protected final String TEXT_68 = " = file_";
  protected final String TEXT_69 = ".getParentFile();" + NL + "    if(parentFile_";
  protected final String TEXT_70 = " != null && !parentFile_";
  protected final String TEXT_71 = ".exists()){" + NL + "        String absolutePath_";
  protected final String TEXT_72 = " = parentFile_";
  protected final String TEXT_73 = ".getAbsolutePath();";
  protected final String TEXT_74 = NL + "        if(parentFile_";
  protected final String TEXT_75 = ".mkdirs()){";
  protected final String TEXT_76 = NL + "            System.out.println(\"The directory '\"+absolutePath_";
  protected final String TEXT_77 = "+\"' has been created successfully.\");" + NL + "        }else{";
  protected final String TEXT_78 = NL + "            System.err.println(\"Fail to create directory '\"+absolutePath_";
  protected final String TEXT_79 = "+\"'.\");" + NL + "        }" + NL + "    }" + NL + "\t";
  protected final String TEXT_80 = NL + "\t";
  protected final String TEXT_81 = NL + "\t\tString filePath_";
  protected final String TEXT_82 = " = file_";
  protected final String TEXT_83 = ".getAbsolutePath().replace(\"\\\\\",\"/\");" + NL + "\t\tString gzPath_";
  protected final String TEXT_84 = " = filePath_";
  protected final String TEXT_85 = " + \".gz\";" + NL + "\t\tfile_";
  protected final String TEXT_86 = " = new java.io.File(gzPath_";
  protected final String TEXT_87 = ");" + NL + "\t\t" + NL + "\t\tjava.io.BufferedWriter csvWriter_";
  protected final String TEXT_88 = " = " + NL + "\t\t\tnew java.io.BufferedWriter(" + NL + "\t\t\t\tnew java.io.OutputStreamWriter(" + NL + "\t\t\t\t\tnew java.util.zip.GZIPOutputStream(" + NL + "\t\t\t\t\t\tnew java.io.FileOutputStream(file_";
  protected final String TEXT_89 = ") " + NL + "\t\t\t\t\t)," + NL + "\t\t\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\t)" + NL + "\t\t\t);";
  protected final String TEXT_91 = NL + "\tjava.io.BufferedWriter csvWriter_";
  protected final String TEXT_92 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "    \tnew java.io.FileOutputStream(file_";
  protected final String TEXT_93 = ", ";
  protected final String TEXT_94 = "), ";
  protected final String TEXT_95 = "));";
  protected final String TEXT_96 = NL + "    resourceMap.put(\"csvWriter_";
  protected final String TEXT_97 = "\", csvWriter_";
  protected final String TEXT_98 = ");";
  protected final String TEXT_99 = NL + "\tresourceMap.put(\"file_";
