...
public class TMysqlOutputMainJava {
  ...
  protected final String TEXT_260 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_261 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_262 = " = rsTable_";
  protected final String TEXT_263 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_264 = ".equalsIgnoreCase(";
  protected final String TEXT_265 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_266 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_267 = NL + "                                if(!whetherExist_";
  protected final String TEXT_268 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_272 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_273 = "));";
  protected final String TEXT_274 = NL + "                                            stmtCreate_";
  protected final String TEXT_275 = ".execute(((\"";
  protected final String TEXT_276 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_288 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_300 = ".commit();";
  protected final String TEXT_301 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_309 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_310 = ".";
  protected final String TEXT_311 = ", \"";
  protected final String TEXT_312 = "\")";
  protected final String TEXT_313 = ".toUpperCase()";
  ...
  protected final String TEXT_320 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_321 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_322 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_332 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_333 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_334 = " = conn_";
  protected final String TEXT_335 = ".createStatement()) {";
  protected final String TEXT_336 = NL + "                              stmtTruncCount_";
  protected final String TEXT_337 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_338 = "));";
  protected final String TEXT_339 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_340 = " = stmtTruncCount_";
  protected final String TEXT_341 = ".executeQuery(\"";
  protected final String TEXT_342 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_343 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_344 = " = rsTruncCount_";
  protected final String TEXT_345 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_362 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_378 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_379 = NL + "            StringBuffer duplidateClause_";
  protected final String TEXT_380 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");";
  protected final String TEXT_381 = NL + "                        duplidateClause_";
  ...
  protected final String TEXT_386 = ".append (\"=\");" + NL + "                        duplidateClause_";
  protected final String TEXT_387 = ".append (";
  protected final String TEXT_388 = ");";
  protected final String TEXT_389 = NL;
  protected final String TEXT_390 = NL + "                    ";
  protected final String TEXT_391 = ";";
  protected final String TEXT_392 = NL + "                insert_";
  protected final String TEXT_393 = " +=  duplidateClause_";
  ...
  protected final String TEXT_407 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_408 = "\", pstmt_";
  protected final String TEXT_409 = ");";
  protected final String TEXT_410 = NL;
  protected final String TEXT_411 = NL + "                        pstmt_";
  protected final String TEXT_412 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_413 = " = conn_";
  protected final String TEXT_414 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_415 = " + \"]\";" + NL + "                        if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_416 = ")== null){" + NL + "                            pstmt_";
  ...
  protected final String TEXT_421 = ");" + NL + "                            GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_422 = ", pstmt_";
  protected final String TEXT_423 = ");" + NL + "                        }else{" + NL + "                            pstmt_";
  protected final String TEXT_424 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_463 = ");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_464 = "\", pstmt_";
  protected final String TEXT_465 = ");";
  protected final String TEXT_466 = NL + NL + "                        insertColName";
  protected final String TEXT_467 = " = \"";
  protected final String TEXT_468 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_469 = ".";
  protected final String TEXT_470 = ", \"";
  protected final String TEXT_471 = "\");" + NL + "                        insertColValue";
  protected final String TEXT_472 = " = \"";
  protected final String TEXT_473 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_474 = ".";
  protected final String TEXT_475 = ");";
  protected final String TEXT_476 = NL + "                        insertColName";
  protected final String TEXT_477 = " = DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_478 = ".";
  protected final String TEXT_479 = ", \"";
  protected final String TEXT_480 = "\");" + NL + "                        insertColValue";
  protected final String TEXT_481 = " = DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_482 = ".";
  protected final String TEXT_483 = ");";
  protected final String TEXT_484 = NL + "                rowCount";
  protected final String TEXT_485 = " = 0;";
  protected final String TEXT_486 = NL + "                int rowCount";
  protected final String TEXT_487 = " = 0;";
  protected final String TEXT_488 = NL + "                    ";
  protected final String TEXT_489 = ";";
  protected final String TEXT_490 = NL + "                        insert_";
  protected final String TEXT_491 = " +=  duplidateClause_";
  protected final String TEXT_492 = ".toString();";
  protected final String TEXT_493 = NL + "                        batchSize_";
  protected final String TEXT_494 = " = ";
  protected final String TEXT_495 = ";" + NL + "                        batchSizeCounter_";
  protected final String TEXT_496 = "=0;";
  protected final String TEXT_497 = NL + "                        int batchSize_";
  ...
  protected final String TEXT_512 = ");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_513 = "\", pstmt_";
  ...
  protected final String TEXT_528 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_529 = "\", pstmt_";
  ...
  protected final String TEXT_537 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_538 = " + \"` WHERE \" + DynamicUtils.getUpdateWhere(";
  protected final String TEXT_539 = ".";
  protected final String TEXT_540 = ", \"";
  protected final String TEXT_541 = "\", new StringBuilder(\"";
  protected final String TEXT_542 = "\"), ";
  protected final String TEXT_543 = "));//String insert_";
  protected final String TEXT_544 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_545 = " + \"` (";
  protected final String TEXT_546 = ") VALUES (";
  protected final String TEXT_547 = ")\";" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_548 = "\", pstmt_";
  protected final String TEXT_549 = ");";
  protected final String TEXT_550 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_551 = " = new StringBuffer(insert_";
  protected final String TEXT_552 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_553 = ".insert(insert_";
  protected final String TEXT_554 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_555 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_556 = " =insertStringBuffer_";
  ...
  protected final String TEXT_561 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_572 = NL + "        pstmtUpdate_";
  protected final String TEXT_573 = " = conn_";
  protected final String TEXT_574 = ".prepareStatement(update_";
  protected final String TEXT_575 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_576 = "\", pstmtUpdate_";
  protected final String TEXT_577 = ");";
  protected final String TEXT_578 = NL + "                ";
  protected final String TEXT_579 = ";";
  protected final String TEXT_580 = NL + "                ";
  protected final String TEXT_581 = ";";
  protected final String TEXT_582 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_583 = " = new StringBuffer(update_";
  protected final String TEXT_584 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_585 = ".insert(update_";
  protected final String TEXT_586 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_587 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_588 = " =updateStringBuffer_";
  ...
  protected final String TEXT_593 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_607 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_608 = "\", pstmtInsert_";
  protected final String TEXT_609 = ");";
  protected final String TEXT_610 = NL + "            String delete_";
  protected final String TEXT_611 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_612 = " + \"` WHERE \" + DynamicUtils.getUpdateWhere(";
  protected final String TEXT_613 = ".";
  protected final String TEXT_614 = ", \"";
  protected final String TEXT_615 = "\", new StringBuilder(\"";
  protected final String TEXT_616 = "\"), ";
  protected final String TEXT_617 = ");";
  protected final String TEXT_618 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_619 = " = new StringBuffer(delete_";
  protected final String TEXT_620 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_621 = ".insert(delete_";
  protected final String TEXT_622 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_623 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_624 = " =deleteStringBuffer_";
  protected final String TEXT_625 = ".toString();  ";
  protected final String TEXT_626 = NL + "        pstmt_";
  protected final String TEXT_627 = " = conn_";
  protected final String TEXT_628 = ".prepareStatement(delete_";
  protected final String TEXT_629 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_636 = ".prepareStatement(replace_";
  protected final String TEXT_637 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_638 = "\", pstmt_";
  protected final String TEXT_639 = ");";
  protected final String TEXT_640 = NL + "            ";
  protected final String TEXT_641 = ";" + NL + "            insertIgnore_";
  protected final String TEXT_642 = " = insertIgnore_";
  protected final String TEXT_643 = " + \" ON DUPLICATE KEY UPDATE \" + DynamicUtils.getUpdateSet(";
  protected final String TEXT_644 = ".";
  protected final String TEXT_645 = ", \"";
  protected final String TEXT_646 = "\", new StringBuilder(\"";
  protected final String TEXT_647 = "\"));";
  protected final String TEXT_648 = NL + "        pstmt_";
  protected final String TEXT_649 = " = conn_";
  protected final String TEXT_650 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_651 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_652 = "\", pstmt_";
  protected final String TEXT_653 = ");";
  protected final String TEXT_654 = NL + "            ";
  protected final String TEXT_655 = ";";
  protected final String TEXT_656 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_657 = " = new StringBuffer(insert_";
  protected final String TEXT_658 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_659 = ".insert(insert_";
  protected final String TEXT_660 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_661 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_662 = " =insertStringBuffer_";
  ...
  protected final String TEXT_667 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_668 = "\", pstmt_";
  protected final String TEXT_669 = ");";
  protected final String TEXT_670 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_671 = " = insert_";
  protected final String TEXT_672 = ".split(\"\\\\?\");";
  protected final String TEXT_673 = NL + "\t\t\tupdate_";
  protected final String TEXT_674 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_675 = " = update_";
  ...
  protected final String TEXT_680 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_681 = " = insert_";
  protected final String TEXT_682 = ".split(\"\\\\?\");";
  protected final String TEXT_683 = NL + "\t\t\tdelete_";
  protected final String TEXT_684 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_685 = " = delete_";
  protected final String TEXT_686 = ".split(\"\\\\?\");";
  protected final String TEXT_687 = NL + "\t\t\treplace_";
  protected final String TEXT_688 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_689 = " = replace_";
  protected final String TEXT_690 = ".split(\"\\\\?\");";
  protected final String TEXT_691 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_692 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_693 = " = insertIgnore_";
  protected final String TEXT_694 = ".split(\"\\\\?\");";
  protected final String TEXT_695 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_696 = " = insert_";
  ...
  protected final String TEXT_703 = ".setNull(counter";
  protected final String TEXT_704 = ",java.sql.Types.CHAR);";
  protected final String TEXT_705 = NL + "                if(";
  protected final String TEXT_706 = ".";
  protected final String TEXT_707 = "==null){";
  protected final String TEXT_708 = NL + "                    ";
  protected final String TEXT_709 = ".setNull(counter";
  protected final String TEXT_710 = ",java.sql.Types.DATE);";
  ...
  protected final String TEXT_716 = ",java.sql.Types.ARRAY);";
  protected final String TEXT_717 = NL + "                if(";
  protected final String TEXT_718 = ".";
  protected final String TEXT_719 = "==null){";
  protected final String TEXT_720 = NL + "                    ";
  protected final String TEXT_721 = ".setNull(counter";
  protected final String TEXT_722 = ",java.sql.Types.INTEGER);";
  protected final String TEXT_723 = NL + "                if(";
  protected final String TEXT_724 = ".";
  protected final String TEXT_725 = "==null){";
  protected final String TEXT_726 = NL + "                    ";
  protected final String TEXT_727 = ".setNull(counter";
  protected final String TEXT_728 = ",java.sql.Types.VARCHAR);";
  protected final String TEXT_729 = NL + "                if(";
  protected final String TEXT_730 = ".";
  protected final String TEXT_731 = "==null){";
  protected final String TEXT_732 = NL + "                    ";
  protected final String TEXT_733 = ".setNull(counter";
  protected final String TEXT_734 = ",java.sql.Types.OTHER);";
  ...
  protected final String TEXT_740 = ",java.sql.Types.BOOLEAN);";
  ...
  protected final String TEXT_746 = ",java.sql.Types.DOUBLE);";
  ...
  protected final String TEXT_752 = ",java.sql.Types.FLOAT);";
  protected final String TEXT_753 = NL + "                }else{";
  protected final String TEXT_754 = NL + "                    if(";
  protected final String TEXT_755 = ".";
  protected final String TEXT_756 = "==null){";
  protected final String TEXT_757 = NL + "                    if((\"null\").equals(String.valueOf(";
  protected final String TEXT_758 = ".";
  protected final String TEXT_759 = ").toLowerCase())){";
  protected final String TEXT_760 = NL + "                ";
  protected final String TEXT_761 = ".setNull(counter";
  protected final String TEXT_762 = ",java.sql.Types.CHAR);" + NL + "" + NL + "                }else if(";
  protected final String TEXT_763 = ".";
  protected final String TEXT_764 = " == '\\0'){" + NL;
  protected final String TEXT_765 = NL + "                    ";
  protected final String TEXT_766 = ".setString(counter";
  protected final String TEXT_767 = ",\"\");" + NL + "" + NL + "                }else{" + NL;
  protected final String TEXT_768 = NL + "                    ";
  protected final String TEXT_769 = ".setString(counter";
  protected final String TEXT_770 = ",String.valueOf(";
  protected final String TEXT_771 = ".";
  protected final String TEXT_772 = "));" + NL + "                }";
  protected final String TEXT_773 = NL + "                if(";
  protected final String TEXT_774 = ".";
  protected final String TEXT_775 = "!=null){" + NL + "                    // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "                    date_";
  protected final String TEXT_776 = " = ";
  protected final String TEXT_777 = ".";
  protected final String TEXT_778 = ".getTime();" + NL + "                    if (date_";
  protected final String TEXT_779 = " < year1_";
  protected final String TEXT_780 = " || date_";
  protected final String TEXT_781 = " >= year10000_";
  protected final String TEXT_782 = ") {";
  protected final String TEXT_783 = NL + "                        ";
  protected final String TEXT_784 = ".setString(counter";
  protected final String TEXT_785 = ", \"0000-00-00 00:00:00\");" + NL + "                    } else {";
  protected final String TEXT_786 = NL + "                        ";
  protected final String TEXT_787 = ".setTimestamp(counter";
  protected final String TEXT_788 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_789 = "));" + NL + "                    }" + NL + "                }else{" + NL;
  protected final String TEXT_790 = NL + "                    ";
  protected final String TEXT_791 = ".setNull(counter";
  protected final String TEXT_792 = ",java.sql.Types.DATE);" + NL + "" + NL + "                }";
  protected final String TEXT_793 = NL + "                ";
  protected final String TEXT_794 = ".set";
  protected final String TEXT_795 = "(counter";
  ...
  protected final String TEXT_801 = " = new StringBuffer(\"\");";
  protected final String TEXT_802 = NL + "                commitEvery_";
  protected final String TEXT_803 = " = buffersSize_";
  protected final String TEXT_804 = ";";
  protected final String TEXT_805 = NL + "                    batchSize_";
  protected final String TEXT_806 = " = buffersSize_";
  protected final String TEXT_807 = ";";
  protected final String TEXT_808 = NL;
  protected final String TEXT_809 = NL + "        whetherReject_";
  protected final String TEXT_810 = " = false;";
  protected final String TEXT_811 = NL + "                        int counter";
  protected final String TEXT_812 = " = rowCount";
  protected final String TEXT_813 = " * ";
  protected final String TEXT_814 = " + 1;";
  protected final String TEXT_815 = NL + "                            counter";
  protected final String TEXT_816 = "++;";
  protected final String TEXT_817 = NL + "                            int count_dyn_";
  protected final String TEXT_818 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_819 = ".";
  protected final String TEXT_820 = ", pstmt_";
  protected final String TEXT_821 = ", counter";
  protected final String TEXT_822 = "-1, \"";
  protected final String TEXT_823 = "\");" + NL + "                            counter";
  protected final String TEXT_824 = "+=count_dyn_";
  protected final String TEXT_825 = ";";
  protected final String TEXT_826 = NL + NL + "                    exInsertColValue";
  protected final String TEXT_827 = " = new BufferLine_";
  ...
  protected final String TEXT_834 = NL + "                    );" + NL + "" + NL + "                    exInsertColValueList";
  protected final String TEXT_835 = ".add(exInsertColValue";
  protected final String TEXT_836 = ");" + NL + "" + NL + "                    rowCount";
  protected final String TEXT_837 = "++;";
  protected final String TEXT_838 = NL + "                nb_line_";
  protected final String TEXT_839 = "++;";
  protected final String TEXT_840 = NL + "                    if(rowCount";
  protected final String TEXT_841 = " == ";
  protected final String TEXT_842 = "){" + NL + "                        try{" + NL + "                            insertedCount_";
  protected final String TEXT_843 = " = insertedCount_";
  protected final String TEXT_844 = " + pstmt_";
  protected final String TEXT_845 = ".executeUpdate();" + NL + "                        }catch(java.lang.Exception e){";
  protected final String TEXT_846 = NL + "                             throw e;";
  protected final String TEXT_847 = NL + "                             System.err.println(e.getMessage());";
  protected final String TEXT_848 = NL + "                        }" + NL + "                        exInsertColValueList";
  protected final String TEXT_849 = ".clear();" + NL + "                        rowCount";
  protected final String TEXT_850 = " = 0;" + NL + "                        counter";
  protected final String TEXT_851 = "=1;" + NL + "                    }";
  ...
  protected final String TEXT_864 = ", pstmt_";
  ...
  protected final String TEXT_871 = NL + "                    pstmt_";
  protected final String TEXT_872 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_873 = "++;" + NL;
  protected final String TEXT_874 = NL + "                      batchSizeCounter_";
  protected final String TEXT_875 = "++;";
  protected final String TEXT_876 = NL + "                    try {" + NL + "                        nb_line_";
  protected final String TEXT_877 = "++;" + NL + "                        insertedCount_";
  protected final String TEXT_878 = " = insertedCount_";
  protected final String TEXT_879 = " + pstmt_";
  protected final String TEXT_880 = ".executeUpdate();";
  protected final String TEXT_881 = NL + "                    } catch(java.lang.Exception e) {" + NL + "                        whetherReject_";
  ...
  protected final String TEXT_955 = ",updateSQLSplits_";
  ...
  protected final String TEXT_963 = "\", true);";
  ...
  protected final String TEXT_980 = NL + "                routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_981 = ".";
  protected final String TEXT_982 = ", pstmt_";
  protected final String TEXT_983 = ", (count_";
  protected final String TEXT_984 = " + ";
  protected final String TEXT_985 = "), \"";
  protected final String TEXT_986 = "\", ";
  protected final String TEXT_987 = ");";
  protected final String TEXT_988 = NL + "                globalMap.put(\"";
  protected final String TEXT_989 = "_QUERY\", query_";
  protected final String TEXT_990 = ".toString().trim());";
  protected final String TEXT_991 = NL;
  protected final String TEXT_992 = NL + "            pstmt_";
  protected final String TEXT_993 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_994 = "++;" + NL;
  protected final String TEXT_995 = NL + "              batchSizeCounter_";
  protected final String TEXT_996 = "++;";
  protected final String TEXT_997 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_998 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_999 = " = updatedCount_";
  protected final String TEXT_1000 = " + pstmt_";
  protected final String TEXT_1001 = ".executeUpdate();";
  protected final String TEXT_1002 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1003 = " = true;";
  protected final String TEXT_1004 = NL + "                    throw(e);";
  protected final String TEXT_1005 = NL + "                        ";
  protected final String TEXT_1006 = " = new ";
  protected final String TEXT_1007 = "Struct();";
  protected final String TEXT_1008 = NL + "                            ";
  protected final String TEXT_1009 = ".";
  protected final String TEXT_1010 = " = ";
  protected final String TEXT_1011 = ".";
  protected final String TEXT_1012 = ";";
  protected final String TEXT_1013 = NL + "                        rejectedCount_";
  protected final String TEXT_1014 = " =  rejectedCount_";
  protected final String TEXT_1015 = "+ 1;";
  protected final String TEXT_1016 = NL + "                        ";
  protected final String TEXT_1017 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1018 = NL + "                        ";
  protected final String TEXT_1019 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1020 = ";";
  protected final String TEXT_1021 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1022 = NL + "            }";
  protected final String TEXT_1023 = NL + "                        ";
  protected final String TEXT_1024 = NL + "                    ";
  protected final String TEXT_1025 = NL + "                    DynamicUtils.insertKeyInWhereClause(";
  ...
  protected final String TEXT_1032 = NL + "            int checkCount_";
  protected final String TEXT_1033 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_1034 = " = pstmt_";
  protected final String TEXT_1035 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_1036 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_1037 = " = rs_";
  protected final String TEXT_1038 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_1039 = " > 0) {";
  protected final String TEXT_1040 = NL + "                        ";
  protected final String TEXT_1041 = NL + "                            query_";
  protected final String TEXT_1042 = " = ";
  protected final String TEXT_1043 = ";";
  protected final String TEXT_1044 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1045 = ",";
  protected final String TEXT_1046 = ".";
  protected final String TEXT_1047 = ", ";
  protected final String TEXT_1048 = ",updateSQLSplits_";
  protected final String TEXT_1049 = ");";
  protected final String TEXT_1050 = NL + "                    int count_";
  protected final String TEXT_1051 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1052 = ".";
  protected final String TEXT_1053 = ", pstmtUpdate_";
  ...
  protected final String TEXT_1059 = NL + "                                    query_";
  ...
  protected final String TEXT_1072 = NL + "                    routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_1073 = ".";
  protected final String TEXT_1074 = ", pstmtUpdate_";
  protected final String TEXT_1075 = ", (count_";
  ...
  protected final String TEXT_1080 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1081 = "_QUERY\", query_";
  protected final String TEXT_1082 = ".toString().trim());";
  protected final String TEXT_1083 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_1084 = " = updatedCount_";
  protected final String TEXT_1085 = " + pstmtUpdate_";
  protected final String TEXT_1086 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_1091 = NL + "                        nb_line_";
  ...
  protected final String TEXT_1101 = NL + "                            rejectedCount_";
  protected final String TEXT_1102 = " =  rejectedCount_";
  protected final String TEXT_1103 = "+ 1;";
  protected final String TEXT_1104 = NL + "                            ";
  protected final String TEXT_1105 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1106 = NL + "                            ";
  protected final String TEXT_1107 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1108 = ";";
  protected final String TEXT_1109 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1110 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_1115 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1116 = ",";
  protected final String TEXT_1117 = ".";
  protected final String TEXT_1118 = ", ";
  protected final String TEXT_1119 = ",insertSQLSplits_";
  protected final String TEXT_1120 = ");";
  protected final String TEXT_1121 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1122 = ".";
  protected final String TEXT_1123 = ", pstmtInsert_";
  ...
  protected final String TEXT_1130 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_1131 = " = insertedCount_";
  protected final String TEXT_1132 = " + pstmtInsert_";
  protected final String TEXT_1133 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1134 = "++;";
  protected final String TEXT_1135 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1136 = " = true;";
  protected final String TEXT_1137 = NL + "                        throw(e);";
  protected final String TEXT_1138 = NL + "                        nb_line_";
  protected final String TEXT_1139 = "++;";
  protected final String TEXT_1140 = NL + "                        ";
  protected final String TEXT_1141 = " = new ";
  protected final String TEXT_1142 = "Struct();";
  protected final String TEXT_1143 = NL + "                                ";
  protected final String TEXT_1144 = ".";
  protected final String TEXT_1145 = " = ";
  protected final String TEXT_1146 = ".";
  protected final String TEXT_1147 = ";";
  protected final String TEXT_1148 = NL + "                            rejectedCount_";
  protected final String TEXT_1149 = " =  rejectedCount_";
  protected final String TEXT_1150 = "+ 1;";
  protected final String TEXT_1151 = NL + "                            ";
  protected final String TEXT_1152 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1153 = NL + "                            ";
  protected final String TEXT_1154 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1155 = ";";
  protected final String TEXT_1156 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1157 = NL + "                }" + NL + "            }";
  protected final String TEXT_1158 = NL + "            int updateFlag_";
  protected final String TEXT_1159 = "=0;";
  protected final String TEXT_1160 = NL + "                    ";
  protected final String TEXT_1161 = NL + "                        query_";
  protected final String TEXT_1162 = " = ";
  protected final String TEXT_1163 = ";";
  protected final String TEXT_1164 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1165 = ",";
  protected final String TEXT_1166 = ".";
  protected final String TEXT_1167 = ", ";
  protected final String TEXT_1168 = ",updateSQLSplits_";
  protected final String TEXT_1169 = ");";
  protected final String TEXT_1170 = NL + "                int count_";
  protected final String TEXT_1171 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1172 = ".";
  protected final String TEXT_1173 = ", pstmtUpdate_";
  protected final String TEXT_1174 = ", ";
  protected final String TEXT_1175 = ", \"";
  protected final String TEXT_1176 = "\", true);";
  protected final String TEXT_1177 = NL + "                            ";
  protected final String TEXT_1178 = NL + "                            ";
  protected final String TEXT_1179 = NL + "                                query_";
  protected final String TEXT_1180 = " = ";
  protected final String TEXT_1181 = ";";
  protected final String TEXT_1182 = NL + "                                query_";
  ...
  protected final String TEXT_1193 = NL + "                routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_1194 = ".";
  protected final String TEXT_1195 = ", pstmtUpdate_";
  protected final String TEXT_1196 = ", (count_";
  ...
  protected final String TEXT_1201 = NL + "                globalMap.put(\"";
  protected final String TEXT_1202 = "_QUERY\", query_";
  protected final String TEXT_1203 = ".toString().trim());";
  protected final String TEXT_1204 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_1205 = "=pstmtUpdate_";
  protected final String TEXT_1206 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_1207 = " = updatedCount_";
  protected final String TEXT_1208 = "+updateFlag_";
  protected final String TEXT_1209 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_1210 = " == 0) {" + NL;
  protected final String TEXT_1211 = NL + "                query_";
  protected final String TEXT_1212 = " = new StringBuffer(\"\");";
  protected final String TEXT_1213 = NL + "                        ";
  protected final String TEXT_1214 = NL + "                            query_";
  protected final String TEXT_1215 = " = ";
  protected final String TEXT_1216 = ";";
  protected final String TEXT_1217 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1218 = ",";
  protected final String TEXT_1219 = ".";
  protected final String TEXT_1220 = ", ";
  protected final String TEXT_1221 = ",insertSQLSplits_";
  protected final String TEXT_1222 = ");";
  protected final String TEXT_1223 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_1229 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1230 = "_QUERY\", query_";
  protected final String TEXT_1231 = ".toString().trim());";
  protected final String TEXT_1232 = NL + "                    insertedCount_";
  protected final String TEXT_1233 = " = insertedCount_";
  protected final String TEXT_1234 = " + pstmtInsert_";
  protected final String TEXT_1235 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1236 = "++;";
  protected final String TEXT_1237 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_1238 = "++;";
  protected final String TEXT_1239 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1240 = " = true;";
  protected final String TEXT_1241 = NL + "                        throw(e);";
  protected final String TEXT_1242 = NL + "                        nb_line_";
  protected final String TEXT_1243 = "++;";
  protected final String TEXT_1244 = NL + "                        ";
  protected final String TEXT_1245 = " = new ";
  protected final String TEXT_1246 = "Struct();";
  ...
  protected final String TEXT_1252 = NL + "                            rejectedCount_";
  protected final String TEXT_1253 = " =  rejectedCount_";
  protected final String TEXT_1254 = "+ 1;";
  protected final String TEXT_1255 = NL + "                            ";
  protected final String TEXT_1256 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1257 = NL + "                            ";
  protected final String TEXT_1258 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1259 = ";";
  protected final String TEXT_1260 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1261 = NL + "                }";
  protected final String TEXT_1262 = NL + "                        ";
  protected final String TEXT_1263 = NL + "                            query_";
  ...
  protected final String TEXT_1270 = NL + "                routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_1271 = ".";
  protected final String TEXT_1272 = ", pstmt_";
  ...
  protected final String TEXT_1280 = NL + "            pstmt_";
  protected final String TEXT_1281 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_1282 = "++;";
  protected final String TEXT_1283 = NL + "              batchSizeCounter_";
  protected final String TEXT_1284 = "++;";
  protected final String TEXT_1285 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1286 = " = deletedCount_";
  protected final String TEXT_1287 = " + pstmt_";
  protected final String TEXT_1288 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1289 = "++;";
  protected final String TEXT_1290 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1291 = " = true;";
  protected final String TEXT_1292 = NL + "                    throw(e);";
  protected final String TEXT_1293 = NL + "                    nb_line_";
  protected final String TEXT_1294 = "++;";
  protected final String TEXT_1295 = NL + "                        ";
  protected final String TEXT_1296 = " = new ";
  protected final String TEXT_1297 = "Struct();";
  ...
  protected final String TEXT_1303 = NL + "                        rejectedCount_";
  protected final String TEXT_1304 = " =  rejectedCount_";
  protected final String TEXT_1305 = "+ 1;";
  protected final String TEXT_1306 = NL + "                        ";
  protected final String TEXT_1307 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1308 = NL + "                        ";
  protected final String TEXT_1309 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1310 = ";" + NL;
  protected final String TEXT_1311 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_1317 = NL + "                DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1318 = ".";
  protected final String TEXT_1319 = ", pstmt_";
  protected final String TEXT_1320 = ", ";
  protected final String TEXT_1321 = ", \"";
  protected final String TEXT_1322 = "\");";
  protected final String TEXT_1323 = NL + "                globalMap.put(\"";
  protected final String TEXT_1324 = "_QUERY\", query_";
  protected final String TEXT_1325 = ".toString().trim());";
  protected final String TEXT_1326 = NL + "            int replaceCount_";
  protected final String TEXT_1327 = " = 0;" + NL + "            try {" + NL + "                replaceCount_";
  protected final String TEXT_1328 = " = pstmt_";
  protected final String TEXT_1329 = ".executeUpdate();";
  protected final String TEXT_1330 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1331 = " = true;";
  protected final String TEXT_1332 = NL + "                    throw(e);";
  protected final String TEXT_1333 = NL + "                        ";
  protected final String TEXT_1334 = " = new ";
  protected final String TEXT_1335 = "Struct();";
  ...
  protected final String TEXT_1341 = NL + "                        rejectedCount_";
  protected final String TEXT_1342 = " =  rejectedCount_";
  protected final String TEXT_1343 = "+ 1;";
  protected final String TEXT_1344 = NL + "                        ";
  protected final String TEXT_1345 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1346 = NL + "                        ";
  protected final String TEXT_1347 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1348 = ";";
  protected final String TEXT_1349 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1350 = NL + "            }" + NL + "            if(replaceCount_";
  protected final String TEXT_1351 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_1352 = " += replaceCount_";
  protected final String TEXT_1353 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_1354 = " += 1;" + NL + "                deletedCount_";
  protected final String TEXT_1355 = " += replaceCount_";
  protected final String TEXT_1356 = " - 1;" + NL + "            }";
  ...
  protected final String TEXT_1361 = NL + "                int count_";
  protected final String TEXT_1362 = " = DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1363 = ".";
  protected final String TEXT_1364 = ", pstmt_";
  ...
  protected final String TEXT_1369 = NL + "                        query_";
  ...
  protected final String TEXT_1375 = NL + "                DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1376 = ".";
  protected final String TEXT_1377 = ", pstmt_";
  protected final String TEXT_1378 = ", (count_";
  ...
  protected final String TEXT_1417 = NL + "                DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1418 = ".";
  protected final String TEXT_1419 = ", pstmt_";
  protected final String TEXT_1420 = ", ";
  protected final String TEXT_1421 = ", \"";
  protected final String TEXT_1422 = "\");";
  protected final String TEXT_1423 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1424 = "_QUERY\", query_";
  protected final String TEXT_1425 = ".toString().trim());";
  protected final String TEXT_1426 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_1427 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_1428 = " = insertedCount_";
  ...
  protected final String TEXT_1463 = NL + "                if ( batchSize_";
  protected final String TEXT_1464 = " <= batchSizeCounter_";
  protected final String TEXT_1465 = ") {";
  protected final String TEXT_1466 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1467 = " = 0;";
  protected final String TEXT_1468 = NL + "                        for(int countEach_";
  protected final String TEXT_1469 = ": pstmt_";
  protected final String TEXT_1470 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_1471 = " += (countEach_";
  protected final String TEXT_1472 = " < 0 ? 0 : 1);" + NL + "                        }";
  protected final String TEXT_1473 = NL + "                        insertedCount_";
  protected final String TEXT_1474 = " += countSum_";
  protected final String TEXT_1475 = ";";
  protected final String TEXT_1476 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1477 = NL + "                        throw(e);";
  protected final String TEXT_1478 = NL + "                    int countSum_";
  protected final String TEXT_1479 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_1480 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_1481 = " += (countEach_";
  protected final String TEXT_1482 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1483 = ");" + NL + "                    }";
  protected final String TEXT_1484 = NL + "                    insertedCount_";
  protected final String TEXT_1485 = " += countSum_";
  protected final String TEXT_1486 = ";";
  protected final String TEXT_1487 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1488 = NL + "                }";
  protected final String TEXT_1489 = NL + NL + "                batchSizeCounter_";
  protected final String TEXT_1490 = " = 0;" + NL + "            }";
  protected final String TEXT_1491 = NL + "                if ( batchSize_";
  protected final String TEXT_1492 = " <= batchSizeCounter_";
  protected final String TEXT_1493 = ") {";
  protected final String TEXT_1494 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1495 = " = 0;";
  protected final String TEXT_1496 = NL + "                        for(int countEach_";
  protected final String TEXT_1497 = ": pstmt_";
  protected final String TEXT_1498 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_1499 = " += (countEach_";
  protected final String TEXT_1500 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1501 = ");" + NL + "                        }";
  protected final String TEXT_1502 = NL + "                        updatedCount_";
  protected final String TEXT_1503 = " += countSum_";
  protected final String TEXT_1504 = ";";
  protected final String TEXT_1505 = NL + "                        deletedCount_";
  protected final String TEXT_1506 = " += countSum_";
  protected final String TEXT_1507 = ";";
  protected final String TEXT_1508 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1509 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1510 = NL + "                        throw(e);";
  protected final String TEXT_1511 = NL + "                    int countSum_";
  protected final String TEXT_1512 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_1513 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  ...
  protected final String TEXT_1523 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1524 = NL + "                }";
  protected final String TEXT_1525 = NL + NL + NL + NL + "                }";
  protected final String TEXT_1526 = NL + "                commitCounter_";
  protected final String TEXT_1527 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_1528 = " <= commitCounter_";
  protected final String TEXT_1529 = ") {" + NL;
  protected final String TEXT_1530 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1531 = " = 0;";
  protected final String TEXT_1532 = NL + "                        for(int countEach_";
  protected final String TEXT_1533 = ": pstmt_";
  protected final String TEXT_1534 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_1535 = " += (countEach_";
  protected final String TEXT_1536 = " < 0 ? 0 : ";
  protected final String TEXT_1537 = ");" + NL + "                        }";
  protected final String TEXT_1538 = NL + "                        insertedCount_";
  protected final String TEXT_1539 = " += countSum_";
  protected final String TEXT_1540 = ";";
  protected final String TEXT_1541 = NL + "                        updatedCount_";
  protected final String TEXT_1542 = " += countSum_";
  protected final String TEXT_1543 = ";";
  protected final String TEXT_1544 = NL + "                        deletedCount_";
  protected final String TEXT_1545 = " += countSum_";
  protected final String TEXT_1546 = ";";
  protected final String TEXT_1547 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1548 = NL + "                        throw(e);";
  protected final String TEXT_1549 = NL + "                    int countSum_";
  protected final String TEXT_1550 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_1551 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  ...
  protected final String TEXT_1564 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1565 = NL + NL + "                }";
  protected final String TEXT_1566 = NL + "                    conn_";
  protected final String TEXT_1567 = ".commit();";
  protected final String TEXT_1568 = NL + "                    commitCounter_";
  protected final String TEXT_1569 = "=0;" + NL + "" + NL + "                }" + NL;
