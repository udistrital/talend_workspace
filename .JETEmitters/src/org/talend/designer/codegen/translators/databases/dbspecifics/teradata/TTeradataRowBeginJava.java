...
public class TTeradataRowBeginJava
{
  ...
  protected final String TEXT_127 = NL + "            if (log.isDebugEnabled()) {" + NL + "                class BytesLimit65535_";
  protected final String TEXT_128 = "{" + NL + "                    public void limitLog4jByte() throws Exception{" + NL + "                    StringBuilder ";
  protected final String TEXT_129 = " = new StringBuilder();";
  protected final String TEXT_130 = NL + "                    ";
  protected final String TEXT_131 = ".append(\"Parameters:\");";
  protected final String TEXT_132 = NL + "                            ";
  protected final String TEXT_133 = ".append(\"";
  protected final String TEXT_134 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_135 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_142 = NL + "                    } " + NL + "                } " + NL + "            new BytesLimit65535_";
  protected final String TEXT_143 = "().limitLog4jByte();" + NL + "            }";
  protected final String TEXT_144 = NL + "            StringBuilder ";
  protected final String TEXT_145 = " = new StringBuilder();    ";
  ...
  protected final String TEXT_154 = ".append(\"<null>\");" + NL + "                    }else{";
  ...
  protected final String TEXT_162 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_163 = " = ";
  protected final String TEXT_164 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_165 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_166 = " == null || dbProperties_";
  protected final String TEXT_167 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_168 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_169 = ";" + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_170 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_171 = " + \"/\" + ";
  protected final String TEXT_172 = ";" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_173 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_174 = " = null;" + NL + "\tString query_";
  protected final String TEXT_175 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_176 = " = false;";
  protected final String TEXT_177 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_182 = ".prepareStatement(";
  protected final String TEXT_183 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_188 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_189 = "\", stmt_";
  protected final String TEXT_190 = ");";
  protected final String TEXT_191 = NL;
  protected final String TEXT_192 = NL + "\t";
  protected final String TEXT_193 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_194 = " =  conn_";
  protected final String TEXT_195 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_196 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_197 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_198 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_199 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_200 = NL + "                 conn_";
  protected final String TEXT_201 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_202 = NL + "               ";
  protected final String TEXT_203 = " + \"=\" + ";
  protected final String TEXT_204 = " + \";\" +";
  protected final String TEXT_205 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_206 = ".setAutoCommit(currentAutoCommitMode";
