...
public class TFirebirdRowBeginJava
{
  ...
  protected final String TEXT_129 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_135 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_140 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_141 = "\", stmt_";
