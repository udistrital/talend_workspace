...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_80 = NL + "            if (log.isDebugEnabled()) {" + NL + "                class BytesLimit65535_";
  protected final String TEXT_81 = "{" + NL + "                    public void limitLog4jByte() throws Exception{" + NL + "                    StringBuilder ";
  protected final String TEXT_82 = " = new StringBuilder();";
  protected final String TEXT_83 = NL + "                    ";
  protected final String TEXT_84 = ".append(\"Parameters:\");";
  protected final String TEXT_85 = NL + "                            ";
  protected final String TEXT_86 = ".append(\"";
  protected final String TEXT_87 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_88 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_95 = NL + "                    } " + NL + "                } " + NL + "            new BytesLimit65535_";
  protected final String TEXT_96 = "().limitLog4jByte();" + NL + "            }";
  protected final String TEXT_97 = NL + "            StringBuilder ";
  protected final String TEXT_98 = " = new StringBuilder();    ";
  ...
  protected final String TEXT_107 = ".append(\"<null>\");" + NL + "                    }else{";
  ...
  protected final String TEXT_115 = NL + NL + "int nb_line_";
  protected final String TEXT_116 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_117 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_118 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_119 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_120 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_121 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_122 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_123 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_124 = "=0;" + NL + "" + NL + "String tableName_";
  ...
  protected final String TEXT_133 = NL + "        int updateKeyCount_";
  protected final String TEXT_134 = " = ";
  protected final String TEXT_135 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_136 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_137 = NL + "        int deleteKeyCount_";
  protected final String TEXT_138 = " = ";
  protected final String TEXT_139 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_140 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_141 = NL + "\t String dbname_";
  protected final String TEXT_142 = " = (String)globalMap.get(\"";
  protected final String TEXT_143 = "\");" + NL + "\t String dbUser_";
  protected final String TEXT_144 = " = (String)globalMap.get(\"";
  ...
  protected final String TEXT_149 = NL + "    String dbname_";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = ";" + NL + "    String driverClass_";
  protected final String TEXT_152 = " = \"com.teradata.jdbc.TeraDriver\";";
  protected final String TEXT_153 = NL + NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_154 = ");" + NL + "    String dbProperties_";
  protected final String TEXT_155 = " = ";
  protected final String TEXT_156 = ";" + NL + "\tString url_";
  protected final String TEXT_157 = " = null;" + NL + "\tif(dbProperties_";
  protected final String TEXT_158 = " == null || dbProperties_";
  protected final String TEXT_159 = ".trim().length() == 0) {" + NL + "\t\turl_";
  protected final String TEXT_160 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_161 = ";" + NL + "\t} else {" + NL + "\t    url_";
  protected final String TEXT_162 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_163 = " + \"/\" + ";
  protected final String TEXT_164 = ";" + NL + "\t}" + NL + "    String dbUser_";
  ...
  protected final String TEXT_174 = NL + NL + "    String dbPwd_";
  protected final String TEXT_175 = " = decryptedPassword_";
  protected final String TEXT_176 = ";" + NL + "" + NL + "\t";
  protected final String TEXT_177 = NL + "    java.sql.Connection conn_";
  protected final String TEXT_178 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_179 = ",dbUser_";
  protected final String TEXT_180 = ",dbPwd_";
  protected final String TEXT_181 = ");";
  protected final String TEXT_182 = NL;
  protected final String TEXT_183 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_184 = " =  conn_";
  protected final String TEXT_185 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_186 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_187 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_188 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_189 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_190 = NL + "                 conn_";
  protected final String TEXT_191 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_192 = NL + "               ";
  protected final String TEXT_193 = " + \"=\" + ";
  protected final String TEXT_194 = " + \";\" +";
  protected final String TEXT_195 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_196 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_197 = ");";
  protected final String TEXT_198 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_199 = "\", conn_";
  protected final String TEXT_200 = ");";
  protected final String TEXT_201 = NL + "        conn_";
  protected final String TEXT_202 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_203 = " = ";
  protected final String TEXT_204 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_205 = " = 0;";
  protected final String TEXT_206 = NL + "String dbschema_";
  protected final String TEXT_207 = " = dbname_";
  protected final String TEXT_208 = ";" + NL + "if(dbname_";
  protected final String TEXT_209 = " == null || dbname_";
  protected final String TEXT_210 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_211 = " = ";
  protected final String TEXT_212 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_213 = " = dbname_";
  protected final String TEXT_214 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_215 = ";" + NL + "}";
  protected final String TEXT_216 = NL + "int count_";
  protected final String TEXT_217 = "=0;";
  protected final String TEXT_218 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_222 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_223 = ")));";
  protected final String TEXT_224 = NL + "                stmtDrop_";
  protected final String TEXT_225 = ".execute(\"";
  protected final String TEXT_226 = "\" ";
  protected final String TEXT_227 = ");";
  protected final String TEXT_228 = NL + "            }";
  protected final String TEXT_229 = NL + "                 conn_";
  protected final String TEXT_230 = ".commit();";
  protected final String TEXT_231 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_235 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_236 = "));";
  protected final String TEXT_237 = NL + "                        stmtCreate_";
  protected final String TEXT_238 = ".execute(((\"";
  protected final String TEXT_239 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_240 = ".";
  protected final String TEXT_241 = ", \"";
  protected final String TEXT_242 = "\")";
  protected final String TEXT_243 = ".toUpperCase()";
  ...
  protected final String TEXT_250 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_270 = NL + "                    String keyCheckTable_";
  protected final String TEXT_271 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_272 = "+\"][\"+";
  protected final String TEXT_273 = "+\"][\"+";
  protected final String TEXT_274 = "+\"][\"+";
  protected final String TEXT_275 = "+\"][\"+";
  protected final String TEXT_276 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_277 = " + \"]\";";
  protected final String TEXT_278 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_279 = " = conn_";
  protected final String TEXT_280 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_281 = " + \"]\";";
  protected final String TEXT_282 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_283 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_284 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_285 = ")== null){//}";
  protected final String TEXT_286 = NL + "                                boolean whetherExist_";
  protected final String TEXT_287 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_288 = " = conn_";
  protected final String TEXT_289 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_290 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_291 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_292 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_293 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_294 = NL + "                                ";
  protected final String TEXT_295 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_296 = " = conn_";
  protected final String TEXT_297 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_298 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_299 = " = tableNameForSearch_";
  protected final String TEXT_300 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_301 = " = tableNameForSearch_";
  protected final String TEXT_302 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_303 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_304 = " = dbMetaData_";
  protected final String TEXT_305 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_306 = ", tableNameForSearch_";
  protected final String TEXT_307 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_308 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_309 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_310 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_311 = " = conn_";
  protected final String TEXT_312 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_313 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_314 = " = dbMetaData_";
  protected final String TEXT_315 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_329 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_330 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_331 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_332 = " = conn_";
  protected final String TEXT_333 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_334 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_335 = " = dbMetaData_";
  protected final String TEXT_336 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_358 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_359 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_360 = " = dbMetaData_";
  protected final String TEXT_361 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_362 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_363 = " == null || dbschema_";
  protected final String TEXT_364 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_365 = " = conn_";
  protected final String TEXT_366 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_367 = " = stmtSchema_";
  protected final String TEXT_368 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_369 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_370 = " = rsSchema_";
  protected final String TEXT_371 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_392 = NL + "                                String tableForSearch_";
  protected final String TEXT_393 = " = ";
  protected final String TEXT_394 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_395 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_396 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_397 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_398 = " =  tableForSearch_";
  protected final String TEXT_399 = ".substring(1,tableForSearch_";
  protected final String TEXT_400 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_401 = " =  tableForSearch_";
  protected final String TEXT_402 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_407 = ".getTables(null, conn_";
  protected final String TEXT_408 = ".getSchema(), tableForSearch_";
  protected final String TEXT_409 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_410 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_411 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_412 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_413 = " = conn_";
  protected final String TEXT_414 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_415 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_416 = " = dbMetaData_";
  protected final String TEXT_417 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_418 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_419 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_420 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_421 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_422 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_423 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_424 = " = conn_";
  protected final String TEXT_425 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_426 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_427 = " = dbMetaData_";
  protected final String TEXT_428 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_429 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_430 = " = rsTable_";
  protected final String TEXT_431 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_432 = ".equalsIgnoreCase(";
  protected final String TEXT_433 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_434 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_435 = NL + "                                if(!whetherExist_";
  protected final String TEXT_436 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_456 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_469 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_475 = NL + "                                        stmtCreate_";
  protected final String TEXT_476 = ".execute(((\"";
  protected final String TEXT_477 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_484 = NL + "                                    stmtCreate_";
  protected final String TEXT_485 = ".execute(\"";
  ...
  protected final String TEXT_490 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_491 = " = conn_";
  protected final String TEXT_492 = ".createStatement()) {";
  protected final String TEXT_493 = NL + "                              stmtClear_";
  protected final String TEXT_494 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_495 = "));";
  protected final String TEXT_496 = NL + "                stmtClear_";
  protected final String TEXT_497 = ".executeUpdate(\"";
  protected final String TEXT_498 = "\");";
  protected final String TEXT_499 = NL + "            }";
  protected final String TEXT_500 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_501 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_502 = " = conn_";
  protected final String TEXT_503 = ".createStatement()) {";
  protected final String TEXT_504 = NL + "                              stmtTruncCount_";
  protected final String TEXT_505 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_506 = "));";
  protected final String TEXT_507 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_508 = " = stmtTruncCount_";
  protected final String TEXT_509 = ".executeQuery(\"";
  protected final String TEXT_510 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_511 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_512 = " = rsTruncCount_";
  protected final String TEXT_513 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_514 = " = conn_";
  protected final String TEXT_515 = ".createStatement()) {";
  protected final String TEXT_516 = NL + "                              stmtTrunc_";
  protected final String TEXT_517 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_518 = "));";
  protected final String TEXT_519 = NL + "                conn_";
  protected final String TEXT_520 = ".commit();";
  protected final String TEXT_521 = NL + "                stmtTrunc_";
  protected final String TEXT_522 = ".executeUpdate(\"";
  protected final String TEXT_523 = "\");";
  protected final String TEXT_524 = NL + "                    if(!conn_";
  protected final String TEXT_525 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_526 = ".commit();" + NL + "                    }";
  protected final String TEXT_527 = NL + "                deletedCount_";
  protected final String TEXT_528 = " += rsTruncCountNumber_";
  protected final String TEXT_529 = ";" + NL + "            }";
  protected final String TEXT_530 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_531 = " = conn_";
  protected final String TEXT_532 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_533 = " = stmtTruncCount_";
  protected final String TEXT_534 = ".executeQuery(\"";
  protected final String TEXT_535 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_536 = " = conn_";
  protected final String TEXT_537 = ".createStatement()) {";
  ...
  protected final String TEXT_543 = NL + "                while(rsTruncCount_";
  protected final String TEXT_544 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_545 = " += rsTruncCount_";
  protected final String TEXT_546 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_547 = NL + "\t conn_";
  protected final String TEXT_548 = ".commit();";
  ...
  protected final String TEXT_573 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_578 = ") VALUES (";
  protected final String TEXT_579 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_580 = " = conn_";
  protected final String TEXT_581 = ".prepareStatement(insert_";
  protected final String TEXT_582 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_591 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_601 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_602 = "\", pstmtUpdate_";
  protected final String TEXT_603 = ");" + NL + "\t    String insert_";
  protected final String TEXT_604 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_605 = " + \"\\\" (";
  protected final String TEXT_606 = ") VALUES (";
  ...
  protected final String TEXT_610 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_611 = "\", pstmtInsert_";
  protected final String TEXT_612 = ");" + NL + "\t    ";
  protected final String TEXT_613 = NL + "\t    String delete_";
  protected final String TEXT_614 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_618 = ".prepareStatement(delete_";
  protected final String TEXT_619 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
