...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_345 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_351 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_359 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_379 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_391 = ".commit();";
  protected final String TEXT_392 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_413 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_424 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_430 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_431 = " = stmtTruncCount_";
  protected final String TEXT_432 = ".executeQuery(\"";
  protected final String TEXT_433 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_434 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_435 = " = rsTruncCount_";
  protected final String TEXT_436 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_443 = ".commit();";
  protected final String TEXT_444 = NL + "                stmtTrunc_";
  protected final String TEXT_445 = ".executeUpdate(\"";
  protected final String TEXT_446 = "\");";
  protected final String TEXT_447 = NL + "                    if(!conn_";
  protected final String TEXT_448 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_449 = ".commit();" + NL + "                    }";
  protected final String TEXT_450 = NL + "                deletedCount_";
  protected final String TEXT_451 = " += rsTruncCountNumber_";
  protected final String TEXT_452 = ";" + NL + "            }";
  protected final String TEXT_453 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_466 = NL + "                while(rsTruncCount_";
  protected final String TEXT_467 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_468 = " += rsTruncCount_";
  protected final String TEXT_469 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_470 = NL + "\t\t\t\ttry (java.sql.Statement stmtCreateProjection_";
  protected final String TEXT_471 = " = conn_";
  protected final String TEXT_472 = ".createStatement()) {" + NL + "\t\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_473 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_474 = " + \"_proj (";
  protected final String TEXT_475 = ") AS SELECT ";
  protected final String TEXT_476 = " FROM \" + tableName_";
  protected final String TEXT_477 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_478 = NL + "\t\t\t\tif(!whetherExist_";
  ...
  protected final String TEXT_488 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_489 = "\", pstmt_";
  protected final String TEXT_490 = ");";
  protected final String TEXT_491 = NL + "        int batchCount_";
  ...
  protected final String TEXT_505 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_506 = " + \" WHERE ";
  protected final String TEXT_507 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_508 = "\", pstmt_";
  ...
  protected final String TEXT_532 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_533 = " = conn_";
  protected final String TEXT_534 = ".prepareStatement(update_";
  protected final String TEXT_535 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_544 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_545 = "\", pstmtInsert_";
  ...
  protected final String TEXT_556 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_557 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_558 = " = conn_";
  protected final String TEXT_559 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_560 = "\", stmt_";
  protected final String TEXT_561 = ");" + NL + "        String template_";
  protected final String TEXT_562 = " = \"COPY \" + tableName_";
  protected final String TEXT_563 = " +\" (";
  protected final String TEXT_564 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_565 = "DIRECT";
  protected final String TEXT_566 = "\";" + NL + "\t\t";
  protected final String TEXT_567 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_576 = NL + "\t\t\tupdate_";
  protected final String TEXT_577 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_578 = " = update_";
  protected final String TEXT_579 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_580 = " = insert_";
  protected final String TEXT_581 = ".split(\"\\\\?\");";
  protected final String TEXT_582 = NL + "\t\t\tdelete_";
  protected final String TEXT_583 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_584 = " = delete_";
  protected final String TEXT_585 = ".split(\"\\\\?\");";
  protected final String TEXT_586 = NL + "\t\t\treplace_";
  protected final String TEXT_587 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_588 = " = replace_";
  protected final String TEXT_589 = ".split(\"\\\\?\");";
  protected final String TEXT_590 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_591 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_592 = " = insertIgnore_";
  protected final String TEXT_593 = ".split(\"\\\\?\");";
  protected final String TEXT_594 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_595 = " = insert_";
  protected final String TEXT_596 = ".split(\"\\\\?\");";
  protected final String TEXT_597 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_598 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_599 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_600 = " =null;";
  protected final String TEXT_601 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_605 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_606 = " =  null;";
  protected final String TEXT_607 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_608 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_612 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_613 = " = null;";
  protected final String TEXT_614 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_618 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_619 = " = null;" + NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_620 = " = null;" + NL + "\t\tString template_";
