...
public class TSQLDWHOutputMainJava {
  ...
  protected final String TEXT_379 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_385 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_392 = NL + "                                if(!whetherExist_";
  protected final String TEXT_393 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_400 = ".execute(((\"";
  protected final String TEXT_401 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_413 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_414 = " = conn_";
  protected final String TEXT_415 = ".createStatement()) {";
  protected final String TEXT_416 = NL + "                                                      stmtDrop_";
  ...
  protected final String TEXT_426 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_445 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_446 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_447 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_457 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_458 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_459 = " = conn_";
  protected final String TEXT_460 = ".createStatement()) {";
  protected final String TEXT_461 = NL + "                              stmtTruncCount_";
  protected final String TEXT_462 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_463 = "));";
  protected final String TEXT_464 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_465 = " = stmtTruncCount_";
  protected final String TEXT_466 = ".executeQuery(\"";
  protected final String TEXT_467 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_468 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_469 = " = rsTruncCount_";
  protected final String TEXT_470 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_487 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_488 = " = conn_";
  protected final String TEXT_489 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_490 = " = stmtTruncCount_";
  protected final String TEXT_491 = ".executeQuery(\"";
  protected final String TEXT_492 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_493 = " = conn_";
  protected final String TEXT_494 = ".createStatement()) {";
  protected final String TEXT_495 = NL + "                conn_";
  protected final String TEXT_496 = ".commit();";
  protected final String TEXT_497 = NL + "                stmtTrunc_";
  protected final String TEXT_498 = ".executeUpdate(\"";
  protected final String TEXT_499 = "\");";
  protected final String TEXT_500 = NL + "                while(rsTruncCount_";
  protected final String TEXT_501 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_502 = " += rsTruncCount_";
  protected final String TEXT_503 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_530 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_542 = ");" + NL + "\t\t\tresourceMap.put(\"pstmt_";
  protected final String TEXT_543 = "\", pstmt_";
  protected final String TEXT_544 = ");" + NL + "\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_545 = ", pstmt_";
  protected final String TEXT_546 = ");" + NL + "\t\t}else{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_547 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_671 = ".prepareStatement(delete_";
  protected final String TEXT_672 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_678 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_679 = "\", pstmt_";
  protected final String TEXT_680 = ");";
  protected final String TEXT_681 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_682 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_683 = " + \"] (";
  protected final String TEXT_684 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_685 = ".";
  protected final String TEXT_686 = ", \"";
  protected final String TEXT_687 = "\")+\") VALUES (";
  protected final String TEXT_688 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_689 = ".";
  protected final String TEXT_690 = ")+\")\";";
  protected final String TEXT_691 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_692 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_693 = " + \"] (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_694 = ".";
  protected final String TEXT_695 = ", \"";
  protected final String TEXT_696 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_697 = ".";
  protected final String TEXT_698 = ")+\")\";";
  protected final String TEXT_699 = NL + "        pstmt_";
  protected final String TEXT_700 = " = conn_";
  protected final String TEXT_701 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_702 = " + \"] WHERE ";
  protected final String TEXT_703 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_704 = "\", pstmt_";
  protected final String TEXT_705 = ");" + NL + "        pstmtInsert_";
  protected final String TEXT_706 = " = conn_";
  protected final String TEXT_707 = ".prepareStatement(insert_";
  protected final String TEXT_708 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_709 = "\", pstmtInsert_";
  protected final String TEXT_710 = ");";
  protected final String TEXT_711 = NL + "       \t";
  protected final String TEXT_712 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_713 = " = insert_";
  protected final String TEXT_714 = ".split(\"\\\\?\");";
  protected final String TEXT_715 = NL + "\t\t\tupdate_";
  protected final String TEXT_716 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_717 = " = update_";
  protected final String TEXT_718 = ".split(\"\\\\?\");";
  protected final String TEXT_719 = NL + "\t\t\tupdate_";
  protected final String TEXT_720 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_721 = " = update_";
  protected final String TEXT_722 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_723 = " = insert_";
  protected final String TEXT_724 = ".split(\"\\\\?\");";
  protected final String TEXT_725 = NL + "\t\t\tdelete_";
  protected final String TEXT_726 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_727 = " = delete_";
  protected final String TEXT_728 = ".split(\"\\\\?\");";
  protected final String TEXT_729 = NL + "\t\t\treplace_";
  protected final String TEXT_730 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  ...
  protected final String TEXT_734 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_735 = " = insertIgnore_";
  protected final String TEXT_736 = ".split(\"\\\\?\");";
  protected final String TEXT_737 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_738 = " = insert_";
  protected final String TEXT_739 = ".split(\"\\\\?\");";
  protected final String TEXT_740 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_741 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_742 = " = buffersSize_";
  protected final String TEXT_743 = ";";
  protected final String TEXT_744 = NL + "\t\t\tbatchSize_";
  protected final String TEXT_745 = " = buffersSize_";
  protected final String TEXT_746 = ";";
  protected final String TEXT_747 = NL + NL;
  protected final String TEXT_748 = NL + "\t\tif ( isShareIdentity_";
  protected final String TEXT_749 = " ) {" + NL + "        \tstmt_";
  protected final String TEXT_750 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_751 = " +\"] ON\");" + NL + "        }";
  protected final String TEXT_752 = NL + "        whetherReject_";
  protected final String TEXT_753 = " = false;";
  protected final String TEXT_754 = NL + "            try {";
  protected final String TEXT_755 = NL + "                    ";
  protected final String TEXT_756 = NL + "                        query_";
  protected final String TEXT_757 = " = ";
  protected final String TEXT_758 = ";";
  protected final String TEXT_759 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_760 = ",";
  protected final String TEXT_761 = ".";
  protected final String TEXT_762 = ", ";
  protected final String TEXT_763 = ",insertSQLSplits_";
  ...
  protected final String TEXT_775 = NL + "        \t\tpstmt_";
  protected final String TEXT_776 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_777 = "++;" + NL + "    \t\t ";
  protected final String TEXT_778 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_779 = "++;" + NL + "    \t\t";
  protected final String TEXT_780 = NL + "            try {";
  protected final String TEXT_781 = NL + "                nb_line_";
  protected final String TEXT_782 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_783 = " = insertedCount_";
  protected final String TEXT_784 = " + pstmt_";
  protected final String TEXT_785 = ".executeUpdate();";
  ...
  protected final String TEXT_801 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_807 = NL + "\t\t     \tint counter";
  protected final String TEXT_808 = " = rowCount";
  protected final String TEXT_809 = " * ";
  protected final String TEXT_810 = " + 1;" + NL + "" + NL + "\t\t     \t \t";
  protected final String TEXT_811 = NL + "\t\t     \tint counter";
  protected final String TEXT_812 = " = rowCount";
  protected final String TEXT_813 = " * ";
  protected final String TEXT_814 = " + 1;" + NL + "" + NL + "\t\t     \t \t";
  ...
  protected final String TEXT_826 = NL + NL + "\t\t                sInsertColValue";
  ...
  protected final String TEXT_836 = NL + "\t\t                );" + NL + "" + NL + "\t\t                sInsertColValueList";
  protected final String TEXT_837 = ".add(sInsertColValue";
  protected final String TEXT_838 = ");" + NL + "" + NL + "\t\t                rowCount";
  protected final String TEXT_839 = "++;" + NL + "\t\t";
  protected final String TEXT_840 = NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_841 = "++;" + NL + "\t\t";
  protected final String TEXT_842 = NL + "\t\t                if(rowCount";
  ...
  protected final String TEXT_847 = ".executeUpdate();" + NL + "\t\t                    sInsertColValueList";
  protected final String TEXT_848 = ".clear();" + NL + "\t\t                    rowCount";
  protected final String TEXT_849 = " = 0;" + NL + "\t\t                    counter";
  protected final String TEXT_850 = "=1;" + NL + "\t\t                }" + NL + NL + NL + NL;
  ...
  protected final String TEXT_860 = ",updateSQLSplits_";
  protected final String TEXT_861 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_862 = NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_892 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_893 = "++;" + NL + "    \t\t";
  protected final String TEXT_894 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_895 = "++;" + NL + "    \t\t";
  protected final String TEXT_896 = NL + "            try {";
  protected final String TEXT_897 = NL + "                nb_line_";
  protected final String TEXT_898 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_899 = " = updatedCount_";
  protected final String TEXT_900 = " + pstmt_";
  protected final String TEXT_901 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_902 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_903 = " = true;";
  ...
  protected final String TEXT_921 = NL + "                        System.err.println(e.getMessage());";
  ...
  protected final String TEXT_927 = NL + "            int checkCount_";
  protected final String TEXT_928 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_929 = " = pstmt_";
  protected final String TEXT_930 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_931 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_932 = " = rs_";
  protected final String TEXT_933 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_934 = " > 0) {";
  protected final String TEXT_935 = NL + "            try {";
  ...
  protected final String TEXT_946 = NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_976 = ".toString().trim());";
  protected final String TEXT_977 = NL + "            try {";
  protected final String TEXT_978 = NL + "                    updatedCount_";
  protected final String TEXT_979 = " = updatedCount_";
  protected final String TEXT_980 = " + pstmtUpdate_";
  protected final String TEXT_981 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_982 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_983 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_1004 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_1005 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_1011 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1012 = ",";
  protected final String TEXT_1013 = ".";
  protected final String TEXT_1014 = ", ";
  protected final String TEXT_1015 = ",insertSQLSplits_";
  protected final String TEXT_1016 = ");" + NL + "                \t";
  protected final String TEXT_1017 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_1023 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1024 = "_QUERY\", query_";
  protected final String TEXT_1025 = ".toString().trim());";
  protected final String TEXT_1026 = NL + "            try {";
  protected final String TEXT_1027 = NL + "                    insertedCount_";
  protected final String TEXT_1028 = " = insertedCount_";
  protected final String TEXT_1029 = " + pstmtInsert_";
  protected final String TEXT_1030 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1031 = "++;";
  protected final String TEXT_1032 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1033 = " = true;";
  protected final String TEXT_1034 = NL + "                        throw(e);";
  protected final String TEXT_1035 = NL + "                    \tnb_line_";
  protected final String TEXT_1036 = "++;" + NL + "                    \t";
  protected final String TEXT_1037 = NL + "                            ";
  protected final String TEXT_1038 = " = new ";
  protected final String TEXT_1039 = "Struct();";
  ...
  protected final String TEXT_1045 = NL + "                            rejectedCount_";
  protected final String TEXT_1046 = " = rejectedCount_";
  protected final String TEXT_1047 = " + 1;";
  protected final String TEXT_1048 = NL + "                            ";
  protected final String TEXT_1049 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1050 = NL + "                            ";
  protected final String TEXT_1051 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1052 = ";";
  protected final String TEXT_1053 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_1054 = NL + "                }" + NL + "            }";
  protected final String TEXT_1055 = NL + "            int updateFlag_";
  protected final String TEXT_1056 = "=0;";
  protected final String TEXT_1057 = NL + "            try {";
  protected final String TEXT_1058 = NL + "                    ";
  protected final String TEXT_1059 = NL + "                        query_";
  protected final String TEXT_1060 = " = ";
  protected final String TEXT_1061 = ";";
  protected final String TEXT_1062 = NL + "\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1063 = ",";
  protected final String TEXT_1064 = ".";
  protected final String TEXT_1065 = ", ";
  protected final String TEXT_1066 = ",updateSQLSplits_";
  protected final String TEXT_1067 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_1068 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_1069 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_1096 = NL + "            try {";
  protected final String TEXT_1097 = NL + "                updateFlag_";
  protected final String TEXT_1098 = "=pstmtUpdate_";
  protected final String TEXT_1099 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_1100 = " = updatedCount_";
  protected final String TEXT_1101 = "+updateFlag_";
  protected final String TEXT_1102 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_1103 = " == 0) {" + NL + "            \t";
  protected final String TEXT_1104 = NL + "\t\t\t\tquery_";
  protected final String TEXT_1105 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_1106 = NL + "                        ";
  protected final String TEXT_1107 = NL + "                            query_";
  protected final String TEXT_1108 = " = ";
  protected final String TEXT_1109 = ";";
  protected final String TEXT_1110 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1111 = ",";
  protected final String TEXT_1112 = ".";
  protected final String TEXT_1113 = ", ";
  protected final String TEXT_1114 = ",insertSQLSplits_";
  protected final String TEXT_1115 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1116 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1117 = ".";
  protected final String TEXT_1118 = ", pstmtInsert_";
  ...
  protected final String TEXT_1125 = NL + "                    insertedCount_";
  protected final String TEXT_1126 = " = insertedCount_";
  protected final String TEXT_1127 = " + pstmtInsert_";
  protected final String TEXT_1128 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_1129 = "++;";
  protected final String TEXT_1130 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_1131 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_1132 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1133 = " = true;";
  protected final String TEXT_1134 = NL + "                        throw(e);";
  protected final String TEXT_1135 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_1145 = NL + "                            rejectedCount_";
  protected final String TEXT_1146 = " = rejectedCount_";
  protected final String TEXT_1147 = " + 1;";
  protected final String TEXT_1148 = NL + "                            ";
  protected final String TEXT_1149 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_1153 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_1154 = NL + "                }";
  protected final String TEXT_1155 = NL + "            try {";
  ...
  protected final String TEXT_1169 = NL + "    \t\tpstmt_";
  protected final String TEXT_1170 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_1171 = "++;" + NL + "\t\t\t";
  protected final String TEXT_1172 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_1173 = "++;" + NL + "    \t\t";
  protected final String TEXT_1174 = NL + "            try {";
  protected final String TEXT_1175 = NL + "                deletedCount_";
  protected final String TEXT_1176 = " = deletedCount_";
  protected final String TEXT_1177 = " + pstmt_";
  protected final String TEXT_1178 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1179 = "++;";
  protected final String TEXT_1180 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1181 = " = true;";
  protected final String TEXT_1182 = NL + "                    throw(e);";
  protected final String TEXT_1183 = NL + "                \tnb_line_";
  protected final String TEXT_1184 = "++;" + NL + "                \t";
  protected final String TEXT_1185 = NL + "                        ";
  protected final String TEXT_1186 = " = new ";
  protected final String TEXT_1187 = "Struct();";
  ...
  protected final String TEXT_1193 = NL + "                        rejectedCount_";
  protected final String TEXT_1194 = " = rejectedCount_";
  protected final String TEXT_1195 = " + 1;";
  protected final String TEXT_1196 = NL + "                        ";
  protected final String TEXT_1197 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1198 = NL + "                        ";
  protected final String TEXT_1199 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1200 = ";";
  protected final String TEXT_1201 = NL + "                        System.err.println(e.getMessage());";
  ...
  protected final String TEXT_1206 = NL + NL + "        java.sql.ResultSet rs_";
  protected final String TEXT_1207 = " = pstmt_";
  protected final String TEXT_1208 = ".executeQuery();" + NL + "        int checkCount_";
  protected final String TEXT_1209 = " = -1;" + NL + "        while(rs_";
  protected final String TEXT_1210 = ".next()) {" + NL + "            checkCount_";
  protected final String TEXT_1211 = " = rs_";
  protected final String TEXT_1212 = ".getInt(1);" + NL + "        }" + NL + "" + NL + "        if (checkCount_";
  protected final String TEXT_1213 = " < 1) {";
  protected final String TEXT_1214 = NL + "            try {";
  ...
  protected final String TEXT_1219 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_1225 = NL + "                globalMap.put(\"";
  protected final String TEXT_1226 = "_QUERY\", query_";
  protected final String TEXT_1227 = ".toString().trim());";
  protected final String TEXT_1228 = NL + "            try {";
  protected final String TEXT_1229 = NL + "                insertedCount_";
  protected final String TEXT_1230 = " = insertedCount_";
  protected final String TEXT_1231 = " + pstmtInsert_";
  protected final String TEXT_1232 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1233 = "++;";
  protected final String TEXT_1234 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\twhetherReject_";
  protected final String TEXT_1235 = " = true;";
  protected final String TEXT_1236 = NL + "                throw(e);";
  protected final String TEXT_1237 = NL + "            \tnb_line_";
  ...
  protected final String TEXT_1247 = NL + "                \trejectedCount_";
  protected final String TEXT_1248 = " = rejectedCount_";
  protected final String TEXT_1249 = " + 1;" + NL + "                \t";
  protected final String TEXT_1250 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1251 = NL + "                    ";
  protected final String TEXT_1252 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1253 = ";";
  protected final String TEXT_1254 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1255 = NL + "                }" + NL + "            }";
  protected final String TEXT_1256 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1267 = NL + "            \t//////////batch execute by batch size///////" + NL + "            \tclass LimitBytesHelper_";
  protected final String TEXT_1268 = "{" + NL + "            \t\tpublic int limitBytePart1(int counter,java.sql.PreparedStatement pstmt_";
  protected final String TEXT_1269 = ") throws Exception {" + NL + "                try {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1270 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1271 = ": pstmt_";
  protected final String TEXT_1272 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1273 = " == -2 || countEach_";
  protected final String TEXT_1274 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcounter += countEach_";
  protected final String TEXT_1275 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1276 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1277 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1278 = NL + "                \tint countSum_";
  protected final String TEXT_1279 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1280 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcounter += (countEach_";
  protected final String TEXT_1281 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1282 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t" + NL + "            \t    \t";
  protected final String TEXT_1283 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1284 = NL + "               \t\t\t }" + NL + "    \t\t\t\treturn counter;" + NL + "            \t}" + NL + "            \t" + NL + "            \tpublic int limitBytePart2(int counter,java.sql.PreparedStatement pstmt_";
  protected final String TEXT_1285 = ") throws Exception {" + NL + "                try {" + NL + "                \t\t";
  protected final String TEXT_1286 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1287 = ": pstmt_";
  protected final String TEXT_1288 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1289 = " == -2 || countEach_";
  protected final String TEXT_1290 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcounter += countEach_";
  protected final String TEXT_1291 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1292 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1293 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1294 = NL + "                \t" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1295 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcounter += (countEach_";
  protected final String TEXT_1296 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1297 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "            \t    \t";
  protected final String TEXT_1298 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1299 = NL + "                \t\t}\t" + NL + "                \treturn counter;\t" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_1300 = NL + "    \t\tif ((batchSize_";
  protected final String TEXT_1301 = " > 0) && (batchSize_";
  protected final String TEXT_1302 = " <= batchSizeCounter_";
  protected final String TEXT_1303 = ")) {" + NL + "    \t\t" + NL + "    \t\t            ";
  protected final String TEXT_1304 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1305 = " = new LimitBytesHelper_";
  protected final String TEXT_1306 = "().limitBytePart1(insertedCount_";
  protected final String TEXT_1307 = ",pstmt_";
  protected final String TEXT_1308 = ");" + NL + "            \t    \t";
  protected final String TEXT_1309 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1310 = " = new LimitBytesHelper_";
  protected final String TEXT_1311 = "().limitBytePart1(updatedCount_";
  protected final String TEXT_1312 = ",pstmt_";
  protected final String TEXT_1313 = ");" + NL + "            \t    \t";
  protected final String TEXT_1314 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1315 = " = new LimitBytesHelper_";
  protected final String TEXT_1316 = "().limitBytePart1(deletedCount_";
  protected final String TEXT_1317 = ",pstmt_";
  protected final String TEXT_1318 = ");" + NL + "            \t    \t";
  protected final String TEXT_1319 = NL + "    \t\t\t" + NL + "\t\t\t    batchSizeCounter_";
  protected final String TEXT_1320 = " = 0;" + NL + "\t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1321 = NL + NL + "    \t////////////commit every////////////" + NL + "    \t\t\t";
  protected final String TEXT_1322 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1323 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1324 = " <= commitCounter_";
  protected final String TEXT_1325 = ") {";
  protected final String TEXT_1326 = NL + "                if ((batchSize_";
  protected final String TEXT_1327 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1328 = " > 0)) {" + NL + "    \t\t            ";
  protected final String TEXT_1329 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1330 = " = new LimitBytesHelper_";
  protected final String TEXT_1331 = "().limitBytePart1(insertedCount_";
  protected final String TEXT_1332 = ",pstmt_";
  protected final String TEXT_1333 = ");" + NL + "            \t    \t";
  protected final String TEXT_1334 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1335 = " = new LimitBytesHelper_";
  protected final String TEXT_1336 = "().limitBytePart1(updatedCount_";
  protected final String TEXT_1337 = ",pstmt_";
  protected final String TEXT_1338 = ");" + NL + "            \t    \t";
  protected final String TEXT_1339 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1340 = " = new LimitBytesHelper_";
  protected final String TEXT_1341 = "().limitBytePart1(deletedCount_";
  protected final String TEXT_1342 = ",pstmt_";
  protected final String TEXT_1343 = ");" + NL + "            \t    \t";
  protected final String TEXT_1344 = NL + "            \tbatchSizeCounter_";
  protected final String TEXT_1345 = " = 0;" + NL + "            \t}";
  protected final String TEXT_1346 = NL + "                \t";
  protected final String TEXT_1347 = NL + "                \tconn_";
  protected final String TEXT_1348 = ".commit();" + NL + "            \t\t";
  protected final String TEXT_1349 = NL + "                \tcommitCounter_";
  protected final String TEXT_1350 = "=0;" + NL + "                }";
  protected final String TEXT_1351 = NL + "\t\tif (isShareIdentity_";
  protected final String TEXT_1352 = " ) {" + NL + "        \t stmt_";
  protected final String TEXT_1353 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_1354 = " +\"] OFF\");" + NL + "        }";
