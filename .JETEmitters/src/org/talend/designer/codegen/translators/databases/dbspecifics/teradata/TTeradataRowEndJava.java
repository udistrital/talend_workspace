...
public class TTeradataRowEndJava
{
  ...
  protected final String TEXT_115 = NL + "        stmt_";
  protected final String TEXT_116 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_117 = " +\" OFF\");" + NL + "\t";
  protected final String TEXT_118 = NL;
  protected final String TEXT_119 = NL + "\tpstmt_";
  protected final String TEXT_120 = ".close();" + NL + "\tresourceMap.remove(\"pstmt_";
  protected final String TEXT_121 = "\");";
  protected final String TEXT_122 = NL + "\tstmt_";
  protected final String TEXT_123 = ".close();" + NL + "\tresourceMap.remove(\"stmt_";
  ...
  protected final String TEXT_130 = NL + NL + "\t\t\tcommitCounter_";
  protected final String TEXT_131 = "=0;" + NL + "" + NL + "\t\t}";
  protected final String TEXT_132 = NL + "\t";
  protected final String TEXT_133 = NL;
  protected final String TEXT_134 = NL + "    conn_";
  protected final String TEXT_135 = ".setAutoCommit(true);" + NL + "    try{" + NL + "         conn_";
  protected final String TEXT_136 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_137 = NL + "                   try{" + NL + "                        conn_";
  protected final String TEXT_138 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_139 = ");" + NL + "                   }catch(Exception e){" + NL + "                         System.err.println(e.getMessage());" + NL + "                   }";
  protected final String TEXT_140 = NL + "     }catch(Exception e){";
  protected final String TEXT_141 = NL + "         System.err.println(e.getMessage());" + NL + "     }";
