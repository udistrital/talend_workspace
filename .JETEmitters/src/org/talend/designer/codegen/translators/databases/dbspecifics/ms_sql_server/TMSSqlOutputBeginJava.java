...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_516 = " = null;" + NL + "        String keyPsmt_";
  protected final String TEXT_517 = " = conn_";
  protected final String TEXT_518 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_519 = " + \"]\";" + NL + "        pstmt_";
  protected final String TEXT_520 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_521 = ",insert_";
  protected final String TEXT_522 = ",keyPsmt_";
  ...
  protected final String TEXT_533 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_549 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_555 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_556 = " = conn_";
  protected final String TEXT_557 = ".prepareStatement(update_";
  protected final String TEXT_558 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_559 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_565 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_566 = " = conn_";
  protected final String TEXT_567 = ".prepareStatement(update_";
  protected final String TEXT_568 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_569 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_577 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_578 = "\", pstmtInsert_";
  protected final String TEXT_579 = ");";
  protected final String TEXT_580 = NL + "        String delete_";
  protected final String TEXT_581 = " = \"DELETE FROM [\" + tableName_";
  ...
  protected final String TEXT_585 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_599 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_600 = " = conn_";
  protected final String TEXT_601 = ".prepareStatement(insert_";
  protected final String TEXT_602 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_603 = "\", pstmtInsert_";
  protected final String TEXT_604 = ");";
  protected final String TEXT_605 = NL + NL + "    class BufferLine_";
  protected final String TEXT_606 = " {";
  protected final String TEXT_607 = NL + "                ";
  protected final String TEXT_608 = " ";
  protected final String TEXT_609 = ";";
  protected final String TEXT_610 = NL + NL + "        public BufferLine_";
  ...
  protected final String TEXT_619 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_620 = "> sInsertColValueList";
  protected final String TEXT_621 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_622 = " sInsertColValue";
  protected final String TEXT_623 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_624 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_625 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_626 = ".append(\"(";
  protected final String TEXT_627 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_628 = "-1) extendInsertValueStmt_";
  protected final String TEXT_629 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_630 = " = \"INSERT INTO \"+";
  protected final String TEXT_631 = "+\" (";
  protected final String TEXT_632 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_633 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_634 = " =  conn_";
  protected final String TEXT_635 = ".prepareStatement(insert_";
  protected final String TEXT_636 = ");" + NL + "    resourceMap.put(\"pstmt_";
  protected final String TEXT_637 = "\", pstmt_";
  protected final String TEXT_638 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_639 = " = \"";
  protected final String TEXT_640 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_641 = " =  \"";
  protected final String TEXT_642 = "\";" + NL + "    int rowCount";
  ...
  protected final String TEXT_674 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_675 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_676 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_677 = "\") == true;";
  protected final String TEXT_678 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_679 = " = conn_";
  protected final String TEXT_680 = ".createStatement();";
  protected final String TEXT_681 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_682 = " ) {" + NL + "\t            stmt_";
  protected final String TEXT_683 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_684 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_685 = NL + "            stmt_";
  protected final String TEXT_686 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_687 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_688 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_689 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_690 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_691 = " =null;" + NL + "\t";
  protected final String TEXT_692 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_698 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_699 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_700 = " = null;";
  protected final String TEXT_701 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_702 = " = null;";
  protected final String TEXT_703 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_704 = " = null;";
  protected final String TEXT_705 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
