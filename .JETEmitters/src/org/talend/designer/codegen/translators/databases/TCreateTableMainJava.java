...
public class TCreateTableMainJava
{
  ...
  protected final String TEXT_125 = NL + "                    java.sql.PreparedStatement tempTablePs_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".prepareStatement(\"SELECT * FROM information_schema.tables WHERE table_type='LOCAL TEMPORARY' AND table_name = ?\");" + NL + "                    tempTablePs_";
  protected final String TEXT_128 = ".setString(1, ";
  protected final String TEXT_129 = ");" + NL + "                    java.sql.ResultSet rsTable_";
  protected final String TEXT_130 = " = tempTablePs_";
  protected final String TEXT_131 = ".executeQuery();" + NL + "                    whetherExist_";
  ...
  protected final String TEXT_138 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                    String defaultSchema_";
  protected final String TEXT_139 = " = \"public\";" + NL + "                    if(dbSchema_";
  protected final String TEXT_140 = " == null || dbSchema_";
  protected final String TEXT_141 = ".trim().length() == 0) {" + NL + "                        java.sql.Statement stmtSchema_";
  protected final String TEXT_142 = " = conn_";
  protected final String TEXT_143 = ".createStatement();" + NL + "                        java.sql.ResultSet rsSchema_";
  protected final String TEXT_144 = " = stmtSchema_";
  protected final String TEXT_145 = ".executeQuery(\"select current_schema() \");" + NL + "                        while(rsSchema_";
  protected final String TEXT_146 = ".next()){" + NL + "                            defaultSchema_";
  protected final String TEXT_147 = " = rsSchema_";
  protected final String TEXT_148 = ".getString(\"current_schema\");" + NL + "                        }" + NL + "                        rsSchema_";
  protected final String TEXT_149 = ".close();" + NL + "                        stmtSchema_";
  protected final String TEXT_150 = ".close();" + NL + "                    }" + NL + "                    while(rsTable_";
  ...
  protected final String TEXT_165 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_171 = NL + "                java.sql.Statement rsTable_";
  protected final String TEXT_172 = " = conn_";
  protected final String TEXT_173 = ".createStatement();" + NL + "                try {" + NL + "                    rsTable_";
  protected final String TEXT_174 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_175 = " + \"]\" );" + NL + "                    whetherExist_";
  protected final String TEXT_176 = " = true;" + NL + "                } catch (Exception e){" + NL + "                    whetherExist_";
  protected final String TEXT_177 = " = false;" + NL + "                }";
  ...
  protected final String TEXT_182 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_191 = ") " + NL + "\t                \t&& (schema_";
  ...
  protected final String TEXT_196 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_197 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + NL;
  protected final String TEXT_198 = NL + "\t\t\t\t\t\tString dbUser_";
  protected final String TEXT_199 = " = (String) globalMap.get(\"username_";
  ...
  protected final String TEXT_205 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_217 = "(dbname_";
  protected final String TEXT_218 = ") || (dbname_";
  protected final String TEXT_219 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_220 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_221 = ")))) {" + NL + "\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_222 = " = true;" + NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL;
  ...
  protected final String TEXT_228 = ".getCatalog(), conn_";
  protected final String TEXT_229 = ".getSchema(),(";
  protected final String TEXT_230 = ")";
  protected final String TEXT_231 = ", new String[] { \"TABLE\" });" + NL + "\t            if(rsTable_";
  ...
  protected final String TEXT_241 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_246 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }     ";
  protected final String TEXT_247 = NL + "            rsTable_";
  protected final String TEXT_248 = ".close();";
  protected final String TEXT_249 = NL + "                if(!whetherExist_";
  protected final String TEXT_250 = ") {" + NL + "                    java.sql.Statement stmt_";
  ...
  protected final String TEXT_254 = " - Creating table '\" + tableName_";
  protected final String TEXT_255 = " + \"'.\");";
  protected final String TEXT_256 = NL + "                    stmt_";
  protected final String TEXT_257 = ".execute(\"";
  protected final String TEXT_258 = "\");                ";
  protected final String TEXT_259 = NL + "                        log.info(\"";
  protected final String TEXT_260 = " - Create table '\" + tableName_";
  protected final String TEXT_261 = " + \"' has succeeded.\");";
  ...
  protected final String TEXT_269 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_275 = " - Drop table '\" + tableName_";
  protected final String TEXT_276 = " + \"' has succeeded.\");";
  protected final String TEXT_277 = NL + "                }" + NL + "                java.sql.Statement stmt_";
  ...
  protected final String TEXT_281 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_288 = " + \"' has succeeded.\");";
  protected final String TEXT_289 = NL + "\t            ";
  protected final String TEXT_290 = NL + "        ";
  protected final String TEXT_291 = NL + "        globalMap.put(\"";
  protected final String TEXT_292 = "_QUERY\", \"";
  protected final String TEXT_293 = "\");        " + NL + "    } catch(java.lang.Exception e) {" + NL + "        globalMap.put(\"";
  protected final String TEXT_294 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "        throw new RuntimeException(\"Creating table failed\", e);" + NL + "    }";
