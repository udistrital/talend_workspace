...
public class TEXAOutputBeginJava {
  ...
  protected final String TEXT_344 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_352 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_372 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_385 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_393 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_394 = ".";
  protected final String TEXT_395 = ", \"";
  protected final String TEXT_396 = "\")";
  protected final String TEXT_397 = ".toUpperCase()";
  ...
  protected final String TEXT_404 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_405 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_406 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_417 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_418 = " = conn_";
  protected final String TEXT_419 = ".createStatement()) {";
  protected final String TEXT_420 = NL + "                              stmtTruncCount_";
  protected final String TEXT_421 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_422 = "));";
  protected final String TEXT_423 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_424 = " = stmtTruncCount_";
  protected final String TEXT_425 = ".executeQuery(\"";
  protected final String TEXT_426 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_427 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_428 = " = rsTruncCount_";
  protected final String TEXT_429 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_446 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_447 = " = conn_";
  protected final String TEXT_448 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_449 = " = stmtTruncCount_";
  protected final String TEXT_450 = ".executeQuery(\"";
  protected final String TEXT_451 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_462 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_487 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_502 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_503 = " = conn_";
  protected final String TEXT_504 = ".prepareStatement(update_";
  protected final String TEXT_505 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_536 = NL + "        StringBuffer query_";
  protected final String TEXT_537 = " = null;";
  protected final String TEXT_538 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_546 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_547 = " = update_";
  protected final String TEXT_548 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_549 = " = insert_";
  protected final String TEXT_550 = ".split(\"\\\\?\");";
  protected final String TEXT_551 = NL + "\t\t\tdelete_";
  protected final String TEXT_552 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_553 = " = delete_";
  protected final String TEXT_554 = ".split(\"\\\\?\");";
  protected final String TEXT_555 = NL + "\t\t\treplace_";
  protected final String TEXT_556 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_557 = " = replace_";
  protected final String TEXT_558 = ".split(\"\\\\?\");";
  protected final String TEXT_559 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_560 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_561 = " = insertIgnore_";
