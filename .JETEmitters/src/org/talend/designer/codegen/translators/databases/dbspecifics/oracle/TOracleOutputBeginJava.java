...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_393 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_399 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_400 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_401 = " = rsTable_";
  protected final String TEXT_402 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_403 = ".equalsIgnoreCase(";
  protected final String TEXT_404 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_405 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_406 = NL + "                                if(!whetherExist_";
  protected final String TEXT_407 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_427 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_440 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_448 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_455 = NL + "                                    stmtCreate_";
  protected final String TEXT_456 = ".execute(\"";
  ...
  protected final String TEXT_461 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_472 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_478 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_479 = " = stmtTruncCount_";
  protected final String TEXT_480 = ".executeQuery(\"";
  protected final String TEXT_481 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_482 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_483 = " = rsTruncCount_";
  protected final String TEXT_484 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_501 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_517 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_539 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_540 = " = conn_";
  protected final String TEXT_541 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_542 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_543 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_544 = ",insert_";
  protected final String TEXT_545 = ",keyPsmt_";
  ...
  protected final String TEXT_570 = "\");" + NL + "                resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_585 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_586 = " = conn_";
  protected final String TEXT_587 = ".prepareStatement(insert_";
  protected final String TEXT_588 = ");" + NL + "                resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_625 = ");" + NL + "                resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_643 = ");" + NL + "                resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_644 = "\", pstmtInsert_";
  protected final String TEXT_645 = ");";
  protected final String TEXT_646 = NL + "                String delete_";
  protected final String TEXT_647 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_648 = " + \" WHERE ";
  protected final String TEXT_649 = "\";";
  protected final String TEXT_650 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_651 = " = new StringBuffer(delete_";
  protected final String TEXT_652 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_653 = ".insert(delete_";
  protected final String TEXT_654 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_655 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_656 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_661 = ");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_662 = "\", pstmt_";
  protected final String TEXT_663 = ");";
  protected final String TEXT_664 = NL + "                StringBuffer query_";
  protected final String TEXT_665 = " = null;";
  protected final String TEXT_666 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_667 = " = insert_";
  protected final String TEXT_668 = ".split(\"\\\\?\");";
  protected final String TEXT_669 = NL + "\t\t\tupdate_";
  protected final String TEXT_670 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_671 = " = update_";
  protected final String TEXT_672 = ".split(\"\\\\?\");";
  protected final String TEXT_673 = NL + "\t\t\tupdate_";
  protected final String TEXT_674 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_675 = " = update_";
  protected final String TEXT_676 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_677 = " = insert_";
  protected final String TEXT_678 = ".split(\"\\\\?\");";
  protected final String TEXT_679 = NL + "\t\t\tdelete_";
  protected final String TEXT_680 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_681 = " = delete_";
  protected final String TEXT_682 = ".split(\"\\\\?\");";
  protected final String TEXT_683 = NL + "\t\t\treplace_";
  protected final String TEXT_684 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_685 = " = replace_";
  protected final String TEXT_686 = ".split(\"\\\\?\");";
  protected final String TEXT_687 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_688 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_689 = " = insertIgnore_";
  ...
  protected final String TEXT_694 = NL + "                // Initialize SRID" + NL + "                int SRID_";
  protected final String TEXT_695 = " = 0;" + NL + "                int dimension_";
  protected final String TEXT_696 = " = 0;" + NL + "                boolean firstGeometry_";
  protected final String TEXT_697 = " = true;";
  protected final String TEXT_698 = NL + NL + "        class ClobTypeUtil_";
  protected final String TEXT_699 = " {" + NL + "            public Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "                oracle.sql.CLOB tempClob = null;" + NL + "                try{" + NL + "                    // If the temporary CLOB has not yet been created, create one" + NL + "                    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "                    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "                    tempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "                    // Get the output stream to write" + NL + "                    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "                    if(data instanceof java.sql.Clob) {" + NL + "                        java.sql.Clob inClob = (java.sql.Clob) data;" + NL + "                        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "                        char[] chs = new char[128];" + NL + "                        int len = 0;" + NL + "                        while ((len = inReader.read(chs)) != -1) {" + NL + "                            tempClobWriter.write(chs, 0, len);" + NL + "                        }" + NL + "                    }else if(data instanceof String) {" + NL + "                       // Write the data into the temporary CLOB" + NL + "                        tempClobWriter.write((String)data);" + NL + "                    }else{" + NL + "                        return data;" + NL + "                    }" + NL + "                    // Flush and close the stream" + NL + "                    tempClobWriter.flush();" + NL + "                    tempClobWriter.close();" + NL + "                    // Close the temporary CLOB" + NL + "                    tempClob.close();" + NL + "                } catch( java.sql.SQLException sqlexp){";
  protected final String TEXT_700 = NL + "                    tempClob.freeTemporary();" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_701 = NL + "                    tempClob.freeTemporary();" + NL + "                    exp.printStackTrace();" + NL + "                }" + NL + "                return tempClob;" + NL + "            }" + NL + "        }" + NL + "        ClobTypeUtil_";
  protected final String TEXT_702 = " clobTypeUtil_";
  protected final String TEXT_703 = "=new ClobTypeUtil_";
  protected final String TEXT_704 = "();";
  protected final String TEXT_705 = NL + NL + "        class BlobTypeUtil_";
  protected final String TEXT_706 = " {" + NL + "            public Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "                if(!(data instanceof java.sql.Blob) || (data instanceof oracle.sql.BLOB)) {" + NL + "                \treturn data;" + NL + "                }" + NL + "" + NL + "                oracle.sql.BLOB blob = null;" + NL + "                java.io.InputStream in = null;" + NL + "                java.io.OutputStream out = null;" + NL + "                try{" + NL + "                \t//in" + NL + "                \tjava.sql.Blob blobData = (java.sql.Blob) data;" + NL + "                \tin = blobData.getBinaryStream();" + NL + "" + NL + "                \t//out" + NL + "                \tblob = oracle.sql.BLOB.createTemporary(conn, true, oracle.sql.BLOB.DURATION_SESSION);" + NL + "                    blob.open(oracle.sql.BLOB.MODE_READWRITE);" + NL + "                    //blob = conn.createBlob(); oracle jdbc don't support it" + NL + "                \tout = blob.setBinaryStream(1);" + NL + "" + NL + "                    byte[] cache = new byte[8192];" + NL + "                    int len = 0;" + NL + "                    while ((len = in.read(cache)) != -1) {" + NL + "                        out.write(cache, 0, len);" + NL + "                    }" + NL + "" + NL + "                    return blob;" + NL + "                } catch(java.sql.SQLException sqlexp){";
  protected final String TEXT_707 = NL + "                \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_708 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_709 = NL + "                   \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_710 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    exp.printStackTrace();" + NL + "                } finally {" + NL + "                \tif(out!=null) {" + NL + "                \t\ttry {" + NL + "                \t\t\tout.flush();" + NL + "                    \t\tout.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_711 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "            \t \tif(in!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tin.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_712 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "                    if(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.close();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_713 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                return null;" + NL + "" + NL + "            }" + NL + "" + NL + "        }" + NL + "        BlobTypeUtil_";
  protected final String TEXT_714 = " blobTypeUtil_";
  protected final String TEXT_715 = "=new BlobTypeUtil_";
  protected final String TEXT_716 = "();";
  protected final String TEXT_717 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_718 = " =null;" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_719 = " =null;" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_720 = " =null;";
  protected final String TEXT_721 = NL + "            StringBuffer query_";
  protected final String TEXT_722 = " = null;";
  protected final String TEXT_723 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_724 = " = null;";
  protected final String TEXT_725 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_726 = " =  null;";
  protected final String TEXT_727 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_728 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_729 = " = null;";
  protected final String TEXT_730 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_731 = " = null;";
  protected final String TEXT_732 = NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_738 = NL + NL + NL + NL;
