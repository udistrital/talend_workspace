...
public class TInterbaseRowBeginJava
{
  ...
  protected final String TEXT_131 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_136 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_137 = "\", stmt_";
