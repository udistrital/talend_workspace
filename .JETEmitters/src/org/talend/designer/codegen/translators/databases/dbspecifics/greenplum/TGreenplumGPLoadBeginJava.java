...
public class TGreenplumGPLoadBeginJava {
  ...
  protected final String TEXT_97 = " = \"org.postgresql.Driver\";" + NL + "\t\t\tString url_";
  protected final String TEXT_98 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_99 = " + \":\" + ";
  protected final String TEXT_100 = " + \"/\" + ";
  protected final String TEXT_101 = ";" + NL + "\t\t";
  protected final String TEXT_102 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_103 = " = \"com.pivotal.jdbc.GreenplumDriver\";" + NL + "\t\t\tString url_";
  protected final String TEXT_104 = " = \"jdbc:pivotal:greenplum://\"+";
  protected final String TEXT_105 = "+\":\"+";
  protected final String TEXT_106 = "+\";DatabaseName=\"+";
  protected final String TEXT_107 = ";" + NL + "\t\t";
  protected final String TEXT_108 = NL + "\t\t" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_130 = ";" + NL + "\t        \t\t" + NL + "\t\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_145 = " =  null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_157 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_158 = "){" + NL + "\t\t\t\t\tthrow new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_159 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_160 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_161 = " - Table '\" + tableName4Load_";
  protected final String TEXT_162 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_163 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_164 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_165 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_169 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_175 = " - Create table '\" + tableName_";
  protected final String TEXT_176 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_177 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_178 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_179 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_180 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_181 = " - Table '\" + tableName4Load_";
  protected final String TEXT_182 = " + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_183 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_189 = " = false;" + NL + "\t\t\tString defaultSchema_";
  protected final String TEXT_190 = " = \"public\";" + NL + "\t\t\tif(dbschema_";
  protected final String TEXT_191 = " == null || dbschema_";
  protected final String TEXT_192 = ".trim().length() == 0) {" + NL + "\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".createStatement();" + NL + "\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_195 = " = stmtSchema_";
  protected final String TEXT_196 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\twhile(rsSchema_";
  protected final String TEXT_197 = ".next()){" + NL + "\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_198 = " = rsSchema_";
  protected final String TEXT_199 = ".getString(\"current_schema\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsSchema_";
  protected final String TEXT_200 = ".close();" + NL + "\t\t\t\tstmtSchema_";
  protected final String TEXT_201 = ".close();" + NL + "\t\t\t}" + NL + "\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_208 = ") && (schema_";
  protected final String TEXT_209 = ".equals(dbschema_";
  protected final String TEXT_210 = ") || ((dbschema_";
  protected final String TEXT_211 = "==null || dbschema_";
  protected final String TEXT_212 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_213 = ".equals(schema_";
  protected final String TEXT_214 = ")))) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_215 = " = true;" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_216 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_217 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_218 = " = null;" + NL + "\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_222 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_228 = " - Create table '\" + tableName_";
  protected final String TEXT_229 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_230 = " " + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_231 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_232 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_233 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_234 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_235 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_237 = NL + "                if(whetherExist_";
  protected final String TEXT_238 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_239 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  ...
  protected final String TEXT_243 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_249 = " - Drop table '\" + tableName_";
  protected final String TEXT_250 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_251 = NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_252 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_253 = "  + \"'. process terminated.\");" + NL + "                    \t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_254 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_255 = " - Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_256 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_257 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_258 = " = null;" + NL + "                try{" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_262 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_268 = " - Create table '\" + tableName_";
  protected final String TEXT_269 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_270 = "           " + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_271 = "){" + NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_272 = "  + \"'. process terminated.\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_273 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_274 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_275 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_276 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_277 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_278 = " = conn_";
  protected final String TEXT_279 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_280 = " = stmtClearCount_";
  protected final String TEXT_281 = ".executeQuery(\"";
  protected final String TEXT_282 = "\");" + NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_286 = " - Truncating table '\" + tableName_";
  protected final String TEXT_287 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_288 = NL + "            stmtClear_";
  protected final String TEXT_289 = ".executeUpdate(\"";
  protected final String TEXT_290 = "\");" + NL + "\t\t\t";
  protected final String TEXT_291 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_292 = " - Truncate table '\" + tableName_";
  protected final String TEXT_293 = " + \"' has succeeded.\" );" + NL + "\t\t\t";
  protected final String TEXT_294 = NL + "            while(rsClearCount_";
  protected final String TEXT_295 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_296 = " = rsClearCount_";
  protected final String TEXT_297 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_298 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_299 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  ...
  protected final String TEXT_303 = " - Clearing table '\" + tableName_";
  protected final String TEXT_304 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_305 = NL + "            \tdeletedCount_";
  protected final String TEXT_306 = " = stmtClear_";
  protected final String TEXT_307 = ".executeUpdate(\"";
  protected final String TEXT_308 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_309 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_310 = "- Clear table '\" + tableName_";
  protected final String TEXT_311 = " +  \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_312 = NL + "            \tstmtClear_";
  protected final String TEXT_313 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_314 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_315 = "  + \"'. process terminated.\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_316 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_317 = " - Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_318 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_319 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_320 = NL;
  protected final String TEXT_321 = NL + "\t\tString gploadCtrlFile = ";
  protected final String TEXT_322 = ";" + NL + "\t\t";
  protected final String TEXT_323 = NL + "\t\tString gploadCtrlFile = \"gp_ctrl_\" + \"";
  protected final String TEXT_324 = "\" + pid + Thread.currentThread().getId() + \".txt\";" + NL + "" + NL + "\t\tString delim_";
  protected final String TEXT_325 = " = ";
  protected final String TEXT_326 = ";" + NL + "\t\tString escape_";
  protected final String TEXT_327 = " = ";
  protected final String TEXT_328 = ";" + NL + "\t\tString quote_";
  protected final String TEXT_329 = " = ";
  protected final String TEXT_330 = ";" + NL + "\t\tdelim_";
  protected final String TEXT_331 = " = \"\\t\".equals(delim_";
  protected final String TEXT_332 = ") ? \"\\\\t\" : delim_";
  protected final String TEXT_333 = ";" + NL + "\t\t" + NL + "\t\ttry (java.io.PrintWriter gpctrl_";
  protected final String TEXT_334 = " = new java.io.PrintWriter(new java.io.FileOutputStream(gploadCtrlFile, false), true)){" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_335 = ".println(\"---\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_336 = ".println(\"VERSION: 1.0.0.1\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_337 = ".println(\"DATABASE: \" + ";
  protected final String TEXT_338 = ");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_339 = ".println(\"USER: \" + ";
  protected final String TEXT_340 = ");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_341 = ".println(\"HOST: \" + ";
  protected final String TEXT_342 = ");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_343 = ".println(\"PORT: \" + ";
  protected final String TEXT_344 = ");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_345 = ".println(\"GPLOAD:\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_346 = ".println(\"  INPUT:\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_347 = ".println(\"    - SOURCE:\");" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_348 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_349 = ".println(\"        LOCAL_HOSTNAME:\");" + NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_350 = ".println(\"          - \" + ";
  protected final String TEXT_351 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_352 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_353 = ".println(\"        PORT: \" + ";
  protected final String TEXT_354 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_356 = ".println(\"        PORT_RANGE: [\" + ";
  protected final String TEXT_357 = " + \"]\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_358 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_359 = ".println(\"        SSL: \" + ";
  protected final String TEXT_360 = " );" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_361 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_362 = ".println(\"        CERTIFICATES_PATH: \" + ";
  protected final String TEXT_363 = " );" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_365 = ".println(\"        FILE:\");" + NL + "\t\t\t";
  protected final String TEXT_366 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_367 = ".println(\"          - \" + (new com.infobright.io.NamedPipeFactory()).getNativePipeName(";
  protected final String TEXT_368 = "));" + NL + "\t\t\t";
  protected final String TEXT_369 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_370 = ".println(\"          - \" + ";
  protected final String TEXT_371 = ");" + NL + "\t\t\t";
  protected final String TEXT_372 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_373 = ".println(\"    - DELIMITER: '\" + delim_";
  protected final String TEXT_374 = " + \"'\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_375 = ".println(\"    - ESCAPE: '\" + escape_";
  protected final String TEXT_376 = " + \"'\");" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_378 = ".println(\"    - NULL_AS: '\" + ";
  protected final String TEXT_379 = " + \"'\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_381 = ".println(\"    - FORCE_NOT_NULL: \" + ";
  protected final String TEXT_382 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_383 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_384 = ".println(\"    - ERROR_LIMIT: \" + ";
  protected final String TEXT_385 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_387 = ".println(\"    - ERROR_TABLE: '\" + ";
  protected final String TEXT_388 = " + \"'\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_389 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_391 = ".println(\"    - FORMAT: csv\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_392 = ".println(\"    - QUOTE: '\" + quote_";
  protected final String TEXT_393 = " + \"'\");" + NL + "\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_395 = ".println(\"    - FORMAT: text\");" + NL + "\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\t";
  protected final String TEXT_397 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_398 = ".println(\"    - HEADER: true\");" + NL + "\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_400 = ".println(\"    - ENCODING: \" + ";
  protected final String TEXT_401 = ");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_402 = ".println(\"  OUTPUT: \");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_403 = ".println(\"    - TABLE: '\" + tableName4Load_";
  protected final String TEXT_404 = "+\"'\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_405 = ".println(\"    - MODE: ";
  protected final String TEXT_406 = "\");" + NL + "\t\t\t";
  protected final String TEXT_407 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_408 = ".println(\"    - MATCH_COLUMNS:\");" + NL + "\t\t\t\t";
  protected final String TEXT_409 = NL + "\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_410 = ".println(\"      - ";
  protected final String TEXT_411 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_412 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_413 = ".println(\"    - UPDATE_COLUMNS:\");" + NL + "\t\t\t\t";
  protected final String TEXT_414 = NL + "\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_415 = ".println(\"      - ";
  protected final String TEXT_416 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t\tgpctrl_";
  protected final String TEXT_418 = ".println(\"    - UPDATE_CONDITION: \" + ";
  protected final String TEXT_419 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_420 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_421 = NL;
  protected final String TEXT_422 = NL + NL + "\tfinal StringBuilder gploadOutput_";
  protected final String TEXT_423 = " = new StringBuilder(200);" + NL + "\tThread gploadThread_";
  protected final String TEXT_424 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] cmds = new String[] {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_425 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_426 = "," + NL + "\t\t\t\t\t\t";
  protected final String TEXT_427 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_428 = NL + "\t\t\t\t\t\t, \"-f\", gploadCtrlFile" + NL + "\t\t\t\t";
  protected final String TEXT_429 = ",";
  protected final String TEXT_430 = NL + "\t\t\t\t};" + NL + "\t\t\t\tfinal Process ps = Runtime.getRuntime().exec(cmds);" + NL + "\t\t\t\t" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tgploadOutput_";
  protected final String TEXT_431 = ".append(line);" + NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_432 = "_GPLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL;
  protected final String TEXT_433 = NL + "\t\tStringBuffer command_";
  protected final String TEXT_434 = " = new StringBuffer(";
  protected final String TEXT_435 = ");" + NL + "\t\t";
  protected final String TEXT_436 = NL + "\t\t\tcommand_";
  protected final String TEXT_437 = ".append(";
  protected final String TEXT_438 = " +\" \");" + NL + "\t\t";
  protected final String TEXT_439 = NL + "\t";
  protected final String TEXT_440 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_441 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_442 = ", true, true, 1024000, 10000);" + NL + "\t\t\tgploadThread_";
  protected final String TEXT_443 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by gpload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_444 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_445 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_446 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_447 = NL + "\t\t";
  protected final String TEXT_448 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_449 = " - Executing '\"+command_";
  protected final String TEXT_450 = ".toString()+\"'.\");" + NL + "\t\t";
  protected final String TEXT_451 = NL + "\tgploadThread_";
  protected final String TEXT_452 = ".start();" + NL + "\tgploadThread_";
  protected final String TEXT_453 = ".join(0);" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_454 = "_GPLOAD_OUTPUT\", gploadOutput_";
  protected final String TEXT_455 = ".toString());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_456 = "_NB_LINE\", insertedCount_";
  protected final String TEXT_457 = ");" + NL + "\t\t";
  protected final String TEXT_458 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_459 = " - Execute '\"+command_";
  protected final String TEXT_460 = ".toString()+\"' has finished.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_461 = " - Loaded records count:\" + insertedCount_";
