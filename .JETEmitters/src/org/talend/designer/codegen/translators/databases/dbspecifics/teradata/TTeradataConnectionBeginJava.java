...
public class TTeradataConnectionBeginJava
{
  ...
  protected final String TEXT_87 = NL + NL + "\tString dbUser_";
  protected final String TEXT_88 = " = ";
  protected final String TEXT_89 = ";";
  protected final String TEXT_90 = NL + "\t" + NL + "\t";
  protected final String TEXT_91 = NL + "\t\tString dbPwd_";
  ...
  protected final String TEXT_103 = NL + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_104 = " = null;" + NL + "\t";
  protected final String TEXT_105 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_106 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_108 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_109 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_110 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_111 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_112 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_113 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_114 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_115 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_116 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_117 = " - Written records count: \" + nb_line_";
  protected final String TEXT_118 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_120 = " = new StringBuffer();" + NL + "\t\t\t";
  ...
  protected final String TEXT_125 = " - Writing the record \" + nb_line_";
  protected final String TEXT_126 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_128 = " - Processing the record \" + nb_line_";
  ...
  protected final String TEXT_134 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_135 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_137 = " - Uses an existing connection ";
  protected final String TEXT_138 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_140 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_141 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_142 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_149 = NL + "\t\t\tconn_";
  protected final String TEXT_150 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\tconn_";
  protected final String TEXT_152 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\tconn_";
  protected final String TEXT_154 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t\tconn_";
  protected final String TEXT_156 = ".setAutoCommit(";
  protected final String TEXT_157 = ");" + NL + "\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\tlog.";
  protected final String TEXT_159 = "(\"";
  protected final String TEXT_160 = " - \" + ";
  protected final String TEXT_161 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_162 = NL + "\t    \t\tlog.";
  protected final String TEXT_163 = "(\"";
  protected final String TEXT_164 = "\");" + NL + "\t\t\t";
  protected final String TEXT_165 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_166 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_167 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_168 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_169 = ": pstmt_";
  protected final String TEXT_170 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_171 = " += (countEach_";
  protected final String TEXT_172 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_176 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_177 = " == null) {";
  protected final String TEXT_178 = NL + "\t\t";
  protected final String TEXT_179 = NL + "\t\t";
  protected final String TEXT_180 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_181 = "\", conn_";
  protected final String TEXT_182 = ");";
  protected final String TEXT_183 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_184 = " = ";
  protected final String TEXT_185 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_186 = ".get(dsAlias_";
  protected final String TEXT_187 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_188 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_189 = " = dataSources_";
  protected final String TEXT_190 = ".get(dsAlias_";
  protected final String TEXT_191 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_192 = "\", conn_";
  protected final String TEXT_193 = ");" + NL + "\t}";
  protected final String TEXT_194 = NL + "\tif (null != conn_";
  protected final String TEXT_195 = ") {" + NL + "\t\t";
  protected final String TEXT_196 = NL + "\t}";
  protected final String TEXT_197 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_198 = "\",conn_";
  protected final String TEXT_199 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_200 = "\", ";
  protected final String TEXT_201 = ");" + NL + "\tglobalMap.put(\"dbname_";
  protected final String TEXT_202 = "\", ";
  protected final String TEXT_203 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_204 = "\", dbUser_";
  protected final String TEXT_205 = ");" + NL + "\tglobalMap.put(\"password_";
  protected final String TEXT_206 = "\", dbPwd_";
  protected final String TEXT_207 = ");" + NL + "\tglobalMap.put(\"url_";
  protected final String TEXT_208 = "\", url_";
