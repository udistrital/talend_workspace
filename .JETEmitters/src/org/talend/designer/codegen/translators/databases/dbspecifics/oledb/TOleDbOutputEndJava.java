...
public class TOleDbOutputEndJava
{
  ...
  protected final String TEXT_48 = ".invoke(\"Close\");" + NL + "\t";
  protected final String TEXT_49 = NL + "\t";
  protected final String TEXT_50 = NL + "\tnb_line_deleted_";
  protected final String TEXT_51 = "=nb_line_deleted_";
  protected final String TEXT_52 = "+ deletedCount_";
  protected final String TEXT_53 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_54 = "=nb_line_update_";
  protected final String TEXT_55 = " + updatedCount_";
  protected final String TEXT_56 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_57 = "=nb_line_inserted_";
  protected final String TEXT_58 = " + insertedCount_";
  protected final String TEXT_59 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_60 = "=nb_line_rejected_";
  protected final String TEXT_61 = " + rejectedCount_";
  protected final String TEXT_62 = ";" + NL + "\t";
  protected final String TEXT_63 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_64 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_65 = "_NB_LINE\",nb_line_";
  protected final String TEXT_66 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_67 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_68 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_69 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_70 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_71 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_72 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_73 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_74 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_75 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_76 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_77 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_78 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_79 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_80 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_81 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_82 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_83 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_84 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_85 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_86 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_87 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_88 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_91 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_92 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_93 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_94 = NL + "        globalMap.put(\"";
  protected final String TEXT_95 = "_NB_LINE\",nb_line_";
  protected final String TEXT_96 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_97 = "_NB_LINE_UPDATED\",nb_line_update_";
  ...
  protected final String TEXT_103 = "_NB_LINE_REJECTED\", nb_line_rejected_";
