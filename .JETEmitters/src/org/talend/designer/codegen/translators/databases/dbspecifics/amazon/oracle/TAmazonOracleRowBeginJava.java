...
public class TAmazonOracleRowBeginJava
{
  ...
  protected final String TEXT_164 = NL + "\t\tint nb_line_inserted_";
  protected final String TEXT_165 = " = 0;";
  protected final String TEXT_166 = NL + "\t\tint nb_line_update_";
  protected final String TEXT_167 = " = 0;";
  protected final String TEXT_168 = NL + "\t\tint nb_line_deleted_";
