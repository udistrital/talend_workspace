...
public class TVerticaBulkExecBeginJava {
  ...
  protected final String TEXT_72 = " = null;" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_80 = " = \"com.vertica.Driver\";" + NL + "\t\t";
  protected final String TEXT_81 = NL + "\t \t\tString driverClass_";
  protected final String TEXT_82 = " = \"com.vertica.jdbc.Driver\";" + NL + "\t\t";
  protected final String TEXT_83 = NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_84 = ").newInstance();" + NL + "\t\t" + NL + "\t\t";
  ...
  protected final String TEXT_104 = NL + "\t   \t" + NL + "\t\tdbschema_";
  ...
  protected final String TEXT_111 = NL + "\tif(dbschema_";
  protected final String TEXT_112 = " == null || dbschema_";
  protected final String TEXT_113 = ".trim().length() == 0) {" + NL + "\t    tableName_";
  protected final String TEXT_114 = " = ";
  protected final String TEXT_115 = ";" + NL + "\t} else {" + NL + "\t    tableName_";
  ...
  protected final String TEXT_123 = " - Droping table ";
  protected final String TEXT_124 = "\" + tableName_";
  ...
  protected final String TEXT_131 = " - Drop table ";
  ...
  protected final String TEXT_140 = " - Creating table ";
  ...
  protected final String TEXT_148 = " - Create table ";
  ...
  protected final String TEXT_175 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_176 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_177 = " = tableNameForSearch_";
  protected final String TEXT_178 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_179 = " = tableNameForSearch_";
  protected final String TEXT_180 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_181 = " = dbMetaData_";
  protected final String TEXT_182 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_183 = ", tableNameForSearch_";
  protected final String TEXT_184 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_185 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_186 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_187 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_197 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_198 = " = rsTable_";
  protected final String TEXT_199 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_200 = ".equalsIgnoreCase(";
  protected final String TEXT_201 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_202 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_203 = ") || dbschema_";
  protected final String TEXT_204 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_215 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_219 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_220 = ".equals(schema_";
  protected final String TEXT_221 = ") || (schema_";
  protected final String TEXT_222 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_223 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_232 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_233 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_234 = " == null || dbschema_";
  protected final String TEXT_235 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_236 = " = conn_";
  protected final String TEXT_237 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_238 = " = stmtSchema_";
  protected final String TEXT_239 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_240 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_241 = " = rsSchema_";
  protected final String TEXT_242 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_243 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_244 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_245 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_246 = " = rsTable_";
  protected final String TEXT_247 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_248 = " = rsTable_";
  protected final String TEXT_249 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_250 = ".equals";
  protected final String TEXT_251 = "IgnoreCase";
  protected final String TEXT_252 = "(";
  protected final String TEXT_253 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  ...
  protected final String TEXT_262 = "(schema_";
  ...
  protected final String TEXT_266 = NL + "            \tString tableForSearch_";
  protected final String TEXT_267 = " = ";
  protected final String TEXT_268 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_269 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_270 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_271 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_272 = " =  tableForSearch_";
  protected final String TEXT_273 = ".substring(1,tableForSearch_";
  protected final String TEXT_274 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_275 = " =  tableForSearch_";
  protected final String TEXT_276 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_280 = ".getTables(null, conn_";
  protected final String TEXT_281 = ".getSchema(), tableForSearch_";
  protected final String TEXT_282 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_283 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_284 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_285 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_291 = ".getTables(null, dbschema_";
  protected final String TEXT_292 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_293 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_294 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_295 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_307 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_314 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_315 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_319 = " - Creating table ";
  ...
  protected final String TEXT_327 = " - Create table ";
  ...
  protected final String TEXT_338 = " - Droping table ";
  ...
  protected final String TEXT_346 = " - Drop table ";
  protected final String TEXT_347 = "\" + tableName_";
  protected final String TEXT_348 = " + \"";
  protected final String TEXT_349 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_350 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_351 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_355 = " - Creating table ";
  ...
  protected final String TEXT_363 = " - Create table ";
  ...
  protected final String TEXT_369 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_373 = " - Clearing table ";
  ...
  protected final String TEXT_381 = "- Clear table ";
  ...
  protected final String TEXT_387 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_388 = " = conn_";
  protected final String TEXT_389 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_390 = " = stmtTruncCount_";
  protected final String TEXT_391 = ".executeQuery(\"";
  protected final String TEXT_392 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_396 = " - Trancating table ";
  ...
  protected final String TEXT_404 = " - Truncate table ";
  ...
  protected final String TEXT_415 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_416 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_417 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_418 = NL + "try {";
  protected final String TEXT_419 = NL + "        int keyCount_";
  protected final String TEXT_420 = " = ";
  protected final String TEXT_421 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_422 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tableName_";
  protected final String TEXT_423 = " = \"tmp_";
  protected final String TEXT_424 = "\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_425 = " != null && dbschema_";
  protected final String TEXT_426 = ".trim().length() != 0) {" + NL + "\t    \ttableName_";
  protected final String TEXT_427 = " = dbschema_";
  protected final String TEXT_428 = " + \".\" + tableName_";
  protected final String TEXT_429 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\tString sql_create_tmpdb = \"";
  protected final String TEXT_430 = ")\";" + NL;
  protected final String TEXT_431 = NL + "\t\tCharacter OUT_DELIM_";
  protected final String TEXT_432 = " = ";
  protected final String TEXT_433 = ".charAt(0);" + NL + "\t\t";
  protected final String TEXT_434 = NL + "\t\tString escapechar_";
  protected final String TEXT_435 = " = ";
  protected final String TEXT_436 = ";" + NL + "\t\tif(!escapechar_";
  protected final String TEXT_437 = ".isEmpty()){" + NL + "\t\t\tescapechar_";
  protected final String TEXT_438 = " = \"\" + escapechar_";
  protected final String TEXT_439 = ".charAt(0);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_440 = NL + "\t\t\tString copySchema_";
  protected final String TEXT_441 = " = \"";
  protected final String TEXT_442 = "\";" + NL + "\t\t\tif (\"null\".equals(copySchema_";
  protected final String TEXT_443 = ")) {" + NL + "\t\t\t\tthrow new RuntimeException(\"Schema is not defined\");" + NL + "\t\t\t}";
  protected final String TEXT_444 = NL + "\t\tString sql_";
  protected final String TEXT_445 = " = \"COPY \" + tableName_";
  protected final String TEXT_446 = " " + NL + "\t\t";
  protected final String TEXT_447 = NL + "\t\t\t+ copySchema_";
  protected final String TEXT_448 = NL + "\t\t";
  protected final String TEXT_449 = "\t\t" + NL + "\t\t+ \" FROM STDIN ";
  protected final String TEXT_450 = " ";
  protected final String TEXT_451 = " DELIMITER '\" + OUT_DELIM_";
  protected final String TEXT_452 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_453 = NL + "\t\t+ \" TRAILING NULLCOLS\"" + NL + "\t\t";
  protected final String TEXT_454 = NL + "\t\t";
  protected final String TEXT_455 = NL + "\t\t+ \" SKIP \" + ";
  protected final String TEXT_456 = NL + "\t\t";
  protected final String TEXT_457 = NL + "\t\t";
  protected final String TEXT_458 = NL + "\t\t+ \" RECORD TERMINATOR E'\" + ";
  protected final String TEXT_459 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_460 = NL + "\t\t";
  protected final String TEXT_461 = NL + "\t\t+ \" ENCLOSED BY E'\" + ";
  protected final String TEXT_462 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_463 = NL + "\t\t";
  protected final String TEXT_464 = NL + "\t\t+ \" ENFORCELENGTH\"" + NL + "\t\t";
  protected final String TEXT_465 = NL + "\t\t";
  protected final String TEXT_466 = NL + "\t\t+ \" REJECTMAX \" + ";
  protected final String TEXT_467 = NL + "\t\t";
  protected final String TEXT_468 = NL + "\t\t";
  protected final String TEXT_469 = NL + "\t\t+ \" ABORT ON ERROR\"" + NL + "\t\t";
  protected final String TEXT_470 = NL + "\t\t";
  protected final String TEXT_471 = NL + "\t\t+ \" ESCAPE AS '\" + escapechar_";
  protected final String TEXT_472 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_473 = NL + "\t\t+\" NO ESCAPE\"" + NL + "\t\t";
  protected final String TEXT_474 = NL + "\t    ";
  protected final String TEXT_475 = " + \" NULL '\"  + ";
  protected final String TEXT_476 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_477 = NL + "\t\t";
  protected final String TEXT_478 = " + \" DIRECT\"";
  protected final String TEXT_479 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_480 = NL + "\t\t\t+ \" REJECTED DATA '\" + ";
  protected final String TEXT_481 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_482 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_483 = NL + "\t\t\t+ \" EXCEPTIONS '\" + ";
  protected final String TEXT_484 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_485 = NL + "\t    ";
  protected final String TEXT_486 = NL + "\t        + \" NO COMMIT\"" + NL + "\t    ";
  protected final String TEXT_487 = NL + "\t\t;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_488 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_489 = " - Bulk SQL:\"+sql_";
  ...
  protected final String TEXT_495 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_496 = " = conn_";
  protected final String TEXT_497 = ".createStatement();" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_498 = " = stmt_";
  protected final String TEXT_499 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_500 = ");" + NL + "\t    int nbLineBeforeLoad_";
  protected final String TEXT_501 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_502 = ".next()) {" + NL + "\t    \tnbLineBeforeLoad_";
  protected final String TEXT_503 = " = rs_";
  protected final String TEXT_504 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_505 = NL + "\t\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_506 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_507 = ",sql_";
  protected final String TEXT_508 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_509 = ".start();";
