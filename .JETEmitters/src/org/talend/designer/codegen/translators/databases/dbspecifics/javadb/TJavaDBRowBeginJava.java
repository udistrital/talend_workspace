...
public class TJavaDBRowBeginJava
{
  ...
  protected final String TEXT_150 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_156 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_157 = "\", pstmt_";
  protected final String TEXT_158 = ");";
  protected final String TEXT_159 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_162 = "\", stmt_";
