...
public class TInformixOutputEndJava
{
  ...
  protected final String TEXT_63 = NL + "\t\t\ttry {" + NL + "\t\t\t\t// when PreparedStatement execute \"executeBatch\" if have no any data to update that will throw \"java.sql.SQLException: Method can be called only once.\"" + NL + "\t\t\t\tif (pstmt_";
  protected final String TEXT_64 = " != null && batchSizeCounter_";
  protected final String TEXT_65 = " > 0) {" + NL + "\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_83 = NL + "    \t    \t}" + NL + "            }catch (java.sql.BatchUpdateException e){" + NL + "            \t";
  protected final String TEXT_84 = NL + "            \t\tthrow(e);" + NL + "            \t";
  protected final String TEXT_85 = NL + "            \tSystem.err.println(e.getMessage());" + NL + "            \t";
  protected final String TEXT_86 = NL + "        \t}";
  protected final String TEXT_87 = NL + "        if(pstmt_";
  protected final String TEXT_88 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_89 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_90 = "\");" + NL + "        }";
  protected final String TEXT_91 = NL + "    resourceMap.put(\"statementClosed_";
  ...
  protected final String TEXT_99 = NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_100 = "\", true);" + NL + "\t";
  protected final String TEXT_101 = NL;
  protected final String TEXT_102 = NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_115 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_116 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_117 = "_NB_LINE\",nb_line_";
  protected final String TEXT_118 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_119 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_120 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_121 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_122 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_123 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_124 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_125 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_126 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_127 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_128 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_129 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_130 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_131 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_134 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_135 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_136 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_137 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_138 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_139 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_140 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_141 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_142 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_143 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_147 = "_NB_LINE\",nb_line_";
  protected final String TEXT_148 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_149 = "_NB_LINE_UPDATED\",nb_line_update_";
