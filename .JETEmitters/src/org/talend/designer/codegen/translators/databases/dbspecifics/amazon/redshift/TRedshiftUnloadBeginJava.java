...
public class TRedshiftUnloadBeginJava
{
  ...
  protected final String TEXT_118 = ".append(\"'s3://\").append(";
  protected final String TEXT_119 = ").append(\"/\").append(";
  protected final String TEXT_120 = ").append(\"' \")" + NL + "\t.append(\"credentials '\")";
  protected final String TEXT_121 = NL + "\t\t\t.append(\"aws_iam_role=\")";
  protected final String TEXT_122 = NL + "\t\t\t\t    .append(\",\")\t";
  protected final String TEXT_123 = NL + "\t\t\t.append(";
  protected final String TEXT_124 = ")";
  protected final String TEXT_125 = NL + "\t    .append(\"aws_access_key_id=\").append(";
  protected final String TEXT_126 = ").append(\";aws_secret_access_key=\").append(decryptedPwd_";
  protected final String TEXT_127 = ")";
  protected final String TEXT_128 = NL + "\t\t.append(\";master_symmetric_key=\")";
  protected final String TEXT_129 = NL + "\t\t\t.append(routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_130 = "))";
  protected final String TEXT_131 = NL + "\t\t\t.append(";
  protected final String TEXT_132 = ")";
  protected final String TEXT_133 = NL + "\t.append(\"' \")";
  protected final String TEXT_134 = NL + "\t\t.append(\"ENCRYPTED \")";
  protected final String TEXT_135 = NL + "\t\t.append(\"ADDQUOTES \")";
  protected final String TEXT_136 = NL + "\t\t.append(\"DELIMITER '\").append(fieldSeparator_";
  protected final String TEXT_137 = ").append(\"' \")";
  protected final String TEXT_138 = NL + "\t\t.append(\"FIXEDWIDTH '\").append(";
  protected final String TEXT_139 = ").append(\"' \")";
  protected final String TEXT_140 = NL + "\t\t.append(\"";
  protected final String TEXT_141 = " \")";
  protected final String TEXT_142 = NL + "\t\t.append(\"ESCAPE \")";
  protected final String TEXT_143 = NL + "\t\t.append(\"ALLOWOVERWRITE \")";
  protected final String TEXT_144 = NL + "\t\t.append(\"PARALLEL OFF \")";
  protected final String TEXT_145 = NL + "\t\t.append(\"NULL '\").append(";
  protected final String TEXT_146 = ").append(\"' \")";
  protected final String TEXT_147 = NL + "\t;" + NL + "\t" + NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_148 = "=conn_";
  protected final String TEXT_149 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_150 = ".execute(command_";
  protected final String TEXT_151 = ".toString());" + NL + "\t";
  protected final String TEXT_152 = NL + "\t\tlog.info(\"";
  protected final String TEXT_153 = " - Finish unloading data to s3.\");" + NL + "\t";
