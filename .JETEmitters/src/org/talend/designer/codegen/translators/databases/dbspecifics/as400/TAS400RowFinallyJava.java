...
public class TAS400RowFinallyJava
{
  ...
  protected final String TEXT_71 = NL + "    if (resourceMap.get(\"statementClosed_";
  protected final String TEXT_72 = "\") == null) {";
  protected final String TEXT_73 = NL + "            java.sql.PreparedStatement pstmtToClose_";
  protected final String TEXT_74 = " = null;" + NL + "            if ((pstmtToClose_";
  protected final String TEXT_75 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmt_";
  protected final String TEXT_76 = "\")) != null) {" + NL + "                pstmtToClose_";
  protected final String TEXT_77 = ".close();" + NL + "            }";
  protected final String TEXT_78 = NL + "            java.sql.Statement stmtToClose_";
  protected final String TEXT_79 = " = null;" + NL + "            if ((stmtToClose_";
  protected final String TEXT_80 = " = (java.sql.Statement) resourceMap.remove(\"stmt_";
  protected final String TEXT_81 = "\")) != null) {" + NL + "                stmtToClose_";
  protected final String TEXT_82 = ".close();" + NL + "            }";
  protected final String TEXT_83 = NL + "    }";
  protected final String TEXT_84 = NL + "} finally {" + NL + "        if(resourceMap.get(\"finish_";
  protected final String TEXT_85 = "\") == null){" + NL + "            java.sql.Connection ctn_";
  protected final String TEXT_86 = " = null;" + NL + "            if((ctn_";
  protected final String TEXT_87 = " = (java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_88 = "\")) != null){" + NL + "                try {";
  protected final String TEXT_89 = NL + "                    ctn_";
  protected final String TEXT_90 = ".close();";
  protected final String TEXT_91 = NL + "                } catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_92 = ") {" + NL + "                    String errorMessage_";
  protected final String TEXT_93 = " = \"failed to close the connection in ";
  protected final String TEXT_94 = " :\" + sqlEx_";
  protected final String TEXT_95 = ".getMessage();";
  protected final String TEXT_96 = NL + "                    System.err.println(errorMessage_";
