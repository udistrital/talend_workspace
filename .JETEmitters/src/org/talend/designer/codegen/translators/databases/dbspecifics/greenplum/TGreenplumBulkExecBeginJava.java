...
public class TGreenplumBulkExecBeginJava {
  ...
  protected final String TEXT_126 = " = \"org.postgresql.Driver\";" + NL + "\t\t\tString url_";
  protected final String TEXT_127 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_128 = " + \":\" + ";
  protected final String TEXT_129 = " + \"/\" + ";
  protected final String TEXT_130 = ";" + NL + "\t\t";
  protected final String TEXT_131 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_132 = " = \"com.pivotal.jdbc.GreenplumDriver\";" + NL + "\t\t\tString url_";
  protected final String TEXT_133 = " = \"jdbc:pivotal:greenplum://\"+";
  protected final String TEXT_134 = "+\":\"+";
  protected final String TEXT_135 = "+\";DatabaseName=\"+";
  protected final String TEXT_136 = ";" + NL + "\t";
  protected final String TEXT_137 = NL + "\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_138 = ").newInstance();" + NL + "\tString dbUser_";
  ...
  protected final String TEXT_156 = " - Droping table ";
  ...
  protected final String TEXT_164 = " - Drop table ";
  protected final String TEXT_165 = "\" + tableName_";
  protected final String TEXT_166 = " + \"";
  protected final String TEXT_167 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_168 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_169 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_173 = " - Creating table ";
  ...
  protected final String TEXT_181 = " - Create table ";
  protected final String TEXT_182 = "\" + tableName_";
  protected final String TEXT_183 = " + \"";
  protected final String TEXT_184 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_186 = ".close();" + NL + "\t\t";
  protected final String TEXT_187 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_213 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_214 = " = dbMetaData_";
  protected final String TEXT_215 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_216 = ", tableNameForSearch_";
  protected final String TEXT_217 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_218 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_219 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_220 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_227 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_233 = ".equalsIgnoreCase(";
  protected final String TEXT_234 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_235 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_248 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_252 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_253 = ".equals(schema_";
  protected final String TEXT_254 = ") || (schema_";
  protected final String TEXT_255 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_256 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_324 = ".getTables(null, dbschema_";
  ...
  protected final String TEXT_328 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_452 = NL + "\t        int keyCount_";
  protected final String TEXT_453 = " = ";
  protected final String TEXT_454 = ";" + NL + "\t        if(keyCount_";
  protected final String TEXT_455 = " == 0) {" + NL + "\t            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "\t        }" + NL + "\t        tmpTableName_";
  protected final String TEXT_456 = " = tableName_";
  protected final String TEXT_457 = ";" + NL + "\t        tableName_";
  protected final String TEXT_458 = " = \"tmp_";
  protected final String TEXT_459 = "_\" + pid + Thread.currentThread().getId();" + NL + "\t        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_463 = " - Creating temp table ";
  ...
  protected final String TEXT_468 = ".execute(\"";
  protected final String TEXT_469 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_470 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_471 = " - Create temp table ";
  protected final String TEXT_472 = "\" + tableName_";
  protected final String TEXT_473 = " + \"";
  protected final String TEXT_474 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_475 = NL + "\t        stmtCreateTmp_";
  ...
  protected final String TEXT_483 = NL + "\t        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_484 = " = conn_";
  protected final String TEXT_485 = ".createStatement();" + NL + "\t        stmtTmpBulk_";
  protected final String TEXT_486 = ".execute(bulkSQL_";
  ...
  protected final String TEXT_490 = " - Bulk insert data into ";
  protected final String TEXT_491 = "\" + tableName_";
  protected final String TEXT_492 = " + \"";
  protected final String TEXT_493 = " has finished.\");" + NL + "\t\t\t";
  protected final String TEXT_494 = NL + "\t        tableName_";
  protected final String TEXT_495 = " = tmpTableName_";
  protected final String TEXT_496 = ";" + NL + "\t        tmpTableName_";
  protected final String TEXT_497 = " = \"tmp_";
  protected final String TEXT_498 = "_\" + pid + Thread.currentThread().getId();" + NL + "\t        java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_502 = " - Updating ";
  protected final String TEXT_503 = "\" + tableName_";
  protected final String TEXT_504 = " + \"";
  protected final String TEXT_505 = " from ";
  protected final String TEXT_506 = "\"+tmpTableName_";
  protected final String TEXT_507 = "+\"";
  protected final String TEXT_508 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_509 = NL + "\t        stmtUpdateBulk_";
  protected final String TEXT_510 = ".executeUpdate(\"";
  protected final String TEXT_511 = "\");" + NL + "\t\t\t";
  protected final String TEXT_512 = NL + "\t        stmtUpdateBulk_";
  protected final String TEXT_513 = ".close();" + NL + "\t        tableName_";
  protected final String TEXT_514 = " = tmpTableName_";
  protected final String TEXT_515 = ";" + NL + "\t        java.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_519 = " - Droping temp table ";
  ...
  protected final String TEXT_524 = ".execute(\"";
  protected final String TEXT_525 = "\");" + NL + "\t\t\t";
  protected final String TEXT_526 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_527 = " - Drop temp table ";
  protected final String TEXT_528 = "\" + tableName_";
  protected final String TEXT_529 = "+ \"";
  protected final String TEXT_530 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_531 = NL + "\t        stmtTmpDrop_";
  protected final String TEXT_532 = ".close();" + NL + "\t        ";
  ...
  protected final String TEXT_540 = NL + "\t    java.sql.Statement stmtBulk_";
  protected final String TEXT_541 = " = conn_";
  protected final String TEXT_542 = ".createStatement();" + NL + "\t    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t    stmtBulk_";
  protected final String TEXT_543 = ".execute(bulkSQL_";
  protected final String TEXT_544 = ");" + NL + "\t    stmtBulk_";
  protected final String TEXT_545 = ".close();" + NL + "\t\t";
  protected final String TEXT_546 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_547 = " - Bulk insert data into ";
  protected final String TEXT_548 = "\" + tableName_";
  protected final String TEXT_549 = " + \"";
  protected final String TEXT_550 = " has finished.\");" + NL + "\t\t";
