...
public class TTeradataFastLoadMainJava {
  ...
  protected final String TEXT_80 = ",java.sql.Types.TIMESTAMP);" + NL + "\t";
  ...
  protected final String TEXT_145 = ",new java.sql.Timestamp(";
  protected final String TEXT_146 = ".";
  protected final String TEXT_147 = ".getTime()));" + NL + "\t\t" + NL + "\t}else{" + NL + "\t" + NL + "\t\t";
  protected final String TEXT_148 = ".setNull(";
  protected final String TEXT_149 = ",java.sql.Types.TIMESTAMP);" + NL + "\t\t" + NL + "\t}" + NL + "\t";
