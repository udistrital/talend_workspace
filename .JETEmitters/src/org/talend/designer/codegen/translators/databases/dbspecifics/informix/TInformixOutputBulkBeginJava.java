...
public class TInformixOutputBulkBeginJava
{
  ...
  protected final String TEXT_45 = " = 0;" + NL + "\t\tchar rowSeparator_";
  protected final String TEXT_46 = " = ";
  protected final String TEXT_47 = ";" + NL + "\t\tchar fieldSeparator_";
  protected final String TEXT_48 = " = ";
  protected final String TEXT_49 = ";" + NL + "\t\t" + NL + "\t\tjava.io.File file_";
  protected final String TEXT_50 = " = new java.io.File(";
  protected final String TEXT_51 = ");\t\t" + NL + "\t\t";
  protected final String TEXT_52 = NL + "        java.io.File parentFile_";
  protected final String TEXT_53 = " = file_";
  protected final String TEXT_54 = ".getParentFile();" + NL + "        if(parentFile_";
  protected final String TEXT_55 = " != null && !parentFile_";
  protected final String TEXT_56 = ".exists()){" + NL + "            String absolutePath_";
  protected final String TEXT_57 = " = parentFile_";
  protected final String TEXT_58 = ".getAbsolutePath();";
  protected final String TEXT_59 = NL + "            if(parentFile_";
  protected final String TEXT_60 = ".mkdirs()){";
  protected final String TEXT_61 = NL + "                System.out.println(\"The directory '\"+absolutePath_";
  protected final String TEXT_62 = "+\"' has been created successfully.\");" + NL + "            }else{";
  protected final String TEXT_63 = NL + "                System.err.println(\"Fail to create directory '\"+absolutePath_";
  protected final String TEXT_64 = "+\"'.\");" + NL + "            }" + NL + "        }" + NL + "\t\t";
  protected final String TEXT_65 = NL + "\t\t\t\t" + NL + "\t\tcom.talend.csv.CSVWriter csvWriter_";
  protected final String TEXT_66 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        new java.io.FileOutputStream(file_";
  protected final String TEXT_67 = ", ";
  protected final String TEXT_68 = "), ";
  protected final String TEXT_69 = ")));" + NL + "        resourceMap.put(\"csvWriter_";
  protected final String TEXT_70 = "\", csvWriter_";
  protected final String TEXT_71 = "); " + NL + "        csvWriter_";
  protected final String TEXT_72 = ".setSeparator(fieldSeparator_";
  protected final String TEXT_73 = ");" + NL + "        " + NL + "        csvWriter_";
  protected final String TEXT_74 = ".setLineEnd(\"\"+rowSeparator_";
  protected final String TEXT_75 = ");" + NL + "        csvWriter_";
  protected final String TEXT_76 = ".setEscapeChar('\\\\');" + NL + "      \tcsvWriter_";
  protected final String TEXT_77 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.NO);  ";
