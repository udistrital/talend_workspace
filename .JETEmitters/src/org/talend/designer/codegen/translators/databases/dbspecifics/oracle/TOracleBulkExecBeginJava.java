...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_529 = NL + "    java.lang.StringBuilder optionClause_";
  protected final String TEXT_530 = " = new java.lang.StringBuilder();" + NL + "    optionClause_";
  protected final String TEXT_531 = ".append(\"OPTIONS (\");";
  protected final String TEXT_532 = NL + "            optionClause_";
  ...
  protected final String TEXT_543 = ".split(\",\").length>1){" + NL + "                    optionClause_";
  protected final String TEXT_544 = ".append(\"";
  protected final String TEXT_545 = "=(\"+";
  protected final String TEXT_546 = "+\")\");" + NL + "                }else{" + NL + "                    optionClause_";
  ...
  protected final String TEXT_558 = NL + "                optionClause_";
  protected final String TEXT_559 = ".append(\"";
  protected final String TEXT_560 = "=";
  protected final String TEXT_561 = "\");";
  protected final String TEXT_562 = NL + "                optionClause_";
  protected final String TEXT_563 = ".append(\"";
  protected final String TEXT_564 = "=\"+";
  protected final String TEXT_565 = ");";
  protected final String TEXT_566 = NL + "    optionClause_";
  protected final String TEXT_567 = ".append(\")\");";
  protected final String TEXT_568 = NL + "    String dataf_";
  protected final String TEXT_569 = " = ";
  protected final String TEXT_570 = " + Thread.currentThread().getId();" + NL + "" + NL + "    String ctlf_";
  protected final String TEXT_571 = " = dataf_";
  protected final String TEXT_572 = " + \".ctl\";" + NL + "" + NL + "    String badf_";
  protected final String TEXT_573 = " = dataf_";
  protected final String TEXT_574 = " + \".bad\";" + NL + "" + NL + "    String dscf_";
  protected final String TEXT_575 = " = dataf_";
  protected final String TEXT_576 = " + \".dsc\";" + NL + "" + NL + "    String logf_";
  protected final String TEXT_577 = " = dataf_";
  protected final String TEXT_578 = " + \".log\";" + NL + "" + NL + "    dataf_";
  protected final String TEXT_579 = " = ";
  protected final String TEXT_580 = ";" + NL + "" + NL + "    java.io.File badFile_";
  protected final String TEXT_581 = " = new java.io.File(badf_";
  protected final String TEXT_582 = ");" + NL + "" + NL + "    if(badFile_";
  protected final String TEXT_583 = ".exists()){" + NL + "" + NL + "        badFile_";
  protected final String TEXT_584 = ".delete();" + NL + "" + NL + "    }" + NL + "    java.io.BufferedWriter bw_";
  protected final String TEXT_585 = " = new java.io.BufferedWriter(new java.io.FileWriter(ctlf_";
  protected final String TEXT_586 = "));" + NL + "    java.io.PrintWriter pw_";
  protected final String TEXT_587 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_588 = " ,false) ;" + NL + "" + NL + "    pw_";
  protected final String TEXT_589 = ".println(optionClause_";
  protected final String TEXT_590 = ".toString());" + NL + "" + NL + "    pw_";
  protected final String TEXT_591 = ".println(\"LOAD DATA\");" + NL + "    pw_";
  protected final String TEXT_592 = ".println(\"CHARACTERSET '\"+";
  protected final String TEXT_593 = "+\"'\") ;" + NL + "    bw_";
  protected final String TEXT_594 = ".write(\"INFILE '\" + dataf_";
  protected final String TEXT_595 = " + \"'\");" + NL;
  protected final String TEXT_596 = NL + "        bw_";
  protected final String TEXT_597 = ".write(\" \\\"str '|'\\\" \");";
  protected final String TEXT_598 = NL + NL + NL;
  protected final String TEXT_599 = NL + "        bw_";
  protected final String TEXT_600 = ".write(\" \\\"str '\" + ";
  protected final String TEXT_601 = " + \"'\\\"\");";
  protected final String TEXT_602 = NL + "        bw_";
  protected final String TEXT_603 = ".write(\" \\\"fix \" + ";
  protected final String TEXT_604 = " + \"\\\"\");";
  protected final String TEXT_605 = NL + "        bw_";
  protected final String TEXT_606 = ".write(\" \\\"var \" + ";
  protected final String TEXT_607 = " + \"\\\"\");";
  protected final String TEXT_608 = NL + "    pw_";
  protected final String TEXT_609 = ".println(\"\");" + NL + "    pw_";
  protected final String TEXT_610 = ".println(\"BADFILE '\" + badf_";
  protected final String TEXT_611 = " + \"'\" );" + NL + "    pw_";
  protected final String TEXT_612 = ".println(\"DISCARDFILE '\" + dscf_";
  protected final String TEXT_613 = " + \"'\");";
  protected final String TEXT_614 = NL + "        pw_";
  protected final String TEXT_615 = ".println(\"PRESERVE BLANKS\");";
  protected final String TEXT_616 = NL + "        bw_";
  protected final String TEXT_617 = ".write(";
  protected final String TEXT_618 = ");";
  protected final String TEXT_619 = NL + "            pw_";
  protected final String TEXT_620 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_621 = ");" + NL + "            pw_";
  protected final String TEXT_622 = ".println(\"INSERT\");";
  protected final String TEXT_623 = NL + "            pw_";
  protected final String TEXT_624 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_625 = ");" + NL + "            pw_";
  protected final String TEXT_626 = ".println(\"";
  protected final String TEXT_627 = "\");";
  protected final String TEXT_628 = NL + "                pw_";
  protected final String TEXT_629 = ".println(\"WHEN \" + ";
  protected final String TEXT_630 = ");";
  protected final String TEXT_631 = NL + "            bw_";
  protected final String TEXT_632 = ".write(\"FIELDS TERMINATED BY ";
  protected final String TEXT_633 = "\");";
  protected final String TEXT_634 = NL + "            bw_";
  protected final String TEXT_635 = ".write(\"FIELDS TERMINATED BY \\\"\"+ ";
  protected final String TEXT_636 = " + \"\\\"\");";
  protected final String TEXT_637 = NL + "                bw_";
  protected final String TEXT_638 = ".write(\" OPTIONALLY ENCLOSED BY \");";
  protected final String TEXT_639 = NL + "                bw_";
  protected final String TEXT_640 = ".write(\"FIELDS ENCLOSED BY \");";
  protected final String TEXT_641 = NL + "            bw_";
  protected final String TEXT_642 = ".write(\"'\" + ";
  protected final String TEXT_643 = " + \"'\");";
  protected final String TEXT_644 = NL + "                bw_";
  protected final String TEXT_645 = ".write(\" AND '\" + ";
  protected final String TEXT_646 = " + \"'\");";
  protected final String TEXT_647 = NL + "            pw_";
  protected final String TEXT_648 = ".println(\"\");";
  protected final String TEXT_649 = NL + "            pw_";
  protected final String TEXT_650 = ".println(\"\");";
  protected final String TEXT_651 = NL + "            pw_";
  protected final String TEXT_652 = ".println(\"TRAILING NULLCOLS\");";
  protected final String TEXT_653 = NL + "            pw_";
  protected final String TEXT_654 = ".println(\"";
  protected final String TEXT_655 = "\");";
  protected final String TEXT_656 = NL + "    bw_";
  protected final String TEXT_657 = ".close();" + NL + "    pw_";
  protected final String TEXT_658 = ".close();";
  protected final String TEXT_659 = NL + "String command_";
  protected final String TEXT_660 = " = \"sqlldr '\" + dbUser_";
  protected final String TEXT_661 = " + \"/\" + dbPwd_";
  protected final String TEXT_662 = " + \"@\" + serviceUrl_";
  protected final String TEXT_663 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_664 = " + \"' LOG='\" + logf_";
  protected final String TEXT_665 = " + \"'\";" + NL + "String printableCommand_";
  protected final String TEXT_666 = " = \"sqlldr '\" + dbUser_";
  protected final String TEXT_667 = " + \"/\" + \"....\" + \"@\" + serviceUrl_";
  protected final String TEXT_668 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_669 = " + \"' LOG='\" + logf_";
  protected final String TEXT_670 = " + \"'\";" + NL;
  protected final String TEXT_671 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_675 = " - Creating temp table ";
  protected final String TEXT_676 = "\" + tableName_";
  protected final String TEXT_677 = " + \"";
  protected final String TEXT_678 = ".\" );";
  protected final String TEXT_679 = NL + "    stmtCreateTmp_";
  protected final String TEXT_680 = ".execute(\"";
  protected final String TEXT_681 = ")\");" + NL + "    stmtCreateTmp_";
  protected final String TEXT_682 = ".close();";
  protected final String TEXT_683 = NL + "        log.info(\"";
  protected final String TEXT_684 = " - Create temp table ";
  protected final String TEXT_685 = "\" + tableName_";
  protected final String TEXT_686 = " + \"";
  protected final String TEXT_687 = " has succeeded.\");" + NL + "        log.info(\"";
  protected final String TEXT_688 = " - Executing command:'\" + printableCommand_";
  protected final String TEXT_689 = " + \"'.\");";
  protected final String TEXT_690 = NL + "    final Process process_";
  protected final String TEXT_691 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_692 = ");";
  protected final String TEXT_693 = NL + "        java.util.ArrayList<String> envParam_";
  protected final String TEXT_694 = "=new java.util.ArrayList<String>();" + NL + "        java.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_695 = " = System.getenv();" + NL + "        for (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_696 = ".entrySet())" + NL + "        {" + NL + "           envParam_";
  protected final String TEXT_697 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "        }";
  protected final String TEXT_698 = NL + "        envParam_";
  protected final String TEXT_699 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_700 = "\");";
  protected final String TEXT_701 = NL + "        envParam_";
  protected final String TEXT_702 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_703 = "\");";
  protected final String TEXT_704 = NL + "            envParam_";
  protected final String TEXT_705 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_706 = "\");";
  protected final String TEXT_707 = NL + "        envParam_";
  protected final String TEXT_708 = ".add(\"";
  protected final String TEXT_709 = "=";
  protected final String TEXT_710 = "\");";
  protected final String TEXT_711 = NL + "        log.info(\"";
  protected final String TEXT_712 = " - Executing command:'\" + printableCommand_";
  protected final String TEXT_713 = " + \"'.\");";
  protected final String TEXT_714 = NL + "    final Process process_";
  protected final String TEXT_715 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_716 = ",envParam_";
  protected final String TEXT_717 = ".toArray(new String[0]));";
  protected final String TEXT_718 = NL + NL + "//System.out.println(command_";
  protected final String TEXT_719 = ");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_720 = " = new Thread() {" + NL + "    public void run() {" + NL + "        try {" + NL + "            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_721 = ".getInputStream()));" + NL + "            String line = \"\";" + NL + "            try {" + NL + "                while((line = reader.readLine()) != null) {";
  protected final String TEXT_722 = NL + "                        System.out.println(line);";
  protected final String TEXT_723 = NL + "                        globalMap.put(\"";
  protected final String TEXT_724 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_725 = "_OUTPUT\") + \"\\n\" + line);";
  protected final String TEXT_726 = NL + "                }" + NL + "            } finally {" + NL + "                 reader.close();" + NL + "            }" + NL + "        }catch(java.io.IOException ioe) {";
  protected final String TEXT_727 = NL + "            ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_728 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_729 = " = new Thread() {" + NL + "    public void run() {" + NL + "       try {" + NL + "           java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_730 = ".getErrorStream()));" + NL + "           String line = \"\";" + NL + "           try {" + NL + "               while((line = reader.readLine()) != null) {" + NL + "                  globalMap.put(\"";
  protected final String TEXT_731 = "_SQLLOAD_ERROR\", \"true\");";
  protected final String TEXT_732 = NL + "                       System.err.println(line);";
  protected final String TEXT_733 = NL + "                       globalMap.put(\"";
  protected final String TEXT_734 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_735 = "_OUTPUT\")+\"\\n\"+line);";
  protected final String TEXT_736 = NL + "               }" + NL + "            } finally {" + NL + "                reader.close();" + NL + "            }" + NL + "        } catch(java.io.IOException ioe) {";
  protected final String TEXT_737 = NL + "           ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_738 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_739 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_740 = " = process_";
  protected final String TEXT_741 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_742 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_743 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_744 = "_SQLLOAD_ERROR\"))) {" + NL + "    throw new TalendException(new java.lang.Exception() , \"";
  protected final String TEXT_745 = "\" , globalMap);" + NL + "}";
  protected final String TEXT_746 = NL + "    log.info(\"";
  protected final String TEXT_747 = " - Excute command: '\" + printableCommand_";
  protected final String TEXT_748 = " + \"' has finished.\");" + NL + "    log.info(\"";
  protected final String TEXT_749 = " - Retrieving information from oracle log file: '\" + logf_";
  protected final String TEXT_750 = " + \"'.\");";
  protected final String TEXT_751 = NL + NL + "int nb_line_data_";
  protected final String TEXT_752 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_753 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_754 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_755 = " = 0;" + NL + "" + NL + "/*  1.get log file all lines count" + NL + "    2.get \"Total logical records read\" line number from file end." + NL + "    3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "" + NL + "//1" + NL + "" + NL + "class LogUtil_";
  protected final String TEXT_756 = "{" + NL + "    public int getNumber(java.io.BufferedReader br)  throws java.io.IOException {" + NL + "        int number=0;" + NL + "        java.util.regex.Pattern pattern = java.util.regex.Pattern.compile(\"\\\\d{1,}\");" + NL + "        String tempLine = br.readLine();" + NL + "        if(tempLine!=null){" + NL + "            String str_number = tempLine.substring(tempLine.indexOf(\":\") + 1).trim();" + NL + "            boolean isNumber= pattern.matcher(str_number).matches();" + NL + "            if(isNumber){" + NL + "                number = Integer.parseInt(str_number);" + NL + "            }" + NL + "        }" + NL + "        return number;" + NL + "    }" + NL + "\t" + NL + "\tpublic java.io.BufferedReader parseLogFileWithDirect(String logf) throws java.io.IOException" + NL + "\t{" + NL + "\t\tString tempLine = \"\";" + NL + "\t\tjava.io.BufferedReader lr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tjava.util.List<String> logLineList = new java.util.ArrayList<String>();" + NL + "\t\twhile ((tempLine = lr.readLine() )!= null) {" + NL + "\t\t\tlogLineList.add(tempLine);" + NL + "\t\t}" + NL + "\t\tlr.close();" + NL + "" + NL + "\t\tboolean isFirstEmptyLine = true;//Is the first empty line of empty block" + NL + "\t\tint emptyLineNum =0;//The number of empty block" + NL + "\t\tint beforeNumLine = 0;" + NL + "\t\tfor(int i=logLineList.size()-1; i>=0; i--)" + NL + "\t\t{" + NL + "\t\t\ttempLine = logLineList.get(i);" + NL + "\t\t\tif(tempLine!=null && tempLine.trim().length()>0){" + NL + "\t\t\t\tisFirstEmptyLine = true;" + NL + "\t\t\t}\t" + NL + "\t\t\telse if (isFirstEmptyLine){//skip empty rows" + NL + "\t\t\t\tisFirstEmptyLine = false;" + NL + "\t\t\t\temptyLineNum++;" + NL + "\t\t\t\tif(emptyLineNum==3){" + NL + "\t\t\t\t\tbeforeNumLine = i+1;" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t" + NL + "\t\tlr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tfor (int i=0; i <= beforeNumLine; i++) {" + NL + "\t\t\tlr.readLine();" + NL + "\t\t}\t" + NL + "\t\t" + NL + "\t\treturn lr;" + NL + "\t}" + NL + "\t" + NL + "\tpublic java.io.BufferedReader parseLogFileWithoutDirect(String logf, String tableName) throws java.io.IOException" + NL + "\t{" + NL + "\t\tString tempLine = \"\";" + NL + "\t\tjava.io.BufferedReader lr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tint countLines =0;//log file lines count" + NL + "\t\tint lastTableLine = 0;//Line Number of the last table name" + NL + "\t\twhile ((tempLine = lr.readLine() )!= null) {" + NL + "\t\t\tcountLines++;" + NL + "\t\t\tif(tempLine.toUpperCase().indexOf(\"TABLE \"+(tableName).toUpperCase())>-1){" + NL + "\t\t\t\tlastTableLine = countLines;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tlr.close();" + NL + "\t\t//need new instance to readLine ." + NL + "\t\tlr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tfor (int i=0; i<= lastTableLine; i++) {" + NL + "\t\t\tlr.readLine();" + NL + "\t\t}" + NL + "\t\tboolean isNumber=false;" + NL + "\t\ttempLine = lr.readLine();" + NL + "\t\tint emptyLineNum =0;//The number of empty block" + NL + "\t\tboolean isFirstEmptyLine = false;//Is the first empty line of empty block" + NL + "\t\tfor (int i=lastTableLine+2; i<= countLines; i++) {" + NL + "\t\t\ttempLine = lr.readLine();" + NL + "\t\t\tif(tempLine!=null && tempLine.trim().length()>0){" + NL + "\t\t\t\tif(emptyLineNum==2){" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisFirstEmptyLine = false;" + NL + "\t\t\t\tcontinue;//skip rows now empty" + NL + "\t\t\t}else if (!isFirstEmptyLine){//skip empty rows" + NL + "\t\t\t\tisFirstEmptyLine = true;" + NL + "\t\t\t\temptyLineNum++;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\treturn lr;" + NL + "\t}" + NL + "\t" + NL + "}" + NL + "" + NL + "LogUtil_";
  protected final String TEXT_757 = " lu_";
  protected final String TEXT_758 = " = new LogUtil_";
  protected final String TEXT_759 = "();" + NL + "java.io.BufferedReader lr_";
  protected final String TEXT_760 = " = null;" + NL + "try {" + NL + "\tif(isDirect_";
  protected final String TEXT_761 = "){" + NL + "\t\tlr_";
  protected final String TEXT_762 = " = lu_";
  protected final String TEXT_763 = ".parseLogFileWithDirect(logf_";
  protected final String TEXT_764 = ");\t\t" + NL + "\t}\t\t" + NL + "\telse{" + NL + "\t\tlr_";
  protected final String TEXT_765 = " = lu_";
  protected final String TEXT_766 = ".parseLogFileWithoutDirect(logf_";
  protected final String TEXT_767 = ", tableName_";
  protected final String TEXT_768 = ");\t" + NL + "\t}" + NL + "" + NL + "\tnb_line_data_";
  protected final String TEXT_769 = " = lu_";
  protected final String TEXT_770 = ".getNumber(lr_";
  protected final String TEXT_771 = ");//get the number of data line" + NL + "\tnb_line_bad_";
  protected final String TEXT_772 = " = lu_";
  protected final String TEXT_773 = ".getNumber(lr_";
  protected final String TEXT_774 = ");//get the number of reject data line" + NL + "\tnb_line_discarded_";
  protected final String TEXT_775 = " = lu_";
  protected final String TEXT_776 = ".getNumber(lr_";
  protected final String TEXT_777 = ");//get the number of discarded data line" + NL + "\tnb_line_inserted_";
  protected final String TEXT_778 = " = nb_line_data_";
  protected final String TEXT_779 = " - nb_line_bad_";
  protected final String TEXT_780 = " - nb_line_discarded_";
  protected final String TEXT_781 = ";" + NL + "} finally {" + NL + "\tlr_";
  protected final String TEXT_782 = ".close();" + NL + "}" + NL + "globalMap.put(\"";
  protected final String TEXT_783 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_784 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_785 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_786 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_787 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_788 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_789 = "_RETURN_CODE\", exitCode_";
  protected final String TEXT_790 = ");";
  protected final String TEXT_791 = NL + "    log.info(\"";
  protected final String TEXT_792 = " - Retrieved number of line: \" + nb_line_data_";
  protected final String TEXT_793 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_794 = " - Retrieved number of bad line: \" + nb_line_bad_";
  protected final String TEXT_795 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_796 = " - Retrieved number of inserted line: \" + nb_line_inserted_";
  protected final String TEXT_797 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_798 = " - Retrieved information from oracle log file: '\" + logf_";
  protected final String TEXT_799 = " + \"' finish.\");";
