...
public class TRedshiftOutputBeginJava {
  ...
  protected final String TEXT_125 = NL + NL + "    java.lang.Class.forName(\"com.amazon.redshift.jdbc41.Driver\");";
  protected final String TEXT_126 = NL + "    ";
  protected final String TEXT_127 = NL + "\t\tString url_";
  protected final String TEXT_128 = " = \"jdbc:redshift://\"+";
  protected final String TEXT_129 = "+\":\"+";
  protected final String TEXT_130 = "+\"/\"+";
  protected final String TEXT_131 = ";" + NL + "\t";
  protected final String TEXT_132 = NL + "\t\tString url_";
  protected final String TEXT_133 = " = \"jdbc:redshift://\" + ";
  protected final String TEXT_134 = " + \":\" + ";
  protected final String TEXT_135 = " + \"/\" + ";
  protected final String TEXT_136 = " + \"?\" + ";
  protected final String TEXT_137 = ";" + NL + "\t";
  protected final String TEXT_138 = NL + "    " + NL + "    String dbUser_";
  ...
  protected final String TEXT_148 = NL + NL + "    String dbPwd_";
  protected final String TEXT_149 = " = decryptedPassword_";
  protected final String TEXT_150 = ";";
  protected final String TEXT_151 = NL + "    conn_";
  protected final String TEXT_152 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_153 = ",dbUser_";
  ...
  protected final String TEXT_159 = ".setAutoCommit(false);" + NL + "\t";
  protected final String TEXT_160 = NL + "        int commitEvery_";
  protected final String TEXT_161 = " = ";
  protected final String TEXT_162 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_163 = " = 0;";
  protected final String TEXT_164 = NL + "\tclass Util_";
  ...
  protected final String TEXT_167 = " = new Util_";
  protected final String TEXT_168 = "();" + NL + "\tint numPerInsert_";
  protected final String TEXT_169 = " = ";
  protected final String TEXT_170 = ";";
  protected final String TEXT_171 = NL + "int count_";
  ...
  protected final String TEXT_378 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_384 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_385 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_386 = " = rsTable_";
  protected final String TEXT_387 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_388 = ".equalsIgnoreCase(";
  protected final String TEXT_389 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_390 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_391 = NL + "                                if(!whetherExist_";
  protected final String TEXT_392 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_412 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_424 = ".commit();";
  protected final String TEXT_425 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_433 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_444 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_445 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_446 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_457 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_458 = " = conn_";
  protected final String TEXT_459 = ".createStatement()) {";
  protected final String TEXT_460 = NL + "                              stmtTruncCount_";
  protected final String TEXT_461 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_462 = "));";
  protected final String TEXT_463 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_464 = " = stmtTruncCount_";
  protected final String TEXT_465 = ".executeQuery(\"";
  protected final String TEXT_466 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_467 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_468 = " = rsTruncCount_";
  protected final String TEXT_469 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_480 = NL + "                    if(!conn_";
  protected final String TEXT_481 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_482 = ".commit();" + NL + "                    }";
  protected final String TEXT_483 = NL + "                deletedCount_";
  protected final String TEXT_484 = " += rsTruncCountNumber_";
  protected final String TEXT_485 = ";" + NL + "            }";
  protected final String TEXT_486 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_502 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_503 = NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_504 = " = conn_";
  protected final String TEXT_505 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_506 = " + \"\\\" (";
  protected final String TEXT_507 = ") VALUES (";
  protected final String TEXT_508 = ")\");" + NL + "\t\t\tresourceMap.put(\"pstmt_";
  protected final String TEXT_509 = "\", pstmt_";
  protected final String TEXT_510 = ");";
  protected final String TEXT_511 = NL + "\t\t\tint rowCount";
  protected final String TEXT_512 = " = 0;" + NL + "\t\t\tclass BufferLine_";
  protected final String TEXT_513 = " {";
  protected final String TEXT_514 = "\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_515 = " ";
  protected final String TEXT_516 = ";" + NL + "\t\t\t\t\t\t" + NL + "\t            \t\tpublic BufferLine_";
  protected final String TEXT_517 = " c";
  protected final String TEXT_518 = "(";
  protected final String TEXT_519 = " ";
  protected final String TEXT_520 = "){" + NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_521 = " = ";
  protected final String TEXT_522 = ";" + NL + "\t\t\t\t\t\t\treturn this;" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_523 = "\t\t" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_524 = "> exInsertColValueList";
  protected final String TEXT_525 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_526 = " exInsertColValue";
  protected final String TEXT_527 = " = null;" + NL + "" + NL + "\t\t\tString valueList_";
  protected final String TEXT_528 = " = \"(";
  protected final String TEXT_529 = ")\";" + NL + "\t\t\tnumPerInsert_";
  protected final String TEXT_530 = " = util_";
  protected final String TEXT_531 = ".correctNumPerInsert(valueList_";
  protected final String TEXT_532 = ", numPerInsert_";
  protected final String TEXT_533 = ");" + NL + "\t\t\t" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_534 = " = new StringBuilder();" + NL + "\t\t\tfor(int i_";
  protected final String TEXT_535 = "=0;i_";
  protected final String TEXT_536 = " < numPerInsert_";
  protected final String TEXT_537 = ";i_";
  protected final String TEXT_538 = "++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_539 = ".append(valueList_";
  protected final String TEXT_540 = ");" + NL + "\t\t\t\t if (i_";
  protected final String TEXT_541 = "!=numPerInsert_";
  protected final String TEXT_542 = "-1) extendInsertValueStmt_";
  protected final String TEXT_543 = ".append(\",\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tString insert_";
  protected final String TEXT_544 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_545 = " + \"\\\" (";
  protected final String TEXT_546 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_547 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_555 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_556 = " + \"\\\" SET ";
  protected final String TEXT_557 = " WHERE ";
  protected final String TEXT_558 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_565 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_566 = "\", pstmt_";
  protected final String TEXT_567 = ");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_568 = " = conn_";
  protected final String TEXT_569 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_570 = " + \"\\\" (";
  protected final String TEXT_571 = ") VALUES (";
  protected final String TEXT_572 = ")\");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_573 = "\", pstmtInsert_";
  protected final String TEXT_574 = ");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_579 = "\");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_580 = "\", pstmtUpdate_";
  protected final String TEXT_581 = ");" + NL + "\t    ";
  protected final String TEXT_582 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_583 = " = conn_";
  protected final String TEXT_584 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_585 = " + \"\\\" SET ";
  protected final String TEXT_586 = " WHERE ";
  protected final String TEXT_587 = "\");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_588 = "\", pstmtUpdate_";
  protected final String TEXT_589 = ");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_590 = " = conn_";
  protected final String TEXT_591 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_592 = " + \"\\\" (";
  protected final String TEXT_593 = ") VALUES (";
  protected final String TEXT_594 = ")\");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_595 = "\", pstmtInsert_";
  protected final String TEXT_596 = ");" + NL + "\t    ";
  protected final String TEXT_597 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_598 = " = conn_";
  protected final String TEXT_599 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_600 = " + \"\\\" WHERE ";
  protected final String TEXT_601 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_602 = "\", pstmt_";
  protected final String TEXT_603 = ");" + NL + "\t    ";
  protected final String TEXT_604 = NL + "\tclass BufferLine_";
  protected final String TEXT_605 = " {";
  protected final String TEXT_606 = NL + "\t\t\t";
  protected final String TEXT_607 = " ";
  protected final String TEXT_608 = ";" + NL + "\t\t\t" + NL + "    \t\tpublic BufferLine_";
  protected final String TEXT_609 = " c";
  protected final String TEXT_610 = "(";
  protected final String TEXT_611 = " ";
  protected final String TEXT_612 = "){" + NL + "\t\t\t\tthis.";
  protected final String TEXT_613 = " = ";
  protected final String TEXT_614 = ";" + NL + "\t\t\t\treturn this;" + NL + "\t\t\t}";
  protected final String TEXT_615 = NL + "\t\t\troutines.system.Dynamic ";
  protected final String TEXT_616 = ";" + NL + "\t\t\t" + NL + "\t\t\tpublic BufferLine_";
  protected final String TEXT_617 = " c";
  protected final String TEXT_618 = "(routines.system.Dynamic ";
  protected final String TEXT_619 = "){" + NL + "\t\t\t\tthis.";
  protected final String TEXT_620 = " = ";
  protected final String TEXT_621 = ";" + NL + "\t\t\t\treturn this;" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_622 = NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_623 = "> exInsertColValueList";
  protected final String TEXT_624 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_625 = " exInsertColValue";
  protected final String TEXT_626 = " = null;" + NL + "    String insert_";
  protected final String TEXT_627 = " = \"\";" + NL + "    int rowCount";
