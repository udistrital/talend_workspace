...
public class TMysqlSPMainJava
{
  ...
  protected final String TEXT_90 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_91 = " = statement_";
  protected final String TEXT_92 = ".getString(";
  protected final String TEXT_93 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_94 = " != null && tmpString_";
  protected final String TEXT_95 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_96 = ".";
  protected final String TEXT_97 = " = tmpString_";
  protected final String TEXT_98 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_99 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_100 = " = statement_";
  protected final String TEXT_101 = ".getDate(";
  protected final String TEXT_102 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_103 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_104 = ".";
  protected final String TEXT_105 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_106 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_108 = ".";
  protected final String TEXT_109 = " = statement_";
  protected final String TEXT_110 = ".get";
  protected final String TEXT_111 = "(";
  protected final String TEXT_112 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_113 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_114 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_115 = ".";
  protected final String TEXT_116 = " = null;" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_127 = NL + "\t\t// No code generated: define a schema for ";
