...
public class TEXistDeleteBeginJava
{
  ...
  protected final String TEXT_74 = " = 0;" + NL + "\torg.xmldb.api.modules.CollectionManagementService mgtService_";
  protected final String TEXT_75 = " = (org.xmldb.api.modules.CollectionManagementService) col_";
  protected final String TEXT_76 = ".getService(\"CollectionManagementService\",\"1.0\");" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_77 = " = new java.util.ArrayList<java.util.Map<String,String>>();";
  protected final String TEXT_78 = NL + "\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_79 = "_";
  protected final String TEXT_80 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap_";
  ...
  protected final String TEXT_88 = NL + NL + "\t\tfor(java.util.Map<String, String> map_";
