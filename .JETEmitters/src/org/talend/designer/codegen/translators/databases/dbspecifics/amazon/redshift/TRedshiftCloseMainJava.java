...
public class TRedshiftCloseMainJava
{
  ...
  protected final String TEXT_53 = NL + "\t}" + NL + "" + NL + "if (null != java.sql.DriverManager.getLogWriter()) {" + NL + "\tjava.sql.DriverManager.getLogWriter().close();" + NL + "}" + NL;
  protected final String TEXT_54 = NL + "java.io.PrintWriter logWriter_";
  protected final String TEXT_55 = " = (java.io.PrintWriter) globalMap.get(\"logWriter_";
  protected final String TEXT_56 = "\");" + NL + "if (logWriter_";
  protected final String TEXT_57 = " != null) {" + NL + "\tlogWriter_";
