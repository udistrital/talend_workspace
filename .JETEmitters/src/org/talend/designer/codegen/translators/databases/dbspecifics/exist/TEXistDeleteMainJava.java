...
public class TEXistDeleteMainJava
{
  ...
  protected final String TEXT_50 = "){" + NL + "\t\tString filemask_";
  protected final String TEXT_51 = " = key_";
  protected final String TEXT_52 = "; " + NL + "\t\tString dir_";
  protected final String TEXT_53 = " = null;\t" + NL + "\t\tString mask_";
  protected final String TEXT_54 = " = filemask_";
  protected final String TEXT_55 = ".replaceAll(\"\\\\\\\\\", \"/\") ;\t" + NL + "\t\tint i_";
  protected final String TEXT_56 = " = mask_";
  protected final String TEXT_57 = ".lastIndexOf('/');" + NL + "  \t\tif (i_";
  protected final String TEXT_58 = "!=-1){" + NL + "\t\t\tdir_";
  protected final String TEXT_59 = " = mask_";
  protected final String TEXT_60 = ".substring(0, i_";
  protected final String TEXT_61 = "); " + NL + "\t\t\tmask_";
  protected final String TEXT_62 = " = mask_";
  protected final String TEXT_63 = ".substring(i_";
  protected final String TEXT_64 = "+1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tmask_";
  protected final String TEXT_65 = " = mask_";
  protected final String TEXT_66 = ".replaceAll(\"\\\\.\", \"\\\\\\\\.\").replaceAll(\"\\\\*\", \".*\");" + NL + "\t\tfinal String finalMask_";
  protected final String TEXT_67 = " = mask_";
  protected final String TEXT_68 = ";";
  protected final String TEXT_69 = NL + "\t\t\tfor(String resourceName_";
  protected final String TEXT_70 = " : col_";
  protected final String TEXT_71 = ".listResources()){" + NL + "\t\t\t\tif(resourceName_";
  protected final String TEXT_72 = ".matches(finalMask_";
  protected final String TEXT_73 = ")){" + NL + "\t\t\t        org.xmldb.api.base.Resource resource_";
  protected final String TEXT_74 = " = col_";
  protected final String TEXT_75 = ".getResource(resourceName_";
  protected final String TEXT_76 = ");" + NL + "\t\t\t        ";
  protected final String TEXT_77 = NL + "\t\t\t        col_";
  protected final String TEXT_78 = ".removeResource(resource_";
  protected final String TEXT_79 = ");" + NL + "\t\t\t        ";
  protected final String TEXT_80 = NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_81 = NL + "\t\t\tfor(String subCol_";
  protected final String TEXT_82 = " : col_";
  protected final String TEXT_83 = ".listChildCollections()){" + NL + "\t\t\t\tif(subCol_";
  protected final String TEXT_84 = ".matches(finalMask_";
  protected final String TEXT_85 = ")){" + NL + "\t\t\t\t\t";
  protected final String TEXT_86 = NL + "\t\t\t\t\tmgtService_";
  protected final String TEXT_87 = ".removeCollection(subCol_";
  protected final String TEXT_88 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_90 = NL + "\t\t\tfor(String resourceName_";
  protected final String TEXT_91 = " : col_";
  protected final String TEXT_92 = ".listResources()){" + NL + "\t\t\t\tif(resourceName_";
  protected final String TEXT_93 = ".matches(finalMask_";
  protected final String TEXT_94 = ")){" + NL + "\t\t\t        org.xmldb.api.base.Resource resource_";
  protected final String TEXT_95 = " = col_";
  protected final String TEXT_96 = ".getResource(resourceName_";
  protected final String TEXT_97 = ");" + NL + "\t\t\t        ";
  protected final String TEXT_98 = NL + "\t\t\t        col_";
  protected final String TEXT_99 = ".removeResource(resource_";
  protected final String TEXT_100 = ");" + NL + "\t\t\t        ";
  protected final String TEXT_101 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tfor(String subCol_";
  protected final String TEXT_102 = " : col_";
  protected final String TEXT_103 = ".listChildCollections()){" + NL + "\t\t\t\tif(subCol_";
  protected final String TEXT_104 = ".matches(finalMask_";
  protected final String TEXT_105 = ")){" + NL + "\t\t\t\t\t";
  protected final String TEXT_106 = NL + "\t\t\t\t\tmgtService_";
  protected final String TEXT_107 = ".removeCollection(subCol_";
  protected final String TEXT_108 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_109 = NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_110 = NL + "\t\tnb_file_";
