...
public class TIngresOutputEndJava
{
  ...
  protected final String TEXT_69 = NL + "                int[] status_";
  protected final String TEXT_70 = " = null;" + NL + "                int countSum_";
  protected final String TEXT_71 = " = 0;" + NL + "                try {" + NL + "                    if(pstmt_";
  protected final String TEXT_72 = "!=null && batchSizeCounter_";
  protected final String TEXT_73 = " > 0 ){";
  protected final String TEXT_74 = NL + "                        status_";
  protected final String TEXT_75 = " = pstmt_";
  protected final String TEXT_76 = ".executeBatch();";
  protected final String TEXT_77 = NL + "                        for(int countEach_";
  protected final String TEXT_78 = ": status_";
  protected final String TEXT_79 = ") {" + NL + "                            countSum_";
  protected final String TEXT_80 = " += (countEach_";
  protected final String TEXT_81 = " < 0 ? 0 : countEach_";
  protected final String TEXT_82 = ");" + NL + "                        }" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_83 = NL + "                        throw(e);";
  protected final String TEXT_84 = NL + "                    for(int countEach_";
  protected final String TEXT_85 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_86 = " += (countEach_";
  protected final String TEXT_87 = " < 0 ? 0 : countEach_";
  protected final String TEXT_88 = ");" + NL + "                    }" + NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_89 = NL + "                }" + NL + "                if(pstmt_";
  protected final String TEXT_90 = "!=null && batchSizeCounter_";
  protected final String TEXT_91 = " > 0 ){" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_92 = " = pstmt_";
  protected final String TEXT_93 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){" + NL + "" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_94 = " = tmp_batchUpdateCount_";
  protected final String TEXT_95 = " > countSum_";
  protected final String TEXT_96 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_97 = " : countSum_";
  protected final String TEXT_98 = ";";
  protected final String TEXT_99 = NL + "                        insertedCount_";
  protected final String TEXT_100 = " += tmp_batchUpdateCount_";
  protected final String TEXT_101 = ";";
  protected final String TEXT_102 = NL + "                        updatedCount_";
  protected final String TEXT_103 = " += tmp_batchUpdateCount_";
  protected final String TEXT_104 = ";";
  protected final String TEXT_105 = NL + "                        deletedCount_";
  protected final String TEXT_106 = " += tmp_batchUpdateCount_";
  ...
  protected final String TEXT_114 = NL + "        if(pstmt_";
  protected final String TEXT_115 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_116 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_117 = "\");" + NL + "        }";
  protected final String TEXT_118 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_119 = "\", true);";
  protected final String TEXT_120 = NL + "\t";
  protected final String TEXT_121 = NL + "    conn_";
  protected final String TEXT_122 = " .close();";
  protected final String TEXT_123 = NL + "    resourceMap.put(\"finish_";
  protected final String TEXT_124 = "\", true);";
  protected final String TEXT_125 = NL;
  protected final String TEXT_126 = NL + "\tnb_line_deleted_";
  protected final String TEXT_127 = "=nb_line_deleted_";
  protected final String TEXT_128 = "+ deletedCount_";
  protected final String TEXT_129 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_130 = "=nb_line_update_";
  protected final String TEXT_131 = " + updatedCount_";
  protected final String TEXT_132 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_133 = "=nb_line_inserted_";
  protected final String TEXT_134 = " + insertedCount_";
  protected final String TEXT_135 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_136 = "=nb_line_rejected_";
  protected final String TEXT_137 = " + rejectedCount_";
  protected final String TEXT_138 = ";" + NL + "\t";
  protected final String TEXT_139 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_140 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_141 = "_NB_LINE\",nb_line_";
  protected final String TEXT_142 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_143 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_144 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_145 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_146 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_147 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_148 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_149 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_150 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_151 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_152 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_155 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_158 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_161 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_162 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_163 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_164 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_167 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_173 = "_NB_LINE_UPDATED\",nb_line_update_";
