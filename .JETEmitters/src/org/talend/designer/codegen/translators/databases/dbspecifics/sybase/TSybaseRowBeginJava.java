...
public class TSybaseRowBeginJava
{
  ...
  protected final String TEXT_118 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_119 = " + \":\" + ";
  protected final String TEXT_120 = " + \";DatabaseName=\" + ";
  protected final String TEXT_121 = "; ";
  protected final String TEXT_122 = NL + "\t\t\t\tString url_";
  protected final String TEXT_123 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_124 = " + \":\" + ";
  protected final String TEXT_125 = " + \";DatabaseName\" + ";
  protected final String TEXT_126 = " + \";\" + ";
  protected final String TEXT_127 = ";";
  protected final String TEXT_128 = NL + "\t\t\t\tString url_";
  protected final String TEXT_129 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_130 = " + \":\" + ";
  protected final String TEXT_131 = " + \"/\" + ";
  protected final String TEXT_132 = "; " + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t\tString url_";
  protected final String TEXT_134 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_141 = " ;" + NL + "\t\t\t\tString dbschema_";
  ...
  protected final String TEXT_148 = ";" + NL + "\t\t\t\t}" + NL + "\t\t\t\tstmt_";
  protected final String TEXT_149 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_150 = " +\" ON\");" + NL + "\t\t\t";
