...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_270 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_278 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_289 = NL + "                                if(whetherExist_";
  protected final String TEXT_290 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_294 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_302 = ".commit();";
  protected final String TEXT_303 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_322 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_323 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_324 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_330 = NL + "                stmtClear_";
  protected final String TEXT_331 = ".executeUpdate(\"";
  protected final String TEXT_332 = "\");";
  protected final String TEXT_333 = NL + "            }";
  protected final String TEXT_334 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_335 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_336 = " = conn_";
  protected final String TEXT_337 = ".createStatement()) {";
  protected final String TEXT_338 = NL + "                              stmtTruncCount_";
  protected final String TEXT_339 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_340 = "));";
  protected final String TEXT_341 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_342 = " = stmtTruncCount_";
  protected final String TEXT_343 = ".executeQuery(\"";
  protected final String TEXT_344 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_345 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_346 = " = rsTruncCount_";
  protected final String TEXT_347 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_355 = NL + "                stmtTrunc_";
  protected final String TEXT_356 = ".executeUpdate(\"";
  protected final String TEXT_357 = "\");";
  protected final String TEXT_358 = NL + "                    if(!conn_";
  protected final String TEXT_359 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_360 = ".commit();" + NL + "                    }";
  protected final String TEXT_361 = NL + "                deletedCount_";
  protected final String TEXT_362 = " += rsTruncCountNumber_";
  protected final String TEXT_363 = ";" + NL + "            }";
  protected final String TEXT_364 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_380 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_387 = "\")+\") VALUES (";
  protected final String TEXT_388 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_396 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_397 = ".";
  protected final String TEXT_398 = ")+\")\";";
  protected final String TEXT_399 = NL + "    pstmt_";
  protected final String TEXT_400 = " = conn_";
  protected final String TEXT_401 = ".prepareStatement(insert_";
  protected final String TEXT_402 = ");" + NL + "    resourceMap.put(\"pstmt_";
  protected final String TEXT_403 = "\", pstmt_";
  protected final String TEXT_404 = ");";
  protected final String TEXT_405 = NL + "    pstmt_";
  protected final String TEXT_406 = " = null;" + NL + "    String keyPsmt_";
  protected final String TEXT_407 = " = conn_";
  protected final String TEXT_408 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_409 = " + \"]\";" + NL + "    if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_410 = ")== null){" + NL + "        pstmt_";
  ...
  protected final String TEXT_414 = "\", pstmt_";
  protected final String TEXT_415 = ");" + NL + "        GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_416 = ", pstmt_";
  protected final String TEXT_417 = ");" + NL + "    }else{" + NL + "        pstmt_";
  protected final String TEXT_418 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_428 = NL + "\t\t\t\tString update_";
  protected final String TEXT_429 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_430 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_437 = ".prepareStatement(update_";
  protected final String TEXT_438 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_478 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_483 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_484 = "\", pstmtInsert_";
  ...
  protected final String TEXT_488 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_489 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_524 = NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_532 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_533 = "\", pstmtInsert_";
  protected final String TEXT_534 = ");" + NL + "\t    ";
  protected final String TEXT_535 = NL + "\t    String delete_";
  protected final String TEXT_536 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_537 = " + \"\\\" WHERE ";
  protected final String TEXT_538 = "\";" + NL + "\t    pstmt_";
  protected final String TEXT_539 = " = conn_";
  protected final String TEXT_540 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_567 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_568 = " = insertIgnore_";
  protected final String TEXT_569 = ".split(\"\\\\?\");";
  protected final String TEXT_570 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_571 = " = insert_";
  protected final String TEXT_572 = ".split(\"\\\\?\");";
  protected final String TEXT_573 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_574 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_575 = " = buffersSize_";
  protected final String TEXT_576 = ";";
  protected final String TEXT_577 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_578 = " = buffersSize_";
  protected final String TEXT_579 = ";";
  protected final String TEXT_580 = NL + "        whetherReject_";
  protected final String TEXT_581 = " = false;";
  protected final String TEXT_582 = NL + "                    ";
  protected final String TEXT_583 = NL + "                        query_";
  protected final String TEXT_584 = " = ";
  protected final String TEXT_585 = ";";
  protected final String TEXT_586 = NL + "                            geometryColumnName_";
  protected final String TEXT_587 = " = \"";
  protected final String TEXT_588 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_589 = ") {" + NL + "                                dimension_";
  protected final String TEXT_590 = " = 2;" + NL + "" + NL + "                                // A null first geometry will lead to unknown coordinate system" + NL + "                                if (";
  protected final String TEXT_591 = ".";
  protected final String TEXT_592 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_593 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_594 = " =" + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_595 = ".";
  protected final String TEXT_596 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_597 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_598 = " = refSys_";
  protected final String TEXT_599 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_600 = " = refSys_";
  protected final String TEXT_601 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_602 = " == null || ident_";
  protected final String TEXT_603 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_604 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_605 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_606 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_607 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_608 = " = Integer.parseInt(code_";
  protected final String TEXT_609 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "                                            String SRIDError_";
  protected final String TEXT_610 = " = \"SRID_";
  protected final String TEXT_611 = " could not be determined\";";
  protected final String TEXT_612 = NL + "                                            System.out.println(SRIDError_";
  protected final String TEXT_613 = ");" + NL + "                                            SRID_";
  protected final String TEXT_614 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_615 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_616 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_617 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_618 = ",";
  protected final String TEXT_619 = ".";
  protected final String TEXT_620 = ", ";
  protected final String TEXT_621 = ",insertSQLSplits_";
  protected final String TEXT_622 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_623 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_624 = ".";
  protected final String TEXT_625 = ", pstmt_";
  protected final String TEXT_626 = ", ";
  protected final String TEXT_627 = ", \"";
  protected final String TEXT_628 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_629 = NL + "                globalMap.put(\"";
  protected final String TEXT_630 = "_QUERY\", query_";
  protected final String TEXT_631 = ".toString().trim());";
  protected final String TEXT_632 = NL + "\t\t\t";
  protected final String TEXT_633 = NL + "    \t\tpstmt_";
  protected final String TEXT_634 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_635 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_636 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_637 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_638 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_639 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_640 = NL + "                \tsp_";
  protected final String TEXT_641 = " = conn_";
  protected final String TEXT_642 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_643 = NL + "                insertedCount_";
  protected final String TEXT_644 = " = insertedCount_";
  protected final String TEXT_645 = " + pstmt_";
  protected final String TEXT_646 = ".executeUpdate();";
  protected final String TEXT_647 = NL + "\t\t\t\t";
  protected final String TEXT_648 = NL + "\t                conn_";
  protected final String TEXT_649 = ".releaseSavepoint(sp_";
  protected final String TEXT_650 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_651 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_652 = NL + "\t                conn_";
  protected final String TEXT_653 = ".rollback(sp_";
  ...
  protected final String TEXT_670 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_697 = NL + "\t\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_715 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_716 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_717 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_718 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_719 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_720 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_721 = NL + "\t                sp_";
  protected final String TEXT_722 = " = conn_";
  protected final String TEXT_723 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_724 = NL + "                updatedCount_";
  protected final String TEXT_725 = " = updatedCount_";
  protected final String TEXT_726 = " + pstmt_";
  protected final String TEXT_727 = ".executeUpdate();";
  protected final String TEXT_728 = NL + "\t\t\t\t";
  protected final String TEXT_729 = NL + "                \tconn_";
  protected final String TEXT_730 = ".releaseSavepoint(sp_";
  protected final String TEXT_731 = ");";
  protected final String TEXT_732 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_733 = NL + "\t                conn_";
  protected final String TEXT_734 = ".rollback(sp_";
  ...
  protected final String TEXT_741 = "Struct();";
  protected final String TEXT_742 = NL + "                            ";
  protected final String TEXT_743 = ".";
  protected final String TEXT_744 = " = ";
  protected final String TEXT_745 = ".";
  protected final String TEXT_746 = ";";
  protected final String TEXT_747 = NL + "                        rejectedCount_";
  protected final String TEXT_748 = " = rejectedCount_";
  protected final String TEXT_749 = " + 1;";
  protected final String TEXT_750 = NL + "                        ";
  protected final String TEXT_751 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_752 = NL + "                        ";
  protected final String TEXT_753 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_754 = ";";
  protected final String TEXT_755 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_756 = NL + "            }";
  protected final String TEXT_757 = NL + "                    \t";
  protected final String TEXT_758 = NL + "                    ";
  protected final String TEXT_759 = NL + "            int checkCount_";
  protected final String TEXT_760 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_761 = " = pstmt_";
  protected final String TEXT_762 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_763 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_764 = " = rs_";
  protected final String TEXT_765 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_766 = " > 0) {";
  protected final String TEXT_767 = NL + "                        ";
  protected final String TEXT_768 = NL + "                            query_";
  protected final String TEXT_769 = " = ";
  protected final String TEXT_770 = ";";
  protected final String TEXT_771 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_772 = ",";
  protected final String TEXT_773 = ".";
  protected final String TEXT_774 = ", ";
  protected final String TEXT_775 = ",updateSQLSplits_";
  protected final String TEXT_776 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_777 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_778 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_779 = ".";
  protected final String TEXT_780 = ", pstmtUpdate_";
  ...
  protected final String TEXT_804 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_805 = NL + "\t                    sp_";
  protected final String TEXT_806 = " = conn_";
  protected final String TEXT_807 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_808 = NL + "                    updatedCount_";
  protected final String TEXT_809 = " = updatedCount_";
  protected final String TEXT_810 = " + pstmtUpdate_";
  protected final String TEXT_811 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_812 = "++;";
  protected final String TEXT_813 = NL + "\t\t\t\t\t";
  protected final String TEXT_814 = NL + "    \t                conn_";
  protected final String TEXT_815 = ".releaseSavepoint(sp_";
  protected final String TEXT_816 = ");" + NL + "    \t            ";
  protected final String TEXT_817 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_818 = NL + "    \t                conn_";
  protected final String TEXT_819 = ".rollback(sp_";
  protected final String TEXT_820 = ");" + NL + "    \t            ";
  protected final String TEXT_821 = NL + "                    whetherReject_";
  protected final String TEXT_822 = " = true;";
  protected final String TEXT_823 = NL + "                        throw(e);";
  ...
  protected final String TEXT_843 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_844 = NL + "                        ";
  protected final String TEXT_845 = NL + "                            query_";
  protected final String TEXT_846 = " = ";
  protected final String TEXT_847 = ";";
  protected final String TEXT_848 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_849 = ",";
  protected final String TEXT_850 = ".";
  protected final String TEXT_851 = ", ";
  protected final String TEXT_852 = ",insertSQLSplits_";
  protected final String TEXT_853 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_854 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_855 = ".";
  protected final String TEXT_856 = ", pstmtInsert_";
  protected final String TEXT_857 = ", ";
  protected final String TEXT_858 = ", \"";
  protected final String TEXT_859 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_860 = NL + "                    globalMap.put(\"";
  protected final String TEXT_861 = "_QUERY\", query_";
  protected final String TEXT_862 = ".toString().trim());";
  protected final String TEXT_863 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_864 = NL + "\t                    sp_";
  protected final String TEXT_865 = " = conn_";
  protected final String TEXT_866 = ".setSavepoint();" + NL + "\t                ";
  ...
  protected final String TEXT_873 = NL + "    \t                conn_";
  protected final String TEXT_874 = ".releaseSavepoint(sp_";
  protected final String TEXT_875 = ");" + NL + "    \t            ";
  protected final String TEXT_876 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_877 = NL + "    \t                conn_";
  protected final String TEXT_878 = ".rollback(sp_";
  protected final String TEXT_879 = ");" + NL + "    \t            ";
  protected final String TEXT_880 = NL + "                    whetherReject_";
  ...
  protected final String TEXT_903 = NL + "            int updateFlag_";
  protected final String TEXT_904 = "=0;";
  protected final String TEXT_905 = NL + "                    ";
  protected final String TEXT_906 = NL + "                        query_";
  protected final String TEXT_907 = " = ";
  protected final String TEXT_908 = ";";
  protected final String TEXT_909 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_910 = ",";
  protected final String TEXT_911 = ".";
  protected final String TEXT_912 = ", ";
  protected final String TEXT_913 = ",updateSQLSplits_";
  protected final String TEXT_914 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_915 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_916 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_917 = ".";
  protected final String TEXT_918 = ", pstmtUpdate_";
  ...
  protected final String TEXT_943 = NL + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_944 = NL + "\t                sp_";
  protected final String TEXT_945 = " = conn_";
  protected final String TEXT_946 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_947 = NL + "                updateFlag_";
  protected final String TEXT_948 = "=pstmtUpdate_";
  protected final String TEXT_949 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_950 = " = updatedCount_";
  protected final String TEXT_951 = "+updateFlag_";
  protected final String TEXT_952 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_953 = NL + "\t                conn_";
  protected final String TEXT_954 = ".releaseSavepoint(sp_";
  protected final String TEXT_955 = ");" + NL + "\t            ";
  protected final String TEXT_956 = NL + "            if(updateFlag_";
  protected final String TEXT_957 = " == 0) {" + NL + "            \t";
  protected final String TEXT_958 = NL + "\t\t\t\tquery_";
  protected final String TEXT_959 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_980 = NL + "\t                    sp_";
  protected final String TEXT_981 = " = conn_";
  protected final String TEXT_982 = ".setSavepoint();" + NL + "\t                ";
  ...
  protected final String TEXT_990 = ".releaseSavepoint(sp_";
  protected final String TEXT_991 = ");" + NL + "    \t            ";
  protected final String TEXT_992 = NL + "    \t            }else{" + NL + "    \t\t\t\t\tnb_line_";
  protected final String TEXT_993 = "++;" + NL + "     \t\t\t\t\t";
  protected final String TEXT_994 = NL + "    \t\t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_995 = NL + "    \t                conn_";
  protected final String TEXT_996 = ".rollback(sp_";
  protected final String TEXT_997 = ");" + NL + "    \t            ";
  protected final String TEXT_998 = NL + "                    whetherReject_";
  protected final String TEXT_999 = " = true;";
  protected final String TEXT_1000 = NL + "                        throw(e);";
  protected final String TEXT_1001 = NL + "                        nb_line_";
  protected final String TEXT_1002 = "++;";
  protected final String TEXT_1003 = NL + "                            ";
  protected final String TEXT_1004 = " = new ";
  protected final String TEXT_1005 = "Struct();";
  ...
  protected final String TEXT_1011 = NL + "                            rejectedCount_";
  protected final String TEXT_1012 = " = rejectedCount_";
  protected final String TEXT_1013 = " + 1;";
  protected final String TEXT_1014 = NL + "                            ";
  protected final String TEXT_1015 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1016 = NL + "                            ";
  protected final String TEXT_1017 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1018 = ";";
  protected final String TEXT_1019 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_1033 = NL + "    \t\tpstmt_";
  protected final String TEXT_1034 = ".addBatch();" + NL + "\t\t\tnb_line_";
  ...
  protected final String TEXT_1038 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_1039 = NL + "\t                sp_";
  protected final String TEXT_1040 = " = conn_";
  protected final String TEXT_1041 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_1042 = NL + "                deletedCount_";
  protected final String TEXT_1043 = " = deletedCount_";
  protected final String TEXT_1044 = " + pstmt_";
  protected final String TEXT_1045 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1046 = "++;";
  protected final String TEXT_1047 = NL + "\t\t\t\t";
  protected final String TEXT_1048 = NL + "\t                conn_";
  protected final String TEXT_1049 = ".releaseSavepoint(sp_";
  protected final String TEXT_1050 = ");" + NL + "\t            ";
  protected final String TEXT_1051 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_1052 = NL + "\t                conn_";
  protected final String TEXT_1053 = ".rollback(sp_";
  protected final String TEXT_1054 = ");" + NL + "\t            ";
  protected final String TEXT_1055 = NL + "                whetherReject_";
  ...
  protected final String TEXT_1078 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1089 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_1090 = " > 0) && (batchSize_";
  protected final String TEXT_1091 = " <= batchSizeCounter_";
  protected final String TEXT_1092 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1093 = " = 0;" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_1094 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1095 = ": pstmt_";
  protected final String TEXT_1096 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1110 = NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_1111 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1112 = "){" + NL + "\t\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_1113 = " = e_";
  protected final String TEXT_1114 = ".getNextException(),sqle_";
  protected final String TEXT_1115 = "=null;" + NL + "\t\t\t\t    \tString errormessage_";
  protected final String TEXT_1116 = ";" + NL + "\t\t\t\t\t\tif (ne_";
  protected final String TEXT_1117 = " != null) {" + NL + "\t\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\t\tsqle_";
  protected final String TEXT_1118 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1119 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1120 = ".getMessage(), ne_";
  protected final String TEXT_1121 = ".getSQLState(), ne_";
  protected final String TEXT_1122 = ".getErrorCode(), ne_";
  protected final String TEXT_1123 = ");" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1124 = " = sqle_";
  protected final String TEXT_1125 = ".getMessage();" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1126 = " = e_";
  protected final String TEXT_1127 = ".getMessage();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1128 = NL + "\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_1129 = " != null) {" + NL + "\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1130 = ");" + NL + "\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t            \tthrow(e_";
  protected final String TEXT_1131 = ");" + NL + "\t\t\t\t            }" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1132 = NL + "\t\t\t\t    \tint countSum_";
  protected final String TEXT_1133 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1134 = ": e_";
  protected final String TEXT_1135 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1136 = " += (countEach_";
  protected final String TEXT_1137 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1142 = NL + "\t\t\t\t    \t\tupdatedCount_";
  ...
  protected final String TEXT_1146 = " += countSum_";
  protected final String TEXT_1147 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1148 = NL + "\t\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_1149 = ");" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1150 = NL + "\t\t\t\t\t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1151 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1152 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1153 = " <= commitCounter_";
  protected final String TEXT_1154 = ") {";
  protected final String TEXT_1155 = NL + "                if ((batchSize_";
  protected final String TEXT_1156 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1157 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1158 = " = 0;" + NL + "                \t\t    ";
  protected final String TEXT_1159 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1160 = ": pstmt_";
  protected final String TEXT_1161 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1162 = " += (countEach_";
  protected final String TEXT_1163 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1164 = ");" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_1165 = NL + "            \t    \t";
  protected final String TEXT_1166 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1167 = " += countSum_";
  protected final String TEXT_1168 = ";" + NL + "            \t    \t";
  protected final String TEXT_1169 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1170 = " += countSum_";
  protected final String TEXT_1171 = ";" + NL + "            \t    \t";
  protected final String TEXT_1172 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1173 = " += countSum_";
  protected final String TEXT_1174 = ";" + NL + "            \t    \t";
  protected final String TEXT_1175 = NL + "                batchSizeCounter_";
  protected final String TEXT_1176 = " = 0;" + NL + "               }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1177 = "){" + NL + "\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_1178 = " = e_";
  protected final String TEXT_1179 = ".getNextException(),sqle_";
  protected final String TEXT_1180 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_1181 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_1182 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_1183 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1184 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1185 = ".getMessage(), ne_";
  protected final String TEXT_1186 = ".getSQLState(), ne_";
  protected final String TEXT_1187 = ".getErrorCode(), ne_";
  protected final String TEXT_1188 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1189 = " = sqle_";
  protected final String TEXT_1190 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1191 = " = e_";
  protected final String TEXT_1192 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t    \t";
  protected final String TEXT_1193 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_1194 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1195 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_1196 = ");" + NL + "\t\t\t            }" + NL + "\t\t\t    \t";
  protected final String TEXT_1197 = NL + "\t\t\t    \tint countSum_";
  protected final String TEXT_1198 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1199 = ": e_";
  protected final String TEXT_1200 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1201 = " += (countEach_";
  protected final String TEXT_1202 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1208 = " += countSum_";
  protected final String TEXT_1209 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1210 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_1211 = " += countSum_";
  protected final String TEXT_1212 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1213 = NL + "\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_1214 = ");" + NL + "\t\t\t    \t";
  protected final String TEXT_1215 = NL + "\t\t\t\t}" + NL + "            }";
  protected final String TEXT_1216 = NL + "                \tconn_";
  protected final String TEXT_1217 = ".commit();" + NL + "                \t";
  protected final String TEXT_1218 = NL + "                \tcommitCounter_";
  protected final String TEXT_1219 = "=0;" + NL + "                }";
