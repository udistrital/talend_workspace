...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_505 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_506 = "\", pstmtInsert_";
  ...
  protected final String TEXT_521 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_522 = " = conn_";
  protected final String TEXT_523 = ".prepareStatement(update_";
  protected final String TEXT_524 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_530 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_531 = " = conn_";
  protected final String TEXT_532 = ".prepareStatement(insert_";
  protected final String TEXT_533 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_545 = NL + "        StringBuffer query_";
  protected final String TEXT_546 = " = null;" + NL + "       \t";
  protected final String TEXT_547 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_548 = " = insert_";
  protected final String TEXT_549 = ".split(\"\\\\?\");";
  protected final String TEXT_550 = NL + "\t\t\tupdate_";
  protected final String TEXT_551 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_575 = NL + "\t    stmt_";
  protected final String TEXT_576 = " = conn_";
  protected final String TEXT_577 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_578 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_579 = " +\" ON\");";
  protected final String TEXT_580 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_581 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_582 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_583 = " =null;" + NL + "\t";
  protected final String TEXT_584 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_588 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_589 = " =  null;";
  protected final String TEXT_590 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_591 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_592 = " = null;";
  protected final String TEXT_593 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_597 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
