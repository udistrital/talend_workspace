...
public class TOleDbInputEndJava
{
  ...
  protected final String TEXT_44 = NL + "oBool_";
  protected final String TEXT_45 = " = (Boolean)reader_";
  protected final String TEXT_46 = ".invokeGeneric(\"Read\");" + NL + "bool_";
  protected final String TEXT_47 = " = oBool_";
  protected final String TEXT_48 = " != null && oBool_";
  protected final String TEXT_49 = ".booleanValue();" + NL + "}";
  protected final String TEXT_50 = NL + "reader_";
  protected final String TEXT_51 = ".invoke(\"Close\");" + NL + "conn_";
  protected final String TEXT_52 = ".invoke(\"Close\");";
