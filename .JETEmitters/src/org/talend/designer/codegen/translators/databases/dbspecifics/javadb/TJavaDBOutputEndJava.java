...
public class TJavaDBOutputEndJava
{
  ...
  protected final String TEXT_52 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  ...
  protected final String TEXT_76 = NL + "    \ttry" + NL + "    \t{" + NL + "    \t\tjava.sql.DriverManager.getConnection(\"jdbc:derby:;shutdown=true\");" + NL + "    \t}" + NL + "    \tcatch(java.sql.SQLException se)" + NL + "    \t{" + NL + "            /*" + NL + "               In embedded mode, an application should shut down Derby." + NL + "               If the application fails to shut down Derby explicitly," + NL + "               the Derby does not perform a checkpoint when the JVM shuts down, which means" + NL + "               that the next connection will be slower." + NL + "               Explicitly shutting down Derby with the URL is preferred." + NL + "               This style of shutdown will always throw an \"exception\"." + NL + "             */" + NL + "    \t}\t";
  protected final String TEXT_77 = NL + "    \tserverControl_";
  protected final String TEXT_78 = ".shutdown();" + NL + "    \t";
  protected final String TEXT_79 = NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_80 = "\", true);" + NL + "\t" + NL + "\tint rejectedCount_";
  protected final String TEXT_81 = " = 0;" + NL + "\t";
  protected final String TEXT_82 = NL + "\tnb_line_deleted_";
  protected final String TEXT_83 = "=nb_line_deleted_";
  protected final String TEXT_84 = "+ deletedCount_";
  protected final String TEXT_85 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_86 = "=nb_line_update_";
  protected final String TEXT_87 = " + updatedCount_";
  protected final String TEXT_88 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_89 = "=nb_line_inserted_";
  protected final String TEXT_90 = " + insertedCount_";
  protected final String TEXT_91 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_92 = "=nb_line_rejected_";
  protected final String TEXT_93 = " + rejectedCount_";
  protected final String TEXT_94 = ";" + NL + "\t";
  protected final String TEXT_95 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_96 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_97 = "_NB_LINE\",nb_line_";
  protected final String TEXT_98 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_99 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_100 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_101 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_102 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_103 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_104 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_105 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_106 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_107 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_108 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_111 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_112 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_113 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_114 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_117 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_118 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_119 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_120 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_123 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_131 = "_NB_LINE_INSERTED\",nb_line_inserted_";
