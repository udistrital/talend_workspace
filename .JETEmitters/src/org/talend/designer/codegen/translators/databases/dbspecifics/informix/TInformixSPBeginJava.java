...
public class TInformixSPBeginJava
{
  ...
  protected final String TEXT_49 = NL + "\tjava.lang.Class.forName(\"com.informix.jdbc.IfxDriver\");" + NL + "\t";
  protected final String TEXT_50 = NL + "    \tString url_";
  protected final String TEXT_51 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_52 = " + \":\" + ";
  protected final String TEXT_53 = " + \"/\" + ";
  protected final String TEXT_54 = " + \":informixserver=\" + ";
  protected final String TEXT_55 = ";";
  protected final String TEXT_56 = NL + "\t\tString url_";
  protected final String TEXT_57 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_58 = " + \":\" + ";
  protected final String TEXT_59 = " + \"/\" + ";
  protected final String TEXT_60 = " + \":informixserver=\" + ";
  ...
  protected final String TEXT_72 = NL + "\tjava.sql.Connection connection_";
  protected final String TEXT_73 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_74 = ", ";
  protected final String TEXT_75 = ", decryptedPassword_";
  protected final String TEXT_76 = ");" + NL + "\t";
  protected final String TEXT_77 = NL + "\t";
  protected final String TEXT_78 = NL + "\tif(connection_";
  protected final String TEXT_79 = ".getAutoCommit()) {" + NL + "\t    connection_";
  protected final String TEXT_80 = ".setAutoCommit(false);" + NL + "\t}";
  protected final String TEXT_81 = NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_82 = " = connection_";
  protected final String TEXT_83 = ".prepareCall(\"{";
  protected final String TEXT_84 = "call \" + ";
  protected final String TEXT_85 = " + \"(";
  protected final String TEXT_86 = "?";
  protected final String TEXT_87 = ",?";
  protected final String TEXT_88 = ")}\");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_89 = ";" + NL + "String tmpString_";
