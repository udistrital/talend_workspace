...
public class TAmazonOracleOutputMainJava {
  ...
  protected final String TEXT_412 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_424 = "    " + NL + "" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_425 = " = conn_";
  protected final String TEXT_426 = ".prepareStatement(insert_";
  protected final String TEXT_427 = ");" + NL + "\t\t\t\tresourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_468 = "\");" + NL + "\t\t\t\tresourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_478 = ".toUpperCase()";
  ...
  protected final String TEXT_489 = ".toUpperCase()";
  protected final String TEXT_490 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_491 = ".";
  protected final String TEXT_492 = ")+\")\";";
  protected final String TEXT_493 = NL + "\t\t\t\t\t\tString update_";
  protected final String TEXT_494 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_495 = " + \" SET ";
  protected final String TEXT_496 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_505 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_524 = ");" + NL + "\t\t\t\tresourceMap.put(\"pstmtInsert_";
  protected final String TEXT_525 = "\", pstmtInsert_";
  protected final String TEXT_526 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_527 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_528 = " = new StringBuffer(update_";
  protected final String TEXT_529 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_530 = ".insert(update_";
  protected final String TEXT_531 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_532 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_533 = " =updateStringBuffer_";
  protected final String TEXT_534 = ".toString(); ";
  protected final String TEXT_535 = NL + "\t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_548 = ".toUpperCase()";
  ...
  protected final String TEXT_559 = ".toUpperCase()";
  protected final String TEXT_560 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_570 = ".toUpperCase()";
  ...
  protected final String TEXT_575 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_591 = NL + "\t\t\t\tpstmtUpdate_";
  protected final String TEXT_592 = " = conn_";
  protected final String TEXT_593 = ".prepareStatement(update_";
  protected final String TEXT_594 = ");" + NL + "\t\t\t\tresourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_595 = "\", pstmtUpdate_";
  protected final String TEXT_596 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_597 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_598 = " = new StringBuffer(insert_";
  protected final String TEXT_599 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_600 = ".insert(insert_";
  protected final String TEXT_601 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_602 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_603 = " =insertStringBuffer_";
  protected final String TEXT_604 = ".toString(); ";
  protected final String TEXT_605 = "    " + NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_606 = " = conn_";
  protected final String TEXT_607 = ".prepareStatement(insert_";
  protected final String TEXT_608 = ");" + NL + "\t\t\t\tresourceMap.put(\"pstmtInsert_";
  protected final String TEXT_609 = "\", pstmtInsert_";
  protected final String TEXT_610 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_611 = NL + "\t\t\t\tString delete_";
  protected final String TEXT_612 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_613 = " + \" WHERE ";
  protected final String TEXT_614 = "\";" + NL + "\t\t\t\t";
  protected final String TEXT_615 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_616 = " = new StringBuffer(delete_";
  protected final String TEXT_617 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_618 = ".insert(delete_";
  protected final String TEXT_619 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_620 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_621 = " =deleteStringBuffer_";
  protected final String TEXT_622 = ".toString();  ";
  protected final String TEXT_623 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_624 = " = conn_";
  protected final String TEXT_625 = ".prepareStatement(delete_";
  protected final String TEXT_626 = ");" + NL + "\t\t\t\tresourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_652 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  ...
  protected final String TEXT_661 = " = new StringBuffer(\"\");";
  protected final String TEXT_662 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_663 = " = buffersSize_";
  protected final String TEXT_664 = ";";
  protected final String TEXT_665 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_666 = " = buffersSize_";
  protected final String TEXT_667 = ";";
  protected final String TEXT_668 = NL + NL;
  protected final String TEXT_669 = NL + "        whetherReject_";
  protected final String TEXT_670 = " = false;";
  protected final String TEXT_671 = NL + "\t\t\t\t\t     \t// TODO unable to parse integer: ";
  protected final String TEXT_672 = NL + "\t\t\t\t\t     \t// TODO error: ";
  protected final String TEXT_673 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_674 = NL + "                    \torg.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_675 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_676 = ".";
  protected final String TEXT_677 = ";" + NL + "\t                    com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_678 = " = tGeometry_";
  protected final String TEXT_679 = "._getInternalGeometry();" + NL + "" + NL + "                    \tcom.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_680 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_681 = "\");" + NL + "                    \tif (extends_";
  protected final String TEXT_682 = " == null) {" + NL + "                    \t    geometryColumnToExtends.put(\"";
  protected final String TEXT_683 = "\", geometry_";
  protected final String TEXT_684 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "                    \telse {" + NL + "                    \t    extends_";
  protected final String TEXT_685 = ".expandToInclude(geometry_";
  protected final String TEXT_686 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "" + NL + "\t\t\t\t\t\tString wkt_";
  protected final String TEXT_687 = " = geometry_";
  protected final String TEXT_688 = ".toText();" + NL + "\t\t\t\t\t\toracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_689 = " = new oracle.spatial.util.WKT();" + NL + "\t\t\t\t\t\toracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_690 = " = oracle_wkt_";
  protected final String TEXT_691 = ".toJGeometry(wkt_";
  protected final String TEXT_692 = ".getBytes());" + NL;
  protected final String TEXT_693 = NL + "\t\t\t\t\t\t\tjgeometry_";
  protected final String TEXT_694 = ".setSRID(";
  protected final String TEXT_695 = ");";
  protected final String TEXT_696 = NL + "               \t\tpstmt_";
  protected final String TEXT_697 = ".setObject(";
  protected final String TEXT_698 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  ...
  protected final String TEXT_705 = NL + "\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_706 = ",";
  protected final String TEXT_707 = ".";
  protected final String TEXT_708 = ", ";
  protected final String TEXT_709 = ",insertSQLSplits_";
  protected final String TEXT_710 = ");";
  protected final String TEXT_711 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_712 = ".";
  protected final String TEXT_713 = ", pstmt_";
  protected final String TEXT_714 = ", ";
  protected final String TEXT_715 = ", \"";
  protected final String TEXT_716 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_717 = NL + "                globalMap.put(\"";
  protected final String TEXT_718 = "_QUERY\", query_";
  protected final String TEXT_719 = ".toString().trim());";
  protected final String TEXT_720 = NL + "    \t\t";
  protected final String TEXT_721 = NL + "    \t\tpstmt_";
  protected final String TEXT_722 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_723 = "++;" + NL + "    \t\tnb_line_";
  protected final String TEXT_724 = "++;";
  protected final String TEXT_725 = NL + "    \t\t";
  protected final String TEXT_726 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_727 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_728 = " = insertedCount_";
  protected final String TEXT_729 = " + pstmt_";
  protected final String TEXT_730 = ".executeUpdate();";
  ...
  protected final String TEXT_742 = NL + "                        rejectedCount_";
  protected final String TEXT_743 = " = rejectedCount_";
  protected final String TEXT_744 = " + 1;";
  protected final String TEXT_745 = NL + "                        ";
  protected final String TEXT_746 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_747 = NL + "                        ";
  protected final String TEXT_748 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_749 = ";";
  protected final String TEXT_750 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_762 = NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_793 = ".addBatch();" + NL + "            batchSizeCounter_";
  ...
  protected final String TEXT_798 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_799 = " = updatedCount_";
  protected final String TEXT_800 = " + pstmt_";
  protected final String TEXT_801 = ".executeUpdate();";
  ...
  protected final String TEXT_813 = NL + "                        rejectedCount_";
  protected final String TEXT_814 = " = rejectedCount_";
  protected final String TEXT_815 = " + 1;";
  protected final String TEXT_816 = NL + "                        ";
  protected final String TEXT_817 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_818 = NL + "                        ";
  protected final String TEXT_819 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_820 = ";";
  protected final String TEXT_821 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_828 = NL + "            int checkCount_";
  protected final String TEXT_829 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_830 = " = pstmt_";
  protected final String TEXT_831 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_832 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_833 = " = rs_";
  protected final String TEXT_834 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_835 = " > 0) {";
  ...
  protected final String TEXT_844 = ",updateSQLSplits_";
  protected final String TEXT_845 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_846 = NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_847 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_873 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_874 = " = updatedCount_";
  ...
  protected final String TEXT_900 = NL + "                }" + NL + "    \t\t} else {";
  ...
  protected final String TEXT_919 = ".toString().trim());";
  protected final String TEXT_920 = NL + "                try {" + NL + "                    insertedCount_";
  ...
  protected final String TEXT_947 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_948 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_958 = ",updateSQLSplits_";
  protected final String TEXT_959 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_960 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_961 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_962 = ".";
  protected final String TEXT_963 = ", pstmtUpdate_";
  ...
  protected final String TEXT_979 = NL + "\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_985 = NL + "                globalMap.put(\"";
  protected final String TEXT_986 = "_QUERY\", query_";
  protected final String TEXT_987 = ".toString().trim());";
  protected final String TEXT_988 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_989 = " = pstmtUpdate_";
  protected final String TEXT_990 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_991 = " = updatedCount_";
  protected final String TEXT_992 = "+updateFlag_";
  protected final String TEXT_993 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_994 = " == 0) {" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_995 = NL + "\t\t\t\tquery_";
  protected final String TEXT_996 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_1018 = " + pstmtInsert_";
  protected final String TEXT_1019 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1020 = "++;";
  protected final String TEXT_1021 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_1022 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_1023 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_1060 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_1061 = "++;" + NL + "    \t\tnb_line_";
  protected final String TEXT_1062 = "++;" + NL + "    \t\t";
  protected final String TEXT_1063 = NL + "    \t\t";
  protected final String TEXT_1064 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1065 = " = deletedCount_";
  protected final String TEXT_1066 = " + pstmt_";
  protected final String TEXT_1067 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_1072 = NL + "                \tnb_line_";
  protected final String TEXT_1073 = "++;" + NL + "                \t";
  protected final String TEXT_1074 = NL + "                        ";
  protected final String TEXT_1075 = " = new ";
  protected final String TEXT_1076 = "Struct();";
  ...
  protected final String TEXT_1082 = NL + "                        rejectedCount_";
  protected final String TEXT_1083 = " = rejectedCount_";
  protected final String TEXT_1084 = " + 1;";
  protected final String TEXT_1085 = NL + "                        ";
  protected final String TEXT_1086 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1087 = NL + "                        ";
  protected final String TEXT_1088 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1089 = ";";
  protected final String TEXT_1090 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1091 = NL + "            }" + NL + "    \t\t";
  protected final String TEXT_1092 = NL + "    \t";
  protected final String TEXT_1093 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1104 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_1105 = " > 0) && (batchSize_";
  protected final String TEXT_1106 = " <= batchSizeCounter_";
  protected final String TEXT_1107 = ")) {" + NL + "                \ttry {" + NL + "                \t\t";
  protected final String TEXT_1108 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_1109 = ".executeBatch();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1110 = NL + "                \t}catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1111 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1112 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1113 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_1114 = " = pstmt_";
  protected final String TEXT_1115 = ".getUpdateCount();" + NL + "        \t    \t";
  ...
  protected final String TEXT_1122 = NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1123 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1124 = ":0);" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_1125 = " = 0;" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_1126 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1127 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1128 = " <= commitCounter_";
  protected final String TEXT_1129 = ") {" + NL + "" + NL + "\t                ";
  protected final String TEXT_1130 = NL + "\t                \tif(batchSizeCounter_";
  protected final String TEXT_1131 = " > 0){" + NL + "\t\t                try {" + NL + "\t\t                \t";
  protected final String TEXT_1132 = NL + "\t                \t\tpstmt_";
  protected final String TEXT_1133 = ".executeBatch();" + NL + "\t\t                \t";
  protected final String TEXT_1134 = NL + "\t\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t\t                \t";
  protected final String TEXT_1135 = NL + "\t\t\t\t\t\t\t\tthrow(e);" + NL + "\t\t                \t";
  protected final String TEXT_1136 = NL + "\t\t                        System.err.println(e.getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_1137 = NL + NL + "\t\t                }" + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_1138 = " = pstmt_";
  protected final String TEXT_1139 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  protected final String TEXT_1140 = NL + "\t\t    \t    \t\tinsertedCount_";
  protected final String TEXT_1141 = NL + "\t\t    \t    \t";
  protected final String TEXT_1142 = NL + "\t\t    \t    \t\tupdatedCount_";
  protected final String TEXT_1143 = NL + "\t\t    \t    \t";
  protected final String TEXT_1144 = NL + "\t\t    \t    \t    deletedCount_";
  ...
  protected final String TEXT_1149 = " = 0;" + NL + "\t\t    \t    \t}" + NL + "\t                ";
  protected final String TEXT_1150 = NL + "\t                ";
  protected final String TEXT_1151 = NL + "                \tconn_";
  protected final String TEXT_1152 = ".commit();" + NL + "    \t\t\t\t";
  protected final String TEXT_1153 = NL + "                \tcommitCounter_";
  protected final String TEXT_1154 = "=0;" + NL + "                }";
