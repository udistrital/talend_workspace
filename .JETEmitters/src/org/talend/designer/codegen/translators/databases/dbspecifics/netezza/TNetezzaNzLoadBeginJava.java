...
public class TNetezzaNzLoadBeginJava {
  ...
  protected final String TEXT_302 = NL + "\t\t\t\t}" + NL + "" + NL + "                String tableName_";
  protected final String TEXT_303 = " = ";
  protected final String TEXT_304 = ";" + NL + "                String dbUser_";
  protected final String TEXT_305 = " = ";
  protected final String TEXT_306 = ";" + NL + "                String dbName_";
  protected final String TEXT_307 = " = ";
  protected final String TEXT_308 = ";" + NL + "\t\t\t\tString actualLogFilePath_";
  protected final String TEXT_309 = " = ";
  protected final String TEXT_310 = NL + "\t\t\t\t\t";
  protected final String TEXT_311 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_312 = NL + "\t\t\t\t\ttableName_";
  protected final String TEXT_313 = ".toUpperCase()" + NL + "\t\t\t\t\t+ \".\" + dbUser_";
  protected final String TEXT_314 = ".toUpperCase()" + NL + "\t\t\t\t\t+ \".\" + dbName_";
  protected final String TEXT_315 = ".toUpperCase()" + NL + "\t\t\t\t\t+ \".nzlog\";" + NL + "\t\t\t\t";
  protected final String TEXT_316 = NL + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_317 = ".set(getProcessedRowsCount(actualLogFilePath_";
  protected final String TEXT_318 = "));" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_319 = "_NZLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tprivate int getProcessedRowsCount(String pathToLogFile) {" + NL + "\t\t\tint processedRowsCount = 0;" + NL + "\t\t\ttry (org.apache.commons.io.input.ReversedLinesFileReader reversedLinesFileReader_";
  protected final String TEXT_320 = " = new org.apache.commons.io.input.ReversedLinesFileReader(new java.io.File(pathToLogFile))) {" + NL + "\t\t\t\tString logLine = null;" + NL + "\t\t\t\twhile(null != (logLine = reversedLinesFileReader_";
  protected final String TEXT_321 = ".readLine())) {" + NL + "\t\t\t\t\tif (logLine.contains(\"  number of records read:\")) {" + NL + "\t\t\t\t\t\tprocessedRowsCount = Integer.parseInt(logLine.split(\":\")[1].trim());" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch(IOException e) {";
  protected final String TEXT_322 = NL + "\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_323 = "\");";
  protected final String TEXT_324 = NL + "\t\t\t\t\tSystem.err.println(\"";
  protected final String TEXT_325 = "\");";
  protected final String TEXT_326 = NL + "\t\t\t\treturn 0;" + NL + "\t\t\t}" + NL + "\t\t\treturn processedRowsCount;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t};" + NL + "\t";
  protected final String TEXT_327 = NL + "\t\tStringBuffer command_";
  protected final String TEXT_328 = " = new StringBuffer(";
  protected final String TEXT_329 = ");" + NL + "\t\t";
  protected final String TEXT_330 = NL + "\t\t\tcommand_";
  protected final String TEXT_331 = ".append(";
  protected final String TEXT_332 = " +\" \");" + NL + "\t\t";
  protected final String TEXT_333 = NL + "\t";
  protected final String TEXT_334 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_335 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_336 = ", true, true, 1024000, 10000);" + NL + "\t\t\tnzloadThread_";
  protected final String TEXT_337 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by nzload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_338 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_339 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_340 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_341 = NL + "\t\t";
  protected final String TEXT_342 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_343 = " - Executing '\"+command_";
  protected final String TEXT_344 = ".toString()+\"'.\");" + NL + "\t\t";
  protected final String TEXT_345 = NL + "\t\tnzloadThread_";
  protected final String TEXT_346 = ".start();" + NL + "\t\tnzloadThread_";
  protected final String TEXT_347 = ".join(0);" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_348 = "_NB_LINE\", nb_line_";
  protected final String TEXT_349 = ".get());" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_350 = "_NZLOAD_OUTPUT\", nzloadOutput_";
  protected final String TEXT_351 = ".toString());" + NL + "\t\t";
  protected final String TEXT_352 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_353 = " - Execute '\"+command_";
  protected final String TEXT_354 = ".toString()+\"' has finished.\");" + NL + "\t\t";
