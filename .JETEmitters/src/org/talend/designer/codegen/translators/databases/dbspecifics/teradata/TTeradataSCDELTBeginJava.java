...
public class TTeradataSCDELTBeginJava {
  ...
  protected final String TEXT_297 = ".equalsIgnoreCase(";
  protected final String TEXT_298 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_299 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_300 = NL + "                                if(!whetherExist_";
  protected final String TEXT_301 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_321 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_322 = " = conn_";
  protected final String TEXT_323 = ".createStatement()) {";
  protected final String TEXT_324 = NL + "                                                      stmtDrop_";
  ...
  protected final String TEXT_334 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_353 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_354 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_355 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_365 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_366 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_367 = " = conn_";
  protected final String TEXT_368 = ".createStatement()) {";
  protected final String TEXT_369 = NL + "                              stmtTruncCount_";
  protected final String TEXT_370 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_371 = "));";
  protected final String TEXT_372 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_373 = " = stmtTruncCount_";
  protected final String TEXT_374 = ".executeQuery(\"";
  protected final String TEXT_375 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_376 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_377 = " = rsTruncCount_";
  protected final String TEXT_378 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_395 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_400 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_411 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_412 = NL;
  protected final String TEXT_413 = NL + "        String updateForType1_";
  protected final String TEXT_414 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_415 = " +\" FROM \"+ sourceTable_";
  protected final String TEXT_416 = " + \" t SET ";
  protected final String TEXT_417 = " WHERE ";
  protected final String TEXT_418 = " AND (";
  protected final String TEXT_419 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_420 = " = conn_";
  protected final String TEXT_421 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_422 = ".executeUpdate(updateForType1_";
  protected final String TEXT_423 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_424 = ".close();";
  protected final String TEXT_425 = NL + "        String updateForType2_";
  protected final String TEXT_426 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_427 = NL + "                                        + \" FROM \" + sourceTable_";
  protected final String TEXT_428 = " + \" t\"" + NL + "                                        + \" SET ";
  protected final String TEXT_429 = " = cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_430 = "\")))" + NL + "                                        + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)')";
  protected final String TEXT_431 = ", ";
  protected final String TEXT_432 = " = 0";
  protected final String TEXT_433 = " \"" + NL + "                                        + \" WHERE ";
  protected final String TEXT_434 = " AND (";
  protected final String TEXT_435 = ") AND \" + tableName_";
  protected final String TEXT_436 = " + \".";
  protected final String TEXT_437 = " IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_438 = " = conn_";
  protected final String TEXT_439 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_440 = ".executeUpdate(updateForType2_";
  protected final String TEXT_441 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_442 = ".close();";
  protected final String TEXT_443 = NL + "        String insertForType2_";
  protected final String TEXT_444 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_445 = " + \"(";
  protected final String TEXT_446 = ", ";
  protected final String TEXT_447 = ") SELECT ";
  protected final String TEXT_448 = "\" + ";
  protected final String TEXT_449 = " + \".NEXTVAL, ";
  protected final String TEXT_450 = "t.";
  protected final String TEXT_451 = ", cast('\" +" + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_452 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)'), NULL";
  protected final String TEXT_453 = ", 1";
  protected final String TEXT_454 = ", d.";
  protected final String TEXT_455 = " + 1";
  protected final String TEXT_456 = " FROM \" +" + NL + "        sourceTable_";
  protected final String TEXT_457 = " + \" t, \" + tableName_";
  protected final String TEXT_458 = " + \" d WHERE ";
  protected final String TEXT_459 = " AND (";
  protected final String TEXT_460 = ") AND d.";
  protected final String TEXT_461 = " = cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_462 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)')\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_463 = " = conn_";
  protected final String TEXT_464 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_465 = ".executeUpdate(insertForType2_";
  protected final String TEXT_466 = ");" + NL + "        stmtType2Insert_";
  ...
  protected final String TEXT_472 = ") SELECT ";
  protected final String TEXT_473 = "\" + ";
  protected final String TEXT_474 = " + \".NEXTVAL, ";
  protected final String TEXT_475 = "t.";
  protected final String TEXT_476 = "\"";
  protected final String TEXT_477 = " + \", cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_478 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)'), NULL\"";
  protected final String TEXT_479 = NL + "    + \"";
  protected final String TEXT_480 = ", 1";
  protected final String TEXT_481 = ", 1";
  protected final String TEXT_482 = " FROM \" +" + NL + "    sourceTable_";
  protected final String TEXT_483 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_484 = " + \" d ON ";
  protected final String TEXT_485 = " WHERE (";
  protected final String TEXT_486 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_487 = " = conn_";
  protected final String TEXT_488 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_489 = ".executeUpdate(insert_";
  protected final String TEXT_490 = ");" + NL + "    stmtInsert_";
