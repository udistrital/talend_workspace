...
public class ComponentProcess_data_begin
{
  ...
  protected final String TEXT_128 = ");" + NL + "\t\t\t\t\tjava.lang.Iterable<?> outgoingRecs_";
  protected final String TEXT_129 = " = writerWithFeedbackMain_";
  protected final String TEXT_130 = ".getSuccessfulWrites();" + NL + "                    java.util.Iterator outgoingMainRecords_";
  protected final String TEXT_131 = " = outgoingRecs_";
  protected final String TEXT_132 = ".iterator();" + NL + "                    Object outgoingMain_";
  protected final String TEXT_133 = " = null;" + NL + "                    if (outgoingMainRecords_";
  protected final String TEXT_134 = ".hasNext()) {" + NL + "                    \toutgoingMainRecordsList_";
  protected final String TEXT_135 = " = outgoingRecs_";
  protected final String TEXT_136 = ";" + NL + "                    }" + NL + "              \t}";
  protected final String TEXT_137 = NL + "                java.lang.Iterable<?> outgoingRejectRecordsList_";
  protected final String TEXT_138 = " = new java.util.ArrayList<Object>();" + NL + "                if (writer_";
  protected final String TEXT_139 = " instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {" + NL + "\t\t\t\t\t     org.talend.components.api.component.runtime.WriterWithFeedback writerWithFeedbackReject_";
  protected final String TEXT_140 = " = (org.talend.components.api.component.runtime.WriterWithFeedback) writer_";
  protected final String TEXT_141 = ";" + NL + "\t\t\t\t\t     writerWithFeedbackReject_";
  protected final String TEXT_142 = " = new org.talend.codegen.flowvariables.runtime.FlowVariablesWriter(writerWithFeedbackReject_";
  protected final String TEXT_143 = ", container_";
  protected final String TEXT_144 = ");" + NL + "\t\t\t\t\t     java.lang.Iterable<?> outgoingRejectRecs_";
  protected final String TEXT_145 = " = writerWithFeedbackReject_";
  protected final String TEXT_146 = ".getRejectedWrites();" + NL + "                    java.util.Iterator outgoingRejectRecords_";
  protected final String TEXT_147 = " = outgoingRejectRecs_";
  protected final String TEXT_148 = ".iterator();" + NL + "                    if (outgoingRejectRecords_";
  protected final String TEXT_149 = ".hasNext()) {" + NL + "                        outgoingRejectRecordsList_";
  protected final String TEXT_150 = " = outgoingRejectRecs_";
  protected final String TEXT_151 = ";" + NL + "                    }" + NL + "                }";
  protected final String TEXT_152 = NL + "            \toutgoingMainRecordsIt_";
  protected final String TEXT_153 = " = outgoingMainRecordsList_";
  protected final String TEXT_154 = ".iterator();";
  protected final String TEXT_155 = NL + "            \tjava.util.Iterator outgoingRejectRecordsIt_";
  protected final String TEXT_156 = " = outgoingRejectRecordsList_";
  protected final String TEXT_157 = ".iterator();";
  protected final String TEXT_158 = NL + "            \twhile(";
  protected final String TEXT_159 = ") { //Start of data processing while block" + NL + "            \t\t";
  protected final String TEXT_160 = NL + "            \t\t\tif(outgoingMainRecordsIt_";
  protected final String TEXT_161 = ".hasNext()) {" + NL + "            \t\t\t\t";
  protected final String TEXT_162 = " = new ";
  protected final String TEXT_163 = "Struct();" + NL + "            \t\t\t\tObject outgoingMain_";
  protected final String TEXT_164 = " = outgoingMainRecordsIt_";
  protected final String TEXT_165 = ".next();" + NL + "            \t\t\t\t";
  protected final String TEXT_166 = NL + "            \t\t\t} else {" + NL + "            \t\t\t\t";
  protected final String TEXT_167 = " = null;" + NL + "            \t\t\t}" + NL + "            \t\t";
  protected final String TEXT_168 = NL + "            \t\t\tif(outgoingRejectRecordsIt_";
  protected final String TEXT_169 = ".hasNext()) {" + NL + "            \t\t\t\t";
  protected final String TEXT_170 = " = new ";
  protected final String TEXT_171 = "Struct();" + NL + "            \t\t\t\tObject outgoingReject_";
  protected final String TEXT_172 = " = outgoingRejectRecordsIt_";
  protected final String TEXT_173 = ".next();" + NL + "            \t\t\t\t";
