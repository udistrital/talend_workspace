...
public class ComponentBegin
{
  ...
  protected final String TEXT_206 = NL + "final String buffersSizeKey_";
  protected final String TEXT_207 = " = \"buffersSizeKey_";
  protected final String TEXT_208 = "_\" + Thread.currentThread().getId(); ";
  protected final String TEXT_209 = NL + "java.net.URL mappings_url_";
  protected final String TEXT_210 = "= this.getClass().getResource(\"/xmlMappings\");" + NL + "globalMap.put(\"";
  protected final String TEXT_211 = "_MAPPINGS_URL\", mappings_url_";
  protected final String TEXT_212 = ");" + NL + "" + NL + "org.talend.components.api.container.RuntimeContainer container_";
  protected final String TEXT_213 = " = new org.talend.components.api.container.RuntimeContainer() {" + NL + "    public Object getComponentData(String componentId, String key) {" + NL + "        return globalMap.get(componentId + \"_\" + key);" + NL + "    }" + NL + "" + NL + "    public void setComponentData(String componentId, String key, Object data) {" + NL + "        globalMap.put(componentId + \"_\" + key, data);" + NL + "    }" + NL + "" + NL + "    public String getCurrentComponentId() {" + NL + "        return \"";
  protected final String TEXT_214 = "\";" + NL + "    }" + NL + "" + NL + "    public Object getGlobalData(String key) {" + NL + "    \treturn globalMap.get(key);" + NL + "    }" + NL + "};" + NL + "" + NL + "int nb_line_";
  protected final String TEXT_215 = " = 0;" + NL + "" + NL + "org.talend.components.api.component.ConnectorTopology topology_";
  protected final String TEXT_216 = " = null;";
  protected final String TEXT_217 = NL + "topology_";
  protected final String TEXT_218 = " = org.talend.components.api.component.ConnectorTopology.INCOMING_AND_OUTGOING;";
  protected final String TEXT_219 = NL + "topology_";
  protected final String TEXT_220 = " = org.talend.components.api.component.ConnectorTopology.INCOMING;";
  protected final String TEXT_221 = NL + "topology_";
  protected final String TEXT_222 = " = org.talend.components.api.component.ConnectorTopology.OUTGOING;";
  protected final String TEXT_223 = NL + "topology_";
  protected final String TEXT_224 = " = org.talend.components.api.component.ConnectorTopology.NONE;";
  protected final String TEXT_225 = NL + NL + "org.talend.daikon.runtime.RuntimeInfo runtime_info_";
  protected final String TEXT_226 = " = def_";
  protected final String TEXT_227 = ".getRuntimeInfo(" + NL + "    org.talend.components.api.component.runtime.ExecutionEngine.DI, props_";
  protected final String TEXT_228 = ", topology_";
  protected final String TEXT_229 = ");" + NL + "java.util.Set<org.talend.components.api.component.ConnectorTopology> supported_connector_topologies_";
  protected final String TEXT_230 = " = def_";
  protected final String TEXT_231 = ".getSupportedConnectorTopologies();" + NL + "" + NL + "org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_";
  protected final String TEXT_232 = " = (org.talend.components.api.component.runtime.RuntimableRuntime)(Class.forName(runtime_info_";
  protected final String TEXT_233 = ".getRuntimeClassName()).newInstance());" + NL + "org.talend.daikon.properties.ValidationResult initVr_";
  protected final String TEXT_234 = " = componentRuntime_";
  protected final String TEXT_235 = ".initialize(container_";
  protected final String TEXT_236 = ", props_";
  protected final String TEXT_237 = ");" + NL + "" + NL + "if (initVr_";
  protected final String TEXT_238 = ".getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR ) {" + NL + "    throw new RuntimeException(initVr_";
  protected final String TEXT_239 = ".getMessage());" + NL + "}" + NL + "" + NL + "if(componentRuntime_";
  protected final String TEXT_240 = " instanceof org.talend.components.api.component.runtime.ComponentDriverInitialization) {" + NL + "\torg.talend.components.api.component.runtime.ComponentDriverInitialization compDriverInitialization_";
  protected final String TEXT_241 = " = (org.talend.components.api.component.runtime.ComponentDriverInitialization)componentRuntime_";
  protected final String TEXT_242 = ";" + NL + "\tcompDriverInitialization_";
  protected final String TEXT_243 = ".runAtDriver(container_";
  protected final String TEXT_244 = ");" + NL + "}" + NL + "" + NL + "org.talend.components.api.component.runtime.SourceOrSink sourceOrSink_";
  protected final String TEXT_245 = " = null;" + NL + "if(componentRuntime_";
  protected final String TEXT_246 = " instanceof org.talend.components.api.component.runtime.SourceOrSink) {" + NL + "\tsourceOrSink_";
  protected final String TEXT_247 = " = (org.talend.components.api.component.runtime.SourceOrSink)componentRuntime_";
  protected final String TEXT_248 = ";" + NL + "\torg.talend.daikon.properties.ValidationResult vr_";
  protected final String TEXT_249 = " = sourceOrSink_";
  protected final String TEXT_250 = ".validate(container_";
  protected final String TEXT_251 = ");" + NL + "\tif (vr_";
  protected final String TEXT_252 = ".getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR ) {" + NL + "    \tthrow new RuntimeException(vr_";
  protected final String TEXT_253 = ".getMessage());" + NL + "\t}" + NL + "}" + NL;
  protected final String TEXT_254 = NL + "    org.talend.components.api.component.runtime.Source source_";
  protected final String TEXT_255 = " =" + NL + "            (org.talend.components.api.component.runtime.Source)sourceOrSink_";
  protected final String TEXT_256 = ";" + NL + "    org.talend.components.api.component.runtime.Reader reader_";
  protected final String TEXT_257 = " =" + NL + "            source_";
  protected final String TEXT_258 = ".createReader(container_";
  protected final String TEXT_259 = ");" + NL + "\treader_";
  protected final String TEXT_260 = " = new org.talend.codegen.flowvariables.runtime.FlowVariablesReader(reader_";
  protected final String TEXT_261 = ", container_";
  protected final String TEXT_262 = ");" + NL;
  protected final String TEXT_263 = NL + "        boolean multi_output_is_allowed_";
  protected final String TEXT_264 = " = false;";
  protected final String TEXT_265 = NL + "        org.talend.components.api.component.Connector c_";
  protected final String TEXT_266 = " = null;" + NL + "        for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_267 = ".getAvailableConnectors(null, true)) {" + NL + "            if (currentConnector.getName().equals(\"";
  protected final String TEXT_268 = "\")) {" + NL + "                c_";
  protected final String TEXT_269 = " = currentConnector;" + NL + "            }" + NL + "" + NL + "            if (currentConnector.getName().equals(\"REJECT\")) {//it's better to move the code to javajet" + NL + "                multi_output_is_allowed_";
  protected final String TEXT_270 = " = true;" + NL + "            }" + NL + "        }" + NL + "        org.apache.avro.Schema schema_";
  protected final String TEXT_271 = " = props_";
  protected final String TEXT_272 = ".getSchema(c_";
  protected final String TEXT_273 = ", true);" + NL;
  protected final String TEXT_274 = NL + NL + "    // Iterate through the incoming data." + NL + "    boolean available_";
  protected final String TEXT_275 = " = reader_";
  protected final String TEXT_276 = ".start();" + NL + "" + NL + "    resourceMap.put(\"reader_";
  protected final String TEXT_277 = "\", reader_";
  protected final String TEXT_278 = ");" + NL + "" + NL + "    for (; available_";
  protected final String TEXT_279 = "; available_";
  protected final String TEXT_280 = " = reader_";
  protected final String TEXT_281 = ".advance()) {" + NL + "    \tnb_line_";
  protected final String TEXT_282 = "++;" + NL + "" + NL + "    \t";
  protected final String TEXT_283 = NL + "        if (multi_output_is_allowed_";
  ...
  protected final String TEXT_291 = NL + NL + "        try {" + NL + "            Object data_";
  protected final String TEXT_292 = " = reader_";
  protected final String TEXT_293 = ".getCurrent();";
  protected final String TEXT_294 = NL + NL + "                if(multi_output_is_allowed_";
  protected final String TEXT_295 = ") {";
  protected final String TEXT_296 = NL + "                    ";
  protected final String TEXT_297 = " = new ";
  protected final String TEXT_298 = "Struct();" + NL + "                }" + NL;
  protected final String TEXT_299 = NL + "        } catch (org.talend.components.api.exception.DataRejectException e_";
  protected final String TEXT_300 = ") {" + NL + "        \tjava.util.Map<String,Object> info_";
  protected final String TEXT_301 = " = e_";
  protected final String TEXT_302 = ".getRejectInfo();";
  protected final String TEXT_303 = NL + "                Object data_";
  protected final String TEXT_304 = " = info_";
  protected final String TEXT_305 = ".get(\"talend_record\");" + NL + "" + NL + "                if (multi_output_is_allowed_";
  protected final String TEXT_306 = ") {";
  protected final String TEXT_307 = NL + "                    ";
  protected final String TEXT_308 = " = new ";
  protected final String TEXT_309 = "Struct();" + NL + "                }" + NL + "\t\t\t\ttry{";
  protected final String TEXT_310 = NL + "                }catch(java.lang.Exception e){" + NL + "                \t// do nothing" + NL + "                }";
  protected final String TEXT_311 = NL + "                        ";
  protected final String TEXT_312 = ".";
  protected final String TEXT_313 = " = (";
  protected final String TEXT_314 = ")info_";
  protected final String TEXT_315 = ".get(\"";
  protected final String TEXT_316 = "\");";
  protected final String TEXT_317 = NL + "            \t//TODO use a method instead of getting method by the special key \"error/errorMessage\"" + NL + "            \tObject errorMessage_";
  protected final String TEXT_318 = " = null;" + NL + "            \tif(info_";
  protected final String TEXT_319 = ".containsKey(\"error\")){" + NL + "            \t\terrorMessage_";
  protected final String TEXT_320 = " = info_";
  protected final String TEXT_321 = ".get(\"error\");" + NL + "        \t\t}else if(info_";
  protected final String TEXT_322 = ".containsKey(\"errorMessage\")){" + NL + "            \t\terrorMessage_";
  protected final String TEXT_323 = " = info_";
  protected final String TEXT_324 = ".get(\"errorMessage\");" + NL + "        \t\t}else{" + NL + "        \t\t\terrorMessage_";
  protected final String TEXT_325 = " = \"Rejected but error message missing\";" + NL + "        \t\t}" + NL + "        \t\terrorMessage_";
  protected final String TEXT_326 = " = \"Row \"+ nb_line_";
  protected final String TEXT_327 = " + \": \"+errorMessage_";
  protected final String TEXT_328 = ";" + NL + "    \t\t\tSystem.err.println(errorMessage_";
  protected final String TEXT_329 = ");";
  protected final String TEXT_330 = NL + "            \t// If the record is reject, the main line record should put NULL" + NL + "            \t";
  protected final String TEXT_331 = " = null;";
  protected final String TEXT_332 = NL + "    }";
  protected final String TEXT_333 = NL + "    org.talend.components.api.component.runtime.Sink sink_";
  protected final String TEXT_334 = " =" + NL + "            (org.talend.components.api.component.runtime.Sink)sourceOrSink_";
  protected final String TEXT_335 = ";" + NL + "    org.talend.components.api.component.runtime.WriteOperation writeOperation_";
  protected final String TEXT_336 = " = sink_";
  protected final String TEXT_337 = ".createWriteOperation();" + NL + "    writeOperation_";
  protected final String TEXT_338 = ".initialize(container_";
  protected final String TEXT_339 = ");" + NL + "    org.talend.components.api.component.runtime.Writer writer_";
  protected final String TEXT_340 = " = writeOperation_";
  protected final String TEXT_341 = ".createWriter(container_";
  protected final String TEXT_342 = ");" + NL + "    writer_";
  protected final String TEXT_343 = ".open(\"";
  protected final String TEXT_344 = "\");" + NL + "" + NL + "    resourceMap.put(\"writer_";
  protected final String TEXT_345 = "\", writer_";
  protected final String TEXT_346 = ");" + NL + "" + NL + "    org.talend.components.api.component.Connector c_";
  protected final String TEXT_347 = " = null;" + NL + "    for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_348 = ".getAvailableConnectors(null, false)) {" + NL + "        if (currentConnector.getName().equals(\"MAIN\")) {" + NL + "            c_";
  protected final String TEXT_349 = " = currentConnector;" + NL + "            break;" + NL + "        }" + NL + "    }" + NL + "    org.apache.avro.Schema designSchema_";
  protected final String TEXT_350 = " = props_";
  protected final String TEXT_351 = ".getSchema(c_";
  protected final String TEXT_352 = ", false);" + NL + "    org.talend.codegen.enforcer.IncomingSchemaEnforcer incomingEnforcer_";
  protected final String TEXT_353 = NL + "            = new org.talend.codegen.enforcer.IncomingSchemaEnforcer(designSchema_";
  protected final String TEXT_354 = ");";
  protected final String TEXT_355 = NL + "                c_";
  protected final String TEXT_356 = " = null;" + NL + "                for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_357 = ".getAvailableConnectors(null, true)) {" + NL + "                    if (currentConnector.getName().equals(\"MAIN\")) {" + NL + "                        c_";
  protected final String TEXT_358 = " = currentConnector;" + NL + "                    }" + NL + "                }" + NL + "                org.apache.avro.Schema mainSchema_";
  protected final String TEXT_359 = " = props_";
  protected final String TEXT_360 = ".getSchema(c_";
  protected final String TEXT_361 = ", true);";
  protected final String TEXT_362 = NL + "                c_";
  protected final String TEXT_363 = " = null;" + NL + "                for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_364 = ".getAvailableConnectors(null, true)) {" + NL + "                    if (currentConnector.getName().equals(\"REJECT\")) {" + NL + "                        c_";
  protected final String TEXT_365 = " = currentConnector;" + NL + "                    }" + NL + "                }" + NL + "                org.apache.avro.Schema rejectSchema_";
  protected final String TEXT_366 = " = props_";
  protected final String TEXT_367 = ".getSchema(c_";
  protected final String TEXT_368 = ", true);";
  protected final String TEXT_369 = NL + "                java.lang.Iterable<?> outgoingMainRecordsList_";
  protected final String TEXT_370 = " = new java.util.ArrayList<Object>();" + NL + "                java.util.Iterator outgoingMainRecordsIt_";
