...
public class TELTOutputMainJava {
  ...
  protected final String TEXT_82 = NL + "            if (log.isDebugEnabled()) {" + NL + "                class BytesLimit65535_";
  protected final String TEXT_83 = "{" + NL + "                    public void limitLog4jByte() throws Exception{" + NL + "                    StringBuilder ";
  protected final String TEXT_84 = " = new StringBuilder();";
  protected final String TEXT_85 = NL + "                    ";
  protected final String TEXT_86 = ".append(\"Parameters:\");";
  protected final String TEXT_87 = NL + "                            ";
  protected final String TEXT_88 = ".append(\"";
  protected final String TEXT_89 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_90 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_97 = NL + "                    } " + NL + "                } " + NL + "            new BytesLimit65535_";
  protected final String TEXT_98 = "().limitLog4jByte();" + NL + "            }";
  protected final String TEXT_99 = NL + "            StringBuilder ";
  protected final String TEXT_100 = " = new StringBuilder();    ";
  ...
  protected final String TEXT_109 = ".append(\"<null>\");" + NL + "                    }else{";
  ...
  protected final String TEXT_118 = NL + "\tString select_query_";
  protected final String TEXT_119 = " = null;\t" + NL + "\tString tableName_";
  protected final String TEXT_120 = " = null;" + NL + "\tString selectQueryColumnsName_";
  protected final String TEXT_121 = " = null;" + NL + "\t";
  protected final String TEXT_122 = NL + "\t\tselect_query_";
  protected final String TEXT_123 = " = (String) globalMap.get(\"";
  protected final String TEXT_124 = "\"+\"QUERY\"+\"";
  protected final String TEXT_125 = "\");" + NL + "\t\tselectQueryColumnsName_";
  protected final String TEXT_126 = " = (String) globalMap.get(\"";
  protected final String TEXT_127 = "\"+\"QUERY_COLUMNS_NAME\"+\"";
  protected final String TEXT_128 = "\");" + NL + "\t\t";
  protected final String TEXT_129 = NL + "\tString dbschema_";
  protected final String TEXT_130 = " = ";
  protected final String TEXT_131 = ";" + NL + "\tif(dbschema_";
  protected final String TEXT_132 = " != null && dbschema_";
  protected final String TEXT_133 = ".trim().length() > 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_134 = " = ";
  protected final String TEXT_135 = " + \".\" + ";
  protected final String TEXT_136 = ";" + NL + "\t}else {" + NL + "\t\ttableName_";
  protected final String TEXT_137 = " = ";
  protected final String TEXT_138 = ";" + NL + "\t}" + NL + "\t";
  protected final String TEXT_139 = NL + "    String dbUser_";
  protected final String TEXT_140 = " = null;";
  protected final String TEXT_141 = NL + "        java.sql.Connection conn_";
  protected final String TEXT_142 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_143 = "\");" + NL + "        dbUser_";
  protected final String TEXT_144 = " = (String)globalMap.get(\"";
  protected final String TEXT_145 = "\");";
  protected final String TEXT_146 = NL + "        String driverClass_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = ";" + NL + "        java.lang.Class.forName(driverClass_";
  protected final String TEXT_149 = ");" + NL + "        String url_";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = "; " + NL + "        dbUser_";
  protected final String TEXT_152 = " = ";
  protected final String TEXT_153 = ";\t        " + NL + "    \t";
  protected final String TEXT_154 = NL + "    \t" + NL + "    \t";
  protected final String TEXT_155 = "String decryptedPassword_";
  ...
  protected final String TEXT_160 = NL + "\tdecryptedPassword_";
  ...
  protected final String TEXT_167 = "\t" + NL + "        \tString insertQuery_";
  protected final String TEXT_168 = " = \"INSERT INTO \"+tableName_";
  protected final String TEXT_169 = "+\"(";
  protected final String TEXT_170 = ")  (\"+select_query_";
  protected final String TEXT_171 = "+\")\";";
  protected final String TEXT_172 = NL + "        \tString updateQuery_";
  protected final String TEXT_173 = " = \"UPDATE \"+tableName_";
  protected final String TEXT_174 = "+\" SET ";
  protected final String TEXT_175 = " \"";
  protected final String TEXT_176 = NL + "        \t\t+\"  WHERE \" + ";
  protected final String TEXT_177 = NL + "        \t;";
  protected final String TEXT_178 = NL + "        \tString deleteQuery_";
  protected final String TEXT_179 = " = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_180 = "+\" WHERE EXISTS (\"+select_query_";
  protected final String TEXT_181 = "+\") \" " + NL + "        \t";
  protected final String TEXT_182 = NL + "        \t+\"  AND \" + ";
  protected final String TEXT_183 = NL + "        \t";
  protected final String TEXT_184 = NL + "        \t;" + NL + "    \t";
  protected final String TEXT_185 = NL + "    \t" + NL + "        int nb_line_";
  protected final String TEXT_186 = " = 0;" + NL + "        int nb_line_updated_";
  protected final String TEXT_187 = " = 0;" + NL + "        int nb_line_inserted_";
  protected final String TEXT_188 = " = 0;" + NL + "        int nb_line_deleted_";
  ...
  protected final String TEXT_199 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_224 = NL + "            \tString tableNameForSearch_";
  protected final String TEXT_225 = " = ";
  protected final String TEXT_226 = ";" + NL + "            \tString dbschemaForSearch_";
  protected final String TEXT_227 = " = null;" + NL + "            \tif(dbschema_";
  protected final String TEXT_228 = " == null || dbschema_";
  protected final String TEXT_229 = ".trim().isEmpty()) {" + NL + "            \t\tdbschemaForSearch_";
  protected final String TEXT_230 = " = dbUser_";
  protected final String TEXT_231 = ".toUpperCase();" + NL + "            \t} else {" + NL + "            \t\tdbschemaForSearch_";
  protected final String TEXT_232 = " = dbschema_";
  protected final String TEXT_233 = ".toUpperCase();" + NL + "            \t}" + NL + "            \t" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_234 = " = conn_";
  protected final String TEXT_235 = ".getMetaData();" + NL + "                if(tableNameForSearch_";
  protected final String TEXT_236 = ".indexOf(\"\\\"\")==-1){" + NL + "                    tableNameForSearch_";
  protected final String TEXT_237 = " = tableNameForSearch_";
  protected final String TEXT_238 = ".toUpperCase();" + NL + "                }else{" + NL + "                    tableNameForSearch_";
  protected final String TEXT_239 = " = tableNameForSearch_";
  protected final String TEXT_240 = ".replaceAll(\"\\\"\",\"\");" + NL + "                }" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_241 = " = dbMetaData_";
  protected final String TEXT_242 = ".getTables(null, dbschemaForSearch_";
  ...
  protected final String TEXT_268 = ".trim().length() ==0)) {" + NL + "                        whetherExist_";
  ...
  protected final String TEXT_355 = NL + "                String schemaForSearch_";
  protected final String TEXT_356 = " = null;" + NL + "\t\t\t\tString tableForSearch_";
  protected final String TEXT_357 = " = ";
  protected final String TEXT_358 = ";" + NL + "\t\t\t\t" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_362 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_363 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_364 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_365 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_366 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_367 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_368 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "                rsTable_";
  protected final String TEXT_369 = ".close();";
  ...
  protected final String TEXT_385 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_394 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_410 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_418 = NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_432 = NL + "        System.out.println(\"Inserting with : \\n\" + insertQuery_";
  protected final String TEXT_433 = " + \"\\n\");";
  protected final String TEXT_434 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_435 = " = conn_";
  protected final String TEXT_436 = ".prepareStatement(insertQuery_";
  protected final String TEXT_437 = ");" + NL + "        nb_line_inserted_";
  protected final String TEXT_438 = " = pstmt_";
  protected final String TEXT_439 = ".executeUpdate();";
  protected final String TEXT_440 = NL + "        System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_441 = " + \" rows inserted. \\n\");" + NL + "        pstmt_";
  protected final String TEXT_442 = ".close();" + NL + "\t\t";
  protected final String TEXT_443 = NL + "        System.out.println(\"Updating with : \\n\" + updateQuery_";
  protected final String TEXT_444 = " +\"\\n\");";
  protected final String TEXT_445 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_446 = " = conn_";
  protected final String TEXT_447 = ".prepareStatement(updateQuery_";
  protected final String TEXT_448 = ");" + NL + "        nb_line_updated_";
  protected final String TEXT_449 = " = pstmt_";
  protected final String TEXT_450 = ".executeUpdate();";
  protected final String TEXT_451 = NL + "    \tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_452 = " + \" rows updated. \\n\");" + NL + "    \tpstmt_";
  protected final String TEXT_453 = ".close();" + NL + "    \t";
  protected final String TEXT_454 = NL + "    \tSystem.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_455 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_456 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_457 = " = conn_";
  protected final String TEXT_458 = ".prepareStatement(deleteQuery_";
  protected final String TEXT_459 = ");" + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_460 = " = pstmt_";
  protected final String TEXT_461 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_462 = NL + "    \tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_463 = " + \" rows deleted. \\n\");" + NL + "    \tpstmt_";
  protected final String TEXT_464 = ".close();" + NL + "\t\t";
  protected final String TEXT_465 = NL;
  protected final String TEXT_466 = NL + "        if(conn_";
  protected final String TEXT_467 = " != null && !conn_";
  protected final String TEXT_468 = ".isClosed()) {" + NL + "    \t\t";
  protected final String TEXT_469 = NL + "        }";
  protected final String TEXT_470 = NL + "    nb_line_";
  protected final String TEXT_471 = " = nb_line_updated_";
  protected final String TEXT_472 = " + nb_line_inserted_";
  protected final String TEXT_473 = " + nb_line_deleted_";
  protected final String TEXT_474 = ";" + NL + "    globalMap.put(\"";
  protected final String TEXT_475 = "_NB_LINE\",nb_line_";
  protected final String TEXT_476 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_477 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_478 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_479 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_480 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_481 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_482 = ");";
  protected final String TEXT_483 = NL + "    \tlog.info(\"";
  protected final String TEXT_484 = " - Has ";
  protected final String TEXT_485 = " records count: \" + nb_line_";
