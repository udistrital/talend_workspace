...
public class TELTGreenplumOutputMainJava
{
  ...
  protected final String TEXT_98 = " = \"org.postgresql.Driver\";" + NL + "\t\t\tString url_";
  protected final String TEXT_99 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_100 = " + \":\" + ";
  protected final String TEXT_101 = " + \"/\" + ";
  protected final String TEXT_102 = ";" + NL + "\t\t";
  protected final String TEXT_103 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_104 = " = \"com.pivotal.jdbc.GreenplumDriver\";" + NL + "\t\t\tString url_";
  protected final String TEXT_105 = " = \"jdbc:pivotal:greenplum://\"+";
  protected final String TEXT_106 = "+\":\"+";
  protected final String TEXT_107 = "+\";DatabaseName=\"+";
  protected final String TEXT_108 = ";" + NL + "\t";
  protected final String TEXT_109 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_110 = ");      " + NL + "    String dbUser_";
  protected final String TEXT_111 = " = ";
  protected final String TEXT_112 = ";" + NL;
  protected final String TEXT_113 = NL;
  protected final String TEXT_114 = NL + "    ";
  protected final String TEXT_115 = "String decryptedPassword_";
  ...
  protected final String TEXT_129 = "\t" + NL + "\tString insertQuery_";
  protected final String TEXT_130 = " = \"INSERT INTO \"+tableName_";
  ...
  protected final String TEXT_135 = ".prepareStatement(insertQuery_";
  protected final String TEXT_136 = ");" + NL;
  protected final String TEXT_137 = NL + "\tString updateQuery_";
  protected final String TEXT_138 = " = \"UPDATE \"+tableName_";
  protected final String TEXT_139 = "+\" SET ";
  protected final String TEXT_140 = " \" +select_query_";
  protected final String TEXT_141 = ".substring(select_query_";
  protected final String TEXT_142 = ".indexOf(\"FROM\"));";
  protected final String TEXT_143 = NL + "\t\tif(select_query_";
  protected final String TEXT_144 = ".indexOf(\"WHERE\")==-1){" + NL + "\t\tupdateQuery_";
  protected final String TEXT_145 = " +=\"  WHERE \";" + NL + "\t\t}else{" + NL + "\t\tupdateQuery_";
  protected final String TEXT_146 = " +=\"  AND \";" + NL + "\t\t} " + NL + "\t\tupdateQuery_";
  protected final String TEXT_147 = "+= ";
  protected final String TEXT_148 = ";";
  protected final String TEXT_149 = NL + "\tpstmt_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = ".prepareStatement(updateQuery_";
  protected final String TEXT_152 = ");" + NL;
  protected final String TEXT_153 = NL + "\t" + NL + "\tString deleteQuery_";
  protected final String TEXT_154 = " = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_155 = "+\" WHERE EXISTS (\"+select_query_";
  protected final String TEXT_156 = "+\") \" " + NL + "\t";
  protected final String TEXT_157 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_158 = NL + "\t";
  protected final String TEXT_159 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".prepareStatement(deleteQuery_";
  protected final String TEXT_162 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_163 = NL + "int nb_line_";
  protected final String TEXT_164 = " = 0;" + NL + "int nb_line_updated_";
  protected final String TEXT_165 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_166 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_167 = " = 0;" + NL + "\t";
  protected final String TEXT_168 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery_";
  protected final String TEXT_169 = " + \"\\n\");";
  protected final String TEXT_170 = " " + NL + "nb_line_inserted_";
  protected final String TEXT_171 = " = pstmt_";
  protected final String TEXT_172 = ".executeUpdate();";
  protected final String TEXT_173 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_174 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_175 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery_";
  protected final String TEXT_176 = " +\"\\n\");";
  protected final String TEXT_177 = " " + NL + "nb_line_updated_";
  protected final String TEXT_178 = " = pstmt_";
  protected final String TEXT_179 = ".executeUpdate();";
  protected final String TEXT_180 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_181 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_182 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_183 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_184 = " " + NL + "\t\tnb_line_deleted_";
  ...
  protected final String TEXT_196 = " = nb_line_updated_";
  protected final String TEXT_197 = " + nb_line_inserted_";
  ...
  protected final String TEXT_202 = "_NB_LINE_UPDATED\",nb_line_updated_";
  ...
  protected final String TEXT_209 = " - Has ";
  protected final String TEXT_210 = " records count: \" + nb_line_";
