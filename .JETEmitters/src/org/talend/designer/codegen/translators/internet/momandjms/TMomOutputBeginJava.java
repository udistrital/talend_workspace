...
public class TMomOutputBeginJava
{
  ...
  protected final String TEXT_196 = NL + "\t\t           System.setProperty(\"com.ibm.mq.cfg.useIBMCipherMappings\",\"";
  protected final String TEXT_197 = "\");" + NL + "\t\t           com.ibm.mq.MQEnvironment.sslCipherSuite = ";
  protected final String TEXT_198 = ";" + NL + "\t\t       ";
  protected final String TEXT_199 = NL + "\t\t           com.ibm.mq.MQEnvironment.sslCipherSuite = \"";
  protected final String TEXT_200 = "\";" + NL + "\t\t       ";
  protected final String TEXT_201 = NL + "\t\t\t\tprops_";
  protected final String TEXT_202 = ".put(\"userID\",";
  ...
  protected final String TEXT_211 = NL + "\t\t\t" + NL + "\t\t" + NL + "\t\t\t\tprops_";
  protected final String TEXT_212 = ".put(\"password\",decryptedPassword_";
  protected final String TEXT_213 = ");" + NL + "\t\t\t";
  protected final String TEXT_214 = NL + "\t\t\tqMgr_";
  protected final String TEXT_215 = "=new com.ibm.mq.MQQueueManager(";
  protected final String TEXT_216 = ",props_";
  protected final String TEXT_217 = ");" + NL + "\t\t\tglobalMap.put(\"qMgr_";
  protected final String TEXT_218 = "\",qMgr_";
  protected final String TEXT_219 = ");" + NL + "\t\t\t";
  protected final String TEXT_220 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_221 = " - Created successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_222 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_223 = " - Creating queue instance for queue: \"+";
  protected final String TEXT_224 = "+\"...\");" + NL + "\t\t";
  protected final String TEXT_225 = NL + "\t    com.ibm.mq.MQQueue remoteQ_";
  protected final String TEXT_226 = " = qMgr_";
  protected final String TEXT_227 = ".accessQueue(";
  protected final String TEXT_228 = ", 16);" + NL + "\t    ";
  protected final String TEXT_229 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_230 = " - Created successfully.\");" + NL + "\t\t";
  protected final String TEXT_231 = NL + "\t    com.ibm.mq.MQPutMessageOptions opM_";
  protected final String TEXT_232 = " = new com.ibm.mq.MQPutMessageOptions();" + NL + "\t\t";
  protected final String TEXT_233 = "\t" + NL + "\t\t\topM_";
  protected final String TEXT_234 = ".options=opM_";
  protected final String TEXT_235 = ".options+com.ibm.mq.MQC.MQGMO_SYNCPOINT;" + NL + "\t\t";
  protected final String TEXT_236 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_237 = " - Start to produce queue: \" + ";
  protected final String TEXT_238 = ");" + NL + "\t\t";
  protected final String TEXT_239 = NL + "\t\t\tif(producer_";
  protected final String TEXT_240 = "!=null){" + NL + "\t\t\t\t";
  protected final String TEXT_241 = NL + "\t\t\t\t\t\tproducer_";
  protected final String TEXT_242 = ".setTimeToLive(";
  protected final String TEXT_243 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_244 = NL + "\t\t\t\t\t\tproducer_";
  protected final String TEXT_245 = ".setPriority(";
  protected final String TEXT_246 = ");\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_247 = NL + "\t\t\t\t\t\tproducer_";
  protected final String TEXT_248 = ".setDisableMessageTimestamp(false);" + NL + "\t\t\t\t\t";
  protected final String TEXT_249 = NL + "\t\t\t\t\t\tproducer_";
  protected final String TEXT_250 = ".setDeliveryMode(";
  protected final String TEXT_251 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_252 = NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_253 = NL + "\t\t\tglobalMap.put(\"producer_";
  protected final String TEXT_254 = "\",producer_";
  protected final String TEXT_255 = ");" + NL + "\t\t\tglobalMap.put(\"session_";
  protected final String TEXT_256 = "\",session_";
  protected final String TEXT_257 = ");" + NL + "\t\t\tglobalMap.put(\"connection_";
