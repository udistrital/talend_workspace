...
public class TFTPFilePropertiesBeginJava
{
  ...
  protected final String TEXT_193 = NL + NL + "\tclass MyTrust_";
  protected final String TEXT_194 = " {" + NL + "" + NL + "\t\tprivate javax.net.ssl.TrustManager[] getTrustManagers() " + NL + "\t\tthrows java.security.KeyStoreException, java.security.NoSuchAlgorithmException, " + NL + "\t\t\tjava.security.cert.CertificateException, java.security.UnrecoverableKeyException," + NL + "\t\t\tjava.io.IOException {" + NL + "\t\t\tjava.security.KeyStore ks = java.security.KeyStore.getInstance(\"JKS\");" + NL;
  protected final String TEXT_195 = " " + NL + "\t\t\t\tString decryptedKeyStorePassword_";
  protected final String TEXT_196 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_197 = ");";
  protected final String TEXT_198 = NL + "\t\t\t\tString decryptedKeyStorePassword_";
  protected final String TEXT_199 = " = ";
  protected final String TEXT_200 = "; ";
  protected final String TEXT_201 = NL + "\t\t\tks.load(new java.io.FileInputStream(";
  protected final String TEXT_202 = "), decryptedKeyStorePassword_";
  protected final String TEXT_203 = ".toCharArray());" + NL + "\t\t\tjavax.net.ssl.TrustManagerFactory tmf = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.KeyManagerFactory.getDefaultAlgorithm());" + NL + "\t\t\ttmf.init(ks);" + NL + "\t\t\treturn tmf.getTrustManagers();" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\t\tclass SSLSessionReuseFTPSClient_";
  protected final String TEXT_204 = " extends org.apache.commons.net.ftp.FTPSClient {" + NL + "" + NL + "\t\tpublic SSLSessionReuseFTPSClient_";
  protected final String TEXT_205 = "(boolean isImplicit, javax.net.ssl.SSLContext context) {" + NL + "\t\t\tsuper(isImplicit, context);" + NL + "\t\t}" + NL + "" + NL + "\t\t// changed to support TLS session resumption" + NL + "\t\t@Override" + NL + "\t\tprotected void _prepareDataSocket_(final java.net.Socket socket) throws IOException {" + NL + "\t\t\tif(socket instanceof javax.net.ssl.SSLSocket) {" + NL + "\t\t\t\tfinal javax.net.ssl.SSLSession session = ((javax.net.ssl.SSLSocket) _socket_).getSession();" + NL + "\t\t\t\tfinal javax.net.ssl.SSLSessionContext context = session.getSessionContext();" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tfinal java.lang.reflect.Field sessionHostPortCache = context.getClass().getDeclaredField(\"sessionHostPortCache\");" + NL + "\t\t\t\t\tsessionHostPortCache.setAccessible(true);" + NL + "\t\t\t\t\tfinal Object cache = sessionHostPortCache.get(context);" + NL + "\t\t\t\t\tfinal java.lang.reflect.Method putMethod = cache.getClass().getDeclaredMethod(\"put\", Object.class, Object.class);" + NL + "\t\t\t\t\tputMethod.setAccessible(true);" + NL + "\t\t\t\t\tfinal java.lang.reflect.Method getHostMethod = socket.getClass().getDeclaredMethod(\"getHost\");" + NL + "\t\t\t\t\tgetHostMethod.setAccessible(true);" + NL + "\t\t\t\t\tObject host = getHostMethod.invoke(socket);" + NL + "\t\t\t\t\tfinal String key = String.format(\"%s:%s\", host, String.valueOf(socket.getPort())).toLowerCase(java.util.Locale.ROOT);" + NL + "\t\t\t\t\tputMethod.invoke(cache, key, session);" + NL + "\t\t\t\t} catch(Exception e) {";
  protected final String TEXT_206 = NL + "\t\t\t\t\t\tlog.error(\"Can't adapt ftps client to support TLS session resumption\");";
  protected final String TEXT_207 = NL + "\t\t\t\t\tthrow new RuntimeException(e);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t\tjavax.net.ssl.SSLContext sslContext_";
  protected final String TEXT_208 = " = null;" + NL + "\t\tjavax.net.ssl.TrustManager[] trustManager_";
  protected final String TEXT_209 = " = null;" + NL + "\t\tjavax.net.ssl.SSLSocketFactory sslSocketFactory_";
  protected final String TEXT_210 = " = null;" + NL + "\t\torg.apache.commons.net.ftp.FTPSClient ftp_";
  protected final String TEXT_211 = " =null;" + NL + "\t\tMyTrust_";
  protected final String TEXT_212 = " myTrust_";
  protected final String TEXT_213 = " = null;" + NL + "\t\ttry {" + NL + "\t\t\tsslContext_";
  protected final String TEXT_214 = " = javax.net.ssl.SSLContext.getInstance(\"SSL\");" + NL + "\t\t\tmyTrust_";
  protected final String TEXT_215 = " = new MyTrust_";
  protected final String TEXT_216 = "();" + NL + "\t\t\ttrustManager_";
  protected final String TEXT_217 = " = myTrust_";
  protected final String TEXT_218 = ".getTrustManagers();" + NL + "\t\t\tsslContext_";
  protected final String TEXT_219 = ".init(null, trustManager_";
  protected final String TEXT_220 = ", new java.security.SecureRandom());" + NL + "\t\t\tsslSocketFactory_";
  protected final String TEXT_221 = " = sslContext_";
  protected final String TEXT_222 = ".getSocketFactory();" + NL + "\t\t\tftp_";
  protected final String TEXT_223 = " = new SSLSessionReuseFTPSClient_";
  protected final String TEXT_224 = "(";
  protected final String TEXT_225 = ", sslContext_";
  protected final String TEXT_226 = ");" + NL + "\t\t\tftp_";
  protected final String TEXT_227 = ".setControlEncoding(";
  protected final String TEXT_228 = ");" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_229 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_230 = " -FTPS security Mode is ";
  protected final String TEXT_231 = ".\");" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_232 = " - Attempt to connect to '\" + ";
  protected final String TEXT_233 = " + \"' with username '\" + ";
  protected final String TEXT_234 = "+ \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\tftp_";
  protected final String TEXT_236 = ".connect(";
  protected final String TEXT_237 = ",";
  protected final String TEXT_238 = ");" + NL + "\t\t\t";
  protected final String TEXT_239 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_240 = " - Connect to '\" + ";
  ...
  protected final String TEXT_249 = NL + NL + "\t\t\tboolean isLoginSuccessful_";
  protected final String TEXT_250 = " = ftp_";
  protected final String TEXT_251 = ".login(";
  protected final String TEXT_252 = ", decryptedPassword_";
  protected final String TEXT_253 = ");" + NL + "" + NL + "\t\t\tif (!isLoginSuccessful_";
  protected final String TEXT_254 = ") {" + NL + "\t\t\t\tthrow new RuntimeException(\"Login failed\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tftp_";
  protected final String TEXT_255 = ".setFileType(org.apache.commons.net.ftp.FTP.BINARY_FILE_TYPE); //to calculate md5 for binary files correctly" + NL + "\t\t\tftp_";
  protected final String TEXT_256 = ".execPROT(";
  protected final String TEXT_257 = ");" + NL + "\t\t\tftp_";
  protected final String TEXT_258 = ".execPBSZ(";
  protected final String TEXT_259 = ");" + NL + "\t\t} catch (Exception e) {" + NL + "\t\t\t";
  protected final String TEXT_260 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_261 = " - Can't create connection: \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_262 = NL + "\t\t\tthrow e;" + NL + "\t\t}";
  protected final String TEXT_263 = NL + "\t\t\tftp_";
  protected final String TEXT_264 = ".enterLocalPassiveMode();";
  protected final String TEXT_265 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_266 = " - Using the passive mode.\");";
  protected final String TEXT_267 = NL + "\t\torg.apache.commons.net.ftp.FTPSClient ftp_";
  protected final String TEXT_268 = " = (org.apache.commons.net.ftp.FTPSClient) globalMap.get(\"";
  protected final String TEXT_269 = "\");";
  protected final String TEXT_270 = NL + "\tString remoteDir_";
  protected final String TEXT_271 = " = (";
  protected final String TEXT_272 = ").replaceAll(\"\\\\\\\\\", \"/\");" + NL + "\torg.apache.commons.net.ftp.FTPFile[] allFiles_";
  protected final String TEXT_273 = " = ftp_";
  protected final String TEXT_274 = ".listFiles(remoteDir_";
  protected final String TEXT_275 = ");" + NL + "" + NL + "\torg.apache.commons.net.ftp.FTPFile expectedFile_";
  protected final String TEXT_276 = " = null;" + NL + "" + NL + "\tfor (org.apache.commons.net.ftp.FTPFile file_";
  protected final String TEXT_277 = " : allFiles_";
  protected final String TEXT_278 = ") {" + NL + "\t\tif ((";
  protected final String TEXT_279 = ").equals(file_";
  protected final String TEXT_280 = ".getName())) {" + NL + "\t\t\texpectedFile_";
  protected final String TEXT_281 = " = file_";
  protected final String TEXT_282 = ";" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_283 = " = new ";
  protected final String TEXT_284 = "Struct();" + NL + "\tif (expectedFile_";
  protected final String TEXT_285 = " != null) {" + NL + "\t\tString fullFilePath_";
  protected final String TEXT_286 = " = (remoteDir_";
  protected final String TEXT_287 = " + \"/\" + expectedFile_";
  protected final String TEXT_288 = ".getName()).replaceAll(\"//\", \"/\");" + NL + "\t\t";
  protected final String TEXT_289 = ".abs_path = fullFilePath_";
  protected final String TEXT_290 = ";" + NL + "\t\t";
  protected final String TEXT_291 = ".dirname = remoteDir_";
  protected final String TEXT_292 = ";" + NL + "\t\t";
  protected final String TEXT_293 = ".basename = expectedFile_";
  protected final String TEXT_294 = ".getName();" + NL + "\t\t";
  protected final String TEXT_295 = ".size = expectedFile_";
  protected final String TEXT_296 = ".getSize();" + NL + "\t\t";
  protected final String TEXT_297 = ".mtime = expectedFile_";
  protected final String TEXT_298 = ".getTimestamp().getTimeInMillis();" + NL + "\t\t";
  protected final String TEXT_299 = ".mtime_string = expectedFile_";
  protected final String TEXT_300 = ".getTimestamp().getTime().toString();" + NL + "" + NL + "\t\t";
  protected final String TEXT_301 = NL + "\t\t\t// Calculation of the Message Digest MD5" + NL + "\t\t\tjava.io.InputStream is_";
  protected final String TEXT_302 = " = ftp_";
  protected final String TEXT_303 = ".retrieveFileStream(fullFilePath_";
  protected final String TEXT_304 = ");" + NL + "\t\t\tbyte[] buffer_";
  protected final String TEXT_305 = " = new byte[8192];" + NL + "\t\t\tint read_";
  protected final String TEXT_306 = " = 0;" + NL + "\t\t\tjava.security.MessageDigest dgs_";
  protected final String TEXT_307 = " = java.security.MessageDigest.getInstance(\"MD5\");" + NL + "" + NL + "\t\t\twhile ( (read_";
  protected final String TEXT_308 = " = is_";
  protected final String TEXT_309 = ".read(buffer_";
  protected final String TEXT_310 = ")) > 0) {" + NL + "\t\t\t\tdgs_";
  protected final String TEXT_311 = ".update(buffer_";
  protected final String TEXT_312 = ", 0, read_";
  protected final String TEXT_313 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_314 = ".md5 =String.format(\"%032x\", new java.math.BigInteger(1, dgs_";
  protected final String TEXT_315 = ".digest()));" + NL + "\t\t\t";
  protected final String TEXT_316 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_317 = " - md5 message is : '\"+ ";
  protected final String TEXT_318 = ".md5 + \"'.\"); " + NL + "\t\t  ";
  protected final String TEXT_319 = NL + "\t\t\tis_";
  protected final String TEXT_320 = ".close();" + NL + "\t\t";
  protected final String TEXT_321 = NL + "\t}";
  protected final String TEXT_322 = NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_323 = " =null;" + NL + "" + NL + "\t";
  protected final String TEXT_324 = NL + "\t\tftp_";
  protected final String TEXT_325 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_326 = "\");" + NL + "\t\t";
  protected final String TEXT_327 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_328 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_329 = " - Use an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_330 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_331 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_332 = NL + "\t";
  protected final String TEXT_333 = NL + "\t    ftp_";
  protected final String TEXT_334 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t    ftp_";
  protected final String TEXT_335 = ".setRemoteHost(";
  protected final String TEXT_336 = ");" + NL + "\t    ftp_";
  protected final String TEXT_337 = ".setRemotePort(";
  ...
  protected final String TEXT_344 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t\t";
  protected final String TEXT_345 = NL + "\t    \tftp_";
  protected final String TEXT_346 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t    ";
  ...
  protected final String TEXT_355 = ".connect();" + NL + "\t    " + NL + "\t\t";
  protected final String TEXT_356 = " " + NL + "    " + NL + "    \t";
  protected final String TEXT_357 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_358 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_359 = ");";
  protected final String TEXT_360 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_361 = " = ";
  protected final String TEXT_362 = "; ";
  protected final String TEXT_363 = NL + "    \t\t" + NL + "\t    ftp_";
  protected final String TEXT_364 = ".login(";
  protected final String TEXT_365 = ", decryptedPassword_";
  protected final String TEXT_366 = ");" + NL + "\t\t";
  protected final String TEXT_367 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_368 = " - Connect to '\" + ";
  protected final String TEXT_369 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_370 = "  " + NL + "\t";
  protected final String TEXT_371 = NL + "\t";
  protected final String TEXT_372 = NL + "\t\tftp_";
  protected final String TEXT_373 = ".setType(com.enterprisedt.net.ftp.FTPTransferType.BINARY);" + NL + "\t";
  protected final String TEXT_374 = NL + "\tString remoteDir_";
  protected final String TEXT_375 = " = ";
  protected final String TEXT_376 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "\t";
  protected final String TEXT_377 = " = new ";
  protected final String TEXT_378 = "Struct();" + NL + "  \tString remoteFile_";
  protected final String TEXT_379 = " = ";
  protected final String TEXT_380 = " + \"/\" + ";
  protected final String TEXT_381 = ";" + NL + "" + NL + "\tif (ftp_";
  protected final String TEXT_382 = ".exists(remoteFile_";
  protected final String TEXT_383 = ")) {" + NL + "\t    ";
  protected final String TEXT_384 = ".abs_path = (remoteFile_";
  protected final String TEXT_385 = ").replaceAll(\"//\", \"/\");" + NL + "\t    ";
  protected final String TEXT_386 = ".dirname = ";
  protected final String TEXT_387 = ";" + NL + "\t    ";
  protected final String TEXT_388 = ".basename = ";
  protected final String TEXT_389 = ";" + NL + "\t    ";
  protected final String TEXT_390 = ".size = ftp_";
  protected final String TEXT_391 = ".size(remoteFile_";
  protected final String TEXT_392 = ");" + NL + "\t    ";
  protected final String TEXT_393 = ".mtime = ftp_";
  protected final String TEXT_394 = ".modtime(remoteFile_";
  protected final String TEXT_395 = ").getTime();" + NL + "\t    ";
  protected final String TEXT_396 = ".mtime_string =ftp_";
  protected final String TEXT_397 = ".modtime(remoteFile_";
  protected final String TEXT_398 = ").toString();" + NL + "\t\t";
  protected final String TEXT_399 = NL + "\t\t\tlog4jSb_";
  protected final String TEXT_400 = ".append(\"";
  protected final String TEXT_401 = " - File properties for remoteDir is : '\" + ";
  protected final String TEXT_402 = " + \"',file name is : '\" + ";
  protected final String TEXT_403 = " +\"',file size is : '\" + ";
  protected final String TEXT_404 = ".size + \"',file last modify time is : '\" + ";
  protected final String TEXT_405 = ".mtime_string + \"'\");" + NL + "\t\t";
  protected final String TEXT_406 = NL + NL + "\t    ";
  protected final String TEXT_407 = NL + "\t      // Calculation of the Message Digest MD5" + NL + "\t      java.security.MessageDigest dgs_";
  protected final String TEXT_408 = " = java.security.MessageDigest.getInstance(\"MD5\");" + NL + "\t      dgs_";
  protected final String TEXT_409 = ".update(ftp_";
  protected final String TEXT_410 = ".get(remoteFile_";
  protected final String TEXT_411 = "));" + NL + "\t      ";
  protected final String TEXT_412 = ".md5 =String.format(\"%032x\", new java.math.BigInteger(1, dgs_";
  protected final String TEXT_413 = ".digest()));" + NL + "\t\t\t";
  protected final String TEXT_414 = NL + "\t\t\t\tlog4jSb_";
  protected final String TEXT_415 = ".append(\",md5 message is : '\"+ ";
  protected final String TEXT_416 = ".md5 + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_417 = NL + "\t    ";
  protected final String TEXT_418 = NL + "\t\t";
  protected final String TEXT_419 = NL + "\t\t\tlog.debug(log4jSb_";
