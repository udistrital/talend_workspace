...
public class TJMSOutputEndJava
{
  ...
  protected final String TEXT_45 = ".close();" + NL + "resourceMap.remove(\"producer_";
  protected final String TEXT_46 = "\");" + NL + "session_";
  protected final String TEXT_47 = ".close();" + NL + "resourceMap.remove(\"session_";
  protected final String TEXT_48 = "\");" + NL + "connection_";
  protected final String TEXT_49 = ".close();" + NL + "resourceMap.remove(\"connection_";
