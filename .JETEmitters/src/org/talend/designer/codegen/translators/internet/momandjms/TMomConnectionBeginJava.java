...
public class TMomConnectionBeginJava
{
  ...
  protected final String TEXT_91 = NL + "\t\tSystem.setProperty(\"com.ibm.mq.cfg.MessageProperties.PropctlToFORCE_RFH2\",\"Yes\");" + NL + "\t\tjava.util.Hashtable properties";
  ...
  protected final String TEXT_101 = NL + "\t\t        System.setProperty(\"com.ibm.mq.cfg.useIBMCipherMappings\",\"";
  protected final String TEXT_102 = "\");" + NL + "\t\t        com.ibm.mq.MQEnvironment.sslCipherSuite = ";
  protected final String TEXT_103 = ";" + NL + "\t\t    ";
  protected final String TEXT_104 = NL + "\t\t        com.ibm.mq.MQEnvironment.sslCipherSuite = \"";
  protected final String TEXT_105 = "\";" + NL + "\t\t    ";
  protected final String TEXT_106 = NL + "\t\t\tproperties";
  protected final String TEXT_107 = ".put(\"userID\",";
  ...
  protected final String TEXT_116 = NL + "\t\t\t" + NL + "\t\t\t" + NL + "\t\t\tproperties";
  protected final String TEXT_117 = ".put(\"password\",decryptedPassword_";
  protected final String TEXT_118 = ");" + NL + "\t\t";
  protected final String TEXT_119 = NL + "\t\t\tcom.ibm.mq.MQQueueManager qMgr_";
  protected final String TEXT_120 = " =  org.talend.mq.SharedWebSphereMQConnection.getMQConnection(";
  protected final String TEXT_121 = ",properties";
  protected final String TEXT_122 = ",";
  protected final String TEXT_123 = ");" + NL + "\t\t";
  protected final String TEXT_124 = NL + "\t\t\tcom.ibm.mq.MQQueueManager qMgr_";
  protected final String TEXT_125 = " = new com.ibm.mq.MQQueueManager(";
  protected final String TEXT_126 = ",properties";
  protected final String TEXT_127 = ");" + NL + "\t\t";
  protected final String TEXT_128 = NL + "\t\tglobalMap.put(\"qMgr_";
  protected final String TEXT_129 = "\", qMgr_";
