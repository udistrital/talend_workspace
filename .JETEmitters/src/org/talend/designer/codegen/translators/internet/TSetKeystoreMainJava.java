...
public class TSetKeystoreMainJava
{
  ...
  protected final String TEXT_3 = NL + "    System.setProperty(\"java.protocol.handler.pkgs\", \"com.sun.net.ssl.internal.www.protocol\");" + NL + "    javax.net.ssl.HttpsURLConnection.setDefaultHostnameVerifier(" + NL + "        new javax.net.ssl.HostnameVerifier(){" + NL + "            public boolean verify(String hostName,javax.net.ssl.SSLSession session) {" + NL + "                return true;" + NL + "            }" + NL + "" + NL + "            // Note we need this method as well or else it won't work the with the" + NL + "            // deprecated HostnameVerifier interface" + NL + "            public boolean verify(final String host, final String certHostname) {" + NL + "                return true;" + NL + "            }" + NL + "        });";
