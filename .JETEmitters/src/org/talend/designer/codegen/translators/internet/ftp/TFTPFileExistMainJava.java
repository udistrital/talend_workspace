...
public class TFTPFileExistMainJava
{
  ...
  protected final String TEXT_121 = NL + NL + "\tftp_";
  protected final String TEXT_122 = ".changeWorkingDirectory(rootDir_";
  protected final String TEXT_123 = ");";
  protected final String TEXT_124 = NL + "\t\tftp_";
  protected final String TEXT_125 = ".changeWorkingDirectory(remoteDir_";
  protected final String TEXT_126 = ");";
  protected final String TEXT_127 = NL + "\t\tString remoteDir_";
  protected final String TEXT_128 = " = (";
  protected final String TEXT_129 = ").replaceAll(\"\\\\\\\\\",\"/\");" + NL + "\t\tif (ftp_";
  protected final String TEXT_130 = ".exists";
  protected final String TEXT_131 = "(remoteDir_";
  protected final String TEXT_132 = " + \"/\" + ";
  protected final String TEXT_133 = ")) {" + NL + "\t\t\t";
  protected final String TEXT_134 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_135 = " - '\" + ";
  protected final String TEXT_136 = " + \"' exists in the remote directory '\"+ ";
  protected final String TEXT_137 = " + \"' .\");" + NL + "\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_139 = "_EXISTS\", true);" + NL + "\t\t} else {" + NL + "\t\t\t";
  protected final String TEXT_140 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_141 = " - '\" + ";
  protected final String TEXT_142 = " + \"' doesn't exist in the remote directory '\"+ ";
  protected final String TEXT_143 = " + \"' .\");" + NL + "\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_145 = "_EXISTS\", false);" + NL + "\t\t}" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_146 = "_FILENAME\", ";
  protected final String TEXT_147 = ");" + NL + "\t";
  protected final String TEXT_148 = NL + "\t\tString remoteDir_";
  protected final String TEXT_149 = " = (";
  protected final String TEXT_150 = ").replaceAll(\"\\\\\\\\\",\"/\");" + NL + "\t\tString directoryname_";
  protected final String TEXT_151 = " = (";
  protected final String TEXT_152 = ").replaceAll(\"\\\\\\\\\",\"/\");" + NL + "\t\tif (ftp_";
  protected final String TEXT_153 = ".exists";
  protected final String TEXT_154 = "(remoteDir_";
  protected final String TEXT_155 = " + \"/\" + directoryname_";
  protected final String TEXT_156 = ")) {" + NL + "\t\t\t";
  protected final String TEXT_157 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_158 = " - '\" + ";
  protected final String TEXT_159 = " + \"' exists in the remote directory '\"+ ";
  protected final String TEXT_160 = " + \"' .\");" + NL + "\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_162 = "_EXISTS\", true);" + NL + "\t\t} else {" + NL + "\t\t\t";
  protected final String TEXT_163 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_164 = " - '\" + ";
  protected final String TEXT_165 = " + \"' doesn't exist in the remote directory '\"+ ";
  protected final String TEXT_166 = " + \"' .\");" + NL + "\t\t\t";
  protected final String TEXT_167 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_168 = "_EXISTS\", false);" + NL + "\t\t}" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_169 = "_DIRECTORYNAME\", ";
