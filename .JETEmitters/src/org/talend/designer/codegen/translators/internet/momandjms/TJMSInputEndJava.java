...
public class TJMSInputEndJava
{
  ...
  protected final String TEXT_44 = NL + "\tnbline_";
  protected final String TEXT_45 = "++;" + NL + "\tmessage_";
  protected final String TEXT_46 = ".acknowledge();" + NL + "\tif(";
  protected final String TEXT_47 = " > 0 && nbline_";
  protected final String TEXT_48 = " >= ";
  protected final String TEXT_49 = "){" + NL + "\t\tbreak;" + NL + "\t}" + NL + "\t" + NL + "}" + NL + "consumer_";
  protected final String TEXT_50 = ".close();" + NL + "resourceMap.remove(\"consumer_";
  protected final String TEXT_51 = "\");" + NL + "session_";
  protected final String TEXT_52 = ".close();" + NL + "resourceMap.remove(\"session_";
  protected final String TEXT_53 = "\");" + NL + "connection_";
  protected final String TEXT_54 = ".close();" + NL + "resourceMap.remove(\"connection_";
