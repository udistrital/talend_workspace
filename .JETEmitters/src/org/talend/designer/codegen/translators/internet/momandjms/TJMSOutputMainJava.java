...
public class TJMSOutputMainJava
{
  ...
  protected final String TEXT_45 = ".send((javax.jms.Message)";
  protected final String TEXT_46 = ".message);" + NL + "nbline_";
  protected final String TEXT_47 = "++;";
  protected final String TEXT_48 = NL + "javax.jms.ObjectMessage message_";
  protected final String TEXT_49 = " = session_";
  protected final String TEXT_50 = ".createObjectMessage();" + NL + "message_";
  protected final String TEXT_51 = ".setObject(";
  protected final String TEXT_52 = ".messageContent);";
  protected final String TEXT_53 = NL + "javax.jms.TextMessage message_";
  protected final String TEXT_54 = " = session_";
  protected final String TEXT_55 = ".createTextMessage();" + NL + "message_";
  protected final String TEXT_56 = ".setText(";
  protected final String TEXT_57 = ".messageContent);";
  protected final String TEXT_58 = NL + "producer_";
  protected final String TEXT_59 = ".send(message_";
  protected final String TEXT_60 = ");" + NL + "" + NL + "nbline_";
