...
public class TServiceNowOutputBeginJava
{
  ...
  protected final String TEXT_50 = "=0;" + NL + "\t\tint rejectedCount_";
  protected final String TEXT_51 = "=0;" + NL + "\t\tboolean whetherReject_";
  protected final String TEXT_52 = " = false;" + NL + "\t\t";
  protected final String TEXT_53 = NL + "\t\tString ";
  protected final String TEXT_54 = "_domain = null;" + NL + "\t\tString ";
  protected final String TEXT_55 = "_URL = null;" + NL + "" + NL + "//Connection method set" + NL + "\t\t";
  ...
  protected final String TEXT_64 = "_URL = StringHandling.EREPLACE(";
  ...
  protected final String TEXT_68 = "_usernamePasswordCredentials = new org.apache.http.auth.UsernamePasswordCredentials(";
  protected final String TEXT_69 = ", decryptedPassword_";
  protected final String TEXT_70 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_71 = NL + "\t\t\t\t";
  protected final String TEXT_72 = "_URL = ((String)globalMap.get(";
  protected final String TEXT_73 = "));" + NL + "\t\t\t\t\t";
  protected final String TEXT_74 = "_domain = ";
  protected final String TEXT_75 = "_URL.replaceAll(\"https?://\", \"\");" + NL + "\t\t\t\torg.apache.http.auth.UsernamePasswordCredentials ";
  protected final String TEXT_76 = "_usernamePasswordCredentials = new org.apache.http.auth.UsernamePasswordCredentials((String)globalMap.get(";
  protected final String TEXT_77 = "), (String)globalMap.get(";
  protected final String TEXT_78 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_79 = NL + "//Credential def" + NL + "\t\t\torg.apache.http.client.CredentialsProvider ";
  protected final String TEXT_80 = "_credsProvider = new org.apache.http.impl.client.BasicCredentialsProvider();" + NL + "\t\t\t";
  protected final String TEXT_81 = "_credsProvider.setCredentials(" + NL + "\t\t\t\tnew org.apache.http.auth.AuthScope(new org.apache.http.HttpHost(";
  protected final String TEXT_82 = "_domain)), new org.apache.http.auth.UsernamePasswordCredentials(" + NL + "\t\t\t\t\t";
  protected final String TEXT_83 = "_usernamePasswordCredentials.getUserName(), ";
  protected final String TEXT_84 = "_usernamePasswordCredentials.getPassword()" + NL + "\t\t\t\t\t)" + NL + "\t\t\t\t);" + NL + "\t\t\torg.apache.http.impl.client.CloseableHttpClient ";
  protected final String TEXT_85 = "_httpclient = org.apache.http.impl.client.HttpClients.custom()" + NL + "\t\t\t.setDefaultCredentialsProvider(";
  protected final String TEXT_86 = "_credsProvider)" + NL + "\t\t\t.build();" + NL + "\t\t\tresourceMap.put(\"";
  protected final String TEXT_87 = "_httpclient\", ";
  protected final String TEXT_88 = "_httpclient);" + NL + "//Set httpPut" + NL + "\t\t\torg.apache.http.client.methods.HttpPut ";
  protected final String TEXT_89 = "_httpPut = new org.apache.http.client.methods.HttpPut(); " + NL + "//Set httpPost" + NL + "\t\t\torg.apache.http.client.methods.HttpPost ";
  protected final String TEXT_90 = "_httpPost = new org.apache.http.client.methods.HttpPost();" + NL + "//Set Cookie" + NL + "\t//remove comment if the connection to sandbox is unreliable" + NL + "\t//you will have to uncomment the setHeader in the main javajet  " + NL + "\t\t\t//String ";
  protected final String TEXT_91 = "_cookie = \"BIGipServerpool_sandbox=791923210.34366.0000; glide_user_route=glide.9965bccaa8dddc4d2c053eefc54fdcb3; JSESSIONID=55CBDCFB6E2B6A07EF4E023CC3F1627E; _gat=1; _ga=GA1.2.1976595674.1437483024; _gat_rollup=1; __CJ_g_startTime=%221437560900688%22\";" + NL + "//Set entity" + NL + "\t\t\torg.apache.http.HttpEntity ";
  protected final String TEXT_92 = "_entity = null;" + NL + "\t\t\torg.apache.http.client.methods.CloseableHttpResponse ";
  protected final String TEXT_93 = "_response = null;" + NL + "// Set response" + NL + "\t\t\tString ";
  protected final String TEXT_94 = "_responseBody = null;" + NL + "\t\t\tint ";
  protected final String TEXT_95 = "_responseCode = 0;" + NL + "\t\t\torg.json.JSONObject ";
  protected final String TEXT_96 = "_jsonResponse = new org.json.JSONObject();" + NL + "\t\t\t";
