...
public class TServiceNowOutputFinallyJava
{
  ...
  protected final String TEXT_46 = NL + "if(resourceMap.get(\"finish_";
  protected final String TEXT_47 = "\") == null) {" + NL + "\tif(resourceMap.get(\"";
  protected final String TEXT_48 = "_httpclient\") != null) {" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\t((org.apache.http.impl.client.CloseableHttpClient)resourceMap.get(\"";
  protected final String TEXT_49 = "_httpclient\")).close();" + NL + "\t\t}" + NL + "\t\tcatch(org.apache.http.conn.HttpHostConnectException httpEx_";
  protected final String TEXT_50 = ")" + NL + "\t\t{" + NL + "\t\t\tString errorMessage_";
  protected final String TEXT_51 = " = \"Failed to close the connection in ";
  protected final String TEXT_52 = " :\" + httpEx_";
  protected final String TEXT_53 = ".getMessage();" + NL + "\t\t\t";
  protected final String TEXT_54 = "log.warn(\"errorMessage_";
