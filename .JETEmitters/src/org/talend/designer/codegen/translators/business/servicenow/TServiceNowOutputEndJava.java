...
public class TServiceNowOutputEndJava
{
  ...
  protected final String TEXT_51 = "_NB_LINE_REJECTED\", nb_line_rejected_";
  protected final String TEXT_52 = ");" + NL;
  protected final String TEXT_53 = NL + "\tif (nb_line_inserted_";
  protected final String TEXT_54 = " == 0 && nb_line_update_";
  protected final String TEXT_55 = " == 0 && nb_line_rejected_";
  protected final String TEXT_56 = " != 0) {" + NL + "\t\tlog.warn(\"";
  protected final String TEXT_57 = " - All '\" + \"";
  protected final String TEXT_58 = "\".toUpperCase() + \"' requests have been rejected.\");" + NL + "\t} else {" + NL + "\t\t";
  protected final String TEXT_59 = "log.info(\"";
  protected final String TEXT_60 = " - Inserted records count: \" + nb_line_inserted_";
  protected final String TEXT_61 = " + \".'\");";
  protected final String TEXT_62 = "log.info(\"";
  protected final String TEXT_63 = " - Updated records count: \" + nb_line_update_";
  protected final String TEXT_64 = " + \".'\");";
  protected final String TEXT_65 = NL + "\t}" + NL + "\t";
  protected final String TEXT_66 = NL;
  protected final String TEXT_67 = NL;
  protected final String TEXT_68 = "_httpclient.close();" + NL + "resourceMap.put(\"finish_";
