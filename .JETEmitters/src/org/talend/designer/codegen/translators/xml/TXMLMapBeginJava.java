...
public class TXMLMapBeginJava {
  ...
  protected final String TEXT_91 = "\", TalendString.replaceSpecialCharForXML(FormatterUtils.fm(valueMap.get(\"";
  ...
  protected final String TEXT_99 = ",\"\",FormatterUtils.fm(valueMap.get(\"";
  ...
  protected final String TEXT_108 = "\",FormatterUtils.fm(valueMap.get(\"";
  ...
  protected final String TEXT_173 = ",FormatterUtils.fm(valueMap.get(\"";
